#!/usr/bin/env python3
"""
Category Hub Page Generator for BJJ Map
...
class CategoryHubPageGenerator:
    ...
    def generate_schema_markup(self, category_name: str, items: List[ContentItem]) -> str:
        ...
        webpage_schema = {
            ...
            "url": f"https://bjjmap.pages.dev/{category_info['url_slug']}",
            "isPartOf": {
                "@type": "WebSite",
                "name": "BJJ Map",
        ...
        for i, item in enumerate(items, 1):
            item_list_elements.append({
                ...
                "position": i,
                "name": item.name,
                "url": f"https://bjjmap.pages.dev/{category_info['dir']}/{item.slug}"
            })
        ...
        breadcrumb_schema = {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "item": f"https://bjjmap.pages.dev/{category_info['url_slug']}"
                }
            ]
        }
...
"""
        ...
        # Build complete page
        hub_page = f"""---
title: "{category_info['page_title']} | BJJ Map"
description: "{category_info['description']}"
---
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate BJJ Map hub pages from content directories"
    )
    parser.add_argument(
        "--category",
