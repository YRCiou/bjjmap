...
const TITLE = "Shared technique list · BJJ Map";
...
html = html.replace(
  ...
  '<link rel="canonical" href="https://bjjmap.pages.dev/"/>',
);
...
const OG_TITLE = "A shared technique list · BJJ Map";
const OG_DESC =
...
const ogRewrites = [
  ...
  [
    ...
    `<meta property="og:url" content="https://bjjmap.pages.dev/l/" data-share-og="url"/>`,
  ],
  [
