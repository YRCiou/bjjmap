...
//
// MODE 1 (bridge into the owner's own tab at bjjmap:8080, served by dev-serve):
...
OWNER — just RELOAD the page you're browsing at ${DEV_SERVE.replace("localhost", "bjjmap")} —
