...
description: How BJJMap collects, uses, stores, and protects your data.
---
...
<script type="application/ld+json">
{
  ...
  "name": "Privacy Policy",
  "description": "How BJJMap collects, uses, stores, and protects your data.",
  "url": "https://bjjmap.pages.dev/privacy",
...
This Privacy Policy explains how **BJJMap** ("BJJMap", "we", "us") collects, uses, stores, and shares information when you use the website at [bjjmap.pages.dev](https://bjjmap.pages.dev) (the "Service"). BJJMap is an educational Brazilian Jiu-Jitsu knowledge graph and training tool operated by YRCiou as an individual. The Service is currently in **beta** and under active development.

If you have any questions about this policy or your data, contact us at **[support@bjjmap.pages.dev](mailto:support@bjjmap.pages.dev)**.

## In short

- You can use almost all of BJJMap **anonymously**. Your training progress is stored **on your own device** and never leaves it unless you choose to create an account.
...
The Service is operated by **YRCiou**, an individual, at the domain **bjjmap.pages.dev**. For any privacy request or question, the data controller can be reached at **[support@bjjmap.pages.dev](mailto:support@bjjmap.pages.dev)**.
...
To exercise any of these rights, email **[support@bjjmap.pages.dev](mailto:support@bjjmap.pages.dev)**.

## Account and data deletion

- **Signing out** clears your session from your device.
- To **delete your account and all associated synced data**, email **[support@bjjmap.pages.dev](mailto:support@bjjmap.pages.dev)** and we will action the request.
