...
---
title: "3-4 Mount to S Mount | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "3-4 Mount to S Mount", "item": "https://bjjmap.pages.dev/Transitions/3-4-Mount-to-S-Mount" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "3-4 Mount to S Mount \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "S-mount troubleshooting (no-gi)",
      "description": "3-4 Mount to S Mount film study: S-mount troubleshooting (no-gi), taught by ZombieProofBJJ.",
    ...
    },
    {
      ...
      "description": "3-4 Mount to S Mount film study: Transition to S-mount, taught by Procel BJJ.",
...
<p class="section-subtitle">Watch 3-4 Mount to S Mount in action — curated instructionals</p>
...
| **Key Principles** | Isolate the near-side arm before initiating any rotational m... | Protect the near-side arm at all costs—keep it bent with elb... |
...
[[3-4 Mount to S Mount/Attacker|→ Full Attacker Guide]]
...
[[3-4 Mount to S Mount/Defender|→ Full Defender Guide]]
