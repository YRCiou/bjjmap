...
---
title: "Single Leg X-Guard to Inside Sankaku | BJJ Technique | BJJ Map"
description: "Master the Single Leg X-Guard to Inside Sankaku entry in BJJ. Elevate, off-balance, and spin under to lock the Honey Hole figure-four with inside heel exposure."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Single Leg X-Guard to Inside Sankaku", "item": "https://bjjmap.pages.dev/Transitions/Single-Leg-X-Guard-to-Inside-Sankaku" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Single Leg X-Guard to Inside Sankaku",
  "description": "The Single Leg X-Guard to Inside Sankaku is a leg-entanglement entry in which the bottom player elevates and off-balances the standing opponent, then spins underneath to fold their own top leg over the trapped leg, locking the Honey Hole figure-four with the inside heel exposed.",
...
<p class="also-known-as"><em>Also known as:</em> <strong>SLX to Honey Hole</strong>, <strong>Single Leg X to 411</strong></p>
</aside>
<div class="role-links">

[[Single Leg X-Guard to Inside Sankaku/Attacker|Play as Attacker]]
[[Single Leg X-Guard to Inside Sankaku/Defender|Play as Defender]]
...
| **Key Principles** | Elevate and off-balance the opponent before spinning so thei... | Keep your weight settled and your free foot heavy so the bot... |
...
[[Single Leg X-Guard to Inside Sankaku/Attacker|→ Full Attacker Guide]]
...
[[Single Leg X-Guard to Inside Sankaku/Defender|→ Full Defender Guide]]
...
- [[Positions/Inside Sankaku]] - Target position - the Honey Hole entanglement reached on a successful entry

- [[Transitions/Single Leg X Sweep]] - Alternative use of the same single leg X-guard control, sweeping to top instead of entering the entanglement

- [[Transitions/Inside Sankaku Heel Hook]] - Primary follow-up submission once the entanglement is locked

- [[Transitions/Inside Sankaku to Saddle]] - Common positional advancement from the entanglement when the opponent rotates

- [[Positions/Ashi Garami/Saddle]] - Adjacent leg entanglement frequently chained with Inside Sankaku

- [[Positions/Ashi Garami/Outside Ashi-Garami]] - Related entanglement reached if the opponent rotates to clear the inside heel

- [[Positions/Ashi Garami/50-50 Guard]] - Counter-entanglement the opponent may reach if they re-enter your leg during the spin

- [[Positions/Standing Position]] - Neutral reset reached if the opponent clears the leg and stands during the entry
