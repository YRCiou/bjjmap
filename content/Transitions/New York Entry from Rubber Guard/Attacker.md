...
---
title: "New York Entry from Rubber Guard Attacker | BJJ Technique Guide | BJJ Map"
description: "Execute the New York entry from Rubber Guard with precise overhook threading and shin control. Master timing, grip sequences, and systematic 10th Planet progression."
---
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "New York Entry from Rubber Guard Attacker",
  "description": "Execute the New York entry from Rubber Guard with precise overhook threading and shin control. Master timing, grip sequences, and systematic 10th Planet progression.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/New-York-Entry-from-Rubber-Guard/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "New York Entry from Rubber Guard (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Prison guard breakdown from rubber guard",
      "description": "New York Entry from Rubber Guard (Attacker) film study: Prison guard breakdown from rubber guard, taught by Eddie Bravo.",
    ...
    },
    {
      ...
      "description": "New York Entry from Rubber Guard (Attacker) film study: Mission Control to Zombie to Invisible Collar, taught by 10th Planet Orange Park.",
    ...
    },
    {
      ...
      "description": "New York Entry from Rubber Guard (Attacker) film study: Basic entries into rubber guard, taught by BJJ4Breakfast.",
...
<p class="section-subtitle">Watch New York Entry from Rubber Guard (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing New York Entry from Rubber Guard?</p>
...
<p class="section-subtitle">What do you need before attempting New York Entry from Rubber Guard?</p>
...
<p class="section-subtitle">How do you execute New York Entry from Rubber Guard step by step?</p>
...
<p class="section-subtitle">How might your opponent counter New York Entry from Rubber Guard?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing New York Entry from Rubber Guard?</p>
...
**Phase 5: Live Positional Sparring** - Application under competition conditions
Start from Rubber Guard in live positional rounds with full resistance. The goal is to reach New York and advance to at least one follow-up position (Invisible Collar, Carni, Chill Dog) within 60 seconds. Track success rates and identify recurring failure patterns. Adjust technique based on which counters you face most frequently.
...
<p class="section-subtitle">What are the safety concerns for New York Entry from Rubber Guard?</p>
