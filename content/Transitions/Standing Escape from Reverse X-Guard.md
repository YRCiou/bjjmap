...
---
title: "Standing Escape from Reverse X-Guard | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Standing Escape from Reverse X-Guard", "item": "https://bjjmap.pages.dev/Transitions/Standing-Escape-from-Reverse-X-Guard" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Standing Escape from Reverse X-Guard",
  "description": "The Standing Escape from Reverse X-Guard is a top-player disengagement that breaks the bottom player's grips, strips both hooks in sequence, and extracts the trapped leg to return safely to neutral standing rather than risk a sweep or leg-lock entry.",
...
[[Standing Escape from Reverse X-Guard/Attacker|Play as Attacker]]
[[Standing Escape from Reverse X-Guard/Defender|Play as Defender]]

</div>

<section id="overview" class="content-section">

**The Standing Escape from Reverse X-Guard is a top-player disengagement that breaks the bottom player's grips, strips both hooks in sequence, and extracts the trapped leg to return safely to neutral standing rather than risk a sweep or leg-lock entry.**
