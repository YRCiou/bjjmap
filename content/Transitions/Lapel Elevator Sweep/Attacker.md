...
---
title: "Lapel Elevator Sweep Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Lapel Elevator Sweep in BJJ. Attacking perspective with setup, execution steps, and counters."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Lapel Elevator Sweep in BJJ",
  "description": "Step-by-step guide for executing Lapel Elevator Sweep from Lapel Guard/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish lapel configuration",
      "text": "Secure the lapel grip with your primary hand, threading the fabric around opponent's thigh or through your guard structure. Maintain constant tension on the lapel to keep them connected to your control system.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Set butterfly hook",
      "text": "Position your butterfly hook on the inner thigh of the opponent's lead leg, same side as your lapel grip. Your foot should be active with toes pointed toward their hip, not passive on the mat.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Control posting hand",
      "text": "Use your secondary grip to control their sleeve or wrist on the side you intend to sweep. This prevents them from posting their hand to base out during the sweep execution.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Break posture forward",
      "text": "Pull sharply on the lapel grip while simultaneously pulling their controlled arm toward you. This loads their weight onto your butterfly hook and breaks their posture forward.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Elevate and turn",
      "text": "Drive your butterfly hook upward while simultaneously turning your body toward the sweep side. Your hip rotation and hook elevation work together—don't try to lift them straight up, angle them over your body.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Follow to mount",
      "text": "As opponent tips over, maintain your lapel grip and immediately follow their falling body. Release the butterfly hook and transition your hips over their torso, establishing mount before they can recover guard.",
      "position": 6
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the primary mechanical advantage the lapel grip provides during the Lapel Elevator Sweep?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The lapel grip creates a persistent connection that prevents the opponent from posting their hand or stepping their leg out to base against the sweep. Unlike a traditional sleeve grip that only controls one limb, the lapel wrapping around their body eliminates multiple defensive options simultaneously, channeling all their momentum into the sweep direction."
      }
    },
    {
      "@type": "Question",
      "name": "What position do you start the Lapel Elevator Sweep from and what must already be established?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "What are the key grips needed for the Lapel Elevator Sweep?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You need a primary grip on the lapel fabric (pistol grip or four-finger hook) maintaining constant tension, plus a secondary grip on opponent's sleeve or wrist on the sweep side to prevent them from posting their hand to base out. The secondary grip is equally critical—without it, the sweep fails even with perfect lapel mechanics."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "When is the optimal timing window to execute the Lapel Elevator Sweep?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Lapel Elevator Sweep Attacker",
  "description": "How to execute Lapel Elevator Sweep in BJJ. Attacking perspective with setup, execution steps, and counters.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Lapel-Elevator-Sweep/Attacker"
    }
  ]
}
</script>
...
<p class="section-subtitle">What are the key principles for executing Lapel Elevator Sweep?</p>
...
<p class="section-subtitle">What do you need before attempting Lapel Elevator Sweep?</p>
...
<p class="section-subtitle">How do you execute Lapel Elevator Sweep step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Lapel Elevator Sweep?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Lapel Elevator Sweep?</p>
...
<p class="section-subtitle">How do you train Lapel Elevator Sweep (Attacker)?</p>

**Week 1-2** - Grip mechanics and body positioning
Practice lapel extraction and configuration without resistance. Focus on finding the correct depth for the lapel wrap and establishing proper butterfly hook placement. Partner remains stationary while you drill the setup repeatedly.

**Week 3-4** - Sweep timing and coordination
Partner provides light forward pressure. Practice timing the sweep to catch their weight shift. Focus on coordinating the lapel pull, sleeve control, and hook elevation as one fluid motion.

**Week 5-6** - Counter integration and chains
Partner provides moderate resistance and occasionally defends the sweep. Practice transitioning to omoplata when they post, or following with back take when they posture away. Develop reactions to common counters.

**Week 7+** - Live application and troubleshooting
Apply the sweep in positional sparring and full rolls. Identify which opponents and body types respond best to this sweep. Refine timing based on real resistance and develop setup combinations.
...
<p class="section-subtitle">What are the safety concerns for Lapel Elevator Sweep?</p>
