...
---
title: "Frame to Guard from Kesa Gatame | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Frame to Guard from Kesa Gatame", "item": "https://bjjmap.pages.dev/Transitions/Frame-to-Guard-from-Kesa-Gatame" }
  ]
}
</script>
...
[[Frame to Guard from Kesa Gatame/Attacker|→ Full Attacker Guide]]
...
[[Frame to Guard from Kesa Gatame/Defender|→ Full Defender Guide]]
...
**Ghost Frame Recovery**: Uses initial frames to create space, then transitions into sliding the hips out behind the opponent rather than pushing them away for a direct guard recovery. The framing creates enough separation for the bottom player to turn away and extract their body, recovering to turtle or open guard from behind the opponent. (When to use: When the opponent maintains extremely tight head control that prevents knee insertion from the front, making standard guard recovery impractical despite successful frame creation.)


**Leg Hook Frame Recovery**: Combines forearm frame creation with near-side leg hooks on the opponent's posted leg to simultaneously disrupt their base while generating space for guard recovery. The leg hook pulls the opponent's base leg inward while frames push their upper body outward, creating a dual-vector space creation that accelerates the escape. (When to use: When the opponent posts their near leg close enough to hook, particularly effective against opponents who sit back heavily with a narrow base in Kesa Gatame.)


**Stiff Arm Frame to Sit-Up**: Rather than hip escaping laterally, uses a stiff arm frame on the opponent's shoulder to create enough vertical space to sit up and face them directly. The bottom player transitions from supine to seated position, recovering to a butterfly guard or seated open guard facing the opponent. (When to use: When the opponent sits back with their weight away from your chest, creating enough vertical clearance for a sit-up recovery rather than requiring lateral hip escape.)
