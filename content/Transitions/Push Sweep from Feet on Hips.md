...
---
title: "Push Sweep from Feet on Hips | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Push Sweep from Feet on Hips", "item": "https://bjjmap.pages.dev/Transitions/Push-Sweep-from-Feet-on-Hips" }
  ]
}
</script>
...
| **Key Principles** | Time the push to coincide with the opponent's forward weight... | Maintain low center of gravity with hips back to prevent the... |
...
[[Push Sweep from Feet on Hips/Attacker|→ Full Attacker Guide]]
...
[[Push Sweep from Feet on Hips/Defender|→ Full Defender Guide]]
