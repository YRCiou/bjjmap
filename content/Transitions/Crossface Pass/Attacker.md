...
---
title: "Crossface Pass Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Crossface Pass in BJJ. Attacking perspective with setup, execution steps, and counters from half guard top."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for executing Crossface Pass from Half Guard/Top.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "What is the correct leg extraction motion and why does a straight pull fail?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Crossface-Pass/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Crossface Pass (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Half guard top cross body pass",
      "description": "Crossface Pass (Attacker) film study: Half guard top cross body pass, taught by SBG New Braunfels.",
    ...
    },
    {
      ...
      "description": "Crossface Pass (Attacker) film study: How to create an insanely tight cross face, taught by Escapology BJJ.",
...
<p class="section-subtitle">Watch Crossface Pass (Attacker) in action — curated instructionals</p>
...
Partner uses full resistance with all common defensive responses: deep underhooks, knee shields, electric chair setups, and frame battles. Practice recognizing and countering each defensive attempt while maintaining technical precision. Begin timing the full sequence.

**Phase 6: Integration and Flow (Ongoing)** - Combining with other half guard passing options
Practice transitioning between crossface pass and other half guard passes (knee slice, smash, backstep) based on opponent's defensive reactions. Develop the ability to chain techniques and recognize when crossface pass is highest percentage versus when to switch strategies. Incorporate into live rolling.
