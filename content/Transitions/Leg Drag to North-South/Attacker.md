...
---
title: "Leg Drag to North-South Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Leg Drag to North-South in BJJ. Attacking perspective with setup, execution steps, and counters."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Leg Drag to North-South in BJJ",
  "description": "Step-by-step guide for executing Leg Drag to North-South from Leg Drag Control/Top.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Assess defensive structure",
      "text": "From leg drag control, recognize when opponent has committed strong frames at your shoulder and hip preventing direct mount or side control entry. Their energy is directed laterally.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Secure arm control",
      "text": "Control opponent's near-side arm by pinning it to the mat with your hand or trapping it against their body with your shoulder pressure. This arm becomes the anchor for your transition.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Release leg control",
      "text": "Let go of the dragged leg grip while maintaining upper body pressure. Your chest weight transfers fully to their shoulder and upper chest area to prevent them from turning toward you.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Circle toward head",
      "text": "Walk your feet in an arc toward opponent's head while keeping your chest glued to their upper body. Your hips stay low, sliding across the mat rather than lifting. Do not create space.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Clear the shoulder line",
      "text": "Continue circling until your body crosses perpendicular to their spine. Your chest transitions from their shoulder to directly over their sternum. Control their far arm as it becomes accessible.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Establish north-south control",
      "text": "Complete the transition by settling chest-to-chest with your hips low and spread wide for base. Control both arms by pinning them with your armpits or gripping their elbows. Your head should be at their hip level.",
      "position": 6
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the primary goal of the leg drag to north-south transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The primary goal is to consolidate a dominant control position when the opponent successfully defends against mount and side control entries from leg drag. Rather than fighting through strong defensive frames, you circle around them to north-south where their hip escape capability is neutralized and submission options become available."
      }
    },
    {
      "@type": "Question",
      "name": "What position do you start the leg drag to north-south transition from?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "This technique starts from leg drag control top position, where you have the opponent's leg pulled across their body and are applying shoulder pressure to their upper body. The position is typically reached after a successful leg drag pass attempt."
      }
    },
    {
      "@type": "Question",
      "name": "What are the key grips and control points needed for the leg drag to north-south transition?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Your opponent starts framing at your hips during the transition—how do you respond?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Keep your hips extremely low and heavy during the transition so frames cannot gain purchase. Do not fight the frames directly or stop to strip them—continue the circular motion around their frames while maintaining chest pressure. The movement itself negates frame effectiveness."
      }
    },
    {
      "@type": "Question",
      "name": "When is the optimal time to attempt the leg drag to north-south transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The optimal timing is when the opponent has committed strong frames and defensive energy toward blocking your mount or side control transitions. Their defensive attention is directed laterally, creating a vulnerable corridor toward their head. Attempting this when they're not actively defending other options wastes the strategic advantage."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Your hips must stay extremely low throughout the entire transition—sliding across the mat rather than lifting. Lifting your hips creates space that allows the opponent to insert frames, recover guard with a knee, or turn to turtle. Low hips maintain constant pressure and prevent defensive reactions."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Leg Drag to North-South Attacker",
  "description": "How to execute Leg Drag to North-South in BJJ. Attacking perspective with setup, execution steps, and counters.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Leg-Drag-to-North-South"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Leg-Drag-to-North-South/Attacker"
    }
  ]
}
</script>
...
<p class="section-subtitle">What are the key principles for executing Leg Drag to North-South?</p>
...
<p class="section-subtitle">What do you need before attempting Leg Drag to North-South?</p>
...
<p class="section-subtitle">How do you execute Leg Drag to North-South step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Leg Drag to North-South?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Leg Drag to North-South?</p>
...
<p class="section-subtitle">How do you train Leg Drag to North-South (Attacker)?</p>
...
<p class="section-subtitle">What are the safety concerns for Leg Drag to North-South?</p>
