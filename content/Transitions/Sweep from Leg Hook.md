...
---
title: "Sweep from Leg Hook | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Sweep from Leg Hook", "item": "https://bjjmap.pages.dev/Transitions/Sweep-from-Leg-Hook" }
  ]
}
</script>
...
| **Key Principles** | Unify upper body control and leg hook into a single coordina... | Maintain centered base with weight distributed evenly to res... |
...
[[Sweep from Leg Hook/Attacker|→ Full Attacker Guide]]
...
[[Sweep from Leg Hook/Defender|→ Full Defender Guide]]
