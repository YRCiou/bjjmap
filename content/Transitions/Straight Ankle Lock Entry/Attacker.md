...
---
title: "Straight Ankle Lock Entry Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Straight Ankle Lock Entry in BJJ. Attacking perspective with setup, execution steps, and counters."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Straight Ankle Lock Entry in BJJ",
  "description": "Step-by-step guide for executing Straight Ankle Lock Entry from Grasshopper Guard/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Identify the target ankle",
      "text": "From grasshopper guard with hips elevated, identify which of the opponent's feet is closest to your body and bearing the most weight. This lead foot becomes your primary target because it cannot easily retract without the opponent losing balance.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Shoot outside leg across hip line",
      "text": "Drive your outside leg (the leg furthest from the target ankle) across the opponent's hip line, placing your foot on their far hip. This leg acts as a barrier preventing them from stepping backward or circling away from your entry attempt.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Thread inside leg behind far knee",
      "text": "Simultaneously thread your inside leg (closest to target ankle) behind the opponent's far knee, hooking with your calf or hamstring. This creates a pincer with your outside leg, trapping their lower body between your two legs and restricting their hip mobility.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Capture the ankle with both hands",
      "text": "As your legs frame the opponent's lower body, reach both hands toward the target ankle. Your near hand cups the heel from underneath while your far hand wraps over the top of the foot near the toes. Secure a tight two-on-one grip before proceeding, pulling the ankle toward your chest.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Close the figure-four leg clamp",
      "text": "With the ankle secured in your hands, close your legs into a tight figure-four configuration by triangling your legs around the opponent's trapped leg. Your outside leg crosses over the inside leg's ankle, creating a locked structure that prevents the opponent from pulling their leg free.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Hip escape to finishing angle",
      "text": "Execute a small hip escape away from the captured leg, turning your body perpendicular to the opponent's trapped limb. This angular adjustment is critical because it aligns your forearm blade across the Achilles tendon at the proper angle for maximum submission pressure.",
      "position": 6
    },
    {
      "@type": "HowToStep",
      "name": "Establish Straight Ankle Lock Control",
      "text": "Pull the captured ankle tight against your chest with your forearm blade positioned across the Achilles tendon just above the heel. Squeeze your knees together to prevent the opponent from rotating their knee inward (which would relieve pressure), and arch your hips slightly to begin applying breaking pressure on the ankle joint.",
      "position": 7
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the optimal timing window for initiating the Straight Ankle Lock Entry from grasshopper guard?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Attack when the opponent commits weight onto their lead foot — stepping forward, reaching for your legs, or starting a pass. This weight commitment prevents them from quickly retracting the targeted foot and gives you the critical extra time needed to complete the entry sequence. Attacking a retreating or evenly balanced opponent dramatically reduces success rates."
      }
    },
    {
      "@type": "Question",
      "name": "What conditions must exist in your grasshopper guard before you can attempt the ankle lock entry?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You need hips elevated to chest height, at least one leg contacting the opponent's lower body, and clear sight of their weighted foot. Active core engagement keeps the elevated position stable, and the leg contact prevents disengagement. Without hip elevation you lack the lateral reach for leg framing, without leg contact the opponent can simply walk away, and without target identification you risk attacking the wrong foot."
      }
    },
    {
      "@type": "Question",
      "name": "Why must the outside leg cross the opponent's hip line before the inside leg threads behind the knee?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The outside leg serves as a barrier that prevents the opponent from stepping backward or circling away from the entry. If you thread the inside leg first without blocking their retreat path, the opponent can simply step their lead foot back and your inside leg threads into empty space. The outside leg pins their base in place, creating the frame that allows the inside leg to complete the entanglement against a trapped opponent."
      }
    },
    {
      "@type": "Question",
      "name": "Your opponent strips your ankle grip while your figure-four is only partially closed - how do you adjust?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Immediately transition to a kneebar attack on the same leg. Since your legs are already partially entangled around their lower body, thread deeper by pushing your inside leg higher behind their knee while your outside leg crosses over their thigh. The opponent's hand-fighting to strip your ankle grip commits their upper body forward and away from their knee, creating the opening for the kneebar. Do not attempt to re-grip the ankle from a compromised position."
      }
    },
    {
      "@type": "Question",
      "name": "What grip configuration provides the strongest control on the captured ankle?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The near hand cups under the heel while the far hand wraps over the top of the foot near the toes to control dorsiflexion. Both hands pull the ankle tight against your chest with the forearm blade of your bottom arm aligned across the Achilles tendon. This two-on-one configuration controls all planes of foot movement and creates the proper lever for finishing pressure."
      }
    },
    {
      "@type": "Question",
      "name": "Your opponent begins driving forward into a stack pass as you initiate the entry - what is your best response?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Abort the entry and use their forward pressure to Granby roll back to guard, or redirect their momentum into an X-Guard entry. For the X-Guard option, hook both feet into their hips as they drive. The stack pass negates your inverted base by folding your body, eliminating the hip elevation necessary for the entry, and trying to fight through a committed stack from grasshopper typically results in being flattened and passed."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Straight Ankle Lock Entry Attacker",
  "description": "How to execute Straight Ankle Lock Entry in BJJ. Attacking perspective with setup, execution steps, and counters.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Straight-Ankle-Lock-Entry/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Straight Ankle Lock Entry (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Basic leg lock entries from standing",
      "description": "Straight Ankle Lock Entry (Attacker) film study: Basic leg lock entries from standing, taught by Jaime Sanchez.",
    ...
    },
    {
      ...
      "description": "Straight Ankle Lock Entry (Attacker) film study: Guard pull into straight ankle lock, taught by Adriano.",
    ...
    },
    {
      ...
      "description": "Straight Ankle Lock Entry (Attacker) film study: Straight ankle lock quick demo, taught by bjjtaro.",
...
<p class="section-subtitle">Watch Straight Ankle Lock Entry (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Straight Ankle Lock Entry?</p>
...
<p class="section-subtitle">What do you need before attempting Straight Ankle Lock Entry?</p>
...
<p class="section-subtitle">How do you execute Straight Ankle Lock Entry step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Straight Ankle Lock Entry?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Straight Ankle Lock Entry?</p>
...
<p class="section-subtitle">How do you train Straight Ankle Lock Entry (Attacker)?</p>
...
<p class="section-subtitle">What are the safety concerns for Straight Ankle Lock Entry?</p>
