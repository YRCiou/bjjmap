...
---
title: "Open Guard to Deep Half Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Open Guard to Deep Half in BJJ. Attacking perspective with setup, execution steps, and counters to opponent defenses."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for executing Open Guard to Deep Half from Open Guard/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish inside positioning",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Open Guard to Deep Half Attacker",
  "description": "How to execute Open Guard to Deep Half in BJJ. Attacking perspective with setup, execution steps, and counters to opponent defenses.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Open-Guard-to-Deep-Half"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Open-Guard-to-Deep-Half/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Open Guard to Deep Half (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Low grip and high grip for deep half guard",
      "description": "Open Guard to Deep Half (Attacker) film study: Low grip and high grip for deep half guard, taught by Jeff Glover.",
    ...
    },
    {
      ...
      "description": "Open Guard to Deep Half (Attacker) film study: Deep half guard sweep, taught by Kyle Dimmitt.",
    ...
    },
    {
      ...
      "description": "Open Guard to Deep Half (Attacker) film study: Deep half guard entry from knee on belly, taught by Team Daruma Dojo.",
...
<p class="section-subtitle">Watch Open Guard to Deep Half (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Open Guard to Deep Half?</p>
...
<p class="section-subtitle">What do you need before attempting Open Guard to Deep Half?</p>
...
<p class="section-subtitle">How do you execute Open Guard to Deep Half step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Open Guard to Deep Half?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Open Guard to Deep Half?</p>
...
<p class="section-subtitle">How do you train Open Guard to Deep Half (Attacker)?</p>
...
**Week 3-4: Progressive Resistance Entry** - Entry timing against light movement and linking to sweeps
Partner begins adding light resistance and movement, attempting to step back or circle away at 30% intensity. Practice following their movement and adjusting entry angle accordingly. Begin linking entry directly to old school sweep or waiter sweep as one continuous motion. 15-20 repetitions per side per session.

**Week 5-8: Dynamic Drilling with Counters** - Problem-solving against common defensive reactions
Partner actively attempts to prevent entry using sprawl, crossface, or leg withdrawal at 50-60% intensity. Practice all counter-responses. If entry fails, flow to alternative guards (butterfly, reverse De La Riva, seated guard). 10-15 quality repetitions per side, emphasizing decision-making over volume.
...
**Week 13+: Competition Simulation** - Entry selection and risk assessment under pressure
...
<p class="section-subtitle">What are the safety concerns for Open Guard to Deep Half?</p>
