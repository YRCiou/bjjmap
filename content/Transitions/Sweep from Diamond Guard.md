...
---
title: "Sweep from Diamond Guard | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Sweep from Diamond Guard", "item": "https://bjjmap.pages.dev/Transitions/Sweep-from-Diamond-Guard" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Sweep from Diamond Guard \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Closed guard overhook sweep",
      "description": "Sweep from Diamond Guard film study: Closed guard overhook sweep, taught by David Morris.",
    ...
    },
    {
      ...
      "description": "Sweep from Diamond Guard film study: Overhook scissor sweep from closed guard, taught by Fight Sports Charlotte.",
...
<p class="section-subtitle">Watch Sweep from Diamond Guard in action — curated instructionals</p>
...
[[Sweep from Diamond Guard/Attacker|→ Full Attacker Guide]]
...
[[Sweep from Diamond Guard/Defender|→ Full Defender Guide]]
...
**Pendulum Kick Variation**: Uses a pendulum motion with the far leg swinging downward for additional momentum during the sit-up. The leg swing generates rotational force that supplements the hip drive, making the sweep effective even against heavier opponents who resist the standard sit-up motion. (When to use: When the opponent has settled their weight low and the standard sit-up alone lacks sufficient force to complete the rotation)


**Hip Bump Sit-Up Variation**: Emphasizes an explosive upward hip thrust combined with the sit-up, driving the hips into the opponent's midsection before redirecting into the sweep rotation. This variant generates more vertical force before converting to horizontal rotation. (When to use: When the opponent's weight is centered rather than forward, requiring additional upward displacement before the rotational sweep can complete)


**Flower Sweep Hybrid**: Incorporates a near-side leg hook behind the opponent's knee on the non-overhook side, pulling their leg out from under them during the sit-up. This addresses the opponent's remaining base point by attacking their leg structure simultaneously with the upper body sweep. (When to use: When the opponent posts their free hand wide to prevent the standard sweep and maintains strong single-leg base on the non-overhook side)
