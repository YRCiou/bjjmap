...
---
title: "Knee Slice from Butterfly Half Attacker | BJJ Technique Guide | BJJ Map"
description: "Complete guide to executing the knee slice pass from butterfly half guard top. Learn the sequential approach to neutralizing the butterfly hook, establishing upper body control, and completing the slice to side control with detailed mechanics and troubleshooting."
---
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Knee Slice from Butterfly Half Attacker",
  "description": "Complete guide to executing the knee slice pass from butterfly half guard top. Learn the sequential approach to neutralizing the butterfly hook, establishing upper body control, and completing the slice to side control with detailed mechanics and troubleshooting.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Knee-Slice-from-Butterfly-Half"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Knee-Slice-from-Butterfly-Half/Attacker"
    }
  ]
}
</script>
...
<p class="section-subtitle">What are the key principles for executing Knee Slice from Butterfly Half?</p>
...
<p class="section-subtitle">What do you need before attempting Knee Slice from Butterfly Half?</p>
...
<p class="section-subtitle">How do you execute Knee Slice from Butterfly Half step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Knee Slice from Butterfly Half?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Knee Slice from Butterfly Half?</p>
...
<p class="section-subtitle">What are the safety concerns for Knee Slice from Butterfly Half?</p>
