...
---
title: "Triangle Clear to Side | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Triangle Clear to Side", "item": "https://bjjmap.pages.dev/Transitions/Triangle-Clear-to-Side" }
  ]
}
</script>
...
| **Key Principles** | Attack the lock mechanics rather than fighting the squeeze: ... | Maintain chest-to-back connection throughout their escape at... |
...
[[Triangle Clear to Side/Attacker|→ Full Attacker Guide]]
...
[[Triangle Clear to Side/Defender|→ Full Defender Guide]]
