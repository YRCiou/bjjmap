...
---
title: "Toreando Pass Defender | BJJ Defense Guide | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Toreando Pass in BJJ",
  "description": "Step-by-step guide for defending and countering Toreando Pass in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Strip passer's grip with two-on-one grip break and immediately re-establish foot-on-hip frame",
      "text": "At the earliest stage when passer is establishing grips on your knees or pants, before they commit to the lateral step If successful: Passer's pass attempt is nullified, you retain open guard with defensive frames intact and can re-engage on your terms",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Hip-switch to follow the passer's lateral movement, rotating your body to keep hips and feet aligned toward them",
      "text": "When the passer has committed to the lateral step and is mid-movement, track their direction with an immediate hip rotation toward the passing side If successful: Your hips follow the passer's movement, preventing them from clearing your legs and maintaining guard structure despite their lateral angle",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Establish collar drag or sleeve pull to off-balance the passer as they step laterally",
      "text": "When the passer begins the explosive lateral step, use their forward and sideways momentum against them by pulling them off-balance with an upper body grip If successful: Passer is swept or off-balanced, potentially resulting in a top position reversal or at minimum a complete reset of their passing attempt",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Invert and granby roll to recover guard as passer advances past your hip line",
      "text": "When the passer has partially completed the pass and your legs have been redirected to one side, use a granby roll to create distance and face the passer again If successful: You escape the near-complete pass and re-establish open guard facing the passer, often from a De La Riva or Reverse De La Riva position",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Insert knee shield and transition to half guard retention as passer's hips approach your hip line",
      "text": "As a last-resort defense when the passer has cleared your open guard legs and is settling toward side control — insert the near-side knee between your bodies If successful: You prevent full side control consolidation and establish a defensive half guard or knee shield position from which you can work systematic escapes",
      "position": 5
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Toreando Pass",
      "item": "https://bjjmap.pages.dev/Transitions/Toreando-Pass"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Toreando-Pass/Defender"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Toreando Pass (Defender) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Toreando defense with roll counter",
      "description": "Toreando Pass (Defender) film study: Toreando defense with roll counter, taught by Revolution BJJ.",
    ...
    },
    {
      "@type": "VideoObject",
      "position": 2,
      "name": "Toreando pass fail options and counters",
      "description": "Toreando Pass (Defender) film study: Toreando pass fail options and counters, taught by SimpleBJJ.",
      "thumbnailUrl": "https://i.ytimg.com/vi/PRaqiE5oPvc/hqdefault.jpg",
      "embedUrl": "https://www.youtube.com/embed/PRaqiE5oPvc",
      "url": "https://www.youtube.com/watch?v=PRaqiE5oPvc",
      "creator": { "@type": "Person", "name": "SimpleBJJ" },
      "duration": "PT203S"
    }
  ]
}
...
<p class="section-subtitle">Watch Toreando Pass (Defender) in action — curated instructionals</p>
...
![](https://www.youtube.com/watch?v=PRaqiE5oPvc)

<p class="clip-credit"><strong>Toreando pass fail options and counters</strong> — taught by SimpleBJJ · 3:23 · <a href="https://www.youtube.com/watch?v=PRaqiE5oPvc" rel="noopener">Watch on YouTube</a></p>
...
- **Consequence**: Once the passer controls both knees with strong grips, the Toreando becomes extremely difficult to stop because they dictate when and where the pass occurs
- **Correction**: Immediately strip or redirect any hand that reaches for your knees. Use two-on-one grip breaks aggressively and maintain at least one sleeve or wrist grip that prevents free hand access to your legs

### 2. Staying flat on your back with static hips instead of actively tracking the passer's lateral movement

- **Consequence**: The passer creates a severe angle and your legs end up pointing away from them, making guard recovery nearly impossible as they advance to side control
- **Correction**: The moment you feel lateral pressure on your legs, rotate your entire body to face the passer. Your belly button should always point toward their chest. Use hip escapes and shoulder walks to maintain alignment

### 3. Reaching with arms extended to push the passer away instead of using structured frames

- **Consequence**: Extended arms are vulnerable to arm drags, kimura attacks, and are easily collapsed, removing your defensive structure entirely while exposing submission opportunities
- **Correction**: Frame with bent-arm structures — forearms on the passer's biceps or collar bone area, elbows tight to your body. Use your legs as the primary distance management tool, not your arms

### 4. Attempting to hold closed guard against a standing passer rather than transitioning to active open guard

- **Consequence**: A standing opponent can easily break closed guard and immediately launch the Toreando from the opened guard before you establish proper open guard frames
- **Correction**: When the passer stands, immediately transition to feet-on-hips or a specific open guard system. Establish grips and hooks proactively rather than waiting for your closed guard to be broken

### 5. Panicking and scrambling randomly once the pass is initiated instead of systematically retaining guard

- **Consequence**: Uncoordinated movement wastes energy, creates openings for the passer, and often results in worse positions than side control (back exposure, mount transition)
- **Correction**: Drill specific guard retention sequences so that defensive responses become automatic. Practice the hierarchy: grip fight first, hip track second, insert knee shield third, and invert as a final option
...
Partner executes Toreando at 50-70% speed with committed lateral steps. Practice matching their movement with hip rotations, shoulder walks, and transitioning to De La Riva or Reverse De La Riva hooks as they step. Work the full defensive hierarchy: grip fight, hip track, insert hook, and invert if needed. 15-20 repetitions per session alternating both sides.

**Week 5-8: Counter-Attacking from Defense** - Convert Toreando defense into offensive opportunities through sweeps and guard transitions
Partner executes Toreando at 70-100% speed. Practice timing collar drags and arm drags during the lateral step to off-balance the passer. Work on converting failed Toreando attempts into immediate guard attacks — triangle setups from the angle created, omoplata entries from the turned position, and back takes when the passer overcommits laterally. Positional sparring rounds of 3-5 minutes starting from open guard.

**Week 9+: Live Integration and Situational Sparring** - Apply Toreando defense in live training against varied passing styles
Incorporate Toreando defense into regular sparring rounds. Start rolls from standing in guard and focus on recognizing when the Toreando is being set up versus other passes. Develop the ability to defend Toreando while simultaneously managing other passing threats. Film rolls and review defensive timing, grip fighting effectiveness, and counter-attack success rates. Adjust strategies based on individual body type and athletic attributes.
