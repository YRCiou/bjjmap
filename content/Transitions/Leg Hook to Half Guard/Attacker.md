...
---
title: "Leg Hook to Half Guard Attacker | BJJ Technique Guide | BJJ Map"
description: "Learn to execute the Leg Hook to Half Guard consolidation from top position. Master weight transfer, upper body control maintenance, and systematic leg repositioning for stable passing progression."
---
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Leg Hook to Half Guard Attacker",
  "description": "Learn to execute the Leg Hook to Half Guard consolidation from top position. Master weight transfer, upper body control maintenance, and systematic leg repositioning for stable passing progression.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Leg-Hook-to-Half-Guard/Attacker"
    }
  ]
}
</script>
...
**Phase 2: Control Maintenance** - Maintaining upper body dominance during transition
Partner provides 50% resistance focusing on underhook attempts and frame creation during the consolidation. Attacker focuses on keeping crossface locked and pressure continuous. Drill until the transition can be completed without losing upper body control.

**Phase 3: Counter Integration** - Responding to defensive reactions during consolidation
Partner provides full resistance with specific counter-attacks: underhook fight, deep half entry, knee shield insertion, and sweep attempts. Attacker practices identifying and addressing each counter while completing or aborting the consolidation as appropriate.

**Phase 4: Decision Making** - Recognizing when to consolidate versus continue passing
Positional sparring starting from leg hook top. Attacker must read the situation and decide whether to attempt pass completion, consolidate to half guard top, or abandon the hook entirely. Develops the tactical judgment for when this transition is the correct choice.

**Phase 5: Live Integration** - Applying consolidation in rolling context
During regular sparring, consciously practice recognizing leg hook deterioration and executing the consolidation under full resistance. Track success rate and identify recurring problems that emerge under competition-speed conditions.
