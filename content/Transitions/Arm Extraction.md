...
---
title: "Arm Extraction | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Arm Extraction", "item": "https://bjjmap.pages.dev/Transitions/Arm-Extraction" }
  ]
}
</script>
...
| **Key Principles** | Establish defensive frames immediately to prevent opponent f... | Maintain constant chest-to-chest pressure to eliminate the s... |
...
[[Arm Extraction/Attacker|→ Full Attacker Guide]]
...
[[Arm Extraction/Defender|→ Full Defender Guide]]
