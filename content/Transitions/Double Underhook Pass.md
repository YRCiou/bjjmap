...
---
title: "Double Underhook Pass | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Double Underhook Pass", "item": "https://bjjmap.pages.dev/Transitions/Double-Underhook-Pass" }
  ]
}
</script>
...
[[Double Underhook Pass/Attacker|→ Full Attacker Guide]]
...
[[Double Underhook Pass/Defender|→ Full Defender Guide]]
...
**Single Underhook to Body Lock Pass**: When opponent defends the second underhook aggressively, abandon the double underhook and instead slide to a body lock configuration. The single underhook becomes a far-side underhook while you wrap their waist, transitioning to a body lock pass to side control. (When to use: When opponent successfully defends second underhook entry for extended period)


**Double Underhook to North-South**: Instead of driving perpendicular for Side Control, maintain the Gable grip and walk your hips around toward their head. The double underhook becomes a powerful control for North-South entry where you can threaten chokes or continue to Side Control from there. (When to use: When opponent's defensive structure makes perpendicular Side Control difficult)


**Gi Double Underhook with Lapel Feed**: In gi training, feed opponent's far lapel under their armpit to your underhooking hand. This creates an even tighter configuration and prevents arm escape. The lapel grip substitutes for the Gable grip with superior control. (When to use: Gi training when opponent has loose lapels accessible)
