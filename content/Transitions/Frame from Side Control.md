...
---
title: "Frame from Side Control | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Frame from Side Control", "item": "https://bjjmap.pages.dev/Transitions/Frame-from-Side-Control" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Frame from Side Control \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Babybridge frames from bottom side control",
      "description": "Frame from Side Control film study: Babybridge frames from bottom side control, taught by Priit Mihkelson.",
    ...
    },
    {
      ...
      "description": "Frame from Side Control film study: Sticky hands framing from bottom side control, taught by Select Jiu Jitsu Academy.",
...
[[Frame from Side Control/Attacker|Play as Attacker]]
[[Frame from Side Control/Defender|Play as Defender]]
...
<p class="section-subtitle">Watch Frame from Side Control in action — curated instructionals</p>
...
| **Key Principles** | Use skeletal structures (ulna bone, forearm flat) rather tha... | Preemptive arm control prevents frame construction before it... |
...
[[Frame from Side Control/Attacker|→ Full Attacker Guide]]
...
[[Frame from Side Control/Defender|→ Full Defender Guide]]
...
- [[Positions/Side Control]] - Starting position where this defensive frame technique is applied

- [[Positions/Side Control]] - Target position after successful framing disrupts consolidation

- [[Transitions/Side Control Escape]] - Full escape sequence that builds on established frames from this technique
