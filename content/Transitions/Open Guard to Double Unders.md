...
---
title: "Open Guard to Double Unders | BJJ Technique | BJJ Map"
description: "Establish the Double Unders stacking control from Open Guard top. Setup, both-leg scoop, hip elevation, and back-clasp to enter a dominant pressure pass in BJJ."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Open Guard to Double Unders", "item": "https://bjjmap.pages.dev/Transitions/Open-Guard-to-Double-Unders" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Open Guard to Double Unders",
  "description": "Open Guard to Double Unders is the entry in which the top passer scoops both of the opponent's legs onto their shoulders, elevates the hips, and clasps the hands behind the back to establish the bilateral-underhook stacking control.",
...
<p class="also-known-as"><em>Also known as:</em> <strong>Double Unders Entry</strong>, <strong>Double Underhook Stack Entry</strong></p>
</aside>
<div class="role-links">

[[Open Guard to Double Unders/Attacker|Play as Attacker]]
[[Open Guard to Double Unders/Defender|Play as Defender]]
...
| **Key Principles** | Dig both underhooks simultaneously in one motion - a stagger... | Treat the moment the passer clears your feet as the alarm - ... |
...
[[Open Guard to Double Unders/Attacker|→ Full Attacker Guide]]
...
[[Open Guard to Double Unders/Defender|→ Full Defender Guide]]
...
- [[Positions/Double Unders]] - Destination control established by this entry, from which pressure passing continues

- [[Transitions/Double Under Pass]] - Follow-up pass that completes the journey from this control to side control

- [[Positions/Open Guard]] - Starting position from which the top passer digs the double underhooks

- [[Transitions/Stack Pass from Double Unders]] - Primary advancing technique available once this control is secured

- [[Positions/Side Control]] - Most common end position after passing from the established double unders control

- [[Positions/Half Guard/Deep Half Guard]] - Counter destination if the defender dives underneath the passer's committed posture

- [[Positions/Back Control]] - Alternative finish when the defender turns away to escape the stacking pressure

- [[Positions/Butterfly Guard]] - Common open guard variation that this entry effectively neutralizes

- [[Positions/Leg Weave]] - Adjacent pressure-pass control reached if one leg escapes during the entry
