...
---
title: "Kimura Switch | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kimura Switch", "item": "https://bjjmap.pages.dev/Transitions/Kimura-Switch" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Kimura Switch \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Kimura trap rolling sweep from bottom side control",
      "description": "Kimura Switch film study: Kimura trap rolling sweep from bottom side control, taught by Mat Life Training Center.",
    ...
    },
    {
      ...
      "description": "Kimura Switch film study: Kimura trap against the turtle, taught by Paul Stolyar.",
    ...
    },
    {
      ...
      "description": "Kimura Switch film study: Standing kimura bodylock switch drill, taught by Brandon Quick.",
...
<p class="section-subtitle">Watch Kimura Switch in action — curated instructionals</p>
...
| **Key Principles** | Release leg entanglement only when Kimura grips are secured ... | Attack the transition window before figure-four grip is full... |
...
[[Kimura Switch/Attacker|→ Full Attacker Guide]]
...
[[Kimura Switch/Defender|→ Full Defender Guide]]
...
- [[Positions/Aoki Lock Control]] - Starting position - leg entangled shoulder control
