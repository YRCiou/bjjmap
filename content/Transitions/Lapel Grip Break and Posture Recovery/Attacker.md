...
---
title: "Lapel Grip Break and Posture Recovery Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Lapel Grip Break and Posture Recovery in BJJ. Attacking perspective with setup, execution steps, and counters for escaping Ringworm Guard."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Lapel Grip Break and Posture Recovery in BJJ",
  "description": "Step-by-step guide for executing Lapel Grip Break and Posture Recovery from Ringworm Guard/Top.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish base",
      "text": "Widen your base by stepping your free leg outward and lowering your hips toward the mat. Distribute your weight primarily through your free leg to prevent the opponent from loading you for sweeps.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Control grip-fighting hand",
      "text": "Use your free hand to grip the opponent's wrist or sleeve on the hand holding the lapel tail. This prevents them from tightening the wrap or adjusting to maintain control while you work the break.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Strip the lapel grip",
      "text": "Bring your second hand to assist with the grip break, peeling the opponent's fingers off the lapel tail using a two-on-one motion. Strip toward their thumb to exploit the weakest point of their grip configuration.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Secure the lapel",
      "text": "Once broken, immediately grab the lapel tail yourself to prevent the opponent from re-establishing the grip. Thread the lapel behind their back or tuck it into their belt to neutralize it as a weapon.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Extract trapped leg",
      "text": "With the lapel tension eliminated, circle your trapped leg outward and backward to extract it from any remaining wrap. Use small circular movements rather than explosive pulling to prevent the opponent from trapping your leg with their hooks.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Recover posture",
      "text": "Stand up to combat base or full standing position, establishing distance and neutral grips on the opponent's legs or hips. You are now ready to engage standard open guard passing sequences without the lapel disadvantage.",
      "position": 6
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the primary goal of Lapel Grip Break and Posture Recovery?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The primary goal is to neutralize the opponent's lapel wrap control, extract your trapped leg, and recover to a neutral position where standard guard passing becomes viable. Without completing this sequence, all other passing attempts are compromised by the mechanical disadvantage the lapel creates."
      }
    },
    {
      "@type": "Question",
      "name": "Why is two-on-one grip fighting recommended for breaking the lapel grip?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The opponent's lapel grip is mechanically strong because the gi material provides excellent friction and their entire arm supports the grip. A single-hand strip rarely generates enough force to overcome this. Two-on-one mechanics concentrate your strength advantage at the weakest point of their grip while preventing their free hand from interfering."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "What direction should you strip the lapel grip and why?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Strip toward the opponent's thumb because this is the weakest point of any grip. The thumb cannot oppose the four fingers in resisting your stripping motion. Stripping toward their fingers forces you to overcome the full strength of their grip, making the break significantly harder and more energy-intensive."
      }
    },
    {
      "@type": "Question",
      "name": "Why is circular leg extraction preferable to pulling straight back?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A direct pulling motion often tightens the remaining lapel wrap and allows the opponent to trap your leg with their hooks during extraction. Circular motion defeats the wrap angle by moving perpendicular to the lapel tension, and the rotational movement makes it harder for their hooks to catch your leg."
      }
    },
    {
      "@type": "Question",
      "name": "What should you do with the lapel after successfully breaking the grip?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Immediately secure the lapel yourself by threading it behind the opponent's back, tucking it into their belt, or maintaining your own grip on the tail. Releasing it allows immediate re-establishment of their guard, wasting your effort. The lapel must be neutralized as a weapon, not just temporarily removed from their hand."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Lapel Grip Break and Posture Recovery Attacker",
  "description": "How to execute Lapel Grip Break and Posture Recovery in BJJ. Attacking perspective with setup, execution steps, and counters for escaping Ringworm Guard.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Lapel-Grip-Break-and-Posture-Recovery/Attacker"
    }
  ]
}
</script>
...
<p class="section-subtitle">What are the key principles for executing Lapel Grip Break and Posture Recovery?</p>
...
<p class="section-subtitle">What do you need before attempting Lapel Grip Break and Posture Recovery?</p>
...
<p class="section-subtitle">How do you execute Lapel Grip Break and Posture Recovery step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Lapel Grip Break and Posture Recovery?</p>

- **Opponent switches to Worm Guard configuration as you begin breaking the grip** (Effectiveness: High) - Your Response: Recognize the transition early by monitoring their leg position. If they begin threading the lapel differently, restart the grip break sequence for the new configuration before it consolidates. → Leads to [[Positions/Ringworm Guard]]
- **Opponent uses their free leg to create a butterfly hook or shin shield during grip break** (Effectiveness: Medium) - Your Response: Address the leg frame before continuing the grip break. Pin their knee to the mat with your free hand or step over the hook to neutralize the barrier before returning to the lapel. → Leads to [[Positions/Ringworm Guard]]
- **Opponent accelerates sweep attempt while you commit both hands to grip breaking** (Effectiveness: Medium) - Your Response: Abort the grip break and immediately address the sweep by widening base and posting with one hand. Better to reset than get swept while focused on the grip. → Leads to [[Positions/Half Guard]]
- **Opponent grabs your sleeve to prevent two-on-one grip fighting** (Effectiveness: Low) - Your Response: Strip their sleeve grip first using wrist circles or elbow pressure, then return to the lapel grip break. Their sleeve grip is typically weaker than the lapel configuration. → Leads to [[Positions/Ringworm Guard]]
...
<p class="section-subtitle">What mistakes should you avoid when executing Lapel Grip Break and Posture Recovery?</p>
...
<p class="section-subtitle">How do you train Lapel Grip Break and Posture Recovery (Attacker)?</p>
...
<p class="section-subtitle">What are the safety concerns for Lapel Grip Break and Posture Recovery?</p>
