...
---
title: "Kimura Trap to Reverse Scarf Hold | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kimura Trap to Reverse Scarf Hold", "item": "https://bjjmap.pages.dev/Transitions/Kimura-Trap-to-Reverse-Scarf-Hold" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Kimura Trap to Reverse Scarf Hold \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Kimura catch from the sidemount",
      "description": "Kimura Trap to Reverse Scarf Hold film study: Kimura catch from the sidemount, taught by Animal.",
    ...
    },
    {
      ...
      "description": "Kimura Trap to Reverse Scarf Hold film study: Kimura trap from reverse kesa-gatame, taught by Smith BJJ.",
    ...
    },
    {
      ...
      "description": "Kimura Trap to Reverse Scarf Hold film study: Kesa gatame reverse arm attack roll over, taught by Carlos Machado.",
...
<p class="section-subtitle">Watch Kimura Trap to Reverse Scarf Hold in action — curated instructionals</p>
...
[[Kimura Trap to Reverse Scarf Hold/Attacker|→ Full Attacker Guide]]
...
- **Confirm Kimura defense and commit to transition**: Verify that the opponent has committed to the elbow-tucked Kimura defense by testing the submission ...

- **Shift weight to chest and begin foot walk**: Transfer your primary weight from your hips to your chest, pressing heavily into the opponent's uppe...

- **Rotate hips while maintaining grip tension**: As your feet walk around, allow your hips to rotate naturally, pivoting around the Kimura grip which...

- **Continue arc past perpendicular position**: Walk your feet past the perpendicular (90-degree) angle and continue toward facing the opponent's le...

- **Settle hips into Reverse Scarf Hold position**: Once your body orientation faces toward the opponent's legs (approximately 180 degrees from starting...

- **Consolidate Reverse Scarf Hold control**: Lock in the final pin by ensuring your hip pressure is low and heavy on their chest, your arm contro...

- **Assess immediate submission and transition opportunities**: Once control is consolidated, evaluate available attacks based on the opponent's arm positioning. If...


### Common Mistakes


- **Lifting chest off opponent's torso during hip rotation to create space for the turn**
...
- **Releasing the Kimura grip prematurely before establishing Reverse Scarf Hold arm control**
...
- **Taking large steps during the foot walk that create base instability**
...
[[Kimura Trap to Reverse Scarf Hold/Defender|→ Full Defender Guide]]
...
- **Insert far-side frame against attacker's neck or shoulder to block rotation** - When: As soon as you feel the foot-walking pattern begin, before the attacker passes the perpendicular angle

- **Hip escape and insert knee shield during mid-rotation vulnerability** - When: When the attacker reaches the perpendicular angle and their base is at its narrowest point during the rotation

- **Explosive bridge toward attacker's head during rotation to destabilize base** - When: When you feel the attacker's weight shifting during the mid-rotation phase and their base is temporarily compromised
...
**Slow Pressure Walk**: A methodical version where the top player walks their feet incrementally in small steps around the opponent's head while maintaining maximum chest pressure throughout. Each step is deliberate, keeping the hip bone heavy on the opponent's sternum. This variant prioritizes control retention over speed and is ideal against strong opponents who might exploit any gap in pressure. (When to use: Use against strong, explosive opponents who will bridge the moment they feel pressure lighten. The slow walk maintains constant weight and leaves no escape window.)


**Quick Hip Switch**: An explosive variant where the top player performs a rapid hip switch, lifting and rotating their hips in one fluid motion from Kimura Trap orientation to Reverse Scarf Hold. The Kimura grip is maintained as an anchor point while the body whips around it. Requires excellent timing and hip mobility but achieves the position before the opponent can react. (When to use: Use against technically skilled opponents who create frames during slow transitions. The speed of the switch bypasses their defensive reactions and establishes the pin before they can adjust.)


**Submission Feint to Position**: The top player aggressively threatens the Kimura finish by pulling the arm outward, which forces the opponent to desperately tuck their elbow and turn toward the grip. This defensive reaction naturally opens the angle for the Reverse Scarf Hold transition, as the opponent's turning movement assists the rotation. The practitioner times the hip switch to coincide with the opponent's defensive commitment. (When to use: Use when the opponent is anticipating the positional transition and maintaining defensive frames. The submission threat forces them to prioritize arm defense, creating the opening for the positional change.)
