...
---
title: "Squid Guard Sweep | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Squid Guard Sweep", "item": "https://bjjmap.pages.dev/Transitions/Squid-Guard-Sweep" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Squid Guard Sweep \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Squid guard entry vs standing then sweep",
      "description": "Squid Guard Sweep film study: Squid guard entry vs standing then sweep, taught by Adam Bradley.",
    ...
    },
    {
      ...
      "description": "Squid Guard Sweep film study: Squid guard to switch X guard sweep, taught by BJJ Online.",
    ...
    },
    {
      ...
      "description": "Squid Guard Sweep film study: Squid guard variations and sweeps, taught by PTC Combat Fitness.",
...
<p class="section-subtitle">Watch Squid Guard Sweep in action — curated instructionals</p>
...
[[Squid Guard Sweep/Attacker|→ Full Attacker Guide]]
...
[[Squid Guard Sweep/Defender|→ Full Defender Guide]]
...
**Forward Momentum Sweep**: Exploits the opponent's forward pressure by using their driving energy to accelerate the sweep. As the opponent pushes forward to initiate a pass, the bottom player redirects the momentum laterally using the lapel tension and hook, turning the passing energy into sweeping force. Requires less personal energy expenditure since the opponent provides the driving force. (When to use: When opponent drives forward with pressure passing attempts or leans in to strip lapel grips)


**Angle-Based Lateral Sweep**: Used against opponents maintaining neutral upright posture with evenly distributed weight. The bottom player creates a sharp angle by hip escaping laterally, then uses the combined pull of the lapel and extension of the hook to sweep the opponent sideways toward their weakest base point. Requires more hip movement and angle creation since the opponent is not providing forward momentum. (When to use: When opponent maintains balanced posture and refuses to commit weight in any direction)


**Pendulum Acceleration Sweep**: Incorporates a pendulum motion with the non-threading leg to generate additional sweeping momentum. The free leg swings wide and then drives across the opponent's body in coordination with the lapel pull and hook extension, creating rotational force that amplifies the sweep's power. Particularly effective against heavier opponents whose base is harder to displace with lapel tension alone. (When to use: Against larger or heavier opponents where standard lapel tension and hook extension lack sufficient force to complete the sweep)
