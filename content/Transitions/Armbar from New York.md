...
---
title: "Armbar from New York | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Armbar from New York", "item": "https://bjjmap.pages.dev/Transitions/Armbar-from-New-York" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Armbar from New York \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Dead Orchard armbar from rubber guard",
      "description": "Armbar from New York film study: Dead Orchard armbar from rubber guard, taught by Eddie Bravo.",
    ...
    },
    {
      ...
      "description": "Armbar from New York film study: Invisible armbar from rubber guard, taught by mean gene.",
    ...
    },
    {
      ...
      "description": "Armbar from New York film study: Mexican Dead Orchard setup, taught by Eddie Bravo.",
...
[[Armbar from New York/Attacker|Play as Attacker]]
[[Armbar from New York/Defender|Play as Defender]]
...
<p class="section-subtitle">Watch Armbar from New York in action — curated instructionals</p>
...
| **Key Principles** | Maintain overhook depth throughout the entire hip pivot — lo... | Recognize the armbar threat early by monitoring the opponent... |
...
[[Armbar from New York/Attacker|→ Full Attacker Guide]]
...
[[Armbar from New York/Defender|→ Full Defender Guide]]
...
- [[Positions/Rubber Guard/New York]] - Starting position providing the overhook and shin control foundation for this armbar entry

- [[Positions/Armbar Control]] - Target position on successful execution where the finish is completed

- [[Positions/Closed Guard]] - Fallback position when the opponent successfully counters and escapes the rubber guard

- [[Positions/Rubber Guard/Mission Control]] - Prerequisite rubber guard position that leads to New York and enables the armbar pathway

- [[Transitions/Armbar from Clamp Guard]] - Analogous armbar entry from a different guard system sharing similar hip pivot mechanics

- [[Transitions/Triangle Setup]] - Primary chain attack when the opponent defends the armbar by stacking or posturing

- [[Positions/Rubber Guard/Invisible Collar]] - Alternative attacking progression from New York that creates the dilemma enabling the armbar

- [[Positions/Omoplata Control]] - Alternative submission control position accessible when the opponent bends the arm during defense

- [[Positions/Rubber Guard/New York Control]] - Related deeper control position within the rubber guard system
