...
---
title: "Deashi Harai Defender | BJJ Defense Guide | BJJ Map"
description: "How to defend against Deashi Harai in BJJ. Recognition cues, defensive options, and escape strategies."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Deashi Harai in BJJ",
  "description": "Step-by-step guide for defending and countering Deashi Harai in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Retract lead leg and redistribute weight to rear foot as you feel the sweep contact approaching your ankle",
      "text": "When you detect the sweep early enough that your weight has not yet fully committed to the lead foot—typically when you feel the opponent's grips tighten and their body angle shifts If successful: You remain standing with your opponent having committed to a failed technique, creating an opening to attack with your own grip advantages or takedown while they recover position",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Break the controlling sleeve grip before the sweep can be coordinated, then immediately re-engage with your own dominant grips",
      "text": "During the setup phase when you recognize the opponent establishing the grip configuration needed for the sweep—before they have initiated any sweeping action If successful: The opponent cannot coordinate the upper and lower body actions needed for an effective sweep, forcing them to re-establish grips before any further attack attempts",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Counter-throw by driving forward into your opponent as they lift their sweeping leg off the ground, exploiting their single-leg base with Ouchi Gari or a body lock takedown",
      "text": "When the opponent has already committed to the sweep and their sweeping foot is off the mat—they are momentarily on one leg and vulnerable to forward pressure If successful: You achieve a takedown or reversal by capitalizing on their compromised single-leg base, potentially scoring points and establishing top position",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Lower your center of gravity by bending your knees and widening your stance while pulling your opponent's upper body down with your grips to deny the lifting action",
      "text": "When you feel the upward lift through the collar grip that precedes the sweep—this is a late-stage defense when retraction is no longer possible If successful: Your lowered base absorbs the sweep without losing balance, and the opponent must abandon the technique and reset",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Deashi Harai",
      "item": "https://bjjmap.pages.dev/Transitions/Deashi-Harai"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Deashi-Harai/Defender"
    }
  ]
}
</script>
...
<p class="section-subtitle">How do you know when someone is attempting Deashi Harai?</p>
...
<p class="section-subtitle">What are the key principles for defending Deashi Harai?</p>
...
<p class="section-subtitle">What can you do to defend against Deashi Harai?</p>
...
<p class="section-subtitle">What is the best outcome when defending Deashi Harai?</p>
...
<p class="section-subtitle">What mistakes should you avoid when defending Deashi Harai?</p>
...
<p class="section-subtitle">How do you train defense against Deashi Harai?</p>

**Week 1-2: Recognition and Base Awareness** - Identifying Deashi Harai setups and maintaining defensive stance
Partner slowly demonstrates the full Deashi Harai setup sequence while you practice recognizing each phase: grip establishment, angle creation, and sweep initiation. Focus on feeling the grip changes and weight manipulation through your body rather than watching their feet. Practice maintaining athletic stance with active footwork while partner applies progressive grip pressure. 15-20 repetitions per session of partner setting up the sweep while you call out the phase you detect.

**Week 3-4: Reactive Defense Drilling** - Executing defensive responses to live sweep attempts
