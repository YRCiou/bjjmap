...
---
title: "Single Leg X Recovery | BJJ Technique | BJJ Map"
description: "Master Single Leg X Recovery from Ushiro Ashi-Garami. Complete guide to leg extraction, Single Leg X-Guard establishment, and offensive transitions."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Single Leg X Recovery", "item": "https://bjjmap.pages.dev/Transitions/Single-Leg-X-Recovery" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Single Leg X Recovery \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Recovering single leg X when you get smashed",
      "description": "Single Leg X Recovery film study: Recovering single leg X when you get smashed, taught by Dubious Dom.",
    ...
    },
    {
      ...
      "description": "Single Leg X Recovery film study: Backstep Retention from Single Leg X, taught by Lachlan Giles.",
    ...
    },
    {
      ...
      "description": "Single Leg X Recovery film study: Single Leg X - Forcing Their Hands to the Mat, taught by Lachlan Giles.",
...
<p class="section-subtitle">Watch Single Leg X Recovery in action — curated instructionals</p>
...
| **Key Principles** | Maintain dorsiflexion throughout extraction to protect heel ... | Maintain deep inside leg control on opponent's thigh to deny... |
...
[[Single Leg X Recovery/Attacker|→ Full Attacker Guide]]
...
[[Single Leg X Recovery/Defender|→ Full Defender Guide]]
