...
---
title: "Lapel Strip from Worm Guard Defender | BJJ Defense Guide | BJJ Map"
description: "Defend against the Lapel Strip from Worm Guard. Guide to maintaining worm guard control, preventing lapel strips, and countering with sweeps during grip fighting."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Lapel Strip from Worm Guard in BJJ",
  "description": "Step-by-step guide for defending and countering Lapel Strip from Worm Guard in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Reinforce lapel grip with second hand and increase tension to resist the strip",
      "text": "Immediately when you recognize the top player is targeting your lapel grip with a two-on-one break If successful: Top player's strip attempt fails and they remain stuck in your worm guard with compromised base from the grip fighting effort",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Execute a sweep while both of the top player's hands are committed to grip fighting the lapel",
      "text": "When the top player commits both hands to the lapel strip and their base narrows or weight shifts forward creating an opening If successful: You sweep the top player and establish top position, converting their passing preparation into your scoring opportunity",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Immediately re-feed the lapel after a partial strip before the top player secures the freed material",
      "text": "The moment the top player breaks your grip but before they have pulled the lapel completely free from under their leg or secured it If successful: You re-establish full worm guard control, forcing the top player to restart the entire stripping sequence from the beginning",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Transition to lasso guard or spider guard using remaining grips before complete lapel loss",
      "text": "When you recognize the lapel control is significantly compromised and re-feeding is unlikely to succeed in time If successful: You maintain a viable guard position with active leg and grip control despite losing the worm guard configuration",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Lapel Strip from Worm Guard Defender",
  "description": "Defend against the Lapel Strip from Worm Guard. Guide to maintaining worm guard control, preventing lapel strips, and countering with sweeps during grip fighting.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Lapel-Strip-from-Worm-Guard/Defender"
    }
  ]
}
</script>
...
<p class="section-subtitle">How do you know when someone is attempting Lapel Strip from Worm Guard?</p>
...
<p class="section-subtitle">What are the key principles for defending Lapel Strip from Worm Guard?</p>
...
<p class="section-subtitle">What can you do to defend against Lapel Strip from Worm Guard?</p>
...
<p class="section-subtitle">What is the best outcome when defending Lapel Strip from Worm Guard?</p>
...
<p class="section-subtitle">What mistakes should you avoid when defending Lapel Strip from Worm Guard?</p>
...
<p class="section-subtitle">How do you train defense against Lapel Strip from Worm Guard?</p>

**Phase 1: Grip Reinforcement Awareness** - Recognizing strip attempts and reinforcing the lapel grip with structural body positioning
Partner attempts lapel strips at low intensity while you focus on recognizing the cues and reinforcing your grip. Practice adding your second hand, curling the wrist, and using your shin to trap the material. No sweeps yet, purely defensive grip retention to build the foundational mechanics.

**Phase 2: Counter-Sweep Timing** - Executing sweeps during the opponent's grip fighting commitment windows
Partner attempts strips at moderate intensity. Practice timing sweep attempts for the moment both their hands are committed to the grip break and their base is compromised. Focus on reading the base vulnerability window and executing worm guard sweeps with proper timing.

**Phase 3: Guard Transition Awareness** - Recognizing compromised lapel control and smoothly transitioning to alternative guards
Partner successfully strips the lapel at varying speeds. Practice the transition from worm guard to spider guard, lasso guard, or De La Riva guard while maintaining some form of control throughout. Focus on the timing decision of when to abandon worm guard versus when to fight for re-establishment.

**Phase 4: Full Resistance Positional Sparring** - Defending lapel strips under full competition pressure with all tools available
Full positional sparring starting from established worm guard. Partner attempts to strip and pass while you use all defensive tools: grip reinforcement, sweep threats, re-feeds, and guard transitions. Track how long you maintain worm guard and what position you end up in when it eventually fails.
