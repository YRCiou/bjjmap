...
---
title: "Triangle Escape | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Triangle Escape", "item": "https://bjjmap.pages.dev/Transitions/Triangle-Escape" }
  ]
}
</script>
...
| **Key Principles** | Prevent leg lock completion by keeping trapped arm tight to ... | Maintain constant downward pressure on the escaper's head us... |
...
[[Triangle Escape/Attacker|→ Full Attacker Guide]]
...
[[Triangle Escape/Defender|→ Full Defender Guide]]
