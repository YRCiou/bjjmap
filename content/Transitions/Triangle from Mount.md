...
---
title: "Triangle from Mount | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Triangle from Mount", "item": "https://bjjmap.pages.dev/Transitions/Triangle-from-Mount" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Triangle from Mount \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Mounted Triangle Extra Details",
      "description": "Triangle from Mount film study: Mounted Triangle Extra Details, taught by FightClubJiuJitsu.",
    ...
    },
    {
      ...
      "description": "Triangle from Mount film study: Mounted Triangle Demonstration, taught by Satori BJJ.",
    ...
    },
    {
      ...
      "description": "Triangle from Mount film study: Finishing the Mounted Triangle, taught by Brandon Mccaghren.",
...
<p class="section-subtitle">Watch Triangle from Mount in action — curated instructionals</p>
...
[[Triangle from Mount/Attacker|→ Full Attacker Guide]]
...
[[Triangle from Mount/Defender|→ Full Defender Guide]]
...
**S-Mount Triangle Entry**: From S-Mount rather than 3-4 Mount, the attacker already has one leg posted high near the opponent's head. The triangle entry becomes a hip rotation and leg curl rather than a full leg swing, reducing the transition time and instability window significantly. (When to use: When you have already advanced to S-Mount during an armbar attempt and the opponent defends by tucking the arm, creating the arm-in configuration for a triangle)


**High Mount Triangle Setup**: From high mount with hips walked up near the opponent's shoulders, the attacker uses knee-on-shoulder pressure to force one arm inside and one outside, then drops directly into the triangle by threading the leg behind the neck. The proximity to the head reduces the distance the leg must travel. (When to use: When the opponent is flattened under heavy high mount pressure and their arms are separated by your knee positioning, particularly effective against opponents who keep their arms wide to prevent the cross-collar choke)


**Reverse Triangle from Mount**: Instead of threading the leg over the far shoulder, the attacker rotates and locks a reverse triangle by threading the near-side leg behind the opponent's head while facing toward their legs. This unorthodox angle catches opponents unfamiliar with the configuration and creates a different choking vector. (When to use: When the opponent defends the standard triangle by turning strongly toward the swinging leg side, their rotation creates the angle needed for the reverse configuration)
