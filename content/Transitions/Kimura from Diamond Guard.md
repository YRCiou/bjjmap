...
---
title: "Kimura from Diamond Guard | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kimura from Diamond Guard", "item": "https://bjjmap.pages.dev/Transitions/Kimura-from-Diamond-Guard" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Kimura from Diamond Guard \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Kimura submission from closed guard",
      "description": "Kimura from Diamond Guard film study: Kimura submission from closed guard, taught by Ultra Jiu Jitsu Academy.",
    ...
    },
    {
      ...
      "description": "Kimura from Diamond Guard film study: Kimura sweep to kimura finish, taught by BJJ4Breakfast.",
...
[[Kimura from Diamond Guard/Attacker|Play as Attacker]]
[[Kimura from Diamond Guard/Defender|Play as Defender]]
...
<p class="section-subtitle">Watch Kimura from Diamond Guard in action — curated instructionals</p>
...
| **Key Principles** | Never release the overhook during the entire grip transition... | React immediately to head control release — this is your pri... |
...
[[Kimura from Diamond Guard/Attacker|→ Full Attacker Guide]]
...
- **Release Head Position to Target Wrist**: Release your head control grip from behind the opponent's neck and immediately reach for their wrist...
...
[[Kimura from Diamond Guard/Defender|→ Full Defender Guide]]
