...
---
title: "Anaconda Setup | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Anaconda Setup", "item": "https://bjjmap.pages.dev/Transitions/Anaconda-Setup" }
  ]
}
</script>
...
| **Key Principles** | Secure tight front headlock control before attempting arm ca... | Tuck your near-side arm tight to your ribs immediately when ... |
...
[[Anaconda Setup/Attacker|→ Full Attacker Guide]]
...
[[Anaconda Setup/Defender|→ Full Defender Guide]]
