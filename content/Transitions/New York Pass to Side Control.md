...
---
title: "New York Pass to Side Control | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "New York Pass to Side Control", "item": "https://bjjmap.pages.dev/Transitions/New-York-Pass-to-Side-Control" }
  ]
}
</script>
...
| **Key Principles** | Base before posture, posture before extraction—the sequentia... | Maintain the shin grip as your primary control mechanism—wit... |
...
[[New York Pass to Side Control/Attacker|→ Full Attacker Guide]]
...
[[New York Pass to Side Control/Defender|→ Full Defender Guide]]
