...
---
title: "Inside Ashi-Garami to Ushiro Ashi Attacker | BJJ Technique Guide | BJJ Map"
description: "Learn to execute Inside Ashi-Garami to Ushiro Ashi as the attacker. Step-by-step guide covering rotation follow mechanics, heel control retention, and reversed finishing angle establishment."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Inside Ashi-Garami to Ushiro Ashi in BJJ",
  "description": "Step-by-step guide for executing Inside Ashi-Garami to Ushiro Ashi from Inside Ashi-Garami/Top.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Read the rotation trigger",
      "text": "Feel the opponent's hips beginning to rotate away from your inside ashi-garami control. Key indicators include their far hip lifting, their torso turning away, or their free leg posting to initiate the inversion. Do not resist this initial movement.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Lock heel control",
      "text": "Before following the rotation, ensure your heel grip is secure. Tighten your C-grip or transition to figure-four configuration around the heel. This grip must survive the entire rotation without slipping, so commit both hands to heel security before moving your body.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Release inside leg frame",
      "text": "As the opponent's hip rotates away, your inside leg across their hip will naturally lose its blocking effectiveness. Rather than fighting to maintain this frame, allow the inside leg to begin sliding underneath the opponent's trapped leg, following the path created by their rotation.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Follow with your torso",
      "text": "Rotate your upper body in the same direction as the opponent's hips, keeping your chest oriented toward their trapped leg throughout. Your shoulders should turn to face the new angle that their rotation is creating. Avoid lifting your hips off the mat during this rotation.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Reposition outside leg over knee line",
      "text": "As you follow the rotation, your outside leg must cross over the opponent's knee line from the reversed angle. This is the critical mechanical adjustment that creates the ushiro configuration. Drive your outside leg across their thigh with active downward pressure to establish the reversed figure-four.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Seat inside leg underneath",
      "text": "Complete the inside leg repositioning by threading it underneath the opponent's trapped leg. The inside leg should now be on the opposite side compared to standard inside ashi, creating the reversed entanglement geometry. Squeeze both legs together to close any gaps.",
      "position": 6
    },
    {
      "@type": "HowToStep",
      "name": "Close distance and consolidate",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Inside Ashi-Garami to Ushiro Ashi Attacker",
  "description": "Learn to execute Inside Ashi-Garami to Ushiro Ashi as the attacker. Step-by-step guide covering rotation follow mechanics, heel control retention, and reversed finishing angle establishment.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Inside-Ashi-Garami-to-Ushiro-Ashi/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Inside Ashi-Garami to Ushiro Ashi (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "V grip from top ushiro transition",
      "description": "Inside Ashi-Garami to Ushiro Ashi (Attacker) film study: V grip from top ushiro transition, taught by Gordon Ryan.",
...
<p class="section-subtitle">Watch Inside Ashi-Garami to Ushiro Ashi (Attacker) in action — curated instructionals</p>
