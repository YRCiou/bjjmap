...
---
title: "Open Guard to Feet on Hips Guard | BJJ Technique | BJJ Map"
description: "Master the transition to feet on hips guard in BJJ. Learn setup mechanics, grip sequences, and hip positioning to establish distance control from open guard."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Open Guard to Feet on Hips Guard", "item": "https://bjjmap.pages.dev/Transitions/Open-Guard-to-Feet-on-Hips-Guard" }
  ]
}
</script>
...
[[Open Guard to Feet on Hips Guard/Attacker|Play as Attacker]]
[[Open Guard to Feet on Hips Guard/Defender|Play as Defender]]
...
| **Key Principles** | Elevate hips before placing feet—hip elevation creates the s... | Control the ankles and pants before the bottom player's feet... |
...
[[Open Guard to Feet on Hips Guard/Attacker|→ Full Attacker Guide]]
...
[[Open Guard to Feet on Hips Guard/Defender|→ Full Defender Guide]]
