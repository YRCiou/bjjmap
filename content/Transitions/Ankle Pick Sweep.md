...
---
title: "Ankle Pick Sweep | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Ankle Pick Sweep", "item": "https://bjjmap.pages.dev/Transitions/Ankle-Pick-Sweep" }
  ]
}
</script>
...
| **Key Principles** | Control opponent's upper body before attacking the ankle to ... | Deny the upper body grip first - without collar, wrist, or s... |
...
[[Ankle Pick Sweep/Attacker|→ Full Attacker Guide]]
...
[[Ankle Pick Sweep/Defender|→ Full Defender Guide]]
