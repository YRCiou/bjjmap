...
---
title: "Knee Slide from Combat Base | BJJ Technique | BJJ Map"
description: "Master the Knee Slide from Combat Base in BJJ. High-percentage guard pass combining crossface pressure with knee cut mechanics to achieve side control."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Knee Slide from Combat Base", "item": "https://bjjmap.pages.dev/Transitions/Knee-Slide-from-Combat-Base" }
  ]
}
</script>
...
| **Key Principles** | Drive the knee diagonally across the opponent's thigh at app... | Deny the crossface by framing against the passer's lead shou... |
...
[[Knee Slide from Combat Base/Attacker|→ Full Attacker Guide]]
...
[[Knee Slide from Combat Base/Defender|→ Full Defender Guide]]
