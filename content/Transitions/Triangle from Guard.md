...
---
title: "Triangle from Guard | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Triangle from Guard", "item": "https://bjjmap.pages.dev/Transitions/Triangle-from-Guard" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Triangle from Guard \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Triangle setup from guard",
      "description": "Triangle from Guard film study: Triangle setup from guard, taught by Conceptual Grappling.",
    ...
    },
    {
      ...
      "description": "Triangle from Guard film study: Closed guard triangle entry, taught by Clark Gracie.",
    ...
    },
    {
      ...
      "description": "Triangle from Guard film study: Triangle choke from the overhook entry, taught by CVL BJJ.",
...
<p class="section-subtitle">Watch Triangle from Guard in action — curated instructionals</p>
...
[[Triangle from Guard/Attacker|→ Full Attacker Guide]]
...
[[Triangle from Guard/Defender|→ Full Defender Guide]]
...
**Crackhead Control Triangle Entry**: Instead of swinging the outside leg directly from standard Mission Control, first transition to Crackhead Control by pulling the shin across the opponent's face. From Crackhead Control, the triangle entry is shorter because the leg is already partially across the opponent's head. This variant works well against opponents who keep very tight posture that prevents the full leg swing from standard Mission Control. (When to use: When opponent maintains extremely tight posture and the direct leg swing is blocked, or when you have already transitioned to Crackhead Control through the natural rubber guard flow)


**New York to Triangle**: From New York control where the overhook has isolated the opponent's arm, release the overhook and use the freed arm to push the opponent's head while swinging the leg across for the triangle. The New York position pre-sets the arm isolation more deeply than standard Mission Control, making the triangle entry tighter and harder to defend. The opponent's arm is already trapped deep, eliminating the most common escape route. (When to use: When the opponent has been defending Mission Control submissions and you have transitioned to New York, or when you want a tighter arm isolation before committing to the triangle entry)


**Double Threat Triangle-Omoplata**: Begin the triangle entry but deliberately leave the angle slightly open, inviting the opponent to attempt an arm extraction defense. If they pull the arm, immediately convert to omoplata. If they keep the arm inside to defend the omoplata, close the triangle angle and finish the choke. This variant weaponizes the opponent's defensive choice, forcing a true dilemma where both options lead to submission danger. (When to use: Against experienced opponents who defend the triangle by keeping elbows tight. The deliberate openness forces them to choose which submission they defend, guaranteeing one attack will land.)
