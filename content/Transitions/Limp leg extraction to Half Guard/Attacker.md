...
---
title: "Limp leg extraction to Half Guard Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Limp Leg Extraction to Half Guard in BJJ. Complete guide to escaping leg entanglements through strategic relaxation, hip movement, and immediate guard establishment."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Limp leg extraction to Half Guard in BJJ",
  "description": "Step-by-step guide for executing Limp leg extraction to Half Guard from Leg Knot/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish frames",
      "text": "Position your free leg with the foot planted firmly on opponent's hip, creating a pushing frame that will generate space during extraction. Simultaneously establish upper body frames with your hands on opponent's shoulder and bicep to control distance.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Assess grip status",
      "text": "Identify exactly where opponent is gripping your trapped leg and wait for a grip adjustment moment—watch for them repositioning hands, shifting weight, or reaching for a deeper control. This transition moment is your extraction window.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Complete leg relaxation",
      "text": "Consciously relax every muscle in your trapped leg from hip to toes, allowing it to become completely limp and heavy. This removes the structural tension opponent relies on for grip maintenance and makes the leg slippery and difficult to control.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Hip escape with push",
      "text": "Simultaneously push off opponent's hip with your free leg while executing a strong hip escape movement away from the entanglement. The combination of the push and hip movement creates significant space while your relaxed leg offers no resistance to extraction.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Extract and retract",
      "text": "As space opens from the hip escape, slide your limp leg out through the gap created. Keep the leg completely relaxed throughout extraction—any tension will allow opponent to re-grip. Immediately retract the knee toward your chest once free.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Establish Half Guard",
      "text": "Once the leg clears, immediately insert it between opponent's legs to establish Half Guard with a knee shield or lockdown configuration. Secure underhook or frame on the near side to prevent immediate passing attempts and stabilize the position.",
      "position": 6
    }
  ],
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Limp leg extraction to Half Guard Attacker",
  "description": "How to execute Limp Leg Extraction to Half Guard in BJJ. Complete guide to escaping leg entanglements through strategic relaxation, hip movement, and immediate guard establishment.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Limp-leg-extraction-to-Half-Guard"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Limp-leg-extraction-to-Half-Guard/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Limp leg extraction to Half Guard (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Freeing the trapped leg from leg entanglement",
      "description": "Limp leg extraction to Half Guard (Attacker) film study: Freeing the trapped leg from leg entanglement, taught by Kuwy Jitsu.",
    ...
    },
    {
      "@type": "VideoObject",
      "position": 2,
      "name": "Extracting the leg from a leglock entry",
      "description": "Limp leg extraction to Half Guard (Attacker) film study: Extracting the leg from a leglock entry, taught by Craig Jones.",
...
<p class="section-subtitle">Watch Limp leg extraction to Half Guard (Attacker) in action — curated instructionals</p>
...
<p class="clip-credit"><strong>Freeing the trapped leg from leg entanglement</strong> — taught by Kuwy Jitsu · 1:01 · <a href="https://www.youtube.com/watch?v=m0NLphEuFoc" rel="noopener">Watch on YouTube</a></p>
...
<p class="clip-credit"><strong>Extracting the leg from a leglock entry</strong> — taught by Craig Jones · 2:43 · <a href="https://www.youtube.com/watch?v=uZbUhFapIhg" rel="noopener">Watch on YouTube</a></p>
...
### 2. Attempting extraction without establishing free leg frame first
...
### 3. Exposing heel during extraction by turning away from opponent
...
### 4. Stopping after leg extraction without immediately establishing Half Guard

- **Consequence**: Opponent re-engages the freed leg or immediately passes to side control through the open space
- **Correction**: Treat extraction and Half Guard establishment as a single continuous movement. The leg should go directly from entanglement to Half Guard position.

### 5. Attempting extraction during opponent's strongest control phase

- **Consequence**: Escape fails and energy is wasted fighting maximum resistance, potentially worsening position
- **Correction**: Wait for grip adjustment or transition moments when opponent's control temporarily weakens. Patience in timing dramatically increases success rate.

### 6. Neglecting upper body frames and allowing opponent to stack

- **Consequence**: Opponent drives weight forward eliminating hip mobility needed for extraction, potentially advancing to mount
- **Correction**: Maintain active upper body frames on opponent's shoulder and bicep throughout the escape sequence to prevent stacking.
