...
---
title: "Double Leg Entry Defender | BJJ Defense Guide | BJJ Map"
description: "How to defend against Double Leg Entry in BJJ. Recognition cues, defensive options, and escape strategies for sprawl defense and counter-attacks."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Double Leg Entry in BJJ",
  "description": "Step-by-step guide for defending and countering Double Leg Entry in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Sprawl defense by explosively driving hips backward and downward while extending legs behind you, dropping your weight onto the attacker's head and upper back to flatten their penetration and kill forward momentum",
      "text": "As soon as you recognize the level change and penetration step beginning - the earlier the sprawl initiates, the more effective it becomes. Ideal timing is when their lead foot leaves the ground for the penetration step. If successful: Attacker is flattened with no forward drive, you establish front headlock control or disengage to reset standing position with significant positional advantage",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Guillotine counter by securing a front headlock grip as the attacker's head comes forward, wrapping your arm under their chin and locking a guillotine grip while pulling guard or sprawling to finish the choke",
      "text": "When the attacker drops their head below your hips or places it inside rather than on the centerline during their entry, exposing their neck to the choke. Most effective when their head position is poor. If successful: You establish guillotine control that either forces immediate submission or transitions to closed guard with a dominant attacking grip already locked",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Guard pull by sitting down and establishing closed guard as the attacker drives forward, converting their takedown momentum into your guard game on your own terms rather than being taken down to a disadvantageous position",
      "text": "When the attacker's penetration is too deep to sprawl effectively and you cannot stop the takedown, or when you prefer to fight from guard rather than risk being taken down to side control or half guard If successful: You establish closed guard with grips already in place, converting a potential defensive crisis into a familiar offensive position where you control the distance and tempo",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Crossface and circle away by placing your forearm across the attacker's face while circling your hips away from their penetration angle, denying them the centerline access needed to secure both legs",
      "text": "When the attacker's penetration is moderate and you have time to redirect their angle rather than sprawling. Particularly effective against entries that come from the side or when you have a strong collar tie position. If successful: You deflect the entry and return to neutral standing position with positional advantage, as the attacker has committed energy and positioning to a failed attempt",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What are the earliest visual cues that indicate your opponent is about to shoot a double leg?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Double Leg Entry Defender",
  "description": "How to defend against Double Leg Entry in BJJ. Recognition cues, defensive options, and escape strategies for sprawl defense and counter-attacks.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Double-Leg-Entry"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Double-Leg-Entry/Defender"
    }
  ]
}
</script>
...
- **Consequence**: Backward stepping actually assists the attacker's penetration by maintaining the same distance relationship while removing your base. Each step back gives them another step of penetration depth, and you eventually run out of space or stumble.
- **Correction**: Train the sprawl as an automatic reaction to any level change. The hips must drive down and back while your upper body stays forward over the attacker. Your legs extend behind you rather than stepping back. This removes your legs from their reach while putting your weight on their upper back.

### 2. Bending at the waist rather than dropping the hips during the sprawl, creating a bent-over posture

- **Consequence**: Bending forward rather than sprawling places your weight over the attacker's head rather than on their back, allowing them to drive underneath you. Your legs remain accessible and your defensive structure is compromised, often resulting in a completed takedown.
- **Correction**: Focus on driving hips to the mat while extending your legs behind you. Your torso should remain relatively upright with chest up as your hips snap backward. Think of pushing your belt buckle toward the floor behind you rather than folding forward at the waist.

### 3. Keeping arms passive or at your sides instead of actively controlling the attacker's head and shoulders

- **Consequence**: Without hand control on the attacker's head, they maintain structural drive and can continue penetrating despite the sprawl. They can also re-angle for a single leg or continue forward pressure until your sprawl weakens.
- **Correction**: As you sprawl, immediately drive one hand to the back of the attacker's head pushing it down and one hand to their far shoulder or armpit to prevent them from turning the corner. This head and shoulder control removes their ability to generate forward pressure and creates front headlock opportunities.

### 4. Attempting a guillotine counter with poor head position when the attacker has proper centerline or outside head placement

- **Consequence**: The guillotine requires the attacker's head to be below your hips and inside your body line. Forcing a guillotine against proper head positioning wastes time, compromises your defensive posture, and often results in the takedown completing while you fumble for a grip that was never available.
- **Correction**: Only attempt the guillotine when the attacker's head drops below your hips or is positioned inside your body line. If their head is correctly placed on the centerline or outside, prioritize the sprawl and front headlock control instead. Read the head position first, then select the appropriate defensive response.

### 5. Freezing momentarily when recognizing the shot instead of reacting immediately

- **Consequence**: Even a half-second freeze allows the attacker to close the distance and achieve deep penetration, making all defensive responses significantly less effective. The double leg is designed to overwhelm with speed, so any hesitation favors the attacker.
- **Correction**: Develop automatic defensive reactions through repetitive drilling so that the sprawl fires as a reflex rather than a conscious decision. Train with partners shooting at various speeds so your body learns to react to the stimulus of level change without cognitive processing delay.
...
**Week 3-5: Defensive Technique Integration** - Combining sprawl with hand fighting and counter-positioning
Practice sprawl defense with partner executing slow-speed double leg entries. Focus on timing the sprawl to the penetration step, controlling the attacker's head after sprawling, and transitioning to front headlock or disengaging to standing position. Introduce guillotine counter timing against entries with poor head position. Begin developing the decision-making framework for choosing between sprawl, guillotine, and guard pull based on the quality of the attacker's entry.

**Week 6-8: Live Defense Under Increasing Resistance** - Defending against progressively faster and more committed entries
Partner increases entry speed and commitment to 70-80% intensity. Practice defending entries from various setups including snap-down to double leg, grip fighting to double leg, and blast double entries. Develop ability to recognize which defensive response matches each entry quality. Begin chaining defensive responses - sprawl to front headlock to re-stand, or failed sprawl to guard pull. Include scramble situations where initial defense succeeds but position is not yet secure.

**Week 9+: Competition-Speed Defense** - Full-speed defensive application with counter-attacking
Positional sparring starting from standing with partner focused on shooting double legs while you defend. Full speed and resistance. Develop personal defensive preferences and recognize which counter-attacks work best for your body type and game. Video review to identify defensive timing failures and positional breakdowns. Integrate takedown defense into full rolling sessions where the double leg is one of many threats requiring awareness.
