...
---
title: "Sweep from Knee Shield | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Sweep from Knee Shield", "item": "https://bjjmap.pages.dev/Transitions/Sweep-from-Knee-Shield" }
  ]
}
</script>
...
| **Key Principles** | Underhook depth determines sweep power—fight for a grip that... | Prevent the underhook—without it, the sweep has no driving e... |
...
[[Sweep from Knee Shield/Attacker|→ Full Attacker Guide]]
...
[[Sweep from Knee Shield/Defender|→ Full Defender Guide]]
