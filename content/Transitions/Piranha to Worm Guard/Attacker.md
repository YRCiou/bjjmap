...
---
title: "Piranha to Worm Guard Attacker | BJJ Technique Guide | BJJ Map"
description: "Master the Piranha to Worm Guard transition as the attacking guard player. Step-by-step execution guide covering lapel re-routing mechanics, DLR hook placement, and grip management for converting Piranha Guard into Worm Guard."
---
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the optimal timing window for initiating the Piranha to Worm Guard transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The optimal window opens when the opponent is reacting to a Piranha-specific attack threat—such as recovering their base after a sweep attempt—rather than actively grip-fighting or initiating a pass. During their defensive recovery, their hands are occupied with balance rather than lapel control, and their lead leg is typically posted in a predictable position. Initiating during an active pass attempt is dangerous because your grip transition creates vulnerability. The secondary window is when they pause to reassess, creating a brief moment of static positioning where the DLR hook can be set without resistance."
      }
    },
    {
      "@type": "Question",
      "name": "What entry requirements must be met before you can safely begin re-routing the lapel?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You need four prerequisites: an established Piranha Guard with adequate lapel tension, a DLR hook set on the opponent's lead leg as an anchor, sufficient extracted lapel material to complete the full worm wrap path, and the opponent's lead leg within your hip range. Missing any single requirement makes the transition high-risk. The DLR hook is particularly critical because without it, the opponent can simply step backward during your grip transition and you lose both the Piranha and the potential Worm Guard."
      }
    },
    {
      "@type": "Question",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Piranha to Worm Guard Attacker",
  "description": "Master the Piranha to Worm Guard transition as the attacking guard player. Step-by-step execution guide covering lapel re-routing mechanics, DLR hook placement, and grip management for converting Piranha Guard into Worm Guard.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Piranha-to-Worm-Guard"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Piranha-to-Worm-Guard/Attacker"
    }
  ]
}
</script>
...
<p class="section-subtitle">What are the key principles for executing Piranha to Worm Guard?</p>
...
<p class="section-subtitle">What do you need before attempting Piranha to Worm Guard?</p>
...
<p class="section-subtitle">How do you execute Piranha to Worm Guard step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Piranha to Worm Guard?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Piranha to Worm Guard?</p>
...
<p class="section-subtitle">How do you train Piranha to Worm Guard (Attacker)?</p>

**Phase 1: Mechanics** - Lapel re-routing path and grip transfer
Practice the physical motion of extracting the lapel from Piranha threading and feeding it under the partner's thigh into worm guard configuration. Partner stands still with no resistance. Focus on the grip transfer sequence, ensuring one hand always maintains tension. Repeat 20 times per side until the motion is smooth and automatic.

**Phase 2: Timing and Recognition** - Identifying transition windows during live guard play
...
<p class="section-subtitle">What are the safety concerns for Piranha to Worm Guard?</p>
