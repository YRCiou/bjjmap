...
---
title: "Pull Guard from Ground | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Pull Guard from Ground", "item": "https://bjjmap.pages.dev/Transitions/Pull-Guard-from-Ground" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Pull Guard from Ground \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Pulling closed guard",
      "description": "Pull Guard from Ground film study: Pulling closed guard, taught by The Paradigm Academy.",
    ...
    },
    {
      ...
      "description": "Pull Guard from Ground film study: Pulling guard no-gi, taught by Backstreet Dojo.",
    ...
    },
    {
      ...
      "description": "Pull Guard from Ground film study: Closed guard pull fundamentals, taught by Absolute MMA.",
...
<p class="section-subtitle">Watch Pull Guard from Ground in action — curated instructionals</p>
...
[[Pull Guard from Ground/Attacker|→ Full Attacker Guide]]
...
[[Pull Guard from Ground/Defender|→ Full Defender Guide]]
...
**Seated Pull to Closed Guard**: From a deliberate seated position, establish collar and sleeve grips, then use a simultaneous pull-and-hip-scoot motion to close distance and wrap legs. The seated base provides stability for grip fighting before committing to the pull. (When to use: When you have time to sit deliberately and establish grips without immediate pressure, commonly used at match start by guard players)


**Collar Drag Guard Pull**: Combine a collar drag motion with the guard pull, using the off-balancing momentum of the drag to pull opponent forward and down as you simultaneously shoot your legs around their waist. Creates a two-directional force that makes defense more difficult. (When to use: When opponent is posturing upright and resisting forward pressure, the collar drag breaks their posture and creates the momentum needed for guard closure)


**Butterfly Hook Entry to Closed Guard**: Establish butterfly hooks first from seated position, use the hooks to elevate and control opponent's hips momentarily, then transition hooks to full leg wrap and lock ankles for closed guard. The butterfly hooks provide intermediate control during the transition. (When to use: When opponent is pressuring forward aggressively and you need intermediate hip control before committing to closed guard closure)
