...
---
title: "Half Butterfly Sweep | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Half Butterfly Sweep", "item": "https://bjjmap.pages.dev/Transitions/Half-Butterfly-Sweep" }
  ]
}
</script>
...
| **Key Principles** | Load the opponent's weight onto the butterfly hook through u... | Deny the underhook on the butterfly side through active hand... |
...
[[Half Butterfly Sweep/Attacker|→ Full Attacker Guide]]
...
[[Half Butterfly Sweep/Defender|→ Full Defender Guide]]
