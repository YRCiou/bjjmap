...
---
title: "Half Guard to Leg Hook Attacker | BJJ Technique Guide | BJJ Map"
description: "Step-by-step guide to executing the Transition to Leg Hook from Half Guard Top. Master hook insertion timing, weight distribution, and pass completion setups."
---
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Why must upper body control be established before attempting the hook insertion?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The hook insertion requires a brief weight shift that creates a vulnerability window. Without established crossface or underhook control, the bottom player can exploit this weight shift to sweep, recover full guard, or take the back. Upper body dominance pins the bottom player and limits their ability to react to the leg repositioning. The crossface specifically turns their head away, reducing their awareness of the hook insertion and slowing their defensive response."
      }
    },
    {
      "@type": "Question",
      "name": "What hip movement pattern creates the most effective hook insertion?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Hip rotation rather than hip elevation produces the most effective hook insertion. The foot should travel in a compact circular path, curling inward underneath the bottom player's knee through rotation of the hip joint. Lifting the hips to create space for the foot is a common error that exposes you to deep half entries and butterfly hook insertions. The rotation keeps your hips low and maintains forward pressure throughout the insertion."
      }
    },
    {
      "@type": "Question",
      "name": "Your opponent establishes a strong knee shield as you begin the hook insertion. How do you adjust?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Stop the hook insertion attempt and address the knee shield first. Use your far-side hand to push their top knee toward the mat while driving shoulder pressure forward, or switch to a long step approach to collapse the shield from the outside. Attempting to force the hook against an active knee shield will fail and waste positional advantage. Once the shield is cleared, restart the hook insertion sequence from the beginning."
      }
    },
    {
      "@type": "Question",
      "name": "What are the three points of contact that create stable base during the transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The three points are: the hooked leg providing lower body control and forward drive, the posted free leg with foot planted on the mat providing lateral stability and sweep resistance, and the upper body pressure through chest and shoulder maintaining top control and pinning the bottom player. Weight must be distributed dynamically across all three points, shifting emphasis based on the bottom player's reactions to maintain control throughout."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "Why should you treat the Leg Hook position as transitional rather than a destination?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The Leg Hook position is mechanically unstable for long-term control because the bottom player retains enough mobility to develop counters over time, including frame establishment, deep half entries, and lockdown re-entanglement. The position's value lies in the temporary control advantage it provides for completing a specific guard pass. Settling into it without a clear passing plan gives the bottom player time to adapt, negating the positional advantage you worked to establish."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Half Guard to Leg Hook Attacker",
  "description": "Step-by-step guide to executing the Transition to Leg Hook from Half Guard Top. Master hook insertion timing, weight distribution, and pass completion setups.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Half-Guard-to-Leg-Hook"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Half-Guard-to-Leg-Hook/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Half Guard to Leg Hook (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Leg entanglement entry against the knee shield",
      "description": "Half Guard to Leg Hook (Attacker) film study: Leg entanglement entry against the knee shield, taught by Grappling Mastery coach.",
    ...
    },
    {
      ...
      "description": "Half Guard to Leg Hook (Attacker) film study: Leg lock entry from knee shield half guard, taught by Hellfish MMA coach.",
...
<p class="section-subtitle">Watch Half Guard to Leg Hook (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Half Guard to Leg Hook?</p>
...
<p class="section-subtitle">What do you need before attempting Half Guard to Leg Hook?</p>
...
<p class="section-subtitle">How do you execute Half Guard to Leg Hook step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Half Guard to Leg Hook?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Half Guard to Leg Hook?</p>
...
<p class="section-subtitle">How do you train Half Guard to Leg Hook (Attacker)?</p>

**Phase 1: Isolated Hook Mechanics** - Hook insertion movement pattern
Practice the hook insertion motion solo and with a compliant partner. Focus on hip rotation mechanics, foot path, and maintaining upper body pressure throughout. Drill the circular foot motion 20 repetitions per side, building muscle memory for the compact insertion path.

**Phase 2: Integration with Upper Body Control** - Combining crossface pressure with hook insertion
Partner provides 25-50% resistance in half guard bottom. Practice the complete sequence: establish crossface, clear knee shield, post free leg, insert hook, consolidate. Focus on maintaining constant pressure throughout the transition without creating space.

**Phase 3: Counter Recognition and Response** - Reacting to defensive responses during insertion
Partner actively counters with hip escapes, deep half entries, bridges, and lockdown attempts at 75% resistance. Practice recognizing each counter and applying the appropriate response. Develop the sensitivity to feel when the bottom player is loading for a counter.

**Phase 4: Chained Passing Sequences** - Hook to pass completion under full resistance
Full resistance positional sparring starting from half guard top. Chain the hook insertion into knee slice, leg drag, or smash pass completions. Develop ability to select the appropriate pass based on bottom player's defensive reactions to the hook establishment.
...
<p class="section-subtitle">What are the safety concerns for Half Guard to Leg Hook?</p>
