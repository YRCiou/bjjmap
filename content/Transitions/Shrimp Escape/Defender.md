...
---
title: "Shrimp Escape Defender | BJJ Defense Guide | BJJ Map"
description: "How to defend against Shrimp Escape in BJJ. Recognition cues, defensive options, and escape strategies from the top player's perspective."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Shrimp Escape in BJJ",
  "description": "Step-by-step guide for defending and countering Shrimp Escape in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Drive heavy crossface pressure and walk hips to follow their shrimp direction, maintaining chest-to-chest connection throughout their movement",
      "text": "As soon as you feel opponent begin to turn onto their hip or sense their frames activating, before they generate significant hip movement If successful: Opponent's shrimp is nullified as you follow their movement, maintaining side control with no space created between your bodies",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Block knee insertion by driving your near-side hip down into the space between your bodies, pinning their thigh before their knee can cross the centerline",
      "text": "When opponent has already created some space with a successful shrimp but has not yet inserted their knee shield or recovered guard legs If successful: You deny guard recovery despite their space creation, allowing you to re-settle weight and close the gap they generated",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Transition to mount by stepping your knee over as opponent bridges, converting their escape attempt into your positional advancement",
      "text": "When opponent commits to a large bridge that lifts their hips high enough to create space underneath—use their bridge momentum to slide your knee across their waist If successful: You advance from side control to mount, converting their escape attempt into a worse position for them and gaining additional points in competition",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Switch to north-south position by sliding your body toward their head as they shrimp away, using their lateral movement to transition rather than fighting it",
      "text": "When opponent successfully creates significant lateral space with their shrimp and you cannot maintain side control chest pressure on their torso If successful: You maintain dominant control from north-south rather than losing position entirely, and can work back to side control or attack from north-south",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "When is the optimal time to transition to mount during your opponent's shrimp escape attempt?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Shrimp-Escape/Defender"
    }
  ]
}
</script>
...
<p class="section-subtitle">How do you know when someone is attempting Shrimp Escape?</p>
...
<p class="section-subtitle">What are the key principles for defending Shrimp Escape?</p>
...
<p class="section-subtitle">What can you do to defend against Shrimp Escape?</p>
...
<p class="section-subtitle">What is the best outcome when defending Shrimp Escape?</p>
...
<p class="section-subtitle">What mistakes should you avoid when defending Shrimp Escape?</p>
