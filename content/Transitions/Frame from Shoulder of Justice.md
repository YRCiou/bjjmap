...
---
title: "Frame from Shoulder of Justice | BJJ Technique | BJJ Map"
description: "Master framing from Shoulder of Justice in BJJ. Defensive guide to creating structural frames, relieving jaw pressure, and transitioning to side control bottom."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Frame from Shoulder of Justice", "item": "https://bjjmap.pages.dev/Transitions/Frame-from-Shoulder-of-Justice" }
  ]
}
</script>
...
[[Frame from Shoulder of Justice/Attacker|→ Full Attacker Guide]]
...
[[Frame from Shoulder of Justice/Defender|→ Full Defender Guide]]
...
**Shoulder Redirect Frame**: Rather than framing against the opponent's hip line, this variant targets the opponent's shoulder itself with a forearm wedge placed against the deltoid-trapezius junction. The frame redirects the shoulder pressure vector away from the jaw by changing the angle of the opponent's shoulder rather than creating distance. This requires less hip escape and is effective when the opponent's hips are tightly connected to your hip line. (When to use: When the opponent's hip connection is extremely tight and prevents any meaningful hip escape, but their shoulder position can be redirected through angled pressure from your forearm wedge)


**Elbow Post Frame**: Uses the near-side elbow planted firmly on the mat beside your own head as a structural post, then levers the forearm against the opponent's neck and jaw to push their head away from optimal pressure angle. This reverses the pressure dynamic by using the ground as the fulcrum point and your forearm as a lever, requiring minimal energy while disrupting the shoulder pressure alignment significantly. (When to use: When you have sufficient space beside your head to plant the elbow and the opponent's head is positioned close enough to your near side for the forearm lever to reach their neck)


**Bridge-Assisted Frame**: Combines a controlled bridge with simultaneous frame insertion to exploit the momentary space created by the bridge. The bridge displaces the opponent's weight briefly, and during that displacement the forearm wedge slides into position against the opponent's hip or shoulder. The bridge is not an escape attempt but purely a frame-insertion tool that creates the structural barrier before the opponent re-settles. (When to use: When the opponent's weight is so heavy that frame insertion is impossible without first creating a momentary space through bridge displacement)
