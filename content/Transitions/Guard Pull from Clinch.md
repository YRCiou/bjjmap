...
---
title: "Guard Pull from Clinch | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Guard Pull from Clinch", "item": "https://bjjmap.pages.dev/Transitions/Guard-Pull-from-Clinch" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Guard Pull from Clinch \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Guard pull from the standing clinch",
      "description": "Guard Pull from Clinch film study: Guard pull from the standing clinch, taught by Mat Life Training Center.",
    ...
    },
    {
      ...
      "description": "Guard Pull from Clinch film study: Pulling closed guard, taught by The Paradigm Academy.",
    ...
    },
    {
      ...
      "description": "Guard Pull from Clinch film study: Pulling guard in no-gi, taught by Backstreet Dojo.",
...
[[Guard Pull from Clinch/Attacker|Play as Attacker]]
[[Guard Pull from Clinch/Defender|Play as Defender]]
...
<p class="section-subtitle">Watch Guard Pull from Clinch in action — curated instructionals</p>
...
| **Key Principles** | Grip before sit — never initiate the guard pull without at l... | Recognize guard pull cues early — grip changes, hip drops, a... |
...
[[Guard Pull from Clinch/Attacker|→ Full Attacker Guide]]
...
[[Guard Pull from Clinch/Defender|→ Full Defender Guide]]
