...
---
title: "KOB to Side Control | BJJ Technique | BJJ Map"
description: "Master the KOB to Side Control transition in BJJ. Learn to consolidate from knee on belly into stable side control while denying guard recovery attempts."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "KOB to Side Control", "item": "https://bjjmap.pages.dev/Transitions/KOB-to-Side-Control" }
  ]
}
</script>
...
[[KOB to Side Control/Attacker|Play as Attacker]]
[[KOB to Side Control/Defender|Play as Defender]]
...
| **Key Principles** | Establish upper body control (crossface or collar grip) befo... | Recognize the transition cues early — the opponent's weight ... |
...
[[KOB to Side Control/Attacker|→ Full Attacker Guide]]
...
[[KOB to Side Control/Defender|→ Full Defender Guide]]
