...
---
title: "Closed Guard to Overhook Guard | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Closed Guard to Overhook Guard", "item": "https://bjjmap.pages.dev/Transitions/Closed-Guard-to-Overhook-Guard" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Closed Guard to Overhook Guard \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Key detail to strengthen your closed guard",
      "description": "Closed Guard to Overhook Guard film study: Key detail to strengthen your closed guard, taught by Jean Jacques Machado.",
    ...
    },
    {
      ...
      "description": "Closed Guard to Overhook Guard film study: Overhook control from closed guard, taught by 6am Jiu Jitsu.",
...
<p class="section-subtitle">Watch Closed Guard to Overhook Guard in action — curated instructionals</p>
...
[[Closed Guard to Overhook Guard/Attacker|→ Full Attacker Guide]]
...
[[Closed Guard to Overhook Guard/Defender|→ Full Defender Guide]]
...
**Pull-Through Overhook Entry**: From closed guard, grab the opponent's wrist with your opposite hand and pull their arm across your centerline. Thread your overhook arm over their tricep and secure the grip on their lat before they can retract. Works best when opponent reaches inside your guard to establish collar or hip grips. (When to use: When opponent reaches inside your guard with an arm to establish grips or attempt guard breaks)


**Posture Break to Overhook**: Break the opponent's posture with a strong collar pull, then as their arm comes forward to post, immediately thread the overhook over the posting arm. The broken posture makes their arm structurally available and difficult to retract quickly. Combine with collar grip on opposite side for complete control. (When to use: Against opponents who maintain disciplined hand position but can be broken down with strong collar pulling)


**Underhook-to-Overhook Switch**: Start by establishing an underhook on the opponent's arm as if setting up a basic sweep, then rotate your grip over the top of their arm to convert to an overhook. The initial underhook draws their arm forward and creates the angle needed for the deeper overhook grip. Effective as a deceptive entry that disguises the overhook intention. (When to use: Against experienced opponents who recognize and defend direct overhook attempts by keeping elbows tight)
