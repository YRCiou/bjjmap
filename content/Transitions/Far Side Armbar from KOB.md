...
---
title: "Far Side Armbar from KOB | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Far Side Armbar from KOB", "item": "https://bjjmap.pages.dev/Transitions/Far-Side-Armbar-from-KOB" }
  ]
}
</script>
...
| **Key Principles** | Maintain constant knee pressure on the diaphragm throughout ... | Keep your far elbow tight against your body at all times und... |
...
[[Far Side Armbar from KOB/Attacker|→ Full Attacker Guide]]
...
[[Far Side Armbar from KOB/Defender|→ Full Defender Guide]]
...
- [[Positions/Knee on Belly]] - Starting position — the far side armbar launches from established KOB control

- [[Positions/Armbar Control]] - Primary success destination — the armbar control position where the finish is executed
