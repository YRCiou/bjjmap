...
---
title: "Kimura Defense Arm Extraction Defender | BJJ Defense Guide | BJJ Map"
description: "Master the defender perspective against Kimura Defense Arm Extraction. Learn grip retention strategies, sweep timing, and counter-techniques to maintain Kimura Trap offensive pressure when opponents attempt arm extraction."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Kimura Defense Arm Extraction in BJJ",
  "description": "Step-by-step guide for defending and countering Kimura Defense Arm Extraction in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Deepen grip and lock elbows tight to body while curling torso forward",
      "text": "Immediately when you feel the opponent beginning to straighten the trapped arm or drive it toward the mat If successful: Maintains Kimura grip and full offensive position, allowing continued sweep, back take, and submission threats from the Kimura Trap system",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Initiate Old School Sweep timed to the extraction attempt",
      "text": "When the opponent lifts hips or shifts weight forward during extraction, creating the base vulnerability needed for sweep mechanics If successful: Sweep the opponent and achieve top position while potentially maintaining the Kimura grip for continued offensive pressure from top",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Transition to back take as opponent drives arm forward and creates space underneath",
      "text": "When the opponent commits heavily to forward arm drive with chest pressure, creating enough space for you to turn underneath them If successful: Take the back and establish back control, transforming their extraction attempt into a significantly worse positional outcome",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Establish lockdown to create compound control before grip breaks",
      "text": "Early in the extraction attempt, before the opponent has fully committed to arm straightening or hip withdrawal If successful: Compound Kimura plus lockdown control makes extraction nearly impossible and opens electric chair and additional sweep threats",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "When should you transition from grip retention to an alternative attack during the extraction?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Transition when you feel the grip reaching approximately 60-70 percent compromised, when the opponent has partially straightened the arm but has not fully broken the figure-four. At this point, their commitment to extraction has compromised their base and attention. Use the remaining grip control to initiate a back take or sweep rather than fighting a losing grip battle. The transition point is when maintaining the grip requires more effort than the positional value it provides."
      }
    },
    {
      "@type": "Question",
      "name": "How does adding lockdown change your defensive strategy against the arm extraction?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Lockdown fundamentally changes the dynamic by eliminating the opponent's ability to walk their hips away, which is the primary extraction mechanic. With lockdown established, the opponent can no longer create the angle needed to drive the arm to the mat because their hips are locked in place. This transforms the situation from defensive grip retention into offensive opportunity, as the opponent is trapped in compound control with diminishing extraction options while you threaten sweeps and submissions."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Kimura Defense Arm Extraction Defender",
  "description": "Master the defender perspective against Kimura Defense Arm Extraction. Learn grip retention strategies, sweep timing, and counter-techniques to maintain Kimura Trap offensive pressure when opponents attempt arm extraction.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Kimura-Defense-Arm-Extraction"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Kimura-Defense-Arm-Extraction/Defender"
    }
  ]
}
</script>
...
<p class="section-subtitle">How do you know when someone is attempting Kimura Defense Arm Extraction?</p>
...
<p class="section-subtitle">What are the key principles for defending Kimura Defense Arm Extraction?</p>
...
<p class="section-subtitle">What can you do to defend against Kimura Defense Arm Extraction?</p>
...
<p class="section-subtitle">What is the best outcome when defending Kimura Defense Arm Extraction?</p>
...
<p class="section-subtitle">What mistakes should you avoid when defending Kimura Defense Arm Extraction?</p>
...
<p class="section-subtitle">How do you train defense against Kimura Defense Arm Extraction?</p>

**Phase 1: Recognition** - Grip Monitoring and Cue Detection
Hold Kimura grip from bottom while partner executes extraction slowly at 30% intensity. Focus on recognizing the mechanical cues: arm straightening, hip walking, weight shifting, and post establishment. Develop tactile sensitivity to distinguish extraction attempts from normal positional adjustments.

**Phase 2: Retention** - Grip Retention Under Progressive Pressure
Hold Kimura grip while partner attempts extraction at progressively increasing intensity from 30% to 70%. Practice elbow tightening, hip angle changes, and lockdown establishment as defensive responses. Measure grip retention duration and track improvement across sessions.

**Phase 3: Counter-Attack** - Extraction to Sweep Timing
Partner attempts extraction while you practice timing sweeps off their extraction movement patterns. Focus on identifying the moment their base is most compromised, typically when weight shifts forward or hips lift, and initiating the sweep at that precise timing window.

**Phase 4: Live Flow** - Full System Decision Tree
Positional sparring from Kimura Trap with partner attempting extraction at full resistance. Work the complete decision tree: retain grip, add secondary controls, counter with sweeps, transition to back take. Both partners develop competitive timing and reactions under realistic conditions.
