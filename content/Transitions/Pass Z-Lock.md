...
---
title: "Pass Z-Lock | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Pass Z-Lock", "item": "https://bjjmap.pages.dev/Transitions/Pass-Z-Lock" }
  ]
}
</script>
...
| **Key Principles** | Establish crossface and shoulder pressure before attempting ... | Maintain constant underhook fighting to prevent the passer f... |
...
[[Pass Z-Lock/Attacker|→ Full Attacker Guide]]
...
[[Pass Z-Lock/Defender|→ Full Defender Guide]]
