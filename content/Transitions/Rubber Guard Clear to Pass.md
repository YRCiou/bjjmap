...
---
title: "Rubber Guard Clear to Pass | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Rubber Guard Clear to Pass", "item": "https://bjjmap.pages.dev/Transitions/Rubber-Guard-Clear-to-Pass" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Rubber Guard Clear to Pass \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Top lockdown turk to clear the guard",
      "description": "Rubber Guard Clear to Pass film study: Top lockdown turk to clear the guard, taught by Craig Jones.",
    ...
    },
    {
      ...
      "description": "Rubber Guard Clear to Pass film study: Beating the step over from rubber guard, taught by Craig Jones.",
...
<p class="section-subtitle">Watch Rubber Guard Clear to Pass in action — curated instructionals</p>
...
| **Key Principles** | Address leg control before attempting arm extraction to prev... | Maintain constant downward breaking pressure on opponent's p... |
...
[[Rubber Guard Clear to Pass/Attacker|→ Full Attacker Guide]]
...
[[Rubber Guard Clear to Pass/Defender|→ Full Defender Guide]]
