...
---
title: "Shoulder of Justice Kimura Setup Attacker | BJJ Technique Guide | BJJ Map"
description: "Master the Kimura setup from Shoulder of Justice top position. Step-by-step guide to converting jaw pressure into figure-four Kimura Trap control with systematic grip establishment."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Shoulder of Justice Kimura Setup in BJJ",
  "description": "Step-by-step guide for executing Shoulder of Justice Kimura Setup from Shoulder of Justice/Top.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Escalate shoulder pressure",
      "text": "Increase shoulder blade pressure into the opponent's jaw by walking your feet slightly forward and driving your hips lower. Angle your shoulder at approximately 45 degrees toward their far shoulder. This escalation forces the opponent to choose between enduring increasing discomfort and extending their near arm to create relief. Maintain your base throughout this pressure increase.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Identify arm exposure",
      "text": "Watch for the opponent's near-side arm to extend, frame, or lift away from their ribs. The critical indicator is space appearing between their elbow and their ribcage. This can manifest as a push against your shoulder, a forearm frame against your neck, or simply their elbow rising as they try to create breathing room. This is your trigger to initiate the grip sequence.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Thread near-side arm underneath",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the optimal timing to initiate the Kimura grip threading from Shoulder of Justice?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The optimal timing is immediately when the opponent's near-side elbow lifts away from their ribs, creating space between the elbow and ribcage. This can happen as a reactive push against your shoulder, a forearm frame attempt, or simply the elbow rising from pain. The window is brief—typically one to two seconds—so the threading motion must be practiced to the point of reflexive execution."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "What are the entry requirements that must exist before you attempt the Kimura setup?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You need fully established Shoulder of Justice with shoulder blade driven into the jaw at a 45-degree angle, hips connected to the opponent's near hip line, a wide stable base with far knee posted, and crucially, the opponent's near arm must show signs of extension or lifting. Without established pressure and base, the threading attempt will fail because you lack the positional stability to maintain control during the grip transition."
      }
    },
    {
      "@type": "Question",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Shoulder of Justice Kimura Setup Attacker",
  "description": "Master the Kimura setup from Shoulder of Justice top position. Step-by-step guide to converting jaw pressure into figure-four Kimura Trap control with systematic grip establishment.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Shoulder-of-Justice-Kimura-Setup"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Shoulder-of-Justice-Kimura-Setup/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Shoulder of Justice Kimura Setup (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Kimura from side control",
      "description": "Shoulder of Justice Kimura Setup (Attacker) film study: Kimura from side control, taught by Alavanca.",
    ...
    },
    {
      ...
      "description": "Shoulder of Justice Kimura Setup (Attacker) film study: Setting up the kimura from side control, taught by Heiho Dojo.",
    ...
    },
    {
      ...
      "description": "Shoulder of Justice Kimura Setup (Attacker) film study: Kimura from side control breakdown, taught by Josh Cooksley.",
...
<p class="section-subtitle">Watch Shoulder of Justice Kimura Setup (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Shoulder of Justice Kimura Setup?</p>
...
<p class="section-subtitle">What do you need before attempting Shoulder of Justice Kimura Setup?</p>
...
<p class="section-subtitle">How do you execute Shoulder of Justice Kimura Setup step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Shoulder of Justice Kimura Setup?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Shoulder of Justice Kimura Setup?</p>
...
<p class="section-subtitle">How do you train Shoulder of Justice Kimura Setup (Attacker)?</p>

**Phase 1: Pressure-to-Exposure Recognition** - Identifying when shoulder pressure creates genuine arm exposure
Drill establishing Shoulder of Justice and incrementally increasing pressure while partner provides realistic defensive reactions. Focus exclusively on recognizing the moment the near arm lifts or extends. No grip attempts—just pressure application and visual/tactile recognition of the exposure window.

**Phase 2: Arm Threading Mechanics** - Precise arm insertion underneath opponent's tricep while maintaining pressure
...
**Phase 3: Grip-to-Trap Transition** - Converting initial grip catch into full Kimura Trap position
Start with Kimura grip already established from Shoulder of Justice. Practice the full transition sequence: re-consolidate pressure, pull arm across body, adjust hip angle, walk feet toward head, and establish Kimura Trap finishing position. Partner provides 30-50% resistance.

**Phase 4: Counter Recognition and Response** - Handling defensive reactions during the setup sequence
Partner cycles through defensive reactions: keeping arm tight, bridging during threading, turning away, grabbing own belt. Practice recognizing each reaction and applying the appropriate response—whether completing the Kimura setup or transitioning to alternative attacks.

**Phase 5: Live Integration** - Full sequence execution under progressive resistance
Positional sparring starting from Shoulder of Justice. Top player attempts Kimura setup while bottom player uses full defensive repertoire. Progress from 50% to full resistance over multiple rounds. Develop timing, pressure sensitivity, and the ability to chain the Kimura setup with other Shoulder of Justice attacks.
...
<p class="section-subtitle">What are the safety concerns for Shoulder of Justice Kimura Setup?</p>
