...
---
title: "X-Guard to Single Leg X | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "X-Guard to Single Leg X", "item": "https://bjjmap.pages.dev/Transitions/X-Guard-to-Single-Leg-X" }
  ]
}
</script>
...
| **Key Principles** | Stagger the leg reconfiguration to maintain at least one act... | Recognize transition cues early to counter during the vulner... |
...
[[X-Guard to Single Leg X/Attacker|→ Full Attacker Guide]]
...
[[X-Guard to Single Leg X/Defender|→ Full Defender Guide]]
