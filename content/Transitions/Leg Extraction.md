...
---
title: "Leg Extraction | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Leg Extraction", "item": "https://bjjmap.pages.dev/Transitions/Leg-Extraction" }
  ]
}
</script>
...
[[Leg Extraction/Attacker|→ Full Attacker Guide]]
...
[[Leg Extraction/Defender|→ Full Defender Guide]]
...
**Technical Standup Extraction**: When upper body remains mobile and you can post strongly, combine leg extraction with technical standup to disengage completely and reset to standing position rather than recovering guard. (When to use: When opponent's hip pressure is not severe and you have good posting angle with far hand)


**Butterfly Hook Extraction**: Use free leg to establish butterfly hook on opponent's inner thigh during extraction, allowing for immediate sweep threat once leg is freed rather than passive guard recovery. (When to use: When opponent is leaning forward heavily and vulnerable to elevation during your escape attempt)


**Rolling Back Take Extraction**: When opponent over-commits to following your hip movement, use momentum to complete a full roll while extracting, ending in position to attack their back as they chase the leg. (When to use: Against aggressive opponents who follow movement too eagerly without maintaining base)
