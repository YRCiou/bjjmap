...
---
title: "Smash Pocket Half Attacker | BJJ Technique Guide | BJJ Map"
description: "Master the attacking mechanics of the Smash Pocket Half. Step-by-step guide to collapsing the pocket half guard through systematic pressure application and underhook neutralization."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Smash Pocket Half in BJJ",
  "description": "Step-by-step guide for executing Smash Pocket Half from Pocket Half Guard/Top.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish heavy chest connection",
      "text": "Lower your entire chest weight directly onto the opponent's upper torso, driving your sternum into their chest. Eliminate any gap between your bodies by sinking your weight through your ribs and pectoral muscles rather than supporting yourself on your elbows or hands. This initial pressure begins collapsing the pocket space.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Drive crossface pressure",
      "text": "Position your head on the opposite side from the opponent's underhook and drive your forehead or temple into their jaw, turning their head away from the underhook side. This disrupts their ability to reinforce the underhook with head pressure and begins separating their shoulder connection to your body.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Collapse the hip frame",
      "text": "Use your near-side hip to drive into the opponent's bottom leg frame, eliminating the pocket space they created with their foot against your hip. Drop your hip weight directly onto their thigh while maintaining chest pressure, removing the structural wedge that gave them sweeping leverage.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Strip or neutralize the underhook",
      "text": "With the pocket space collapsed and crossface established, use your free hand to either strip the opponent's underhook grip by peeling their hand off your back, or drive your shoulder deeper to pin their arm against their body. The key is eliminating their underhook as a pulling mechanism for sweeps.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Flatten the opponent's hips",
      "text": "Drive your near-side knee toward the mat while maintaining chest pressure to force the opponent's hips flat to the ground. Their angle on the mat was maintaining offensive potential - removing this angle eliminates sweep threats and transitions the position toward flattened half guard.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Pin the near shoulder",
      "text": "Use your crossface arm to pin the opponent's near shoulder to the mat, preventing them from turning back to their side or recovering the pocket position. The crossface pressure combined with shoulder pinning completes the transition to a flattened half guard configuration.",
      "position": 6
    },
    {
      "@type": "HowToStep",
      "name": "Consolidate Flattened Half Guard",
      "text": "Settle your weight into the new flattened half guard position, ensuring the opponent cannot recover their underhook, hip frame, or angle. Widen your base with your free leg and maintain forward pressure through your chest. From here, you are positioned to execute subsequent passes to side control.",
      "position": 7
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Why must you collapse the pocket space before attempting to strip the opponent's underhook?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The pocket space created by the bottom player's hip frame provides the structural foundation for their underhook-based sweeps. If you try to strip the underhook while the hip frame is intact, you must lift or shift your weight to fight the grip, which gives the bottom player leverage to execute sweeps like the Old School. Collapsing the hip frame first removes the sweeping foundation, making the underhook progressively weaker and safer to strip without exposing yourself to counters."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "How should you adjust your base if the opponent bridges explosively during the smash?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Smash Pocket Half Attacker",
  "description": "Master the attacking mechanics of the Smash Pocket Half. Step-by-step guide to collapsing the pocket half guard through systematic pressure application and underhook neutralization.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Smash-Pocket-Half"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Smash-Pocket-Half/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Smash Pocket Half (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Passing the flat half guard",
      "description": "Smash Pocket Half (Attacker) film study: Passing the flat half guard, taught by Malachy Friedman.",
    ...
    },
    {
      ...
      "description": "Smash Pocket Half (Attacker) film study: Countering the half guard underhook on top, taught by Marcos Escobar.",
    ...
    },
    {
      ...
      "description": "Smash Pocket Half (Attacker) film study: Body lock pass off their underhook, taught by Gordon Ryan.",
...
<p class="section-subtitle">Watch Smash Pocket Half (Attacker) in action — curated instructionals</p>
...
**Phase 2: Sequential Collapse** - Learning the step-by-step pocket collapse sequence
Walk through the full smash sequence at 30% speed with a cooperative partner: chest connection, crossface, hip frame collapse, underhook strip, hip flattening, shoulder pin. Partner allows each step to succeed while providing positional feedback. Repeat 20 times per round.

**Phase 3: Resistance Training** - Executing against progressive defensive resistance
Partner begins at 40% resistance and increases to 70% over multiple rounds. Bottom player actively fights to maintain pocket structure including re-establishing underhook, creating frames, and threatening sweeps. Top player must complete the full smash sequence against increasing defensive quality.

**Phase 4: Counter Integration** - Recognizing and responding to common defensive reactions
Partner alternates between different counter-strategies: deep half entry, Old School sweep threats, bridging, and framing. Top player must identify the counter and apply the appropriate response while maintaining smash pressure. Practice scenario recognition and reaction selection.

**Phase 5: Live Application** - Integrating the smash into live rolling situations
Positional sparring starting from Pocket Half Guard Top. Top player's primary objective is completing the smash to Flattened Half Guard, with secondary option of completing the pass. Bottom player attempts full resistance offense and defense. Three-minute rounds with reset on position change.
