...
---
title: "Stack Pass from Spider | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Stack Pass from Spider", "item": "https://bjjmap.pages.dev/Transitions/Stack-Pass-from-Spider" }
  ]
}
</script>
...
| **Key Principles** | Wait for the trigger: never force the stack pass while spide... | Maintain at least one frame or foot-on-bicep hook when initi... |
...
[[Stack Pass from Spider/Attacker|→ Full Attacker Guide]]
...
[[Stack Pass from Spider/Defender|→ Full Defender Guide]]
