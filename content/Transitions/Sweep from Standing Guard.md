...
---
title: "Sweep from Standing Guard | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Sweep from Standing Guard", "item": "https://bjjmap.pages.dev/Transitions/Sweep-from-Standing-Guard" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Sweep from Standing Guard \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Flower sweep against a standing opponent",
      "description": "Sweep from Standing Guard film study: Flower sweep against a standing opponent, taught by Jeffjitsu.",
...
<p class="section-subtitle">Watch Sweep from Standing Guard in action — curated instructionals</p>
...
| **Key Principles** | Control distance with feet on hips before initiating any swe... | Maintain a wide base with weight distributed through the bal... |
...
[[Sweep from Standing Guard/Attacker|→ Full Attacker Guide]]
...
[[Sweep from Standing Guard/Defender|→ Full Defender Guide]]
