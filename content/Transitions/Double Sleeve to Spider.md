...
---
title: "Double Sleeve to Spider | BJJ Technique | BJJ Map"
description: "Master the Double Sleeve to Spider Guard transition in BJJ. Learn grip transfer, bicep hook placement, and systematic foot positioning for effective guard control."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Double Sleeve to Spider", "item": "https://bjjmap.pages.dev/Transitions/Double-Sleeve-to-Spider" }
  ]
}
</script>
...
[[Double Sleeve to Spider/Attacker|→ Full Attacker Guide]]
...
[[Double Sleeve to Spider/Defender|→ Full Defender Guide]]
...
**Single-Side Spider Entry**: Transition only one foot to the bicep while keeping the other foot on the hip, creating a hybrid half-spider half-double-sleeve configuration. This maintains distance control throughout and allows you to test the opponent's reaction before committing the second foot. (When to use: When the opponent is actively grip fighting and you need to maintain maximum defensive structure during the transition. Also effective against aggressive passers who exploit momentary gaps.)


**Lasso-Spider Hybrid Entry**: During the transition, thread one leg under the opponent's arm to establish a lasso hook while placing the other foot on the opposite bicep. Creates an asymmetrical spider-lasso guard that offers both distance control and rotational sweep options. (When to use: When the opponent circles to one side during your transition attempt, use their lateral movement to thread the lasso leg. Particularly effective against opponents who try to create angles to pass during your guard transition.)


**Seated Spider Entry**: Sit up during the transition to place feet on biceps from a seated position rather than lying flat. This uses hip extension power to drive feet into the biceps and creates immediate sweep threats from the elevated posture. (When to use: Against opponents who maintain very upright posture making it difficult to place feet on biceps from your back. The seated position gives you better angle and leverage to reach the biceps.)
