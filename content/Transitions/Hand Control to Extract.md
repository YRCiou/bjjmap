...
---
title: "Hand Control to Extract | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Hand Control to Extract", "item": "https://bjjmap.pages.dev/Transitions/Hand-Control-to-Extract" }
  ]
}
</script>
...
| **Key Principles** | Address the opponent's hands controlling their foot before a... | Maintain constant hip elevation to keep shin pressure on the... |
...
[[Hand Control to Extract/Attacker|→ Full Attacker Guide]]
...
[[Hand Control to Extract/Defender|→ Full Defender Guide]]
