...
---
title: "Sweep from Clamp Guard Attacker | BJJ Technique Guide | BJJ Map"
description: "Master the offensive sweep from Clamp Guard. Learn to time sweep entries, exploit compromised base from arm isolation, and achieve mount through precise hip mechanics."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Sweep from Clamp Guard in BJJ",
  "description": "Step-by-step guide for executing Sweep from Clamp Guard from Clamp Guard/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Confirm clamp integrity",
      "text": "Verify shin-on-bicep positioning and ensure the trapped arm is securely isolated between your legs. Adjust your hip angle if the clamp has drifted toward the forearm. The sweep will fail if the opponent frees their arm during the roll, so clamp confirmation is the non-negotiable first step.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Establish posture control grips",
      "text": "Use your free hands to grip the opponent's collar, head, or far shoulder to break their posture and keep their weight distributed forward over your centerline. In no-gi, cup behind the neck with one hand and control the far tricep or wrist with the other. These grips serve dual purpose: posture breaking for sweep setup and directional pulling during execution.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Read opponent's weight distribution",
      "text": "Wait for the moment when the opponent drives forward, reaches with their free arm, or attempts arm extraction. These actions shift their center of gravity forward and remove their only remaining base point. Do not initiate the sweep against a well-based, settled opponent — patience here separates successful sweeps from wasted energy.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Load the sweep by shifting hips underneath",
      "text": "As the timing window opens, shift your hips underneath the opponent's center of gravity while maintaining the clamp. Your body becomes a lever — hips are the fulcrum, the clamp is the fixed point preventing the arm-side post, and your posture grips provide the directional pull that initiates the roll.",
      "position": 4
    },
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Sweep from Clamp Guard Attacker",
  "description": "Master the offensive sweep from Clamp Guard. Learn to time sweep entries, exploit compromised base from arm isolation, and achieve mount through precise hip mechanics.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Sweep-from-Clamp-Guard/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Sweep from Clamp Guard (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Shoulder crunch sweep from butterfly guard",
      "description": "Sweep from Clamp Guard (Attacker) film study: Shoulder crunch sweep from butterfly guard, taught by Gordon Ryan.",
    ...
    },
    {
      ...
      "description": "Sweep from Clamp Guard (Attacker) film study: Shoulder crunch sweep breakdown, taught by Gordon Ryan.",
    ...
    },
    {
      ...
      "description": "Sweep from Clamp Guard (Attacker) film study: The clamp guard: control and sweep mechanics, taught by Fenrir Jiu-Jitsu.",
...
<p class="section-subtitle">Watch Sweep from Clamp Guard (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Sweep from Clamp Guard?</p>
...
<p class="section-subtitle">What do you need before attempting Sweep from Clamp Guard?</p>
...
<p class="section-subtitle">How do you execute Sweep from Clamp Guard step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Sweep from Clamp Guard?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Sweep from Clamp Guard?</p>
...
<p class="section-subtitle">How do you train Sweep from Clamp Guard (Attacker)?</p>

**Phase 1: Mechanics** - Hip movement and directional force generation
...
**Phase 2: Timing** - Reading opponent weight shifts and commitment
...
**Phase 3: Integration** - Combining sweeps with submission threats
Chain submission attempts with sweep entries at 50-70% resistance. Threaten armbar to force base widening, then sweep. Threaten triangle to force posture change, then sweep. Develop the read-and-react flow where each submission defense opens a sweep window and each sweep defense opens a submission pathway.

**Phase 4: Live Application** - Full resistance execution and recovery
Execute sweep attempts during live rolling from clamp guard at full resistance. Focus on identifying real-time sweep opportunities, managing failed attempts without losing the clamp, and immediately consolidating mount after successful sweeps. Track success rate and analyze which variations work best against different body types and defensive styles.
...
<p class="section-subtitle">What are the safety concerns for Sweep from Clamp Guard?</p>
