...
---
title: "Long Step Pass Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Long Step Pass in BJJ. Attacking perspective with setup, execution steps, counters, and combination passing sequences."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for executing Long Step Pass from Open Guard/Top.",
  "step": [
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "Begin to angle your body approximately 45 degrees to the side you intend to pass. Push the opponent's knees down and away while maintaining your upright posture. This creates the initial angle and begins to flatten the opponent's guard structure. Your head should stay over your hips to maintain balance and prevent being pulled forward into closed guard or triangles.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Execute Long Step",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Long-Step-Pass/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Long Step Pass (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Long step pass solo drills",
      "description": "Long Step Pass (Attacker) film study: Long step pass solo drills, taught by Tainan Dalpra.",
    ...
    },
    {
      ...
      "description": "Long Step Pass (Attacker) film study: Long step guard pass drill and body mechanics, taught by Greg Hamilton.",
...
<p class="section-subtitle">Watch Long Step Pass (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Long Step Pass?</p>
...
<p class="section-subtitle">What do you need before attempting Long Step Pass?</p>
...
<p class="section-subtitle">How do you execute Long Step Pass step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Long Step Pass?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Long Step Pass?</p>
...
<p class="section-subtitle">How do you train Long Step Pass (Attacker)?</p>
...
<p class="section-subtitle">What are the safety concerns for Long Step Pass?</p>
