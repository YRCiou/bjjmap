...
---
title: "Side Control to Scarf Hold Position | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Side Control to Scarf Hold Position", "item": "https://bjjmap.pages.dev/Transitions/Side-Control-to-Scarf-Hold-Position" }
  ]
}
</script>
...
| **Key Principles** | Maintain continuous chest-to-chest contact throughout the ro... | Recognize the transition early by feeling for arm threading ... |
...
[[Side Control to Scarf Hold Position/Attacker|→ Full Attacker Guide]]
...
[[Side Control to Scarf Hold Position/Defender|→ Full Defender Guide]]
