...
---
title: "Bridge Escape from Kesa Gatame Attacker | BJJ Technique Guide | BJJ Map"
description: "Execute the bridge escape from Kesa Gatame to recover half guard. Step-by-step guide covering setup, timing, hip mechanics, and guard recovery techniques."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Bridge Escape from Kesa Gatame in BJJ",
  "description": "Step-by-step guide for executing Bridge Escape from Kesa Gatame from Kesa Gatame/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish Defensive Frame",
      "text": "Use your free arm (far arm) to create a frame against the opponent's face, neck, or shoulder. This frame prevents smothering pressure and gives you breathing room to prepare the escape. If your far arm is being controlled, fight to free it first—the bridge escape requires at least one free arm for controlling the opponent's posting ability.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Plant Feet and Load Hips",
      "text": "Bring both feet flat on the mat as close to your buttocks as possible, with knees bent at approximately 90 degrees. This foot positioning maximizes bridge height and explosive power. Avoid extending your legs or planting feet too far from your hips, as this reduces the mechanical advantage of your bridge and may telegraph the escape attempt to an attentive opponent.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Control Opponent's Far Arm",
      "text": "Reach across with your free hand and grab the opponent's far wrist, elbow, or sleeve to eliminate their ability to post when you bridge. This is the most critical preparatory step—without controlling the posting arm, the opponent can simply extend their arm and absorb your bridge with minimal effort. In gi, grip the sleeve at the wrist; in no-gi, control the wrist directly or secure an overhook.",
      "position": 3
    },
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "What must happen immediately after the bridge creates space?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You must insert your near-side knee across the opponent's hip line within the fraction of a second that space exists at the bridge apex. The space window is extremely brief—the opponent's weight begins returning as soon as your bridge peaks. The knee insertion and bridge should feel like one continuous movement rather than two distinct actions. Any pause between the bridge peak and knee insertion allows the opponent to resettle and close the space."
      }
    },
    {
      "@type": "Question",
      "name": "How does the bridge escape complement the ghost escape from Kesa Gatame?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The bridge escape attacks the opponent's base by driving into them (turning toward the opponent), while the ghost escape attacks their exposed back by turning away. This creates a two-directional escape dilemma: if the opponent sits back heavily to defend ghost escapes, they become lighter on your chest and more vulnerable to bridges. If they drive forward with heavy pressure to prevent bridges, they expose their back further for ghost escapes. Training both escapes together forces the opponent to defend two opposing threats simultaneously."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Bridge Escape from Kesa Gatame Attacker",
  "description": "Execute the bridge escape from Kesa Gatame to recover half guard. Step-by-step guide covering setup, timing, hip mechanics, and guard recovery techniques.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Bridge-Escape-from-Kesa-Gatame"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Bridge-Escape-from-Kesa-Gatame/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Bridge Escape from Kesa Gatame (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Kesa gatame escape",
      "description": "Bridge Escape from Kesa Gatame (Attacker) film study: Kesa gatame escape, taught by SBG Australia.",
    ...
    },
    {
      ...
      "description": "Bridge Escape from Kesa Gatame (Attacker) film study: Kesa gatame bridge escape to armbar, taught by Ivan Chumakov.",
...
<p class="section-subtitle">Watch Bridge Escape from Kesa Gatame (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Bridge Escape from Kesa Gatame?</p>
...
<p class="section-subtitle">What do you need before attempting Bridge Escape from Kesa Gatame?</p>
...
<p class="section-subtitle">How do you execute Bridge Escape from Kesa Gatame step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Bridge Escape from Kesa Gatame?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Bridge Escape from Kesa Gatame?</p>
...
<p class="section-subtitle">How do you train Bridge Escape from Kesa Gatame (Attacker)?</p>

**Solo Bridge Mechanics** - Hip extension power and directional bridging
Practice bridging drills without a partner, focusing on explosive hip extension, directional bridging at 45-degree angles, and immediate hip rotation at the apex. Perform sets of 10 bridges in each direction, emphasizing the connection between leg drive and hip lift.

**Cooperative Technical Drilling** - Full sequence with compliant partner
Partner establishes Kesa Gatame with minimal resistance. Execute the complete escape sequence from frame establishment through half guard consolidation. Perform 20-30 repetitions focusing on grip placement, bridge timing, knee insertion speed, and guard recovery. Partner provides feedback on bridge direction and timing.

**Progressive Resistance Drilling** - Timing and adaptation under increasing pressure
Partner gradually increases resistance from 25% to 75% over multiple rounds. Bottom player must find timing windows and adjust bridge power to match resistance level. Focus on recognizing when the opponent creates openings through weight shifts and submission attempts. 3-minute rounds with increasing resistance each round.

**Escape Chain Integration** - Combining bridge escape with complementary escapes
Start from Kesa Gatame bottom and chain the bridge escape with ghost escape, back take, and frame-to-guard escapes. When one escape is shut down, immediately transition to the next. Partner applies realistic resistance and capitalizes on mistakes. Develop automatic transitions between escape pathways based on opponent reactions.
...
<p class="section-subtitle">What are the safety concerns for Bridge Escape from Kesa Gatame?</p>
