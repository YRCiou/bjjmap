...
---
title: "Sweep from Double Jump | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Sweep from Double Jump", "item": "https://bjjmap.pages.dev/Transitions/Sweep-from-Double-Jump" }
  ]
}
</script>
...
| **Key Principles** | Control the near arm before initiating the sweep to eliminat... | Protect posting arm at all costs—the sweep requires near arm... |
...
[[Sweep from Double Jump/Attacker|→ Full Attacker Guide]]
...
[[Sweep from Double Jump/Defender|→ Full Defender Guide]]
