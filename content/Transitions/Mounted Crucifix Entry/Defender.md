...
---
title: "Mounted Crucifix Entry Defender | BJJ Defense Guide | BJJ Map"
description: "How to defend against Mounted Crucifix Entry in BJJ. Recognition cues, defensive options, and escape strategies when opponent attempts crucifix from S Mount."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Mounted Crucifix Entry in BJJ",
  "description": "Step-by-step guide for defending and countering Mounted Crucifix Entry in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Explosive bridge toward the threading leg during weight shift",
      "text": "The instant you feel opponent shift weight forward and begin lifting their far leg off your torso If successful: Disrupts opponent's balance during their most vulnerable moment, forcing them to abandon the crucifix attempt and re-establish S Mount base",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Retract far arm tight to body and frame against opponent's hip",
      "text": "Preemptively whenever you recognize S Mount position, before any crucifix attempt begins If successful: Removes the target arm from exposure, making the crucifix entry impossible while maintaining defensive structure against armbar",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Hip escape toward opponent's legs combined with shoulder turn during weight shift",
      "text": "When opponent commits to the forward weight shift and begins rotating hips for the leg thread If successful: Creates enough distance that opponent cannot complete the leg thread and may recover half guard position",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Hook opponent's threading leg with free hand to physically block the leg-over motion",
      "text": "When you can see or feel the far leg beginning to lift off your torso for the thread If successful: Physically prevents the leg from crossing over your arm, stalling the crucifix entry and potentially opening armbar defense windows",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Mounted Crucifix Entry Defender",
  "description": "How to defend against Mounted Crucifix Entry in BJJ. Recognition cues, defensive options, and escape strategies when opponent attempts crucifix from S Mount.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Mounted-Crucifix-Entry"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Mounted-Crucifix-Entry/Defender"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Mounted Crucifix Entry (Defender) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Escaping the mounted crucifix",
      "description": "Mounted Crucifix Entry (Defender) film study: Escaping the mounted crucifix, taught by Shem Rock.",
    ...
    },
    {
      ...
      "description": "Mounted Crucifix Entry (Defender) film study: Crucifix escape, taught by Chosen Few BJJ.",
...
<p class="section-subtitle">Watch Mounted Crucifix Entry (Defender) in action — curated instructionals</p>
...
- **Consequence**: This is the exact arm exposure the crucifix entry requires - your far arm crosses your centerline directly into the path of the threading leg
- **Correction**: Defend the armbar by keeping your near arm bent and gripping your own collar with that hand. Use your far arm to frame against opponent's hip, keeping it on your side of your body at all times.

### 2. Bridging away from the threading leg instead of toward it

- **Consequence**: Bridging away creates space that assists the leg threading motion and may accelerate the crucifix establishment
- **Correction**: Bridge toward the leg being threaded to collapse the space needed for the motion. Your bridge should aim to knock their base out from underneath them on the threading side.

### 3. Remaining flat on your back without hip movement during the opponent's transition

- **Consequence**: A flat, static bottom position provides the stable platform the attacker needs to thread their leg cleanly over your arm
- **Correction**: Maintain constant subtle hip movement and angle changes. Even small hip escapes during the threading attempt can prevent the leg from clearing your arm.

### 4. Panicking and attempting to bench-press the opponent off with both arms extended

- **Consequence**: Both extended arms become immediately available for trapping, potentially giving the opponent an even easier crucifix than they would have achieved otherwise
- **Correction**: Keep elbows tight to your ribs. Use skeletal structure and positioning rather than pushing strength. Bent arms close to your body are nearly impossible to isolate with leg threads.

### 5. Focusing entirely on arm defense while ignoring hip escape opportunities

- **Consequence**: Even if you temporarily prevent the arm trap, remaining stationary in S Mount bottom means the opponent will simply reattempt with better positioning
- **Correction**: Combine arm protection with active hip escaping. Every defensive action should also move your hips toward recovering half guard or creating distance from the S Mount.
...
**Week 3-4** - Timed bridging and hip escape responses
Partner performs crucifix entries at moderate speed. Practice timing explosive bridges to the weight shift moment and combining them with hip escapes toward the opponent's legs. Drill the specific direction of the bridge (toward the threading leg) until it becomes automatic. Track success rate of preventing the second arm trap.

**Week 5-6** - Integration with S Mount defense system
Combine crucifix entry defense with broader S Mount survival skills. Partner chains armbar attacks with crucifix attempts, requiring you to defend both threats while maintaining proper arm positioning. Practice transitioning between armbar defense posture and crucifix prevention posture without exposing vulnerabilities to either attack.

**Week 7+** - Live positional sparring from S Mount bottom
Full resistance positional sparring starting from S Mount bottom. Partner attacks freely with armbars, triangles, and crucifix entries. Measure success by time survived and positions recovered to. Develop personal timing for defensive explosions and build confidence in the recognition-response cycle under realistic pressure.
