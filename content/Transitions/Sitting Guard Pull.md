...
---
title: "Sitting Guard Pull | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Sitting Guard Pull", "item": "https://bjjmap.pages.dev/Transitions/Sitting-Guard-Pull" }
  ]
}
</script>
...
[[Sitting Guard Pull/Attacker|→ Full Attacker Guide]]
...
[[Sitting Guard Pull/Defender|→ Full Defender Guide]]
...
**Butterfly Guard Pull**: Sit directly to butterfly guard by inserting both hooks inside opponent's thighs as you sit, with overhook or collar tie grips controlling upper body. This version emphasizes immediate sweeping opportunities from the moment you land. (When to use: When opponent is relatively close and upright, and you want immediate offensive butterfly guard with active hooks for sweeps.)


**De La Riva Entry Pull**: As you sit, immediately establish De La Riva hook with your outside leg while placing opposite foot on hip, combined with same-side collar and cross-sleeve grips. Creates immediate DLR guard structure upon landing. (When to use: Against opponents who tend to stand and pass in gi, particularly effective when you want to establish classic De La Riva control and berimbolo or sweep entries immediately.)


**Shin-to-Shin Pull**: Sit while placing one shin directly against opponent's lead shin with foot hooked behind their knee, establishing immediate shin-to-shin guard. Often combined with collar and sleeve control for upper body management. (When to use: When you want to control opponent's lead leg and prevent strong passing posture, setting up single leg X-guard and X-guard entries.)


**Seated Open Guard Pull**: Sit to traditional seated open guard position with both feet framing on opponent's hips or knees, maintaining upright seated posture with strong grip control. Most conservative and safe variation with maximum defensive structure. (When to use: When you want maximum safety and distance control, particularly against aggressive opponents or when you need time to assess and react to opponent's passing approach before committing to a specific guard.)
