...
---
title: "Shoulder of Justice to Mount Defender | BJJ Defense Guide | BJJ Map"
description: "Defend against the Shoulder of Justice to Mount transition in BJJ. Learn recognition cues, frame insertion timing, and guard recovery techniques to prevent mount."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Shoulder of Justice to Mount in BJJ",
  "description": "Step-by-step guide for defending and countering Shoulder of Justice to Mount in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Insert near-side knee between your body and opponent's chest as their weight shifts during the step-over attempt",
      "text": "The moment you feel the opponent's weight lighten on your hip line as they begin walking their knee up or loading weight forward for the step-over If successful: Block the step-over path and recover to half guard or re-establish frames to prevent repeated transition attempts",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Time a sharp hip escape toward the opponent's legs as their far leg lifts off the mat during the step-over",
      "text": "When you feel the opponent's base narrow and their weight shifts forward, indicating imminent step-over commitment If successful: Create enough angle to prevent the step-over and force opponent to re-establish Shoulder of Justice positioning from scratch",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Execute an explosive bridge directed toward the side the opponent is stepping from as their leg crosses your body midway through the step-over",
      "text": "When opponent's far leg is in the air and they are committed to the step-over with weight distributed across your centerline and their base at its narrowest If successful: Reverse the position by catching opponent off-balance during their most vulnerable transitional moment, potentially achieving top half guard",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Create a forearm frame against opponent's hip line as you sense their weight consolidating for the mount attempt",
      "text": "As early as possible when you recognize setup cues such as base narrowing or increased forward pressure through the shoulder If successful: Block the step-over path and maintain enough space to prevent mount establishment, forcing opponent to address the frame first",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Shoulder of Justice to Mount Defender",
  "description": "Defend against the Shoulder of Justice to Mount transition in BJJ. Learn recognition cues, frame insertion timing, and guard recovery techniques to prevent mount.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Shoulder-of-Justice-to-Mount"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Shoulder-of-Justice-to-Mount/Defender"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Shoulder of Justice to Mount (Defender) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Iron pillow frame vs side mount",
      "description": "Shoulder of Justice to Mount (Defender) film study: Iron pillow frame vs side mount, taught by SBG New Braunfels.",
      "thumbnailUrl": "https://i.ytimg.com/vi/O19KhyZBZwg/hqdefault.jpg",
      "embedUrl": "https://www.youtube.com/embed/O19KhyZBZwg",
      "url": "https://www.youtube.com/watch?v=O19KhyZBZwg",
    ...
    },
    {
      "@type": "VideoObject",
      "position": 2,
      "name": "Side Control Escape Against Shoulder Pressure",
      "description": "Shoulder of Justice to Mount (Defender) film study: Side Control Escape Against Shoulder Pressure, taught by Coach Brian.",
      "thumbnailUrl": "https://i.ytimg.com/vi/kYcMvSDftVo/hqdefault.jpg",
      "embedUrl": "https://www.youtube.com/embed/kYcMvSDftVo",
      "url": "https://www.youtube.com/watch?v=kYcMvSDftVo",
    ...
    },
    {
      "@type": "VideoObject",
      "position": 3,
      "name": "Best Side Control Escape for Heavy Pressure",
      "description": "Shoulder of Justice to Mount (Defender) film study: Best Side Control Escape for Heavy Pressure, taught by Jules Bruchez.",
      "thumbnailUrl": "https://i.ytimg.com/vi/CgTZaZkmtTo/hqdefault.jpg",
      "embedUrl": "https://www.youtube.com/embed/CgTZaZkmtTo",
      "url": "https://www.youtube.com/watch?v=CgTZaZkmtTo",
      "creator": { "@type": "Person", "name": "Jules Bruchez" },
      "duration": "PT306S"
    }
  ]
}
...
<p class="section-subtitle">Watch Shoulder of Justice to Mount (Defender) in action — curated instructionals</p>


<div class="film-clip">

![](https://www.youtube.com/watch?v=O19KhyZBZwg)

<p class="clip-credit"><strong>Iron pillow frame vs side mount</strong> — taught by SBG New Braunfels · 1:22 · <a href="https://www.youtube.com/watch?v=O19KhyZBZwg" rel="noopener">Watch on YouTube</a></p>

</div>

<div class="film-clip">

![](https://www.youtube.com/watch?v=kYcMvSDftVo)

<p class="clip-credit"><strong>Side Control Escape Against Shoulder Pressure</strong> — taught by Coach Brian · 3:07 · <a href="https://www.youtube.com/watch?v=kYcMvSDftVo" rel="noopener">Watch on YouTube</a></p>

</div>

<div class="film-clip">

![](https://www.youtube.com/watch?v=CgTZaZkmtTo)

<p class="clip-credit"><strong>Best Side Control Escape for Heavy Pressure</strong> — taught by Jules Bruchez · 5:06 · <a href="https://www.youtube.com/watch?v=CgTZaZkmtTo" rel="noopener">Watch on YouTube</a></p>
...
**Phase 2: Frame Mechanics** - Defensive frame and knee insertion technique
From Shoulder of Justice bottom, practice inserting your near-side knee and creating forearm frames without resistance. Focus on maintaining elbow connection to ribs, achieving proper knee angle for blocking, and combining frame with small hip escape. Drill the mechanical movements until they require no conscious thought.

**Phase 3: Timing** - Matching defensive action to transition window
Partner performs the mount transition at moderate speed. Practice deploying your defensive action at the precise moment when their base narrows and weight shifts. Partner provides feedback on timing accuracy. Progress from 25% speed to 75% speed over multiple rounds.

**Phase 4: Live Application** - Defending under progressive resistance
Full positional sparring starting from Shoulder of Justice. Partner attempts the mount transition with increasing resistance and unpredictability, mixing mount attempts with submission threats. Develop the ability to distinguish genuine mount transition setups from feints and to select the appropriate defensive response under pressure.
