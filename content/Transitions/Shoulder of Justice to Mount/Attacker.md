...
---
title: "Shoulder of Justice to Mount Attacker | BJJ Technique Guide | BJJ Map"
description: "Execute the Shoulder of Justice to Mount transition with precision. Step-by-step guide covering pressure maintenance, leg stepping, and mount establishment."
---
...
<script type="application/ld+json">
{
  ...
  "step": [
    ...
    {
      "@type": "HowToStep",
      "name": "Land Knee and Close Distance",
      "text": "Drive your stepping knee to the mat on the opponent's far side, landing as close to their body as possible to prevent space creation. Your knee should contact the mat at their hip level or slightly above. Immediately squeeze both knees against the opponent's torso to establish the initial mount control framework.",
      "position": 6
    },
    {
      "@type": "HowToStep",
      "name": "Settle Mount and Redistribute Weight",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "Why must the opponent's near-side arm be controlled before initiating the mount transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The near-side arm is the opponent's primary defensive tool for creating frames that block the step-over path. An uncontrolled near arm can insert an elbow frame between your chest and their body during the critical moment when your weight shifts for the step-over. This frame creates a structural wedge that prevents your knee from clearing their body and forces you to abort the transition. Additionally, an active near arm can initiate hip escape sequences that create angles for guard recovery."
      }
    },
    {
      "@type": "Question",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Shoulder of Justice to Mount Attacker",
  "description": "Execute the Shoulder of Justice to Mount transition with precision. Step-by-step guide covering pressure maintenance, leg stepping, and mount establishment.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Shoulder-of-Justice-to-Mount/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Shoulder of Justice to Mount (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Side control to mount transition",
      "description": "Shoulder of Justice to Mount (Attacker) film study: Side control to mount transition, taught by White Belt Jiu Jitsu.",
    ...
    },
    {
      ...
      "description": "Shoulder of Justice to Mount (Attacker) film study: Side control to mount, taught by CSW Association.",
    ...
    },
    {
      ...
      "description": "Shoulder of Justice to Mount (Attacker) film study: No-gi side control to mount, taught by Training with Lions.",
...
<p class="section-subtitle">Watch Shoulder of Justice to Mount (Attacker) in action — curated instructionals</p>
...
**Phase 2: Pressure Maintenance** - Maintaining continuous pressure during transition
Partner provides feedback on pressure consistency throughout the step-over. The goal is zero pressure relief at any point during the transition. Partner signals whenever they feel space or reduced pressure. Repeat until you can complete the full transition without any partner feedback signals.

**Phase 3: Timing and Reading** - Identifying optimal transition windows
...
Start in Shoulder of Justice with increasing resistance from 50% to full. Integrate the mount transition with kimura threats and other attacks from the position. The goal is to use the dilemma system to create genuine transition opportunities rather than relying on the transition in isolation.
