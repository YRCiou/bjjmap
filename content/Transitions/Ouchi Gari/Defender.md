...
---
title: "Ouchi Gari Defender | BJJ Defense Guide | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Ouchi Gari in BJJ",
  "description": "Step-by-step guide for defending and countering Ouchi Gari in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Step back and retract the attacked leg before the reap makes contact, pulling your lead foot behind your base foot while maintaining grip control and posture",
      "text": "As soon as you feel the initial kuzushi (backward pull) and sense the opponent's leg beginning to move toward your inside leg. This must be done early—before the reaping leg hooks behind your calf. If successful: You return to neutral standing with both feet under you. The attacker's momentum carries forward slightly, potentially creating an opening for your own counter-attack such as Kouchi Gari or a snap down.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Sprawl your hips back and down while posting your hands on opponent's shoulders or head, creating distance that prevents the reaping leg from reaching your leg effectively",
      "text": "When the opponent has already stepped in close and you cannot retract your leg in time. The sprawl removes your hips from their reach and puts your weight on their upper body, collapsing their throwing structure. If successful: The throw is completely neutralized and you end up with your weight on the opponent's back or in a front headlock position, giving you offensive opportunities including snap downs and chokes.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Circle laterally away from the direction of the reap while breaking the collar grip, denying both the angle and the grip control needed to complete the throw",
      "text": "When you recognize the setup early during the grip-fighting phase before the opponent has fully closed distance. Circling works best as a preemptive defense when you sense the opponent loading up for the attack. If successful: You create an angle that makes the reaping action ineffective and may expose the opponent's back for your own offensive entries such as arm drags or back takes.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Counter-throw with Tani Otoshi by sitting through as they commit forward, using their own momentum to take them down over your hip",
      "text": "When the opponent has fully committed to the forward drive of Ouchi Gari and their weight is moving aggressively into you. This requires confidence in sacrifice throws and precise timing. If successful: You reverse the takedown entirely and land in a dominant position on top of the attacker, converting their offensive momentum into your advantage.",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Ouchi Gari",
      "item": "https://bjjmap.pages.dev/Transitions/Ouchi-Gari"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Ouchi-Gari/Defender"
    }
  ]
}
</script>
...
- **Consequence**: This posture makes you maximally vulnerable to the backward off-balancing that precedes Ouchi Gari. Your locked knees prevent quick foot adjustment, and weight on heels means the backward pull immediately compromises your base. The throw completes easily against a stiff, upright defender.
- **Correction**: Maintain an athletic stance with knees slightly bent and weight distributed toward the balls of your feet. When you feel the backward pull, immediately lower your center of gravity by bending your knees further and drive your hips slightly forward to resist the kuzushi rather than stiffening up.

### 2. Crossing your feet or narrowing your base when stepping back to defend

- **Consequence**: Crossing feet eliminates your base entirely and can result in an even easier throw than if you had stood still. A narrow stance provides no lateral stability, making you vulnerable to both the original Ouchi Gari and any follow-up combination attacks.
- **Correction**: When retracting the attacked leg, step it directly behind your base foot to maintain a shoulder-width stance. Never let your feet cross or come closer than hip-width apart. Practice defensive footwork patterns that maintain stable base throughout the retreat.

### 3. Posting with a straight, locked arm against the mat to catch yourself during a partially completed throw

- **Consequence**: A straight-arm post absorbs the full force of your body weight plus the throwing momentum through your wrist, elbow, and shoulder joints. This commonly results in wrist sprains, elbow hyperextension, or shoulder dislocation—some of the most frequent throwing-related injuries in grappling.
- **Correction**: If you feel the throw succeeding, commit to a proper breakfall by tucking your chin, rounding your back, and slapping the mat with your arm at roughly 45 degrees from your body with a slightly bent elbow. Train breakfall technique regularly so it becomes an automatic response rather than the instinctive straight-arm post.

### 4. Focusing only on defending the leg reap while ignoring the upper body kuzushi

- **Consequence**: Even if you manage to pull your leg free from the reap, the attacker's collar grip continues to break your posture backward. Without addressing the grip control, you remain off-balance and vulnerable to immediate follow-up attacks. Defending only the leg treats the symptom rather than the cause.
- **Correction**: Address both the grip control and the leg attack simultaneously. Fight the collar grip with your same-side hand while moving your leg defensively. Breaking or weakening the collar grip removes the primary mechanism of off-balancing and makes the leg reap far less effective even if it makes contact.
...
**Phase 2: Isolated Defense Drilling (Weeks 3-5)** - Practicing specific defensive responses in isolation
Partner performs Ouchi Gari at moderate speed and you practice each defensive option in isolation: step-back defense for one round, sprawl defense for the next, circular movement for another. Develop muscle memory for each response independently before combining them. Partner provides enough force to require a real defensive response but cooperates enough to allow clean execution and repetition.

**Phase 3: Reactive Defense with Combinations (Weeks 6-9)** - Choosing the right defense based on attack timing and angle
Partner varies the timing, angle, and intensity of their Ouchi Gari attacks and you must read the situation to select the appropriate defense. Sometimes the step-back is correct, sometimes the sprawl, sometimes circling. Partner also begins chaining Ouchi Gari with Kouchi Gari and Osoto Gari combinations, forcing you to defend sequences rather than single attacks. Develop the ability to recover base between chained attacks.

**Phase 4: Counter-Attack Integration (Weeks 10-14)** - Converting successful defense into offensive opportunities
After successfully defending Ouchi Gari, immediately transition to a counter-attack rather than resetting to neutral. Practice the step-back to Kouchi Gari counter, the sprawl to front headlock sequence, and the circular movement to arm drag or back take. Build the habit of treating every successful defense as a launching pad for offense. Partner provides full resistance on defense and realistic attacks.
