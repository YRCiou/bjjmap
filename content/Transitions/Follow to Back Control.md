...
---
title: "Follow to Back Control | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Follow to Back Control", "item": "https://bjjmap.pages.dev/Transitions/Follow-to-Back-Control" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Follow to Back Control \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Following to the back when they slip the heel",
      "description": "Follow to Back Control film study: Following to the back when they slip the heel, taught by Factory Fresh Jiu Jitsu.",
    ...
    },
    {
      ...
      "description": "Follow to Back Control film study: Back take from the leg entanglement, taught by Brandon Quick.",
...
<p class="section-subtitle">Watch Follow to Back Control in action — curated instructionals</p>
...
[[Follow to Back Control/Attacker|→ Full Attacker Guide]]
...
[[Follow to Back Control/Defender|→ Full Defender Guide]]
...
**Crab Ride Entry**: Instead of immediately establishing seat belt, insert bottom hook first and ride the opponent's hip as they continue rotating. Use the bottom hook to control their movement while your hands secure wrist control. Convert to full back control once rotation stops. (When to use: When opponent's rotation is too fast to establish seat belt cleanly, or when they have strong frames preventing upper body control.)


**Body Triangle Conversion**: After establishing seat belt and bottom hook, skip the top hook entirely and immediately lock a body triangle by triangling your legs around opponent's waist. Provides superior control against strong opponents who are difficult to flatten. (When to use: Against larger opponents or when opponent is actively defending hook insertion with their hands.)


**Chair Sit Follow**: Rather than following around to the back, sit up behind the opponent as they complete their rotation and use a chair sit position with one hook and a collar tie to control them from behind. Transitions to full back control once their base is disrupted. (When to use: When the opponent's rotation leaves them in a high turtle with their hips elevated, creating space underneath for the chair sit entry.)
