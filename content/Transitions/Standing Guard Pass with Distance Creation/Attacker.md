...
---
title: "Standing Guard Pass with Distance Creation Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Standing Guard Pass with Distance Creation in BJJ. Attacking perspective with setup, execution steps, and counters."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Standing Guard Pass with Distance Creation in BJJ",
  "description": "Step-by-step guide for executing Standing Guard Pass with Distance Creation from Ringworm Guard/Top.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish combat base",
      "text": "From kneeling in Ringworm Guard, post your free leg (non-wrapped) wide to the side with foot flat on the mat, keeping your hips heavy and center of gravity low. Control the opponent's nearest sleeve or wrist with your free hand to limit their grip-fighting ability during the transition to standing.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Stand to full height",
    ...
    {
      "@type": "HowToStep",
      "name": "Secure two-handed grip on lapel",
      "text": "Release the sleeve grip and bring both hands to the lapel wrap around your leg. One hand grips the lapel tail near the opponent's controlling hand to prevent re-securing, while the other hand works underneath the wrap at the point where it contacts your knee or thigh, creating leverage for extraction.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Circle and extract",
      "text": "Step your free leg laterally away from the opponent's strong side while peeling the lapel wrap off your trapped leg using both hands in a coordinated stripping motion. Push the lapel tail downward and away from your body while simultaneously stepping your trapped leg backward out of the loosened configuration. Keep your hips back to resist any pulling forces.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Clear the lapel completely",
      "text": "Once the wrap is loosened, step your previously trapped leg completely free of the lapel and push the loose lapel fabric toward the opponent's body or to the mat, ensuring they cannot re-thread it. Verify full clearance by checking that no fabric remains looped around your knee, shin, or ankle before proceeding.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Establish passing grips",
      "text": "Immediately secure passing grips before the opponent can establish a new guard configuration. Grip the pants at both knees or one knee and one collar for a toreando-style pass, or secure a pant grip and collar grip for a leg drag entry. The opponent is momentarily grip-less and in a weakened open guard.",
      "position": 6
    },
    {
      "@type": "HowToStep",
      "name": "Execute the pass",
      "text": "Drive laterally with a toreando, leg drag, or bullfighter pass motion while the opponent is still recovering from the loss of their lapel control system. Push both knees to one side while stepping your hips past their legs, or execute a leg drag by pulling one leg across their body. Maintain forward pressure and a low center of gravity throughout the passing action.",
      "position": 7
    },
    {
      "@type": "HowToStep",
      "name": "Consolidate side control",
      "text": "As you clear the opponent's legs, drop your chest perpendicular across their torso and establish crossface pressure with your forearm driving across their jaw. Secure an underhook on their far arm and drop your hips heavy against their near hip to prevent any guard recovery. Settle your weight and establish full side control.",
      "position": 8
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "What is the most critical hip position during the standing phase of this technique?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Standing Guard Pass with Distance Creation Attacker",
  "description": "How to execute Standing Guard Pass with Distance Creation in BJJ. Attacking perspective with setup, execution steps, and counters.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Standing-Guard-Pass-with-Distance-Creation/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Standing Guard Pass with Distance Creation (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Standing guard pass with distance and posture",
      "description": "Standing Guard Pass with Distance Creation (Attacker) film study: Standing guard pass with distance and posture, taught by Rickson Gracie.",
    ...
    },
    {
      ...
      "description": "Standing Guard Pass with Distance Creation (Attacker) film study: Standing armpit pin guard pass, taught by BJJ4Breakfast.",
...
<p class="section-subtitle">Watch Standing Guard Pass with Distance Creation (Attacker) in action — curated instructionals</p>
...
- You have identified which hand the opponent is using to control the lapel tail and assessed the depth of the wrap around your leg
- Your back is protected with shoulders square to the opponent, no angle exposure that would facilitate back takes during the standing sequence
...
### 2. Using only one hand to strip the lapel while keeping the other hand on sleeve or collar control
...
### 3. Initiating a passing motion before the lapel is fully cleared from the leg
...
### 4. Standing straight up without controlling the opponent's ability to follow with leg hooks

- **Consequence**: Bottom player inserts butterfly hooks, De La Riva hooks, or foot-on-hip frames during the stand, maintaining distance control even as the lapel loosens
- **Correction**: Control at least one of the opponent's legs or maintain a pants grip during the initial standing phase to limit their ability to reattach guard hooks

### 5. Pausing after clearing the lapel instead of immediately transitioning to passing grips

- **Consequence**: The opponent uses the gap to establish a new guard configuration such as collar-sleeve, spider guard, or re-thread the lapel, losing the window of advantage created by the extraction
- **Correction**: Drill the extraction-to-passing-grip transition as a single continuous sequence with no pause, so the opponent never has a moment to re-establish control

### 6. Turning sideways or exposing your back during the circling extraction phase

- **Consequence**: Bottom player capitalizes on the angle exposure to enter a back take sequence, converting your escape attempt into a worse position
- **Correction**: Keep shoulders square and facing the opponent throughout the circling motion, using lateral steps rather than turning your body away from the guard player
