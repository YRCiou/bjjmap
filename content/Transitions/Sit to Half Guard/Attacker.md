...
---
title: "Sit to Half Guard Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Sit to Half Guard in BJJ. Attacking perspective with setup, execution steps, and counters for escaping the Buggy Choke."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Sit to Half Guard in BJJ",
  "description": "Step-by-step guide for executing Sit to Half Guard from Buggy Choke/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Assess and commit",
      "text": "Recognize that continued turtle defense is failing as opponent establishes deep collar access. Make the mental commitment to execute the full sitting motion without hesitation or partial attempts.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Post and prepare",
      "text": "Plant your near hand firmly on the mat beside your hip with fingers pointing toward your feet. This post will guide and support the sitting motion while creating the pivot point for hip rotation.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Drop hip to mat",
      "text": "Drop your near hip to the mat explosively while simultaneously driving your far hip under your body toward the posting hand. This creates the sitting base while displacing opponent's perpendicular pressure angle.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Insert knee shield",
      "text": "As your hip contacts the mat, immediately insert your inside knee across opponent's torso with shin angled to create the shield frame. This prevents them from immediately consolidating side control or mount.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Hook far leg",
      "text": "Reach your outside leg to hook opponent's far leg at the knee or thigh, establishing the Half Guard entanglement that prevents them from simply stepping over your guard recovery attempt.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Face and frame",
      "text": "Turn your upper body to face opponent squarely while establishing defensive frames with your arms. Create an underhook with your near arm if possible, or establish collar and sleeve control to complete Half Guard structure.",
      "position": 6
    },
    {
      "@type": "HowToStep",
      "name": "Consolidate position",
      "text": "Adjust hip angle to create proper Half Guard positioning with your head toward opponent's trapped leg side. Establish your preferred Half Guard variation (knee shield, lockdown, or underhook) based on opponent's reactions.",
      "position": 7
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the primary goal of the Sit to Half Guard escape?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The primary goal is to recover guard position by transitioning from deteriorating turtle defense to Half Guard structure. This exchanges a position where you're being choked for one where you have defensive frames, leg entanglement, and the ability to attack or recover full guard."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Execute after opponent establishes grip access but before they apply full perpendicular body pressure with the choke locked. This window typically occurs during their weight transition while deepening grips. Too early exposes your back unnecessarily; too late and the sitting motion tightens an already-locked choke."
      }
    },
    {
      "@type": "Question",
      "name": "What is the most critical body part to position immediately as your hip contacts the mat?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Your inside knee must insert across opponent's torso as a shield frame simultaneously with your hip landing. This prevents immediate pass to mount or side control. Without the knee shield, the sitting motion creates a worse position than staying in turtle."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "Why must the sitting motion be directed toward the opponent rather than away?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sitting toward opponent closes distance necessary for immediate leg entanglement and Half Guard establishment. Sitting away creates space that opponent uses to disengage from failed choke, reset to dominant top position, or easily take back control during your extended transition."
      }
    },
    {
      "@type": "Question",
      "name": "What role does the outside leg hook play in completing this transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The outside leg hook on opponent's far leg establishes the Half Guard entanglement that prevents them from simply stepping over your knee shield. Without this hook, the knee shield alone is insufficient—opponent extracts their leg and passes to mount before your guard retention structure is complete."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Sit to Half Guard Attacker",
  "description": "How to execute Sit to Half Guard in BJJ. Attacking perspective with setup, execution steps, and counters for escaping the Buggy Choke.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Sit-to-Half-Guard"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Sit-to-Half-Guard/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Sit to Half Guard (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Turtle to Half Guard",
      "description": "Sit to Half Guard (Attacker) film study: Turtle to Half Guard, taught by Bernardo Faria.",
    ...
    },
    {
      ...
      "description": "Sit to Half Guard (Attacker) film study: Turtle Guard Sweeps and Reversals, taught by Stephan Kesting.",
...
<p class="section-subtitle">Watch Sit to Half Guard (Attacker) in action — curated instructionals</p>
