...
---
title: "Darce from Turtle | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Darce from Turtle", "item": "https://bjjmap.pages.dev/Transitions/Darce-from-Turtle" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Darce from Turtle \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Modified darce choke from turtle (no-gi)",
      "description": "Darce from Turtle film study: Modified darce choke from turtle (no-gi), taught by Simple JiuJitsu coach.",
    ...
    },
    {
      ...
      "description": "Darce from Turtle film study: Gator roll into the darce choke, taught by Applied Pressure MMA coach.",
...
<p class="section-subtitle">Watch Darce from Turtle in action — curated instructionals</p>
...
| **Key Principles** | Control opponent's far shoulder to prevent escape and create... | Recognize the Darce threat early by monitoring opponent's ar... |
...
[[Darce from Turtle/Attacker|→ Full Attacker Guide]]
...
[[Darce from Turtle/Defender|→ Full Defender Guide]]
...
- [[Submissions/Arm Triangle/from Turtle]] - Alternative submission from similar control position
