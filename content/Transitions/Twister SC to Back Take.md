...
---
title: "Twister SC to Back Take | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Twister SC to Back Take", "item": "https://bjjmap.pages.dev/Transitions/Twister-SC-to-Back-Take" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Twister SC to Back Take \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Back attacks and RNC from twister side control",
      "description": "Twister SC to Back Take film study: Back attacks and RNC from twister side control, taught by Thunderdome BJJ.",
    ...
    },
    {
      ...
      "description": "Twister SC to Back Take film study: Twister side control attacks, taught by Eddie Bravo.",
...
<p class="section-subtitle">Watch Twister SC to Back Take in action — curated instructionals</p>
...
| **Key Principles** | Maintain continuous chest-to-back contact throughout the ent... | Recognize the shift from twister attack to back take attempt... |
...
[[Twister SC to Back Take/Attacker|→ Full Attacker Guide]]
...
[[Twister SC to Back Take/Defender|→ Full Defender Guide]]
