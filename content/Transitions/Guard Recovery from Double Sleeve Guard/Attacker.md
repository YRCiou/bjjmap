...
---
title: "Guard Recovery from Double Sleeve Guard Attacker | BJJ Technique Guide | BJJ Map"
description: "Learn to recover closed guard from double sleeve guard as the bottom player in BJJ. Complete guide covering grip transition, leg retraction, and closed guard reestablishment when sleeve control is compromised."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Guard Recovery from Double Sleeve Guard in BJJ",
  "description": "Step-by-step guide for executing Guard Recovery from Double Sleeve Guard from Double Sleeve Guard/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Recognize Grip Failure",
      "text": "Identify the moment your opponent strips one or both sleeve grips, or when their forward pressure compromises your foot-on-hip or bicep frame positioning. This recognition must happen instantly—any delay allows the opponent to advance past your legs and establish a dominant passing position.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Secure Remaining Control Point",
      "text": "If one sleeve grip remains, tighten it and use it as your primary anchor for the recovery. If both grips are lost, immediately transition your hands to collar, wrist, or bicep grips—any upper body connection that prevents the opponent from freely advancing while you retract your legs.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Retract Near Leg and Hip Escape",
      "text": "Pull your near-side leg off the opponent's hip or bicep and simultaneously execute a hip escape away from the passing direction. Bend your knee and drive it toward your own chest, creating a compact barrier between you and the advancing passer while your hip escape generates the angle for guard closure.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Thread Far Leg Behind Opponent",
      "text": "As your hip escape creates angle, swing your far leg from its extended position on the opponent's bicep or hip and thread it behind their back. Use the momentum of your hip escape to accelerate this leg movement. Your heel should make contact with the opponent's far hip or lower back.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Pull Opponent Forward with Grip",
      "text": "Use your remaining upper body grip to pull the opponent's weight forward and down toward you as your legs close behind them. This forward pull prevents them from posturing up and retreating out of guard closure range. In gi, a collar grip provides excellent leverage for this pull.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Close Guard and Lock Ankles",
      "text": "Cross your ankles behind the opponent's lower back and squeeze your knees together to lock the closed guard position. Ensure your ankles cross at the small of their back rather than high on their torso—a low lock prevents immediate guard opening and gives you maximum control of their hip movement.",
      "position": 6
    },
    {
      "@type": "HowToStep",
      "name": "Break Posture and Establish Offensive Grips",
      "text": "Immediately pull the opponent's posture down using a combination of your closed guard squeeze, collar grip, and core engagement. Transition your hands to offensive grip configurations—cross collar and sleeve, overhook and collar, or head and arm control depending on gi or no-gi context. Launching an attack within three seconds of guard closure prevents the opponent from settling and working to reopen your guard.",
      "position": 7
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the hip escape during guard recovery create the angle needed for closing guard?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The hip escape moves the bottom player's hips laterally relative to the advancing passer, creating a diagonal angle between the players' centerlines. This angle allows the far leg to travel a shorter distance around the opponent's body to reach their back, making guard closure mechanically easier. Without the hip escape, the bottom player must pull the opponent directly on top of them in a symmetrical position, which requires significantly more leg reach and gives the opponent optimal posture for guard opening."
      }
    },
    {
      "@type": "Question",
      "name": "What should you do if the opponent stands up immediately after stripping both sleeve grips?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "If the opponent stands before leg retraction can begin, abandon the closed guard recovery and immediately transition to feet-on-hips open guard. Place both feet on the opponent's hip bones, establish collar and sleeve grips from the supine position, and work to control their standing posture. Attempting to close guard against a fully standing opponent from flat on your back is extremely low percentage and likely results in being passed during the reaching attempt."
      }
    },
    {
      "@type": "Question",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Guard Recovery from Double Sleeve Guard Attacker",
  "description": "Learn to recover closed guard from double sleeve guard as the bottom player in BJJ. Complete guide covering grip transition, leg retraction, and closed guard reestablishment when sleeve control is compromised.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Guard-Recovery-from-Double-Sleeve-Guard"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Guard-Recovery-from-Double-Sleeve-Guard/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Guard Recovery from Double Sleeve Guard (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Guard retention: recovering through the legs",
      "description": "Guard Recovery from Double Sleeve Guard (Attacker) film study: Guard retention: recovering through the legs, taught by Lachlan Giles.",
    ...
    },
    {
      ...
      "description": "Guard Recovery from Double Sleeve Guard (Attacker) film study: Guard retention: recovering around the legs, taught by Lachlan Giles.",
...
<p class="section-subtitle">Watch Guard Recovery from Double Sleeve Guard (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Guard Recovery from Double Sleeve Guard?</p>
...
<p class="section-subtitle">What do you need before attempting Guard Recovery from Double Sleeve Guard?</p>
...
<p class="section-subtitle">How do you execute Guard Recovery from Double Sleeve Guard step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Guard Recovery from Double Sleeve Guard?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Guard Recovery from Double Sleeve Guard?</p>
...
<p class="section-subtitle">How do you train Guard Recovery from Double Sleeve Guard (Attacker)?</p>

**Phase 1: Grip Failure Recognition** - Identifying the moment to abandon sleeve control and commit to recovery
Partner holds double sleeve guard while training partner breaks grips in various ways—one grip strip, both grip strips, explosive pull-out, gradual pressure advancement. Bottom player practices recognizing the exact moment recovery must begin and immediately initiating leg retraction. Work at 30% resistance to build pattern recognition.

**Phase 2: Leg Retraction and Hip Escape Coordination** - Simultaneous leg retraction with directional hip escape for guard closure angle
...
<p class="section-subtitle">What are the safety concerns for Guard Recovery from Double Sleeve Guard?</p>
