...
---
title: "Anaconda from Turtle | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Anaconda from Turtle", "item": "https://bjjmap.pages.dev/Transitions/Anaconda-from-Turtle" }
  ]
}
</script>
...
[[Anaconda from Turtle/Attacker|→ Full Attacker Guide]]
...
[[Anaconda from Turtle/Defender|→ Full Defender Guide]]
...
- [[Submissions/Arm Triangle/from Turtle]] - Alternative arm-in choke option from turtle using different wrapping mechanics
