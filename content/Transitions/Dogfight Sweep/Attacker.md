...
---
title: "Dogfight Sweep Attacker | BJJ Technique Guide | BJJ Map"
description: "Complete attacking guide for the Dogfight Sweep. Step-by-step execution of underhook drive and far leg control to achieve side control from the Dogfight Position."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Dogfight Sweep",
      "item": "https://bjjmap.pages.dev/Transitions/Dogfight-Sweep"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Dogfight-Sweep/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Dogfight Sweep (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Roger\u0027s windmill half guard sweep",
      "description": "Dogfight Sweep (Attacker) film study: Roger\u0027s windmill half guard sweep, taught by Roger Gracie.",
    ...
    },
    {
      ...
      "description": "Dogfight Sweep (Attacker) film study: Armlock off the dogfight sweep, taught by Brandon Mccaghren.",
    ...
    },
    {
      ...
      "description": "Dogfight Sweep (Attacker) film study: Dogfight basics: plan B and old school sweep, taught by Brandon Mccaghren.",
...
<p class="section-subtitle">Watch Dogfight Sweep (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Dogfight Sweep?</p>
...
<p class="section-subtitle">What do you need before attempting Dogfight Sweep?</p>
...
<p class="section-subtitle">How do you execute Dogfight Sweep step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Dogfight Sweep?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Dogfight Sweep?</p>
...
**Phase 5: Competition Integration** - Incorporating the sweep into full rolling and match scenarios
During regular sparring, deliberately seek the Dogfight Position from half guard and execute the sweep under full competition conditions. Track how often you reach Dogfight, how often the sweep succeeds, and what defenses opponents use. Refine approach based on recurring patterns across multiple training partners with different body types and defensive styles.
...
<p class="section-subtitle">What are the safety concerns for Dogfight Sweep?</p>
