...
---
title: "Heel Drag Escape | BJJ Technique | BJJ Map"
description: "Master the Heel Drag Escape from mount in BJJ. Learn precise heel hooking mechanics, optimal timing windows, and systematic half guard recovery chains."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Heel Drag Escape", "item": "https://bjjmap.pages.dev/Transitions/Heel-Drag-Escape" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Heel Drag Escape",
  "description": "The Heel Drag Escape is a low-energy mount escape where the bottom player hooks the top player's planted foot with their heel and drags it across the centerline to recover half guard.",
...
**The Heel Drag Escape is a low-energy mount escape where the bottom player hooks the top player's planted foot with their heel and drags it across the centerline to recover half guard.**
...
[[Heel Drag Escape/Attacker|→ Full Attacker Guide]]
...
[[Heel Drag Escape/Defender|→ Full Defender Guide]]
...
**Near-Side Heel Drag**: The standard version where the same-side heel hooks the opponent's nearest foot. Your right heel hooks their right foot or left heel hooks their left foot. This is the highest-percentage variation because the heel travels the shortest distance and the hooking angle is most natural. (When to use: Default option when the opponent has a foot planted within range of your same-side heel. Best for initial heel drag attempts.)


**Cross-Body Heel Drag**: The opposite foot reaches across your body to hook the opponent's far foot. Requires greater hip mobility and a slightly larger bridge to create space for the longer reach. Creates a different entanglement angle that can catch opponents who have learned to defend the near-side version. (When to use: When the near-side foot has been retracted or is positioned too high. Also effective as a surprise variation when the opponent expects same-side attacks.)


**Bridge-to-Heel Drag Combination**: Combines a full-power bridge toward one side as if attempting an upa escape, then immediately executes the heel drag on the opposite side as the opponent posts to defend the bridge. The bridge displaces the opponent's weight and frequently plants their posting foot in a perfect position for the heel hook. (When to use: Against opponents with excellent mount retention who preemptively lift their feet against standard heel drag attempts. The bridge forces them to plant a foot for base, creating the hooking opportunity.)
