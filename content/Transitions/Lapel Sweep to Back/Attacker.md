...
---
title: "Lapel Sweep to Back Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Lapel Sweep to Back in BJJ. Attacking perspective with setup, execution steps, and counters."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Lapel Sweep to Back in BJJ",
  "description": "Step-by-step guide for executing Lapel Sweep to Back from Lapel Guard/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish lapel configuration",
      "text": "From seated or supine lapel guard, ensure your lapel grip is secure with the fabric wrapped around the opponent's leg behind the knee (worm guard style) or around their arm. Use a pistol grip or four-finger hook through the lapel fabric for maximum security.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Secure sleeve control",
      "text": "Grip the opponent's far sleeve at the wrist or cuff with your free hand. This grip prevents them from posting their hand when you initiate the sweep, which is essential for opening the back take pathway. Without this control, they can simply post and base out.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Load the sweep",
      "text": "Use your legs and hip movement to begin disrupting the opponent's base, pulling them forward and to the side with your lapel grip while controlling their posting arm. Create the genuine sweep threat by elevating your hips and directing their weight over their base.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Follow the rotation",
      "text": "As the opponent defends the sweep by rotating or attempting to backstep, do not release your grips. Instead, sit up aggressively and follow their rotation, using the lapel as your anchor point. Your momentum should carry you toward their back as they turn to prevent being swept.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Transition to back",
      "text": "Continue following the opponent's rotation while maintaining lapel control. Use your free arm to establish an underhook or seatbelt grip as you come up to their back. The lapel grip maintains your connection throughout the transition, preventing them from facing you.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Secure back control",
      "text": "Insert your hooks as you establish the seatbelt grip with your arms. The lapel grip can now be released or maintained as additional control. Ensure your chest is tight to their back with your head positioned on the choking side before settling into the position.",
      "position": 6
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the primary goal of Lapel Sweep to Back?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The primary goal is to use the sweep threat to force a defensive reaction from the opponent, then follow their rotation to establish back control. The technique creates a dilemma where defending the sweep exposes the back, making it a two-for-one attack."
      }
    },
    {
      "@type": "Question",
      "name": "Why is sleeve control essential for this technique?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sleeve control prevents the opponent from posting their hand to base when you initiate the sweep. Without this control, they can simply post and stabilize, eliminating both the sweep threat and the back take opportunity. The sleeve grip is non-negotiable for the back take pathway to open."
      }
    },
    {
      "@type": "Question",
      "name": "What should you do when the opponent begins rotating to defend the sweep?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Follow their rotation aggressively while maintaining your lapel grip. Do not release grips or hesitate—sit up and pursue the back immediately. Their defensive rotation IS the technique working correctly; it's opening the pathway to their back. The lapel grip keeps you attached throughout."
      }
    },
    {
      "@type": "Question",
      "name": "Your opponent drops their weight and drives forward to flatten you—how do you adjust?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How do you counter the backstep escape when opponent recognizes your attack?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Follow their backstep aggressively with your sit-up motion—their backstep actually accelerates your path to their back if you stay attached via the lapel grip. Maintain sleeve control to prevent posting. The backstep escape only works if you release grips; staying attached converts their escape into your technique."
      }
    },
    {
      "@type": "Question",
      "name": "What distinguishes a successful back take attempt from a failed sweep?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The distinction is in commitment and recognition. A failed sweep happens when you treat the opponent's rotation as technique failure and release grips. A successful back take recognizes that rotation IS the goal—the sweep threat is the setup, not the end goal. Maintaining grips and following the rotation converts 'failed sweep' into successful back take."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Lapel Sweep to Back Attacker",
  "description": "How to execute Lapel Sweep to Back in BJJ. Attacking perspective with setup, execution steps, and counters.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Lapel-Sweep-to-Back/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Lapel Sweep to Back (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Worm guard to back choke",
      "description": "Lapel Sweep to Back (Attacker) film study: Worm guard to back choke, taught by Keenan Cornelius.",
    ...
    },
    {
      ...
      "description": "Lapel Sweep to Back (Attacker) film study: Lapel helicopter sweep, taught by bjjtaro.",
...
<p class="section-subtitle">Watch Lapel Sweep to Back (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Lapel Sweep to Back?</p>
...
<p class="section-subtitle">What do you need before attempting Lapel Sweep to Back?</p>
...
<p class="section-subtitle">How do you execute Lapel Sweep to Back step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Lapel Sweep to Back?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Lapel Sweep to Back?</p>
...
<p class="section-subtitle">How do you train Lapel Sweep to Back (Attacker)?</p>
...
<p class="section-subtitle">What are the safety concerns for Lapel Sweep to Back?</p>
