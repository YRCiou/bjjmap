...
---
title: "Half Guard Whizzer Counter | BJJ Technique | BJJ Map"
description: "Master the Half Guard Whizzer Counter in BJJ. Kill the bottom player's underhook with an overhook (whizzer) from half guard top to establish overhook control, flatten, and pass."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Half Guard Whizzer Counter", "item": "https://bjjmap.pages.dev/Transitions/Half-Guard-Whizzer-Counter" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Half Guard Whizzer Counter",
  "description": "The Half Guard Whizzer Counter is a top-game transition where the passer answers the bottom player's underhook by wrapping an overhook (whizzer) over that same arm, killing the underhook and establishing overhook control to flatten and pass.",
...
<p class="also-known-as"><em>Also known as:</em> <strong>Half Guard Overhook Counter</strong>, <strong>Whizzer over the Underhook</strong></p>
</aside>
<div class="role-links">

[[Half Guard Whizzer Counter/Attacker|Play as Attacker]]
[[Half Guard Whizzer Counter/Defender|Play as Defender]]
...
| **Key Principles** | Seal the armpit tightly over the opponent's shoulder - the a... | Keep your underhook deep and tight to your opponent's ribs s... |
...
[[Half Guard Whizzer Counter/Attacker|→ Full Attacker Guide]]
...
[[Half Guard Whizzer Counter/Defender|→ Full Defender Guide]]
...
- [[Positions/Overhook Control]] - Target position - successful whizzer establishes overhook control as the dominant top player

- [[Positions/Half Guard]] - Starting position - this counter is executed from half guard top against the bottom player's underhook

- [[Positions/Back Control]] - Common follow-up - when the bottom player turns away to escape the whizzer, the top player takes the back

- [[Positions/Side Control]] - Primary passing destination from overhook control after the underhook is neutralized

- [[Positions/Kimura Trap]] - Submission chain available from the overhook when the opponent's elevated arm is exposed

- [[Positions/Half Guard/Knee Shield Half Guard]] - Related half guard variation where underhook battles and whizzer counters frequently occur

- [[Positions/Half Guard/Old School]] - Bottom-side underhook sweep the whizzer counter is specifically designed to neutralize

- [[Positions/Turtle]] - Related context where overhook/whizzer control is established to attack the back
