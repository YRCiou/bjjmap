...
---
title: "Omoplata to Back | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Omoplata to Back", "item": "https://bjjmap.pages.dev/Transitions/Omoplata-to-Back" }
  ]
}
</script>
...
[[Omoplata to Back/Attacker|→ Full Attacker Guide]]
...
- **Recognize the roll initiation**: As opponent attempts to escape the omoplata by rolling forward over their trapped shoulder, identify...

- **Maintain shoulder connection through the roll**: Keep your outside leg (the leg over their shoulder) tightly connected to their shoulder girdle as th...

- **Follow the roll with your entire body**: Allow your torso and hips to follow the momentum of the opponent's forward roll while maintaining th...

- **Insert the first hook at the hip pass**: As the opponent completes the roll and their hips rotate through, immediately thread your inside leg...

- **Secure the seatbelt grip**: Simultaneously with or immediately after the first hook, establish the seatbelt grip. Your choking a...

- **Drive chest-to-back connection**: Bring your chest flush against the opponent's back, eliminating all space between your torso and the...

- **Insert the second hook**: With seatbelt and first hook secured, work the second hook (the leg that was originally over their s...

- **Consolidate full back control**: With both hooks deep and seatbelt tight, finalize your position. Adjust the choking arm high across ...


### Common Mistakes


- **Losing shoulder connection during the opponent's forward roll**
...
- **Insisting on the omoplata finish rather than following the roll**
...
- **Delaying the first hook insertion past the hip rotation window**
...
[[Omoplata to Back/Defender|→ Full Defender Guide]]
...
- **Roll explosively at an angle to break shoulder connection and immediately turn to face attacker** - When: When you must roll to escape the omoplata and the attacker's leg is heavy on your shoulder indicating they plan to follow

- **Post your free arm behind you during the roll to block the attacker's first hook insertion** - When: As you complete the forward roll and feel the attacker following, use your free hand to frame against their inserting leg

- **Strip the seatbelt grip with two-on-one control on the choking arm before hooks are consolidated** - When: When the attacker has begun establishing the seatbelt after the roll but has not yet locked both hooks
...
**Body Triangle Variation**: Instead of inserting a second hook, establish a body triangle by locking your ankle behind your opposite knee across the opponent's torso. This provides extremely strong hip control and is useful when the opponent is actively defending hook insertion by grabbing your feet. (When to use: When opponent is hand fighting your second hook or has strong leg defense. Also effective for smaller practitioners facing larger opponents who need maximum control leverage.)


**Rolling Back Take from Broken Omoplata**: If you lose tight omoplata control before they roll but still maintain some shoulder connection, pursue the back take by doing your own forward roll alongside their roll, using combined momentum to establish back position. Requires more dynamic movement and athleticism than the standard version. (When to use: When the initial omoplata control is compromised but the opponent still commits to the forward roll escape. Effective for mobile, athletic practitioners comfortable with inverting.)


**Truck Position Entry**: As opponent rolls and you follow, instead of establishing traditional back control, secure a lockdown on their far leg while maintaining shoulder control. This creates the truck position, opening crotch ripper, banana split, and twister attacks as alternatives to standard back control. (When to use: When opponent successfully prevents hook insertion but you maintain shoulder connection. Effective for practitioners comfortable with the truck and twister control systems.)


**Gi Lapel Control Variation**: In the gi, as opponent begins rolling, release leg control temporarily to secure deep grips on their collar and lapel. Use these grips to control the roll speed and direction, then establish back position with superior gi grip control before inserting hooks. (When to use: Gi competition when opponent has strong defense against hook insertion. Collar grips provide additional control anchors throughout the transition and set up bow and arrow choke.)
