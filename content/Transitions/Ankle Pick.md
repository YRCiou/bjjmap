...
---
title: "Ankle Pick | BJJ Technique | BJJ Map"
description: "Learn the Ankle Pick takedown in BJJ. Step-by-step execution from standing position to top control with setup, grip details, and defensive strategies."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Ankle Pick", "item": "https://bjjmap.pages.dev/Transitions/Ankle-Pick" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Ankle Pick \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Ankle pick variations",
      "description": "Ankle Pick film study: Ankle pick variations, taught by Alex Pereira Jiu Jitsu.",
    ...
    },
    {
      ...
      "description": "Ankle Pick film study: Ankle pick from the underhook, taught by Base Monkey.",
    ...
    },
    {
      ...
      "description": "Ankle Pick film study: Over collar tie ankle pick, taught by Footwork Trainer.",
...
<p class="section-subtitle">Watch Ankle Pick in action — curated instructionals</p>
...
| **Key Principles** | Create forward pressure from opponent through grip fighting ... | Deny the collar tie and wrist control that precede every ank... |
...
[[Ankle Pick/Attacker|→ Full Attacker Guide]]
...
[[Ankle Pick/Defender|→ Full Defender Guide]]
