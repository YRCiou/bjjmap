...
---
title: "Triangle to Back Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Triangle to Back in BJJ. Attacking perspective with setup, execution steps, timing cues, and counter responses."
---
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "What is the most critical hip position during the leg swing phase of this transition?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Triangle to Back Attacker",
  "description": "How to execute Triangle to Back in BJJ. Attacking perspective with setup, execution steps, timing cues, and counter responses.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Triangle-to-Back/Attacker"
    }
  ]
}
</script>
...
**Phase 2: Defensive recognition** - Identifying when opponent's defense creates back take opportunities versus when to maintain triangle
...
**Phase 3: Timed transitions with light resistance** - Executing the transition as opponent commits to defensive movement with realistic timing
...
**Phase 4: Counter-defense integration** - Maintaining control when opponent actively resists the back take
Partner actively defends the back take attempt by turning in, sitting to hip, posting hands, or clamping elbows. Practitioner must use appropriate counter responses to maintain control and either complete the back take or return to triangle control. This phase develops troubleshooting skills and backup options including technical mount entry and triangle re-engagement.

**Phase 5: Positional sparring from triangle** - Executing against full resistance in isolated positional rounds
...
**Phase 6: Live integration and chain development** - Implementing the transition as part of the complete triangle attack system during open sparring
