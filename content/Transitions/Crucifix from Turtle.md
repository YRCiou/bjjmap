...
---
title: "Crucifix from Turtle | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Crucifix from Turtle", "item": "https://bjjmap.pages.dev/Transitions/Crucifix-from-Turtle" }
  ]
}
</script>
...
| **Key Principles** | Control the near-side arm before any other action - this is ... | Keep elbows tight to knees in turtle - space between elbow a... |
...
[[Crucifix from Turtle/Attacker|→ Full Attacker Guide]]
...
[[Crucifix from Turtle/Defender|→ Full Defender Guide]]
...
- [[Submissions/Armbar/from Crucifix]] - Primary submission follow-up from crucifix
