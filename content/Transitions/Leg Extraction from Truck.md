...
---
title: "Leg Extraction from Truck | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Leg Extraction from Truck", "item": "https://bjjmap.pages.dev/Transitions/Leg-Extraction-from-Truck" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Leg Extraction from Truck \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
...
<p class="section-subtitle">Watch Leg Extraction from Truck in action — curated instructionals</p>
...
| **Key Principles** | Protect the neck throughout the entire extraction process—th... | Maintain constant awareness of the trapped leg's movement wi... |
...
[[Leg Extraction from Truck/Attacker|→ Full Attacker Guide]]
...
[[Leg Extraction from Truck/Defender|→ Full Defender Guide]]
