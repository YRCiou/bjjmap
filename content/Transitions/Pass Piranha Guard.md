...
---
title: "Pass Piranha Guard | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Pass Piranha Guard", "item": "https://bjjmap.pages.dev/Transitions/Pass-Piranha-Guard" }
  ]
}
</script>
...
[[Pass Piranha Guard/Attacker|→ Full Attacker Guide]]
...
[[Pass Piranha Guard/Defender|→ Full Defender Guide]]
...
**Toreando Pass Variation**: After clearing the lapel configuration, grip both pant legs at the knees and use a toreando-style lateral redirection to swing the bottom player's legs to one side while stepping around to side control. Best suited for situations where the bottom player's legs are extended and hip control is minimal. (When to use: When the bottom player has weak hook placement and their legs are extended after lapel grip is cleared)


**Knee Slice Variation**: Once the primary lapel grip is broken, immediately drive a knee slice through the centerline before the bottom player can re-establish any guard configuration. Requires an underhook on the far side and crossface pressure to prevent the bottom player from re-threading the collar during the pass. (When to use: When the bottom player's legs are flat and you can secure an underhook during the grip-clearing phase)


**Long Step Pass Variation**: After stripping the lapel, use a long backstep to clear the legs entirely while maintaining pants grip control. This variation creates maximum distance from the bottom player's re-gripping range and works well against opponents who are quick to re-establish lapel configurations. (When to use: When the bottom player has fast re-gripping hands and you need to create significant distance after clearing the lapel)
