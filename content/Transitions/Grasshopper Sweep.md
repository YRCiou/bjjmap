...
---
title: "Grasshopper Sweep | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Grasshopper Sweep", "item": "https://bjjmap.pages.dev/Transitions/Grasshopper-Sweep" }
  ]
}
</script>
...
| **Key Principles** | Hip elevation must precede the sweep motion - drive hips tow... | Deny hook depth by maintaining wide base and keeping knees a... |
...
[[Grasshopper Sweep/Attacker|→ Full Attacker Guide]]
...
[[Grasshopper Sweep/Defender|→ Full Defender Guide]]
