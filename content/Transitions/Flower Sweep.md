...
---
title: "Flower Sweep | BJJ Technique | BJJ Map"
description: "Learn the Flower Sweep in BJJ. Master this fundamental closed guard sweep with step-by-step execution from guard to mount. Complete attacker and defender guide."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Flower Sweep", "item": "https://bjjmap.pages.dev/Transitions/Flower-Sweep" }
  ]
}
</script>
...
| **Key Principles** | Control the opponent's sleeve and collar/back of the head to... | Maintain strong upright posture with head over hips to resis... |
...
[[Flower Sweep/Attacker|→ Full Attacker Guide]]
...
[[Flower Sweep/Defender|→ Full Defender Guide]]
