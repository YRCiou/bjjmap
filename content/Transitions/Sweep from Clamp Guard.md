...
---
title: "Sweep from Clamp Guard | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Sweep from Clamp Guard", "item": "https://bjjmap.pages.dev/Transitions/Sweep-from-Clamp-Guard" }
  ]
}
</script>
...
[[Sweep from Clamp Guard/Attacker|→ Full Attacker Guide]]
...
[[Sweep from Clamp Guard/Defender|→ Full Defender Guide]]
...
**Forward Drive Scissor Sweep**: When the opponent drives forward into the clamp to close distance and neutralize submissions, use a scissor motion with the legs — bottom leg sweeps their far knee while the top leg drives across their chest. The clamp maintains arm isolation throughout, preventing the posting that normally defends scissor sweeps. The forward momentum adds to the sweeping force, making this the highest-percentage variation when the opponent cooperates by driving in. (When to use: When opponent drives forward aggressively into the clamp, shifting their weight past their center of gravity)


**Hip Bump Counter Sweep**: When the opponent reaches with their free arm — either to extract the trapped arm, grip fight, or attempt a pass — their remaining base collapses momentarily. Sit up explosively while maintaining the clamp, bumping your hip into their torso and redirecting them over the trapped arm side. The opponent cannot post with the clamped arm, making the hip bump nearly indefensible when timed with their arm commitment. (When to use: When opponent commits their free arm to extraction, grip fighting, or any action that removes it from basing duty)


**Pendulum Sweep Variation**: Against a well-based opponent who keeps their hips low and free arm posted, use the non-clamping leg as a pendulum to generate momentum. Swing the free leg wide and then cut it back across the opponent's body while simultaneously pulling their posture with your hand grips. The pendulum generates sufficient force to overcome a wider base, and the clamp prevents the arm-side posting that normally defends this sweep. (When to use: Against a defensively sound opponent with wide base who is resisting forward commitment and keeping free arm posted)
