...
---
title: "Shin-to-Shin to Single Leg X | BJJ Technique | BJJ Map"
description: "Master the Shin-to-Shin to Single Leg X-Guard transition in BJJ. Learn entry mechanics, hip threading, hook placement, and pathways to sweeps and leg attacks."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Shin-to-Shin to Single Leg X", "item": "https://bjjmap.pages.dev/Transitions/Shin-to-Shin-to-Single-Leg-X" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Shin-to-Shin to Single Leg X",
  "description": "Shin-to-Shin to Single Leg X is a guard transition where the bottom player threads their inside leg around the opponent's trapped ankle and plants a hip hook, converting shin pressure into the Single Leg X sweeping and leg-lock platform.",
...
**Shin-to-Shin to Single Leg X is a guard transition where the bottom player threads their inside leg around the opponent's trapped ankle and plants a hip hook, converting shin pressure into the Single Leg X sweeping and leg-lock platform.**
...
[[Shin-to-Shin to Single Leg X/Attacker|→ Full Attacker Guide]]
...
[[Shin-to-Shin to Single Leg X/Defender|→ Full Defender Guide]]
...
**Heel Drag SLX Entry**: Using a heel drag on the mat to assist threading the inside leg underneath the opponent's trapped leg, reducing the hip travel distance needed and making the entry more compact against wide-stance opponents. (When to use: When the opponent maintains a wide stance that creates additional clearance for the threading path but requires more hip travel to get underneath their center of gravity.)


**Collar Drag to SLX**: Combining a sharp collar drag to break the opponent's posture forward, using their forward momentum to create the weight commitment and angle needed for immediate SLX entry without requiring prolonged shin pressure buildup. (When to use: When the opponent maintains strong upright posture that resists normal weight loading through the shin connection, requiring an explosive pulling action to break their balance forward.)


**Ankle Grip Assisted Entry**: Securing a direct hand grip on the opponent's ankle before initiating the inside leg thread, providing additional control that prevents the opponent from retracting their leg during the transition and allowing a more controlled entry sequence. (When to use: When the opponent has been actively clearing the shin connection and you need additional control to prevent leg retraction during the threading phase.)
