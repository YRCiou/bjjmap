...
---
title: "Counter Leg Attack Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Counter Leg Attack in BJJ. Attacking perspective with setup, execution steps, and counters from Inside Sankaku Bottom."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Counter Leg Attack in BJJ",
  "description": "Step-by-step guide for executing Counter Leg Attack from Inside Sankaku/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Protect trapped heel",
      "text": "Hide your heel by pressing it tightly against your own hip, turning toes inward and knee outward. Use your near-side hand to grab your own foot or ankle to reinforce protection. This defensive posture must be maintained throughout the entire counter-attack sequence.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Identify free leg target",
      "text": "Locate opponent's leg that is not part of the figure-four entanglement structure. This is typically the leg on the outside of the configuration. Assess its accessibility and defensive positioning before committing to counter-attack.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Create hip angle",
      "text": "Shift your hips toward the opponent's free leg to create the angle necessary for entry. Use your free leg to push off opponent's hip or the mat to generate this lateral movement while keeping your trapped leg position stable.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Thread free leg",
      "text": "Insert your free leg between opponent's legs, threading it around their free leg to begin your own entanglement. Hook your instep behind their knee or thigh depending on accessibility. Your leg should enter from the inside, creating an inside hook position.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Establish leg configuration",
      "text": "Cross your trapped leg over your free leg to complete your own figure-four configuration around opponent's free leg. This creates mutual entanglement and begins to neutralize their positional advantage. Maintain heel protection on original trapped leg throughout.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Secure 50-50 or Ashi",
      "text": "Complete the transition by either accepting 50-50 Guard position where both practitioners have equal leg entanglement, or if opponent releases to defend, immediately advance to Ashi Garami on their leg. Establish control grips on their ankle once position is secured.",
      "position": 6
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the primary goal of Counter Leg Attack from Inside Sankaku Bottom?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The primary goal is to neutralize the opponent's positional advantage by establishing your own leg entanglement on their free leg. This either creates mutual 50-50 position where neither has advantage, forces them to release Inside Sankaku to defend, or allows you to establish your own Ashi Garami. The counter-attack transforms a losing defensive position into an equal exchange."
      }
    },
    {
      "@type": "Question",
      "name": "Your opponent begins reaching for your heel with two hands - should you attempt the counter-attack?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "This is actually the optimal timing window to attempt the counter-attack. When they shift both hands to heel grips, their upper body and leg positioning become static as they focus on the finish. Their free leg becomes most accessible during this moment. However, you must assess whether you can complete the thread before they secure the heel - if they already have firm grip with wrist blade on Achilles, tap instead."
      }
    },
    {
      "@type": "Question",
      "name": "What are the key grips needed for Counter Leg Attack?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The primary grips are: (1) your near-side hand grabbing your own foot or ankle to maintain heel protection throughout, (2) your free leg hooking behind opponent's knee or thigh to establish entanglement, and (3) once 50-50 is established, two-on-one grip control on their ankle. No hand grips on opponent are required during entry - the legs do the work."
      }
    },
    {
      "@type": "Question",
      "name": "How do you determine which leg to target for the counter-attack?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Always target the opponent's free leg - the leg that is NOT part of their figure-four entanglement structure around your leg. This leg has minimal defensive resources since their entanglement is committed to controlling you. It is typically their outside leg in the configuration. Never attempt to attack the leg that is part of their active entanglement."
      }
    },
    {
      "@type": "Question",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Counter Leg Attack Attacker",
  "description": "How to execute Counter Leg Attack in BJJ. Attacking perspective with setup, execution steps, and counters from Inside Sankaku Bottom.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Counter-Leg-Attack"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Counter-Leg-Attack/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Counter Leg Attack (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Inside sankaku counter with inside ashi dive",
      "description": "Counter Leg Attack (Attacker) film study: Inside sankaku counter with inside ashi dive, taught by Combat by the Minute.",
    ...
    },
    {
      ...
      "description": "Counter Leg Attack (Attacker) film study: Outside heel hook defense into inside heel hook, taught by Holy Grail BJJ.",
...
<p class="section-subtitle">Watch Counter Leg Attack (Attacker) in action — curated instructionals</p>
...
### 2. Attempting counter-attack when opponent has already secured submission grips
...
### 3. Threading leg on wrong side creating cross-body entanglement
...
### 4. Collapsing flat on back during counter-entry attempt

- **Consequence**: Loss of hip mobility necessary to complete leg threading, stalled counter-attack that opponent easily defends
- **Correction**: Maintain shoulder off mat and core engagement throughout to preserve the hip mobility needed for leg insertion

### 5. Forcing counter-attack against opponent with superior leg lock finishing ability

- **Consequence**: Mutual 50-50 position favors opponent who wins the leg lock exchange
- **Correction**: Assess opponent's leg lock skill before committing - against superior finishers, prioritize pure escape over mutual entanglement
