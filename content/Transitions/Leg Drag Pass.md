...
---
title: "Leg Drag Pass | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Leg Drag Pass", "item": "https://bjjmap.pages.dev/Transitions/Leg-Drag-Pass" }
  ]
}
</script>
...
| **Key Principles** | Control the opponent's near leg with both hands to prevent r... | Address the grip on your leg immediately - every second of u... |
...
[[Leg Drag Pass/Attacker|→ Full Attacker Guide]]
...
[[Leg Drag Pass/Defender|→ Full Defender Guide]]
