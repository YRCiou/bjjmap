...
---
title: "Whip-up Sweep | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Whip-up Sweep", "item": "https://bjjmap.pages.dev/Transitions/Whip-up-Sweep" }
  ]
}
</script>
...
| **Key Principles** | Coordinate lockdown extension with upper-body drive so the o... | Maintain disciplined weight distribution with center of grav... |
...
[[Whip-up Sweep/Attacker|→ Full Attacker Guide]]
...
[[Whip-up Sweep/Defender|→ Full Defender Guide]]
