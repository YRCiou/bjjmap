...
---
title: "Ringworm Guard to Worm Guard Defender | BJJ Defense Guide | BJJ Map"
description: "How to defend against Ringworm Guard to Worm Guard in BJJ. Recognition cues, defensive options, and escape strategies."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Ringworm Guard to Worm Guard in BJJ",
  "description": "Step-by-step guide for defending and countering Ringworm Guard to Worm Guard in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Strip the lapel grip during the rethreading window by using both hands to peel the loosened lapel from around your leg",
      "text": "The moment you feel lapel tension decrease and the wrap begins loosening around your leg If successful: Lapel control is completely broken, reducing the position to neutral open guard where you can re-engage with standard passing",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Drive forward with heavy shoulder pressure and flatten the bottom player to deny rethreading space",
      "text": "When you recognize the hip escape and angle creation that precede the transition attempt If successful: Bottom player cannot create sufficient space under your leg for the deeper threading, forcing them to maintain the existing Ringworm configuration",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Circle your trapped leg backward and away from the threading direction while maintaining base with your free leg",
      "text": "When you feel the lapel being fed under your leg in the new direction during the rethreading If successful: The leg movement disrupts the threading path and prevents the lapel from completing the deeper Worm Guard weave",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Stand up explosively to create distance and shake the partial lapel configuration loose before Worm Guard is consolidated",
      "text": "When the transition is partially complete but the bottom player has not yet secured full Worm Guard tension If successful: Distance makes it difficult for the bottom player to complete the wrap around their shin, and gravity helps loosen the partially threaded lapel",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the most critical moment to intervene when defending against this transition?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How does the bottom player's secondary grip affect your defensive options?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The secondary grip on your sleeve or collar limits your ability to posture, use both hands for lapel stripping, or create distance by standing. If they have strong sleeve control, your grip-stripping hand is restricted. If they have collar control, your posture and base are compromised. Address the secondary grip first when possible, or accept that you may need to sacrifice posture temporarily to strip the primary lapel control."
      }
    },
    {
      "@type": "Question",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Ringworm Guard to Worm Guard Defender",
  "description": "How to defend against Ringworm Guard to Worm Guard in BJJ. Recognition cues, defensive options, and escape strategies.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Ringworm-Guard-to-Worm-Guard/Defender"
    }
  ]
}
</script>
...
<p class="section-subtitle">How do you know when someone is attempting Ringworm Guard to Worm Guard?</p>
...
<p class="section-subtitle">What are the key principles for defending Ringworm Guard to Worm Guard?</p>
...
<p class="section-subtitle">What can you do to defend against Ringworm Guard to Worm Guard?</p>
...
<p class="section-subtitle">What is the best outcome when defending Ringworm Guard to Worm Guard?</p>
...
<p class="section-subtitle">What mistakes should you avoid when defending Ringworm Guard to Worm Guard?</p>
...
<p class="section-subtitle">How do you train defense against Ringworm Guard to Worm Guard?</p>

**Week 1-2** - Recognition drill
Partner alternates between normal Ringworm Guard adjustments and actual transition attempts. Practice identifying the recognition cues (hip escape, tension decrease, grip strengthening) and calling out 'transition' when detected. No physical defense yet - purely visual and tactile recognition development.
