...
---
title: "Sweep from Z-Guard | BJJ Technique | BJJ Map"
description: "Master the Z-Guard sweep in BJJ. Complete guide covering knee shield leverage, underhook mechanics, and off-balancing techniques from half guard."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Sweep from Z-Guard", "item": "https://bjjmap.pages.dev/Transitions/Sweep-from-Z-Guard" }
  ]
}
</script>
...
[[Sweep from Z-Guard/Attacker|Play as Attacker]]
[[Sweep from Z-Guard/Defender|Play as Defender]]
...
| **Key Principles** | Coordinate knee shield extension with underhook pull simulta... | Maintain wide base with weight distributed across both knees... |
...
[[Sweep from Z-Guard/Attacker|→ Full Attacker Guide]]
...
[[Sweep from Z-Guard/Defender|→ Full Defender Guide]]
