...
---
title: "Inverted Triangle | BJJ Technique | BJJ Map"
description: "Master the Inverted Triangle in BJJ. Reverse-angle triangle choke when opponent defends standard triangle by turning shoulder inward. Complete execution guide."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Inverted Triangle", "item": "https://bjjmap.pages.dev/Transitions/Inverted-Triangle" }
  ]
}
</script>
...
[[Inverted Triangle/Attacker|→ Full Attacker Guide]]
...
- **Recognize trigger**: Identify when opponent turns their trapped shoulder inward toward your hip to defend the standard tr...

- **Secure leg control**: Tighten your triangle lock by squeezing knees together and pulling your top foot deeper behind oppon...

- **Release and regrip**: Release your head control grip and reach across to grab opponent's far hip or belt line—this grip be...

- **Hip rotation**: Use your shoulder as a pivot point and rotate your hips 180 degrees toward opponent's back, keeping ...

- **Reestablish triangle**: As you complete the rotation, reconfigure your legs into the inverted triangle position with the cho...

- **Control head position**: Reach around and control opponent's head by pulling it toward your hip, breaking their posture and p...

- **Angle adjustment**: Fine-tune your hip angle to approximately 30-45 degrees off opponent's centerline, ensuring your cho...

- **Finish submission**: Squeeze knees together while extending hips upward, pull opponent's head down into the choke, and ma...


### Common Mistakes


- **Releasing triangle lock during rotation to make the body turn easier**
...
- **Rotating in the wrong direction relative to opponent's shoulder turn**
...
- **Attempting inversion without establishing far hip grip first**
...
[[Inverted Triangle/Defender|→ Full Defender Guide]]
...
**No-gi inverted triangle**: Without gi grips, control opponent's head with arm wrapped around the back of their skull rather than collar grip. Hip control uses overhook on their far arm or wrist control. Requires faster execution due to reduced friction and grip options. (When to use: All no-gi grappling situations when opponent turns shoulder to defend standard triangle)


**Mounted inverted triangle**: When opponent stands or elevates from your triangle control, maintain leg configuration while they lift you. As they attempt to slam or stack, use momentum to swing into inverted position from elevated mount. High-risk, high-reward variation. (When to use: Opponent lifts you while in triangle control and attempts slam defense or aggressive stacking)


**Partial inversion to back take**: Begin inverted triangle rotation but instead of completing the submission, use the movement to climb onto opponent's back. As you rotate, release triangle and establish back control with seatbelt grip. Useful when opponent's posture is too strong for submission. (When to use: When opponent begins posture recovery during inversion and submission finish is unlikely)
