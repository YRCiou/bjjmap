...
---
title: "Pull Guard from Combat Base | BJJ Technique | BJJ Map"
description: "Learn to pull closed guard from combat base bottom in BJJ. Complete guide to breaking posture, closing guard, and establishing bottom control effectively."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Pull Guard from Combat Base", "item": "https://bjjmap.pages.dev/Transitions/Pull-Guard-from-Combat-Base" }
  ]
}
</script>
...
| **Key Principles** | Establish upper body control before attempting guard closure... | Maintain upright posture with hands controlling opponent's h... |
...
[[Pull Guard from Combat Base/Attacker|→ Full Attacker Guide]]
...
[[Pull Guard from Combat Base/Defender|→ Full Defender Guide]]
