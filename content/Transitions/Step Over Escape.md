...
---
title: "Step Over Escape | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Step Over Escape", "item": "https://bjjmap.pages.dev/Transitions/Step-Over-Escape" }
  ]
}
</script>
...
| **Key Principles** | Step the far leg (leg furthest from opponent) over their hea... | Keep your head position high relative to the bottom player's... |
...
[[Step Over Escape/Attacker|→ Full Attacker Guide]]
...
[[Step Over Escape/Defender|→ Full Defender Guide]]
