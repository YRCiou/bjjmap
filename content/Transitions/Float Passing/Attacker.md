...
---
title: "Float Passing Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Float Passing in BJJ. Attacking perspective with setup, execution steps, and counters for movement-based guard passing."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for executing Float Passing from Open Guard/Top.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How should you adjust your floating pattern when facing a strong De La Riva guard player?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Float-Passing/Attacker"
    }
  ]
}
</script>
...
<p class="section-subtitle">What are the key principles for executing Float Passing?</p>
...
<p class="section-subtitle">What do you need before attempting Float Passing?</p>
...
<p class="section-subtitle">How do you execute Float Passing step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Float Passing?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Float Passing?</p>
...
<p class="section-subtitle">How do you train Float Passing (Attacker)?</p>
...
Partner actively attempts sweeps, recoveries, and grip fighting during your float passing. Practice defending sweeps while maintaining floating posture, breaking grips efficiently, and adjusting to opponent's counter strategies. Focus on staying safe while creating passing opportunities.
...
**Ongoing: Style Development** - Developing personal float passing variations and combinations
Experiment with combining float passing with other passing styles such as toreando, leg drag, and backstep sequences. Develop your signature movement patterns, grip configurations, and passing entries. Continue refining against diverse opponents and guard styles.
...
<p class="section-subtitle">What are the safety concerns for Float Passing?</p>
