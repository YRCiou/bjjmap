...
---
title: "Clear leg and transition to X-Guard Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Clear Leg to X-Guard in BJJ. Attacking perspective with setup from Leg Knot Bottom, execution steps, and counter responses."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for executing Clear leg and transition to X-Guard from Leg Knot/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Clear leg and transition to X-Guard Attacker",
  "description": "How to execute Clear Leg to X-Guard in BJJ. Attacking perspective with setup from Leg Knot Bottom, execution steps, and counter responses.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Clear-leg-and-transition-to-X-Guard/Attacker"
    }
  ]
}
</script>
...
<p class="section-subtitle">What are the key principles for executing Clear leg and transition to X-Guard?</p>
...
<p class="section-subtitle">What do you need before attempting Clear leg and transition to X-Guard?</p>
...
<p class="section-subtitle">How do you execute Clear leg and transition to X-Guard step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Clear leg and transition to X-Guard?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Clear leg and transition to X-Guard?</p>

### 1. Pulling the trapped leg straight back instead of using hip rotation to clear
...
### 2. Releasing grip on opponent's ankle before X-Guard hooks are established
...
### 3. Establishing hooks in the wrong sequence—cross-body hook before butterfly hook
...
### 4. Attempting the transition while hips are flat on the mat
...
### 5. Stopping at neutral after clearing the leg instead of flowing into X-Guard
...
<p class="section-subtitle">How do you train Clear leg and transition to X-Guard (Attacker)?</p>
...
<p class="section-subtitle">What are the safety concerns for Clear leg and transition to X-Guard?</p>
