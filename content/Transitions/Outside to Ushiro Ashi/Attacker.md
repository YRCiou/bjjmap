...
---
title: "Outside to Ushiro Ashi Attacker | BJJ Technique Guide | BJJ Map"
description: "Learn to execute the Outside to Ushiro Ashi-Garami transition. Master following opponent inversion, maintaining leg control, and establishing reversed entanglement."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Outside to Ushiro Ashi in BJJ",
  "description": "Step-by-step guide for executing Outside to Ushiro Ashi from Outside Ashi-Garami/Top.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Recognize inversion commitment",
      "text": "Detect the opponent's hip rotation initiation through their weight shift, internal rotation of the trapped leg, and directional hip movement turning away from you. Identify the moment they commit to inverting rather than fighting the position directly. Early recognition provides the critical head start needed to match their rotation speed and maintain entanglement integrity throughout the transition.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Tighten figure-four configuration",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Outside to Ushiro Ashi Attacker",
  "description": "Learn to execute the Outside to Ushiro Ashi-Garami transition. Master following opponent inversion, maintaining leg control, and establishing reversed entanglement.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Outside-to-Ushiro-Ashi"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Outside-to-Ushiro-Ashi/Attacker"
    }
  ]
}
</script>
...
<p class="section-subtitle">What are the key principles for executing Outside to Ushiro Ashi?</p>
...
<p class="section-subtitle">What do you need before attempting Outside to Ushiro Ashi?</p>
...
<p class="section-subtitle">How do you execute Outside to Ushiro Ashi step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Outside to Ushiro Ashi?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Outside to Ushiro Ashi?</p>
...
<p class="section-subtitle">How do you train Outside to Ushiro Ashi (Attacker)?</p>

**Phase 1: Mechanics** - Solo hip rotation patterns and figure-four maintenance
Practice hip rotation mechanics with a stationary partner in Outside Ashi-Garami. Focus on following rotational movement patterns while maintaining tight figure-four configuration at walking speed with no resistance. Develop the motor pattern of hip-first following and progressive grip transitions.

**Phase 2: Cooperative Flow** - Partner flow drilling with slow inversion
Partner inverts slowly from Outside Ashi-Garami at 25% speed while the attacker follows with correct technique. Focus on leg triangle maintenance throughout the full rotation, progressive grip transitions, and arriving in consolidated Ushiro position. Reset and repeat for continuous repetitions each side.

**Phase 3: Progressive Resistance** - Follow mechanics against increasing resistance
...
Starting from Outside Ashi-Garami, partner freely attempts all available escapes including inversion, standing extraction, and counter-entanglement. Attacker works to maintain control and transition to Ushiro when inversion occurs, applying full-speed decision-making in 3-minute positional rounds.
...
<p class="section-subtitle">What are the safety concerns for Outside to Ushiro Ashi?</p>
