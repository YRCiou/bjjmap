...
---
title: "Outside to Ushiro Ashi Defender | BJJ Defense Guide | BJJ Map"
description: "Defend the Outside to Ushiro Ashi-Garami transition. Learn to recognize inversion follows, prevent Ushiro establishment, and escape leg entanglement effectively."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Outside to Ushiro Ashi in BJJ",
  "description": "Step-by-step guide for defending and countering Outside to Ushiro Ashi in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Accelerate inversion to turtle position before attacker can consolidate Ushiro Ashi-Garami configuration",
      "text": "When attacker's follow is delayed or their figure-four shows any looseness during rotation, indicating they cannot match your speed If successful: Escape leg entanglement entirely by completing full rotation to turtle, then work to stand or reguard from safer position",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Frame on attacker's hips with both hands to create separation and prevent hip-to-thigh follow during rotation",
      "text": "Early in rotation before attacker's follow is established, when you first detect their hips beginning to rotate with your movement If successful: Attacker cannot complete the follow and transition stalls, returning to original Outside Ashi-Garami position for another escape attempt",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Strip attacker's inside leg hook using both hands during the transitional moment when their leg configuration is adjusting",
      "text": "Mid-rotation when attacker is repositioning their outside leg and the inside leg hook is most vulnerable to removal If successful: Removing the inside leg hook collapses the entire figure-four structure, allowing complete leg extraction and escape from entanglement",
      "position": 3
    }
  ],
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Outside to Ushiro Ashi Defender",
  "description": "Defend the Outside to Ushiro Ashi-Garami transition. Learn to recognize inversion follows, prevent Ushiro establishment, and escape leg entanglement effectively.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Outside-to-Ushiro-Ashi/Defender"
    }
  ]
}
</script>
...
<p class="section-subtitle">How do you know when someone is attempting Outside to Ushiro Ashi?</p>
...
<p class="section-subtitle">What are the key principles for defending Outside to Ushiro Ashi?</p>
...
<p class="section-subtitle">What can you do to defend against Outside to Ushiro Ashi?</p>
...
<p class="section-subtitle">What is the best outcome when defending Outside to Ushiro Ashi?</p>
...
<p class="section-subtitle">What mistakes should you avoid when defending Outside to Ushiro Ashi?</p>
...
<p class="section-subtitle">How do you train defense against Outside to Ushiro Ashi?</p>

**Phase 1: Recognition** - Identifying attacker follow cues during inversion
Partner initiates the Ushiro transition from Outside Ashi at slow speed while you practice identifying the key follow cues: hip rotation, maintained inside hook pressure, and grip adjustment. Call out each cue as you detect it before the partner consolidates Ushiro position.

**Phase 2: Escape Mechanics** - Drilling each defensive option individually
Cooperative drilling of each defensive response (accelerated turtle completion, hip framing, inside leg strip) with partner following at 25% resistance. Focus on correct hand positioning, timing of each technique, and maintaining heel protection throughout every defensive option.

**Phase 3: Decision Making** - Selecting correct defensive response under pressure
Partner follows your inversion with 50% intensity using varying levels of control depth. Practice selecting the appropriate defensive response based on how tight their follow is and how deeply their control has progressed: frames for early follow, inside leg strip for mid-transition, turtle for deep follow.

**Phase 4: Live Situational Sparring** - Full resistance defensive application
Full resistance positional sparring starting from Outside Ashi-Garami where you attempt inversion escape and the attacker works to follow into Ushiro. Practice all defensive options under realistic conditions in 2-minute rounds with position resets.
