...
---
title: "Crossface to Combat Base Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Crossface to Combat Base in BJJ. Attacking perspective with setup, execution steps, and counters."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Crossface to Combat Base in BJJ",
  "description": "Step-by-step guide for executing Crossface to Combat Base from Half Guard/Top.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Secure crossface control",
      "text": "Drive your forearm blade across the opponent's face and neck, keeping continuous pressure that turns their head away from you. Your shoulder weight should be heavy, flattening them to their back and eliminating their ability to turn into you or create effective defensive frames.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Control far arm",
      "text": "Use your free hand to establish underhook on opponent's far arm or pin their wrist to the mat. This eliminates their primary framing tool and prevents them from recovering frames as you begin to move your hips. The arm control works in conjunction with crossface to create complete upper body dominance.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Create extraction angle",
      "text": "Walk your free foot toward opponent's head while keeping your trapped knee stationary initially. This shifts your body angle and creates the mechanical advantage needed to extract your trapped leg. Maintain forward pressure on the crossface throughout this adjustment to prevent opponent from following.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Extract trapped leg",
      "text": "Pull your trapped knee upward and backward in a circular arc, moving it up over opponent's bottom leg and then down and outward. This circular motion is critical as it works with the natural anatomy of their leg entanglement rather than against it. Keep weight forward on crossface during extraction.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Establish combat base stance",
      "text": "As your leg clears, immediately post that foot flat on the mat with knee raised, creating the combat base posture. Your other knee should be posted on the mat, creating the triangulated base characteristic of combat base. Do not rush past this position but establish it firmly.",
      "position": 5
    },
    {
      "@type": "HowToStep",
    ...
    {
      "@type": "HowToStep",
      "name": "Prepare passing options",
      "text": "From the established combat base, read opponent's defensive response to determine optimal passing pathway. Active hands control opponent's hips and legs while maintaining upright posture. Be ready to execute toreando, knee slice, or pressure pass based on how they defend and attempt guard recovery.",
      "position": 7
    }
  ],
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Crossface to Combat Base Attacker",
  "description": "How to execute Crossface to Combat Base in BJJ. Attacking perspective with setup, execution steps, and counters.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Crossface-to-Combat-Base/Attacker"
    }
  ]
}
</script>
...
<p class="section-subtitle">What are the key principles for executing Crossface to Combat Base?</p>
...
<p class="section-subtitle">What do you need before attempting Crossface to Combat Base?</p>
...
<p class="section-subtitle">How do you execute Crossface to Combat Base step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Crossface to Combat Base?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Crossface to Combat Base?</p>
...
<p class="section-subtitle">How do you train Crossface to Combat Base (Attacker)?</p>
...
<p class="section-subtitle">What are the safety concerns for Crossface to Combat Base?</p>
