...
---
title: "Toreando from Inverted | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Toreando from Inverted", "item": "https://bjjmap.pages.dev/Transitions/Toreando-from-Inverted" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Toreando from Inverted \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Speed passing drill session",
      "description": "Toreando from Inverted film study: Speed passing drill session, taught by Rafael Mendes.",
    ...
    },
    {
      ...
      "description": "Toreando from Inverted film study: Toreando pass with leg drag, taught by Lachlan Giles.",
    ...
    },
    {
      ...
      "description": "Toreando from Inverted film study: Three variations of the toreando pass, taught by Lachlan Giles.",
...
<p class="section-subtitle">Watch Toreando from Inverted in action — curated instructionals</p>
...
[[Toreando from Inverted/Attacker|→ Full Attacker Guide]]
...
[[Toreando from Inverted/Defender|→ Full Defender Guide]]
...
**Speed Toreando**: Rapid grip-and-redirect using shallow pant grips at the knee line rather than deep ankle grips, sacrificing maximum leverage for faster execution. The passer barely pauses after gripping, immediately driving the legs laterally and sprinting around the opponent's hip line in one continuous burst. (When to use: Against opponents with fast hip rotation who will track standard toreando timing, or when the opponent is mid-transition into inverted guard and has not fully established their position)


**Double Ankle Toreando with Lift**: Deep ankle cuff grips combined with a slight upward lift before the lateral redirection, temporarily unweighting the opponent's shoulders from the mat. The lift disrupts their rotation pivot point and creates a brief moment where they cannot track lateral movement because their connection to the mat is compromised. (When to use: Against heavier or less flexible opponents whose inversion relies on strong shoulder-to-mat pressure for rotation, or when standard lateral redirection alone is insufficient to break their centerline alignment)


**Toreando to Leg Drag Transition**: Begins as a standard toreando but transitions to leg drag control when the inverted player's near leg crosses their centerline. Instead of fully clearing both legs and circling to side control, the passer pins the near leg across the opponent's body in leg drag position, using the toreando momentum to flatten the inversion into a leg drag passing position. (When to use: When the opponent partially defends the toreando by hooking one leg but the other leg has already been redirected past centerline, creating a natural leg drag opportunity)
