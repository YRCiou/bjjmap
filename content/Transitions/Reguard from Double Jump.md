...
---
title: "Reguard from Double Jump | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Reguard from Double Jump", "item": "https://bjjmap.pages.dev/Transitions/Reguard-from-Double-Jump" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Reguard from Double Jump \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Merman guard retention",
      "description": "Reguard from Double Jump film study: Merman guard retention, taught by Erik Koehne.",
    ...
    },
    {
      ...
      "description": "Reguard from Double Jump film study: Getting to closed guard from half guard, taught by Lachlan Giles.",
    ...
    },
    {
      ...
      "description": "Reguard from Double Jump film study: Two ways to recover full guard from half guard, taught by BIG OSS Jiu-Jitsu.",
...
<p class="section-subtitle">Watch Reguard from Double Jump in action — curated instructionals</p>
...
| **Key Principles** | Establish defensive frames before initiating any leg movemen... | Maintain heavy chest-to-back pressure to eliminate the space... |
...
[[Reguard from Double Jump/Attacker|→ Full Attacker Guide]]
...
[[Reguard from Double Jump/Defender|→ Full Defender Guide]]
