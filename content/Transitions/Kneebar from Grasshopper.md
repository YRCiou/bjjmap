...
---
title: "Kneebar from Grasshopper | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kneebar from Grasshopper", "item": "https://bjjmap.pages.dev/Transitions/Kneebar-from-Grasshopper" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Kneebar from Grasshopper \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Inverted guard to kneebar",
      "description": "Kneebar from Grasshopper film study: Inverted guard to kneebar, taught by RKBJJ coach.",
    ...
    },
    {
      ...
      "description": "Kneebar from Grasshopper film study: Reverse closed guard leg attack entry, taught by Lachlan Giles.",
...
[[Kneebar from Grasshopper/Attacker|Play as Attacker]]
[[Kneebar from Grasshopper/Defender|Play as Defender]]
...
<p class="section-subtitle">Watch Kneebar from Grasshopper in action — curated instructionals</p>
...
| **Key Principles** | Hip positioning beneath opponent's knee creates the fulcrum ... | Early recognition beats late defense - identify the inversio... |
...
[[Kneebar from Grasshopper/Attacker|→ Full Attacker Guide]]
...
[[Kneebar from Grasshopper/Defender|→ Full Defender Guide]]
