...
---
title: "Sickle Sweep Defender | BJJ Defense Guide | BJJ Map"
description: "How to defend against the Sickle Sweep from De La Riva Guard in BJJ. Recognition cues, defensive options, and escape strategies for the standing passer."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Sickle Sweep in BJJ",
  "description": "Step-by-step guide for defending and countering Sickle Sweep in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Step far leg back and widen base while stripping collar grip",
      "text": "Early prevention - when you recognize the hip angle shift and collar grip establishment before the sickle motion begins If successful: Neutralize the sweep entirely and maintain your passing position with improved base, allowing you to restart your pass attempt",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Post hand firmly on the mat on the side you're being swept toward while maintaining low center of gravity",
      "text": "Mid-sweep reaction - when the sickle motion has already begun and you cannot widen base in time to prevent the off-balance If successful: Stop the sweep mid-execution and create an opportunity to reset your base or transition to a passing sequence",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Drop weight forward and drive hips into the guard player to flatten their angle and collapse the sweeping structure",
      "text": "When you feel the collar grip pulling you forward and the hook beginning to extend - use their own pull to drive into them If successful: Flatten the guard player's hips, killing the 45-degree angle and neutralizing both the hook leverage and the sickle motion",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Backstep over the De La Riva hook to extract your leg and immediately initiate a backstep pass",
      "text": "When you read the sweep setup early and want to counter-attack rather than simply defend, using their commitment against them If successful: Extract your leg from the hook entirely and land in a passing position behind the guard player's legs",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Sickle Sweep",
      "item": "https://bjjmap.pages.dev/Transitions/Sickle-Sweep"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Sickle-Sweep/Defender"
    }
  ]
}
</script>
...
<p class="section-subtitle">How do you know when someone is attempting Sickle Sweep?</p>
...
<p class="section-subtitle">What are the key principles for defending Sickle Sweep?</p>
...
<p class="section-subtitle">What can you do to defend against Sickle Sweep?</p>
...
<p class="section-subtitle">What is the best outcome when defending Sickle Sweep?</p>
...
<p class="section-subtitle">What mistakes should you avoid when defending Sickle Sweep?</p>
