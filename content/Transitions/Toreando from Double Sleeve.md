...
---
title: "Toreando from Double Sleeve | BJJ Technique | BJJ Map"
description: "Master the Toreando pass from Double Sleeve Guard. Step-by-step guide covering grip transitions, lateral passing mechanics, and side control finishing."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Toreando from Double Sleeve", "item": "https://bjjmap.pages.dev/Transitions/Toreando-from-Double-Sleeve" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Toreando from Double Sleeve \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Two ways to pass the collar-and-sleeve guard",
      "description": "Toreando from Double Sleeve film study: Two ways to pass the collar-and-sleeve guard, taught by Carpio Jiu Jitsu.",
    ...
    },
    {
      ...
      "description": "Toreando from Double Sleeve film study: C-grip toreando pass against the frame, taught by Isaac Doederlein.",
    ...
    },
    {
      ...
      "description": "Toreando from Double Sleeve film study: Double arm (sleeve) guard pass, taught by 10th Planet Costa Mesa.",
...
<p class="section-subtitle">Watch Toreando from Double Sleeve in action — curated instructionals</p>
...
[[Toreando from Double Sleeve/Attacker|→ Full Attacker Guide]]
...
[[Toreando from Double Sleeve/Defender|→ Full Defender Guide]]
...
**Standing Toreando**: Executed from full standing posture with wider lateral arc and greater momentum. Break both sleeve grips, immediately grab both pant legs at the knees, and use a wide matador-style swing to clear the legs before dropping to side control. (When to use: When opponent is flat on their back with limited hip mobility and you have space to move laterally)


**Grip-and-Go Toreando**: Combines grip breaking and passing into a single explosive movement. Strip one sleeve grip while simultaneously grabbing the same-side pant leg, then immediately redirect and pass before the opponent can re-establish grips or adjust foot placement. (When to use: When opponent has fatigued grips or you detect a momentary lapse in their sleeve tension)


**Kneeling Toreando**: Performed from combat base or kneeling posture with shorter lateral movement. Control both legs at the knees from kneeling, pin them to one side while sliding your knee across, and transition directly to side control without standing. (When to use: When standing is risky due to opponent's sweep threats or when you prefer low-posture passing)
