...
---
title: "Stack from Williams Guard Attacker | BJJ Technique Guide | BJJ Map"
description: "Learn to execute the Stack from Williams Guard as the attacker. Master stacking mechanics, pressure distribution, and arm extraction to pass Williams Guard."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Stack from Williams Guard in BJJ",
  "description": "Step-by-step guide for executing Stack from Williams Guard from Williams Guard/Top.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Secure base and protect shoulder alignment",
      "text": "From Williams Guard Top with your arm trapped in the shoulder lock, establish a wide base with both feet posted and your free hand controlling the bottom player's far hip. Ensure your controlled arm's shoulder is properly aligned with elbow bent close to your body to prevent submission completion during the forward drive.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Drop hips and initiate forward pressure",
      "text": "Lower your center of gravity by dropping your hips toward the mat while beginning to drive forward with your chest and shoulder. Direct initial pressure into the bottom player's thigh and hip on the controlled arm side, beginning to compress their guard structure and limit their hip mobility.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Walk feet forward in controlled increments",
      "text": "Take small, deliberate steps forward with both feet, advancing your hips past the bottom player's centerline. Each step increases the stacking angle, progressively folding the bottom player's hips toward their head and reducing their ability to generate the hip mobility needed for shoulder lock leverage.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Control opponent's hip angle with free hand",
      "text": "Use your free hand to push the bottom player's far hip toward the mat or toward their head, preventing lateral hip escape which is the primary defense against the stack. Keep constant hip control pressure to ensure the stacking angle continues to steepen with each forward step.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Drive shoulder through to collapse guard structure",
      "text": "Commit your shoulder and chest weight forward through the bottom player's leg barrier, folding their guard structure completely. The increasing compression on the shoulder lock grip creates a mechanical dilemma where maintaining the grip becomes structurally untenable as their hips elevate over their shoulders.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Extract trapped arm using circular motion",
      "text": "As the stacking pressure forces the bottom player's grip to weaken or release entirely, immediately extract your trapped arm using a circular motion away from the lock direction. Rotate your elbow outward rather than pulling straight back, as linear pulling can re-engage the shoulder lock mechanism.",
      "position": 6
    },
    {
      "@type": "HowToStep",
      "name": "Consolidate to half guard top position",
      "text": "Upon freeing your arm, immediately establish crossface control with the freed arm and drop your hips to secure half guard top position. Prevent the bottom player from recovering guard by maintaining heavy shoulder pressure into their jaw line and controlling their hip movement to set up your preferred passing sequence.",
      "position": 7
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the optimal timing window to initiate the stack from Williams Guard?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Stack from Williams Guard Attacker",
  "description": "Learn to execute the Stack from Williams Guard as the attacker. Master stacking mechanics, pressure distribution, and arm extraction to pass Williams Guard.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Stack-from-Williams-Guard"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Stack-from-Williams-Guard/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Stack from Williams Guard (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Closed guard stack pass in live rolling",
      "description": "Stack from Williams Guard (Attacker) film study: Closed guard stack pass in live rolling, taught by Roll 247.",
    ...
    },
    {
      ...
      "description": "Stack from Williams Guard (Attacker) film study: Stack pass variation from open guard, taught by Scott Ryan Chiriboga.",
...
<p class="section-subtitle">Watch Stack from Williams Guard (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Stack from Williams Guard?</p>
...
<p class="section-subtitle">What do you need before attempting Stack from Williams Guard?</p>
...
<p class="section-subtitle">How do you execute Stack from Williams Guard step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Stack from Williams Guard?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Stack from Williams Guard?</p>
...
<p class="section-subtitle">How do you train Stack from Williams Guard (Attacker)?</p>

**Phase 1: Mechanics** - Stacking motion and pressure distribution
Practice the basic stacking motion against a compliant partner. Focus on controlled hip walking, shoulder alignment protection, and free hand hip control. No resistance. Drill 20 repetitions per side focusing on smooth, progressive pressure application.

**Phase 2: Timing and Recognition** - Reading opponent's grip and initiating at optimal moments
Partner maintains Williams Guard with varying levels of shoulder lock pressure. Practice identifying the optimal moment to initiate the stack based on partner's grip commitment level. Begin adding light resistance at 30-40% intensity.

**Phase 3: Counter Integration** - Responding to defensive reactions during the stack
Partner actively defends using hip escape, grip release, and omoplata attempts at 50-60% resistance. Practice adjusting the stack in real time and transitioning to alternative passes when the stack is effectively defended.

**Phase 4: Live Application** - Full positional sparring from Williams Guard
Start in Williams Guard Top with full resistance. Integrate the stack with other passing options including arm extraction, posture recovery, and knee slice passes. Develop pattern recognition for when the stack is the optimal choice versus alternative approaches.
...
<p class="section-subtitle">What are the safety concerns for Stack from Williams Guard?</p>
