...
---
title: "Shin to Shin Pull Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Shin to Shin Pull in BJJ. Attacking perspective with setup, execution steps, and counters."
---
...
<script type="application/ld+json">
{
  ...
  "description": "Step-by-step guide for executing Shin to Shin Pull from Standing Position/Top.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish primary grip control",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Shin to Shin Pull Attacker",
  "description": "How to execute Shin to Shin Pull in BJJ. Attacking perspective with setup, execution steps, and counters.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Shin-to-Shin-Pull/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Shin to Shin Pull (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Shin to Shin Guard entry and grips",
      "description": "Shin to Shin Pull (Attacker) film study: Shin to Shin Guard entry and grips, taught by RGA South Herts coach.",
    ...
    },
    {
      ...
      "description": "Shin to Shin Pull (Attacker) film study: De La Riva to shin-on-shin to the back, taught by Carpio Jiu Jitsu coach.",
...
<p class="section-subtitle">Watch Shin to Shin Pull (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Shin to Shin Pull?</p>
...
<p class="section-subtitle">What do you need before attempting Shin to Shin Pull?</p>
...
<p class="section-subtitle">How do you execute Shin to Shin Pull step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Shin to Shin Pull?</p>

- **Opponent steps back and disengages their leg from shin connection** (Effectiveness: Medium) - Your Response: Follow their backward movement by scooting forward or technical standing up to maintain connection. You can also transition to a standing guard pull or switch to butterfly hooks if they create too much distance. → Leads to [[Positions/Standing Position]]
...
<p class="section-subtitle">What mistakes should you avoid when executing Shin to Shin Pull?</p>

### 1. Pulling to guard without establishing shin connection first
...
### 2. Using only shin pressure without grip control on opponent's upper body
...
### 3. Allowing opponent to settle into static top position after pull
...
### 4. Keeping free leg passive or inactive during the pull
...
### 5. Pulling when opponent has overwhelming forward momentum
...
### 6. Collapsing backward with rounded spine during pull execution
...
<p class="section-subtitle">How do you train Shin to Shin Pull (Attacker)?</p>
