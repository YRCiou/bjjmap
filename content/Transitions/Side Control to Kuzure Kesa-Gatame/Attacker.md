...
---
title: "Side Control to Kuzure Kesa-Gatame Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute the transition from side control to Kuzure Kesa-Gatame in BJJ. Complete attacker guide with arm isolation, hip shift, and troubleshooting."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Side Control to Kuzure Kesa-Gatame in BJJ",
  "description": "Step-by-step guide for executing Side Control to Kuzure Kesa-Gatame from Side Control/Top.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Create access to the near arm",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Side Control to Kuzure Kesa-Gatame Attacker",
  "description": "How to execute the transition from side control to Kuzure Kesa-Gatame in BJJ. Complete attacker guide with arm isolation, hip shift, and troubleshooting.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Side-Control-to-Kuzure-Kesa-Gatame/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Side Control to Kuzure Kesa-Gatame (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Kuzure Kesa Gatame (broken scarf hold) no-gi demo",
      "description": "Side Control to Kuzure Kesa-Gatame (Attacker) film study: Kuzure Kesa Gatame (broken scarf hold) no-gi demo, taught by Sampson Judo.",
    ...
    },
    {
      ...
      "description": "Side Control to Kuzure Kesa-Gatame (Attacker) film study: Kuzure Kesa Gatame study and application, taught by Judo Life.",
...
<p class="section-subtitle">Watch Side Control to Kuzure Kesa-Gatame (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Side Control to Kuzure Kesa-Gatame?</p>
...
<p class="section-subtitle">What do you need before attempting Side Control to Kuzure Kesa-Gatame?</p>
...
<p class="section-subtitle">How do you execute Side Control to Kuzure Kesa-Gatame step by step?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Side Control to Kuzure Kesa-Gatame?</p>
...
<p class="section-subtitle">How do you train Side Control to Kuzure Kesa-Gatame (Attacker)?</p>

**Week 1-2: Static Position Familiarization** - Learning the Kuzure Kesa-Gatame end position and the feel of the arm trap
Partner allows you to establish the modified scarf hold from a static start. Focus on the depth and tightness of the armpit clamp, the two-point control at shoulder and wrist, the angle of hip pressure, and the wide far-leg base. Hold for 60-second rounds with zero resistance and drill 10-15 entries from already-established side control to develop the feel of proper weight distribution and arm isolation.

**Week 3-4: Capture and Shift Mechanics from Side Control** - Developing the arm scoop and hip shift while maintaining pressure
...
<p class="section-subtitle">What are the safety concerns for Side Control to Kuzure Kesa-Gatame?</p>
