...
---
title: "Roll to Deep Half Guard Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Roll to Deep Half Guard in BJJ. Attacking perspective with setup, execution steps, and counters for escaping buggy choke."
---
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the primary goal of Roll to Deep Half Guard?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The primary goal is to escape the buggy choke submission threat while simultaneously establishing an offensive guard position. Unlike other escapes that return to neutral positions, this transition converts defense into immediate sweeping and leg attack opportunities from deep half guard, punishing the opponent for overcommitting to the choke."
      }
    },
    {
      "@type": "Question",
      "name": "Why must you roll toward the opponent's leg rather than away from choking pressure?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Rolling away from pressure exposes your back directly to the opponent and eliminates all guard recovery options. Rolling toward the trapped leg uses the opponent's grip structure against them—their choking commitment compromises their base in that direction, and the roll leads into an established guard position rather than an undefined scramble."
      }
    },
    {
      "@type": "Question",
      "name": "What is the optimal timing window for attempting this escape?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The optimal window is when the opponent has established their buggy choke grips but has not yet consolidated full body pressure. During this phase, they are committed to finishing the choke with forward pressure, which compromises their base and creates vulnerability to rotational escapes. Once flattened with full pressure, this escape becomes very low percentage."
      }
    },
    {
      "@type": "Question",
      "name": "Your opponent sprawls during your roll attempt - how should you respond?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "If you recognize the sprawl early, abort the roll and transition to an alternative escape like sitting to half guard or grip fighting. Once the opponent sprawls, the rolling angle is blocked and forcing the technique will expose your back. The sprawl counter must be recognized during the initiation phase, not mid-roll when aborting is more difficult."
      }
    },
    {
      "@type": "Question",
      "name": "What grips must be established during the rolling motion to ensure deep half entry?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You must secure opponent's near leg at the thigh level with both arms forming a gable grip or seatbelt configuration around the trapped leg. This grip must be established during the rotation itself, not after completion. Without this grip, the roll lands in an undefined scramble rather than deep half guard, and the opponent easily recovers."
      }
    },
    {
      "@type": "Question",
      "name": "How do the hooks function in position consolidation after the roll?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The bottom leg inserts as a hook behind opponent's trapped leg to control their knee line and prevent leg extraction. The top leg positions as a controlling hook on their hip or lower back to maintain distance and off-balance them toward the trapped side. Together these hooks enable sweeping mechanics and prevent the opponent from recovering top position."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Roll to Deep Half Guard Attacker",
  "description": "How to execute Roll to Deep Half Guard in BJJ. Attacking perspective with setup, execution steps, and counters for escaping buggy choke.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Roll-to-Deep-Half-Guard/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Roll to Deep Half Guard (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Entering deep half guard from knee on belly",
      "description": "Roll to Deep Half Guard (Attacker) film study: Entering deep half guard from knee on belly, taught by Team Daruma Dojo.",
    ...
    },
    {
      ...
      "description": "Roll to Deep Half Guard (Attacker) film study: Entry to deep half guard, taught by Lucas Valle.",
    ...
    },
    {
      ...
      "description": "Roll to Deep Half Guard (Attacker) film study: Pulling deep half guard into the Faria sweep, taught by Bernardo Faria.",
...
<p class="section-subtitle">Watch Roll to Deep Half Guard (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Roll to Deep Half Guard?</p>
...
<p class="section-subtitle">What do you need before attempting Roll to Deep Half Guard?</p>
...
<p class="section-subtitle">How do you execute Roll to Deep Half Guard step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Roll to Deep Half Guard?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Roll to Deep Half Guard?</p>
...
<p class="section-subtitle">How do you train Roll to Deep Half Guard (Attacker)?</p>

**Week 1-2** - Rolling mechanics and direction
...
**Week 5-6** - Hook consolidation and counter awareness
...
<p class="section-subtitle">What are the safety concerns for Roll to Deep Half Guard?</p>
