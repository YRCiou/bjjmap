...
---
title: "Armbar from North-South | BJJ Technique | BJJ Map"
description: "Master the Armbar from North-South in BJJ. Complete guide covering setup from North-South position, execution steps, counters, and defensive strategies."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Armbar from North-South", "item": "https://bjjmap.pages.dev/Transitions/Armbar-from-North-South" }
  ]
}
</script>
...
| **Key Principles** | Isolate the near-side arm before initiating any rotational m... | Keep elbows tight to your ribs at all times during North-Sou... |
...
[[Armbar from North-South/Attacker|→ Full Attacker Guide]]
...
[[Armbar from North-South/Defender|→ Full Defender Guide]]
...
- [[Submissions/Armbar/from Armbar Control]] - Follow-up finish submission from Armbar Control
...
- [[Submissions/Armbar/from Crucifix]] - Related armbar entry from alternative controlling position
...
- [[Transitions/Hitchhiker Escape from Armbar]] - Primary defensive escape the attacker must counter
