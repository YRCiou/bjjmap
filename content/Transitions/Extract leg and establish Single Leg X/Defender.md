...
---
title: "Extract leg and establish Single Leg X Defender | BJJ Defense Guide | BJJ Map"
description: "How to defend against leg extraction to Single Leg X-Guard in BJJ. Recognition cues, retention tactics, and counter-attack strategies from Leg Knot Top."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Extract leg and establish Single Leg X in BJJ",
  "description": "Step-by-step guide for defending and countering Extract leg and establish Single Leg X in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Drive forward with heavy hip pressure and sprawl to pin opponent's hips flat against the mat, eliminating rotation angles",
      "text": "When you detect early signs of hip rotation or free leg framing activity indicating extraction is being set up If successful: Opponent's extraction attempt is stuffed, they remain in Leg Knot Bottom, and you can advance your own leg lock attacks",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Tighten leg crossing and immediately re-attack with submission as opponent begins extraction, forcing them to abandon escape to defend",
      "text": "When opponent's leg begins sliding through the entanglement and you feel control loosening despite your attempts to maintain it If successful: Opponent is forced back into defending submission threats and you advance to tighter Saddle configuration during their moment of vulnerability",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Disengage your own leg and immediately sprawl to top passing position before opponent can establish Single Leg X-Guard hooks",
      "text": "When extraction is largely complete and opponent's leg is nearly free, making retention of the entanglement impractical If successful: You escape the leg entanglement exchange entirely and achieve a top passing position where you dictate the engagement",
      "position": 3
    }
  ],
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Extract leg and establish Single Leg X Defender",
  "description": "How to defend against leg extraction to Single Leg X-Guard in BJJ. Recognition cues, retention tactics, and counter-attack strategies from Leg Knot Top.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Extract-leg-and-establish-Single-Leg-X/Defender"
    }
  ]
}
</script>
...
<p class="section-subtitle">How do you know when someone is attempting Extract leg and establish Single Leg X?</p>
...
<p class="section-subtitle">What are the key principles for defending Extract leg and establish Single Leg X?</p>
...
<p class="section-subtitle">What can you do to defend against Extract leg and establish Single Leg X?</p>
...
<p class="section-subtitle">What is the best outcome when defending Extract leg and establish Single Leg X?</p>
...
<p class="section-subtitle">What mistakes should you avoid when defending Extract leg and establish Single Leg X?</p>
...
<p class="section-subtitle">How do you train defense against Extract leg and establish Single Leg X?</p>
...
**Week 3-4** - Counter-attack integration
Partner attempts extraction at moderate speed. Practice transitioning from retention to counter-attack by advancing to Saddle when extraction creates angle opportunities. Develop the timing to recognize when retention is failing and when to capitalize offensively instead. Add submission threats during extraction attempts to force opponent back to defense.

**Week 5-6** - Disengagement and reset tactics
Partner executes full-speed extractions while defender practices all three defensive options: retain, advance to Saddle, or disengage to top. Develop decision-making for which option to use based on how far the extraction has progressed. Practice seamless transitions between defensive strategies.

**Week 7+** - Live positional sparring
Full resistance rounds starting from Leg Knot with both players working their systems. Top player practices proactive control maintenance with no transitional windows while recognizing and responding to extraction attempts. Track how often bottom player achieves Single Leg X versus being retained or countered.
