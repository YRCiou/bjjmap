...
---
title: "Triangle Setup from De La Riva | BJJ Technique | BJJ Map"
description: "Master the Triangle Setup from De La Riva Guard in BJJ. Complete guide to arm isolation, posture breaking, and triangle lock mechanics using DLR hooks."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Triangle Setup from De La Riva", "item": "https://bjjmap.pages.dev/Transitions/Triangle-Setup-from-De-La-Riva" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Triangle Setup from De La Riva \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Triangle from De La Riva guard",
      "description": "Triangle Setup from De La Riva film study: Triangle from De La Riva guard, taught by Nartay Kazhekov.",
    ...
    },
    {
      ...
      "description": "Triangle Setup from De La Riva film study: Rafael Mendes triangle choke setup, taught by Rafael Mendes.",
...
<p class="section-subtitle">Watch Triangle Setup from De La Riva in action — curated instructionals</p>
...
| **Key Principles** | Use the DLR hook to anchor the opponent in range while you c... | Keep both elbows pinched tight to your ribcage and inside th... |
...
[[Triangle Setup from De La Riva/Attacker|→ Full Attacker Guide]]
...
[[Triangle Setup from De La Riva/Defender|→ Full Defender Guide]]
