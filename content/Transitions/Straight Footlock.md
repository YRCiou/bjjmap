...
---
title: "Straight Footlock | BJJ Technique | BJJ Map"
description: "Master the Straight Footlock finish in BJJ. Complete guide to ankle lock finishing mechanics, hip extension technique, and defensive strategies from control."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Straight Footlock", "item": "https://bjjmap.pages.dev/Transitions/Straight-Footlock" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Straight Footlock",
  "description": "The Straight Footlock is the committed finishing sequence from Straight Ankle Lock Control that breaks the ankle by driving hip extension and a back arch through a forearm blade seated behind the Achilles while the trapped heel is pinned to the chest.",
...
**The Straight Footlock is the committed finishing sequence from Straight Ankle Lock Control that breaks the ankle by driving hip extension and a back arch through a forearm blade seated behind the Achilles while the trapped heel is pinned to the chest.**
...
| **Key Principles** | Hip extension generates the primary finishing force, not arm... | Address the most time-critical threat first: if extension ha... |
...
[[Straight Footlock/Attacker|→ Full Attacker Guide]]
...
[[Straight Footlock/Defender|→ Full Defender Guide]]
