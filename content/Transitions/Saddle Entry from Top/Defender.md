...
---
title: "Saddle Entry from Top Defender | BJJ Defense Guide | BJJ Map"
description: "How to defend against Saddle Entry from Top in BJJ. Recognition cues, defensive options, and escape strategies to prevent leg entanglement."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Saddle Entry from Top in BJJ",
  "description": "Step-by-step guide for defending and countering Saddle Entry from Top in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Immediately retract near leg by pulling knee to chest and turning hip away from attacker",
      "text": "At the earliest stage when opponent first grips your leg before the step-over begins If successful: Denies the entry entirely and resets to standard guard passing scenario where you retain defensive guard structure",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Frame on opponent's hip with far leg and push to create distance while stripping ankle grip with hands",
      "text": "When opponent has gripped your leg but has not yet stepped over - prevents the angle creation phase If successful: Creates enough distance to free your leg and recover guard position with opponent still in top passing position",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Sit up aggressively and attack opponent's upper body with underhook or collar tie while they focus on leg control",
      "text": "During the step-over phase when opponent's hands are committed to leg control and their posture is compromised If successful: Forces opponent to abandon leg entry to defend upper body attack, often resulting in scramble where you can recover to neutral or take top position",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Bring far leg over opponent's head and body to clear the knee line before entanglement completes",
      "text": "During the threading phase when opponent has stepped over but has not yet locked their feet together If successful: Clears your knee past their leg configuration, preventing the saddle from locking and allowing guard recovery",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Invert and roll through the entanglement to face opponent before saddle locks",
      "text": "As a last resort when the step-over is nearly complete but feet are not yet locked If successful: Reverses the angle of entanglement and can create scramble opportunities or transition to counter-entanglement",
      "position": 5
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "Why is extending your leg to fight the step-over a common but dangerous defensive mistake?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How should you use your far leg throughout the saddle entry defense sequence?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Saddle Entry from Top Defender",
  "description": "How to defend against Saddle Entry from Top in BJJ. Recognition cues, defensive options, and escape strategies to prevent leg entanglement.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Saddle-Entry-from-Top"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Saddle-Entry-from-Top/Defender"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Saddle Entry from Top (Defender) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Defending heel hooks from the saddle",
      "description": "Saddle Entry from Top (Defender) film study: Defending heel hooks from the saddle, taught by Lachlan Giles.",
    ...
    },
    {
      ...
      "description": "Saddle Entry from Top (Defender) film study: Leg lock defense basics, taught by 10th Planet coach.",
...
<p class="section-subtitle">Watch Saddle Entry from Top (Defender) in action — curated instructionals</p>
...
<p class="clip-credit"><strong>Defending heel hooks from the saddle</strong> — taught by Lachlan Giles · 1:32 · <a href="https://www.youtube.com/watch?v=v3w0qXLKxug" rel="noopener">Watch on YouTube</a></p>
...
<p class="clip-credit"><strong>Leg lock defense basics</strong> — taught by 10th Planet coach · 1:01 · <a href="https://www.youtube.com/watch?v=m0NLphEuFoc" rel="noopener">Watch on YouTube</a></p>
...
<p class="section-subtitle">How do you know when someone is attempting Saddle Entry from Top?</p>
...
<p class="section-subtitle">What are the key principles for defending Saddle Entry from Top?</p>
...
<p class="section-subtitle">What can you do to defend against Saddle Entry from Top?</p>
...
<p class="section-subtitle">What is the best outcome when defending Saddle Entry from Top?</p>
...
<p class="section-subtitle">What mistakes should you avoid when defending Saddle Entry from Top?</p>
...
<p class="section-subtitle">How do you train defense against Saddle Entry from Top?</p>

**Phase 1: Recognition and Early Defense (Weeks 1-2)** - Learning to identify saddle entry setups and practicing immediate leg retraction
Partner telegraphs saddle entry attempts from various top positions. Defender practices recognizing the two-handed leg grip and step-over cues, then executes immediate knee retraction and hip turning. No resistance from attacker beyond initial grip. Focus on reaction speed and correct defensive mechanics at the earliest stage of the entry.

**Phase 2: Mid-Entry Defense Drilling (Weeks 3-4)** - Defending during the step-over and threading phases with increasing resistance
Partner executes entries at progressively faster speeds while defender practices far-leg framing, knee-line clearing, and sit-up counters at each phase. Start with known timing and build toward responding to unpredictable entry timing. Connect early defense failures to mid-entry defensive options so defender learns the full timeline.

**Phase 3: Post-Lock Survival and Escape (Weeks 5-6)** - Systematic escape from fully locked saddle position
Start with saddle already locked at various tightness levels. Practice heel protection, grip fighting, hip clearing, and methodical leg extraction. Emphasize safe movement patterns that reduce joint stress. Include tap recognition training for situations where escape is no longer technically possible.

**Phase 4: Live Integration (Weeks 7-12)** - Defending saddle entries during live guard retention against leg lock specialists
Situational sparring starting from guard positions where top player actively hunts saddle entries alongside passing attempts. Defender works preventive leg management, early recognition, and full defensive sequence against committed entries. Progress to open rolling where saddle entry defense is tested against complete game plans.
