...
---
title: "X-Guard Technical Stand Up Attacker | BJJ Technique Guide | BJJ Map"
description: "Learn to execute the X-Guard Technical Stand Up with step-by-step posting mechanics, hip drive timing, and single leg control for reaching dominant standing position from X-Guard bottom."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute X-Guard Technical Stand Up in BJJ",
  "description": "Step-by-step guide for executing X-Guard Technical Stand Up from X-Guard/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Elevate and off-balance opponent",
      "text": "From X-Guard bottom, elevate your hips and extend both legs to push opponent's weight backward onto their heels, creating momentary instability that freezes their ability to attack or reposition. This elevation is the critical setup that buys time for the posting phase.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Post base hand behind hip",
      "text": "While maintaining leg control, post your free hand behind your hip on the mat with fingers pointing away from your body, creating a stable base point for the stand-up drive. Keep the posting arm close to your body for structural strength rather than reaching far behind you.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Shallow the inside hook",
      "text": "Slide your inside hook from deep behind the opponent's knee to a shallower position around the ankle or lower calf, creating space for your hip to travel forward while maintaining enough leg contact to prevent the opponent from simply stepping away or disengaging.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Drive hips forward and upward",
      "text": "Using the posted hand as a pivot point, drive your hips forward and upward by extending your posting arm and pushing through your feet. Bring your center of gravity under your shoulders in one smooth arc rather than jerking upward, generating power from hip extension rather than arm pull.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Establish standing base",
      "text": "Plant your free foot firmly on the mat and transfer weight to a full standing position while keeping your other foot's hook active on the opponent's leg to maintain control throughout the transition. Both feet should be firmly planted before releasing any remaining hook contact.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Secure single leg control",
      "text": "Once standing, immediately consolidate control of the opponent's trapped leg by transitioning your grips to a proper single leg hold with your head positioned on the inside of their thigh, creating immediate takedown pressure and denying them the ability to recover guard grips.",
      "position": 6
    },
    {
      "@type": "HowToStep",
      "name": "Execute follow-up attack",
      "text": "With the opponent's leg controlled in standing, drive forward to complete a single leg takedown finish, attack the far ankle for an ankle pick, or release the leg to establish dominant standing position with grip advantage, selecting based on the opponent's defensive reaction.",
      "position": 7
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the optimal timing window for initiating the technical stand up from X-Guard?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Your opponent grabs your collar and pulls downward as you begin to post - how do you adjust?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Why is this technique considered lower risk than committing to a full X-Guard sweep?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "X-Guard Technical Stand Up Attacker",
  "description": "Learn to execute the X-Guard Technical Stand Up with step-by-step posting mechanics, hip drive timing, and single leg control for reaching dominant standing position from X-Guard bottom.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/X-Guard-Technical-Stand-Up"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/X-Guard-Technical-Stand-Up/Attacker"
    }
  ]
}
</script>
...
<p class="section-subtitle">What are the key principles for executing X-Guard Technical Stand Up?</p>
...
<p class="section-subtitle">What do you need before attempting X-Guard Technical Stand Up?</p>
...
<p class="section-subtitle">How do you execute X-Guard Technical Stand Up step by step?</p>
...
<p class="section-subtitle">How might your opponent counter X-Guard Technical Stand Up?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing X-Guard Technical Stand Up?</p>
...
<p class="section-subtitle">How do you train X-Guard Technical Stand Up (Attacker)?</p>

**Phase 1: Solo Mechanics** - Technical stand-up posting and hip drive
Practice the technical stand-up movement solo without a partner, focusing on smooth posting, hip drive forward, and arriving on your feet with balanced base. Perform 20 repetitions per side, emphasizing fluid motion from seated to standing. Build muscle memory for the posting hand position and hip arc.

**Phase 2: Cooperative Integration** - Combining X-Guard hooks with stand-up sequence
Partner establishes standing position while you set up X-Guard. Practice the complete sequence from hook establishment through elevation, posting, and stand-up at slow speed with no resistance. Focus on maintaining hook control throughout the transition and arriving with proper single leg grip. 15 repetitions per side.

**Phase 3: Progressive Resistance** - Timing and counter adjustment under pressure
Partner provides increasing resistance at 30%, 50%, then 70% by pulling collar grips, posting to prevent stand-up, and attempting to maintain base. Develop timing for the elevation-to-stand sequence and learn to adjust when resistance is encountered at different phases. Five-minute rounds at each resistance level.

**Phase 4: Live Positional Sparring** - Decision-making and chain integration
...
<p class="section-subtitle">What are the safety concerns for X-Guard Technical Stand Up?</p>
