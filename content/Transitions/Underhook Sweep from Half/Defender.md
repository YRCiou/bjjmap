...
---
title: "Underhook Sweep from Half Defender | BJJ Defense Guide | BJJ Map"
description: "How to defend against Underhook Sweep from Half in BJJ. Recognition cues, defensive options, and escape strategies."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Underhook Sweep from Half in BJJ",
  "description": "Step-by-step guide for defending and countering Underhook Sweep from Half in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish deep whizzer over the underhook arm by threading your arm over their bicep and gripping your own thigh or their hip, then drive your shoulder weight down to flatten them",
      "text": "Immediately when opponent establishes underhook before they create significant angle or load their hips If successful: Opponent's underhook is neutralized and they are driven flat on their back, removing their angle and sweeping leverage entirely",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Post your far leg out wide at a 45-degree angle with your foot firmly on the mat, creating a wide triangular base that prevents being tipped over the sweeping trajectory",
      "text": "When you feel the sweep being loaded and your weight shifting toward the underhook side, or preemptively when opponent has established angle If successful: The wide base absorbs the sweeping force and prevents the reversal, allowing you to reset your passing position and re-engage",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Drive heavy crossface pressure by dropping your shoulder into opponent's jaw and neck while sprawling your hips back, flattening their shoulders to the mat",
      "text": "As a preventive measure before opponent establishes angle, or to counter early-stage sweep attempts before the explosive phase If successful: Opponent is flattened with shoulders on the mat, eliminating the side angle necessary for sweep mechanics and opening passing opportunities",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Strip the far hip grip by peeling opponent's hand off your hip or pants and pinning it to the mat, then immediately resume passing pressure",
      "text": "When you feel opponent's hand grip your far hip, belt, or pants during the setup phase before they combine it with the underhook drive If successful: Without the far hip grip, opponent cannot prevent your base leg from posting, and the sweep loses a critical control element",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How should you adjust your passing strategy after successfully defending an underhook sweep attempt?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Underhook Sweep from Half Defender",
  "description": "How to defend against Underhook Sweep from Half in BJJ. Recognition cues, defensive options, and escape strategies.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Underhook-Sweep-from-Half"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Underhook-Sweep-from-Half/Defender"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Underhook Sweep from Half (Defender) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Stop the half guard underhook before the sweep",
      "description": "Underhook Sweep from Half (Defender) film study: Stop the half guard underhook before the sweep, taught by Malachy Friedman.",
    ...
    },
    {
      "@type": "VideoObject",
      "position": 2,
      "name": "Countering the half guard underhook",
      "description": "Underhook Sweep from Half (Defender) film study: Countering the half guard underhook, taught by Holy Grail BJJ coach.",
    ...
    },
    {
      "@type": "VideoObject",
      "position": 3,
      "name": "How to beat the underhook in half guard",
      "description": "Underhook Sweep from Half (Defender) film study: How to beat the underhook in half guard, taught by Rituals Jiu Jitsu coach.",
      "thumbnailUrl": "https://i.ytimg.com/vi/BoPodHPmDYY/hqdefault.jpg",
      "embedUrl": "https://www.youtube.com/embed/BoPodHPmDYY",
      "url": "https://www.youtube.com/watch?v=BoPodHPmDYY",
...
<p class="section-subtitle">Watch Underhook Sweep from Half (Defender) in action — curated instructionals</p>
...
<p class="clip-credit"><strong>Stop the half guard underhook before the sweep</strong> — taught by Malachy Friedman · 1:38 · <a href="https://www.youtube.com/watch?v=dOdO6xJ-TcU" rel="noopener">Watch on YouTube</a></p>
...
<p class="clip-credit"><strong>Countering the half guard underhook</strong> — taught by Holy Grail BJJ coach · 2:06 · <a href="https://www.youtube.com/watch?v=Zy88ds_RDG4" rel="noopener">Watch on YouTube</a></p>

</div>

<div class="film-clip">

![](https://www.youtube.com/watch?v=BoPodHPmDYY)

<p class="clip-credit"><strong>How to beat the underhook in half guard</strong> — taught by Rituals Jiu Jitsu coach · 3:55 · <a href="https://www.youtube.com/watch?v=BoPodHPmDYY" rel="noopener">Watch on YouTube</a></p>
...
<p class="section-subtitle">How do you know when someone is attempting Underhook Sweep from Half?</p>
...
<p class="section-subtitle">What are the key principles for defending Underhook Sweep from Half?</p>
...
<p class="section-subtitle">What can you do to defend against Underhook Sweep from Half?</p>
...
<p class="section-subtitle">What is the best outcome when defending Underhook Sweep from Half?</p>
...
<p class="section-subtitle">What mistakes should you avoid when defending Underhook Sweep from Half?</p>
...
<p class="section-subtitle">How do you train defense against Underhook Sweep from Half?</p>

**Phase 1: Recognition Drilling (Weeks 1-2)** - Identifying sweep setup cues
...
**Phase 2: Defensive Response Drilling (Weeks 2-4)** - Executing individual defensive techniques
...
**Phase 3: Combined Defense with Counters (Weeks 4-6)** - Chaining defensive responses and counter-attacking
Partner attempts underhook sweep at 75% resistance. Top player practices combining multiple defensive elements (whizzer plus crossface, leg post plus grip strip) and immediately transitioning to passing sequences after successful defense. Develop the habit of counter-attacking rather than simply surviving.

**Phase 4: Positional Sparring (Weeks 6-10)** - Live defense integration
Full-speed positional rounds starting from half guard top. Bottom player actively works underhook sweeps and chain attacks while top player practices defensive recognition and counter-passing. Three-minute rounds with reset after sweep completion or pass completion. Track defensive success rate and identify which sweep variations give you the most difficulty.
