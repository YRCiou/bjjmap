...
---
title: "Pass Pocket Half Attacker | BJJ Technique Guide | BJJ Map"
description: "Learn to pass the Pocket Half Guard with systematic pressure techniques. Step-by-step execution for completing the pass to side control from underhook dominance."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Pass Pocket Half in BJJ",
  "description": "Step-by-step guide for executing Pass Pocket Half from Pocket Half Guard/Top.",
  "step": [
    {
      "@type": "HowToStep",
    ...
    {
      "@type": "HowToStep",
      "name": "Collapse the Pocket Space",
    ...
    },
    {
      ...
      "text": "With the pocket space collapsed, increase forward pressure to drive the opponent's shoulders flat to the mat. Their ability to maintain an angle on their side is their primary defensive asset—eliminating this angle removes their sweep mechanics and back take entries. You should feel their body going flat underneath your weight.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Isolate the Trapped Leg",
      "text": "Begin separating the trapped leg from the opponent's entanglement by walking your free foot toward their hip in small steps. Use your posted leg to create a base angle that allows you to shift weight slightly toward their head while your trapped leg begins working free. Keep hips heavy throughout this adjustment.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Extract Through Knee Slide or Backstep",
      "text": "Drive your trapped knee diagonally across the opponent's thigh using a knee slice angle, or rotate your hips to backstep the leg free. The extraction must be smooth and controlled rather than explosive—jerky movements create the space and momentum the bottom player needs for sweeps. Maintain constant upper body pressure during extraction.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Clear the Legs Completely",
      "text": "Once the knee passes the opponent's thigh line, continue sliding or stepping until your leg is entirely free of their guard. Do not pause halfway through—a partially extracted leg is the most vulnerable position for reguarding and sweep attempts. Drive through until your leg is completely past their hip line.",
      "position": 6
    },
    {
      "@type": "HowToStep",
      "name": "Establish Side Control",
      "text": "Immediately upon clearing the legs, drop your hips heavy into side control position with chest perpendicular to the opponent's torso. Maintain your crossface and transition your underhook to a hip-blocking position on their far side. Consolidate side control before releasing any pressure or adjusting grips to prevent last-moment guard recovery attempts.",
      "position": 7
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "What is the optimal moment to begin the extraction when the bottom player is actively defending?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Pass Pocket Half Attacker",
  "description": "Learn to pass the Pocket Half Guard with systematic pressure techniques. Step-by-step execution for completing the pass to side control from underhook dominance.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Pass-Pocket-Half"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Pass-Pocket-Half/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Pass Pocket Half (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Pick pocket method to pass half guard",
      "description": "Pass Pocket Half (Attacker) film study: Pick pocket method to pass half guard, taught by Patrick Donabedian.",
    ...
    },
    {
      ...
      "description": "Pass Pocket Half (Attacker) film study: Z guard pass into side control, taught by JitzLive.",
    ...
    },
    {
      ...
      "description": "Pass Pocket Half (Attacker) film study: Passing the knee shield half guard, taught by Sticks and Stones BJJ.",
...
<p class="section-subtitle">Watch Pass Pocket Half (Attacker) in action — curated instructionals</p>
...
**Phase 2: Timing and Sensitivity** - Reading opponent's defensive structures and choosing extraction moment
Partner provides light resistance (30-40%) and actively maintains pocket frame and underhook. Practice reading when their structures are sufficiently broken down to begin extraction. Develop sensitivity to the moment their hip frame collapses and their body begins going flat. Focus on patience—only extract when you genuinely feel readiness.

**Phase 3: Counter Recognition** - Identifying and defeating specific defensive responses
