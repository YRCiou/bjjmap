...
---
title: "Sweep from Quarter Guard | BJJ Technique | BJJ Map"
description: "Master the Sweep from Quarter Guard in BJJ. Learn underhook-driven reversals from compromised half guard with step-by-step execution and defensive counters."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Sweep from Quarter Guard", "item": "https://bjjmap.pages.dev/Transitions/Sweep-from-Quarter-Guard" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Sweep from Quarter Guard",
  "description": "The Sweep from Quarter Guard is an underhook-driven reversal in which the bottom player, with their guard nearly passed, elevates and redirects the forward-committed top player to land in side control top.",
...
**The Sweep from Quarter Guard is an underhook-driven reversal in which the bottom player, with their guard nearly passed, elevates and redirects the forward-committed top player to land in side control top.**
...
| **Key Principles** | Underhook depth determines sweep power—the deeper your forea... | Maintain wide base and low hips to resist underhook-driven e... |
...
[[Sweep from Quarter Guard/Attacker|→ Full Attacker Guide]]
...
[[Sweep from Quarter Guard/Defender|→ Full Defender Guide]]
