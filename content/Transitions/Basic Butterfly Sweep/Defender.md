...
---
title: "Basic Butterfly Sweep Defender | BJJ Defense Guide | BJJ Map"
description: "How to defend against Basic Butterfly Sweep in BJJ. Recognition cues, defensive options, and escape strategies."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Basic Butterfly Sweep in BJJ",
  "description": "Step-by-step guide for defending and countering Basic Butterfly Sweep in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Post hand firmly on the mat on the sweeping side to create structural brace against rotation",
      "text": "As soon as you feel elevation beginning under one leg and upper body pull in one direction - the earlier the post, the more effective If successful: Sweep is stopped and you maintain top position. The posted hand creates a tripod base that prevents the rotational force from completing. You can then re-establish passing posture and work to clear hooks",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Sprawl hips back explosively to disengage the hook and create distance, removing the fulcrum point",
      "text": "When you feel opponent loading the hook and pulling your upper body forward - sprawl before the hook drive reaches full extension If successful: Hooks disengage from your thighs, removing the elevation mechanism entirely. You reset to a neutral top position with distance advantage and can re-engage with standing passing or pressure passing approach",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Step one leg over the sweeping hook to establish headquarters position and neutralize that hook",
      "text": "When opponent commits to angling for the sweep on one side, creating an opening to step the targeted leg over their hook before the drive initiates If successful: You neutralize the primary sweeping hook and establish headquarters position with one leg free, creating immediate half guard passing opportunities and removing the sweep threat from that side",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Drive forward with heavy cross-face pressure while pinning the sweeping-side underhook to flatten opponent",
      "text": "When opponent is still setting up grips and has not yet created the hip angle - use preemptive pressure to deny the seated posture they need If successful: Opponent is flattened onto their back, losing the upright posture essential for butterfly sweep mechanics. Their hooks lose elevation power and you can begin pressure passing sequences",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Basic Butterfly Sweep Defender",
  "description": "How to defend against Basic Butterfly Sweep in BJJ. Recognition cues, defensive options, and escape strategies.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Transitions/Basic-Butterfly-Sweep/Defender"
    }
  ]
}
</script>
...
<p class="section-subtitle">How do you know when someone is attempting Basic Butterfly Sweep?</p>
...
<p class="section-subtitle">What are the key principles for defending Basic Butterfly Sweep?</p>
...
<p class="section-subtitle">What can you do to defend against Basic Butterfly Sweep?</p>
...
### 2. Sprawl hips back explosively to disengage the hook and create distance, removing the fulcrum point

- **When to use**: When you feel opponent loading the hook and pulling your upper body forward - sprawl before the hook drive reaches full extension
- **Targets**: [[Positions/Butterfly Guard/Half Butterfly]]
...
<p class="section-subtitle">What is the best outcome when defending Basic Butterfly Sweep?</p>

### → [[Positions/Butterfly Guard/Half Butterfly]]

Deny the sweep through posting, grip fighting, or sprawling to maintain your top position while the opponent retains half butterfly. From here you can continue working your passing game with the advantage of having disrupted their offensive rhythm.

### → [[Positions/Butterfly Guard/Half Butterfly]]

Counter the sweep attempt by stepping over the hook to establish headquarters, smashing their half-butterfly structure flat, or using their commitment against them by timing a guard pass during their sweep attempt. This advances your position from neutral engagement to active passing.
...
<p class="section-subtitle">What mistakes should you avoid when defending Basic Butterfly Sweep?</p>
...
<p class="section-subtitle">How do you train defense against Basic Butterfly Sweep?</p>

**Week 1-2: Recognition and Posting Fundamentals** - Learning to identify sweep initiation cues and developing automatic posting reflexes
Partner executes butterfly sweeps at reduced speed while you focus on recognizing the hip angle shift, grip pull, and hook loading that precede the sweep. Practice posting your hand on the correct side when you feel elevation beginning. Start at 25% speed and progress to 50% by end of week 2. Aim for 20-30 reps per side each session to build automatic posting response.

**Week 3-4: Grips and Posture Maintenance** - Developing proactive grip denial and maintaining upright posture under pull pressure
...
**Week 5-8: Counter-Passing During Sweep Defense** - Integrating defensive reactions with offensive passing entries during opponent's sweep attempts
