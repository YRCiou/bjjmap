...
---
title: "Triangle to Back | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Triangle to Back", "item": "https://bjjmap.pages.dev/Transitions/Triangle-to-Back" }
  ]
}
</script>
...
| **Key Principles** | Follow opponent's defensive rotation rather than forcing the... | Recognize the transition initiation early by monitoring oppo... |
...
[[Triangle to Back/Attacker|→ Full Attacker Guide]]
...
[[Triangle to Back/Defender|→ Full Defender Guide]]
