...
---
title: "De La Riva to Inverted Guard | BJJ Technique | BJJ Map"
description: "Master the De La Riva to Inverted Guard entry in BJJ. Step-by-step inversion mechanics, berimbolo setups, neck safety, and counters for modern guard players."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "De La Riva to Inverted Guard", "item": "https://bjjmap.pages.dev/Transitions/De-La-Riva-to-Inverted-Guard" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "De La Riva to Inverted Guard",
  "description": "The De La Riva to Inverted Guard entry is a guard-retention transition in which the bottom player uses their De La Riva hook and deep collar or pant grip to rotate underneath the opponent onto their shoulders, arriving in Inverted Guard to set up berimbolos and back takes.",
...
<p class="also-known-as"><em>Also known as:</em> <strong>DLR Inversion</strong>, <strong>De La Riva Invert</strong></p>
</aside>
<div class="role-links">

[[De La Riva to Inverted Guard/Attacker|Play as Attacker]]
[[De La Riva to Inverted Guard/Defender|Play as Defender]]
...
| **Key Principles** | Keep the De La Riva hook engaged throughout the rotation — i... | Attack the two dependencies of the entry: strip the De La Ri... |
...
[[De La Riva to Inverted Guard/Attacker|→ Full Attacker Guide]]
...
[[De La Riva to Inverted Guard/Defender|→ Full Defender Guide]]
...
- [[Positions/De La Riva Guard]] - Starting position - the hook and grip structure that powers the inversion

- [[Positions/Inverted Guard]] - Target position achieved on a successful inversion

- [[Transitions/Berimbolo Entry]] - Primary follow-up sequence once inverted, leading to back control

- [[Transitions/Rolling Back Take]] - Common finish chained directly off the inversion

- [[Positions/De La Riva Guard/Reverse De La Riva Guard]] - Sister guard that feeds the same inverted entries

- [[Positions/X-Guard/Single Leg X-Guard]] - Alternative exit from the inversion when the back take is unavailable

- [[Positions/Back Control]] - Ultimate offensive goal of the inversion and berimbolo chain

- [[Transitions/Granby Roll to Guard]] - Safety-valve movement to recover guard if the inversion stalls

- [[Positions/Spider Guard]] - Related grip-heavy open guard that can chain into inversion
