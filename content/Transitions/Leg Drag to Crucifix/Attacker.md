...
---
title: "Leg Drag to Crucifix Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Leg Drag to Crucifix in BJJ. Attacking perspective with setup, execution steps, and counters."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Leg Drag to Crucifix in BJJ",
  "description": "Step-by-step guide for executing Leg Drag to Crucifix from Leg Drag Control/Top.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Recognize turn-in",
      "text": "Feel for the opponent beginning to rotate their hips toward you and extend their far arm to post or frame. This typically occurs when they try to turn in to recover guard rather than accepting the pass or defending the back take.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Follow rotation",
      "text": "As opponent turns, follow their movement by shifting your weight and beginning to transition your body perpendicular to theirs. Maintain pressure on their upper body while keeping your leg control of their dragged leg. Do not resist their turn but flow with it.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Capture far arm",
      "text": "As their far arm extends for posting or framing, reach over their body and secure control above the elbow using your hand or overhook. Pull the arm toward you while continuing your perpendicular movement. The arm capture must happen while they are committed to the turn.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Step leg over",
      "text": "Step your lead leg over their captured arm and torso, placing your foot on the far side of their body. Your thigh should trap their arm against your hip, creating the initial arm isolation that defines the crucifix entry.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Secure near arm",
      "text": "Release the dragged leg and use your other leg to triangle around their near arm and torso. The near arm, which was previously defending the leg drag, becomes trapped between your legs. Now both arms are isolated through different mechanisms.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Consolidate crucifix",
      "text": "Drive your weight onto opponent's upper body, flattening them or positioning them on their side. Secure wrist control on the far arm with your hands while your legs maintain the near arm trap. Adjust hip position perpendicular to their body for optimal control.",
      "position": 6
    },
    {
      "@type": "HowToStep",
      "name": "Establish submission position",
      "text": "Once both arms are controlled and your weight is settled, begin attacking the exposed neck or either arm. Keep constant pressure to prevent escape while systematically threatening submissions from the crucifix position.",
      "position": 7
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the primary goal of Leg Drag to Crucifix?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The primary goal is to capitalize on opponent's turn-in defense from leg drag bottom by capturing their extended arm and transitioning to crucifix position. This punishes a common defensive error where they try to face you rather than accepting the pass or defending the back take, resulting in both arms isolated and the neck exposed for submissions."
      }
    },
    {
      "@type": "Question",
      "name": "What position do you start Leg Drag to Crucifix from?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "What creates the opportunity to attempt the crucifix transition from leg drag?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The opportunity arises when the opponent turns into you to recover guard and extends their far arm for posting or framing. This arm extension, which is a natural part of their turn-in defense, creates the window for capture. If they keep elbows tight while turning, take the back instead since they cannot defend both threats simultaneously."
      }
    },
    {
      "@type": "Question",
      "name": "What are the essential grips needed for Leg Drag to Crucifix?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Initially you need your standard leg drag grips controlling the dragged leg and their upper body. For the crucifix capture, you need to secure their extended far arm above the elbow with your hand or overhook, then transition to controlling their wrist while your legs trap both arms. The near arm gets trapped in a leg triangle while you maintain wrist control on the far arm."
      }
    },
    {
      "@type": "Question",
      "name": "How do you shut down the primary counter of opponent keeping elbows tight during turn-in?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "If opponent keeps elbows tight while turning in, immediately transition to the back take since their tight arm position actually helps you by preventing them from creating distance or frames. The crucifix threat forces them to choose between defending arm exposure and defending back exposure, and tight elbows concedes the back. This creates the dilemma that makes leg drag so effective."
      }
    },
    {
      "@type": "Question",
      "name": "When is the optimal timing window to attempt the arm capture?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The optimal window is during the one to two seconds when opponent commits to turning in and their far arm extends for posting or framing. Before this, the arm is protected by their body position. After this, they may have completed the turn and retracted the arm. You must recognize the commitment to turn and act while they are in transition, not before they start or after they finish."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Leg Drag to Crucifix Attacker",
  "description": "How to execute Leg Drag to Crucifix in BJJ. Attacking perspective with setup, execution steps, and counters.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/Leg-Drag-to-Crucifix"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Leg-Drag-to-Crucifix/Attacker"
    }
  ]
}
</script>
...
- Commit fully once you initiate the arm capture since hesitation allows opponent to withdraw and reset defense
- Transition your body perpendicular to opponent as you capture the arm to establish optimal crucifix angle
- Use the captured arm as a lever to break down opponent's base and complete the positional transition
- Keep constant pressure through your chest and hips to prevent opponent from creating space during the capture
...
- Your weight positioned to follow their rotation and transition perpendicular to their body
- Free hand available to capture the extended arm while leg maintains control of dragged leg
...
### 2. Attempting the capture when opponent's arm is not sufficiently extended
...
### 3. Losing chest-to-back pressure during the transition to perpendicular position
...
### 4. Capturing only one arm and attempting to finish without securing the second arm

- **Consequence**: Opponent uses free arm to defend submissions and create escapes, reducing crucifix effectiveness dramatically
- **Correction**: Complete the full crucifix with both arms trapped before attacking submissions

### 5. Rushing to attack submissions before consolidating crucifix control

- **Consequence**: Opponent escapes during your submission attempt because positional control was not secured first
- **Correction**: Follow position-before-submission principle and fully establish crucifix before attacking

### 6. Not following opponent's rotation and fighting against their turn-in movement

- **Consequence**: Creates scramble situation where opponent may recover guard or escape to turtle
- **Correction**: Flow with their turn rather than resisting it, using their momentum to achieve perpendicular position
