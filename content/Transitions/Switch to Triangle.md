...
---
title: "Switch to Triangle | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Switch to Triangle", "item": "https://bjjmap.pages.dev/Transitions/Switch-to-Triangle" }
  ]
}
</script>
...
[[Switch to Triangle/Attacker|Play as Attacker]]
[[Switch to Triangle/Defender|Play as Defender]]
...
| **Key Principles** | Create multiple threats to overwhelm opponent's defense and ... | Maintain strong upright posture throughout the initial attac... |
...
[[Switch to Triangle/Attacker|→ Full Attacker Guide]]
...
[[Switch to Triangle/Defender|→ Full Defender Guide]]
