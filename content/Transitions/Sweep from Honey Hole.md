...
---
title: "Sweep from Honey Hole | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Sweep from Honey Hole", "item": "https://bjjmap.pages.dev/Transitions/Sweep-from-Honey-Hole" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Sweep from Honey Hole \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Single leg X to honey hole sweep and heel hook",
      "description": "Sweep from Honey Hole film study: Single leg X to honey hole sweep and heel hook, taught by Ilya Bodnya.",
    ...
    },
    {
      ...
      "description": "Sweep from Honey Hole film study: Saddle entries from guard, taught by Lachlan Giles.",
    ...
    },
    {
      ...
      "description": "Sweep from Honey Hole film study: The Stomp: inside sankaku entry breakdown, taught by Garry Tonon.",
...
<p class="section-subtitle">Watch Sweep from Honey Hole in action — curated instructionals</p>
...
| **Key Principles** | Use the entanglement connection as leverage rather than figh... | Maintain low hip pressure against the trapped leg at all tim... |
...
[[Sweep from Honey Hole/Attacker|→ Full Attacker Guide]]
...
[[Sweep from Honey Hole/Defender|→ Full Defender Guide]]
