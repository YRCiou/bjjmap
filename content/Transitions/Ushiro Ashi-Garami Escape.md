...
---
title: "Ushiro Ashi-Garami Escape | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Ushiro Ashi-Garami Escape", "item": "https://bjjmap.pages.dev/Transitions/Ushiro-Ashi-Garami-Escape" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Ushiro Ashi-Garami Escape \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Double outside ashi escape \u2014 running man",
      "description": "Ushiro Ashi-Garami Escape film study: Double outside ashi escape \u2014 running man, taught by Grappling Game Changer.",
    ...
    },
    {
      ...
      "description": "Ushiro Ashi-Garami Escape film study: Leg defense and escape from ashi garami, taught by The Coop BJJ.",
    ...
    },
    {
      ...
      "description": "Ushiro Ashi-Garami Escape film study: Ashi garami escape: sit over foot to mount, taught by Troy Manning.",
...
<p class="section-subtitle">Watch Ushiro Ashi-Garami Escape in action — curated instructionals</p>
...
[[Ushiro Ashi-Garami Escape/Attacker|→ Full Attacker Guide]]
...
[[Ushiro Ashi-Garami Escape/Defender|→ Full Defender Guide]]
...
**Granby Roll Extraction**: When the opponent's control is too deep for direct leg extraction, commit to a full Granby roll through turtle to complete the inversion and clear both legs simultaneously. The rolling momentum breaks the figure-four configuration by changing the angle of entanglement faster than the opponent can follow. This variant trades position (ending in turtle rather than open guard) for higher escape probability against deep control. (When to use: When opponent has deep inside leg control and is actively working heel hook grips, making sequential clearing too dangerous)


**Counter-Entanglement Entry**: Instead of purely escaping, use the inverted hip position to attack the opponent's free leg with your own outside ashi-garami entry. This transforms the defensive situation into a leg lock exchange where both practitioners are entangled. Requires strong leg lock offense to be effective, as you must be willing to engage in a submission race from a partially compromised position. (When to use: When the opponent exposes their leg during grip adjustment phases and you have confidence in your offensive leg lock game to win the exchange)


**Deep Half Guard Recovery**: When the outside leg is cleared but the inside leg maintains deep thigh control, thread underneath the opponent's body to establish deep half guard rather than forcing full extraction. Use the cleared outside space to scoop under their base with your shoulder, converting the leg entanglement into a deep half guard underhook position with sweep potential. (When to use: When inside leg control is too deep for direct extraction but outside leg has been successfully cleared, creating space for positional transition)
