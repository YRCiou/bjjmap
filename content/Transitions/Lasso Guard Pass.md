...
---
title: "Lasso Guard Pass | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Lasso Guard Pass", "item": "https://bjjmap.pages.dev/Transitions/Lasso-Guard-Pass" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Lasso Guard Pass \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Passing lasso guard to the back",
      "description": "Lasso Guard Pass film study: Passing lasso guard to the back, taught by Gabriel Sousa.",
    ...
    },
    {
      ...
      "description": "Lasso Guard Pass film study: Pressure pass the Lasso Guard, taught by Alberto Serrano.",
    ...
    },
    {
      ...
      "description": "Lasso Guard Pass film study: Deep lasso guard pass to leg drag, taught by Carpio Jiu Jitsu.",
...
<p class="section-subtitle">Watch Lasso Guard Pass in action — curated instructionals</p>
...
| **Key Principles** | Control the lassoed arm to prevent opponent from maintaining... | Maintain constant tension on the sleeve grip and lasso leg e... |
...
[[Lasso Guard Pass/Attacker|→ Full Attacker Guide]]
...
[[Lasso Guard Pass/Defender|→ Full Defender Guide]]
