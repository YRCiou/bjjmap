...
---
title: "Butterfly Sweep Attacker | BJJ Technique Guide | BJJ Map"
description: "How to execute Butterfly Sweep in BJJ. Attacking perspective with setup, execution steps, and counters."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Butterfly Sweep in BJJ",
  "description": "Step-by-step guide for executing Butterfly Sweep from Butterfly Guard/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish butterfly guard control",
      "text": "Sit up in butterfly guard with both feet positioned as hooks on opponent's inner thighs, balls of feet making contact. Secure upper body control with underhooks or collar grips, bringing opponent's weight forward onto your centerline. Maintain active posture with chest up and hips mobile.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Break opponent's posture",
      "text": "Pull opponent forward using your grips while simultaneously driving your forehead or shoulder into their chest. This breaks their posture and brings their weight onto you, compromising their base. Your goal is to get them heavy on top of you, making it difficult for them to post or resist the sweep.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Post base hand",
      "text": "Post your non-sweeping hand (typically the hand opposite to your sweep direction) on the mat behind you for stability and leverage. This hand acts as a pivot point and prevents you from falling backward. Keep elbow slightly bent to absorb pressure and maintain structural integrity.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Elevate with primary hook",
      "text": "Drive your primary butterfly hook (the one on the side you're sweeping toward) upward and slightly across your body, lifting opponent's near leg off the mat. Extend your knee forcefully while maintaining flexion in your hip. This elevation breaks opponent's base and initiates the rolling momentum.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Generate rotational momentum",
      "text": "As you elevate with your hook, simultaneously fall to your base hand side while pulling opponent across your body with your grips. Your body acts as a fulcrum, using your hip movement and upper body control to rotate opponent over you. Drive through with your hips, creating a scooping motion that amplifies the sweep.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Follow through to top position",
      "text": "Continue the rotational momentum until opponent is inverted, then drive forward with your entire body to establish mount or side control. Remove your hooks as you transition on top, replacing them with knee pressure and hip control. Secure the dominant position immediately by establishing strong crossface and underhook control before opponent can recover guard.",
      "position": 6
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the primary mechanical principle that makes the butterfly sweep effective against larger opponents?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/Butterfly-Sweep/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Butterfly Sweep (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Marcelo Garcia hits the butterfly push sweep at ADCC",
      "description": "Butterfly Sweep (Attacker) film study: Marcelo Garcia hits the butterfly push sweep at ADCC, taught by Marcelo Garcia.",
    ...
    },
    {
      ...
      "description": "Butterfly Sweep (Attacker) film study: Butterfly sweep with hip and one hook, taught by Nine Nine Jiu Jitsu.",
    ...
    },
    {
      ...
      "description": "Butterfly Sweep (Attacker) film study: Marcelo Garcia breaks down the butterfly sweep, taught by Marcelo Garcia.",
...
<p class="section-subtitle">Watch Butterfly Sweep (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Butterfly Sweep?</p>
...
<p class="section-subtitle">What do you need before attempting Butterfly Sweep?</p>
...
<p class="section-subtitle">How do you execute Butterfly Sweep step by step?</p>
...
<p class="section-subtitle">How might your opponent counter Butterfly Sweep?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Butterfly Sweep?</p>
...
<p class="section-subtitle">How do you train Butterfly Sweep (Attacker)?</p>
...
<p class="section-subtitle">What are the safety concerns for Butterfly Sweep?</p>
