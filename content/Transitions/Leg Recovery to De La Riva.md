...
---
title: "Leg Recovery to De La Riva | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Leg Recovery to De La Riva", "item": "https://bjjmap.pages.dev/Transitions/Leg-Recovery-to-De-La-Riva" }
  ]
}
</script>
...
[[Leg Recovery to De La Riva/Attacker|→ Full Attacker Guide]]
...
[[Leg Recovery to De La Riva/Defender|→ Full Defender Guide]]
...
**Reverse De La Riva Recovery**: Instead of inserting a standard DLR hook, thread your leg to the outside and establish Reverse De La Riva. Particularly effective when opponent's stance is square or when they begin retreating during your extraction. (When to use: When opponent backs away during your extraction or has a very upright posture that makes standard DLR hook insertion difficult)


**Single Leg X Recovery**: As you extract your leg, immediately hook your instep behind their knee and establish your other leg on their hip for Single Leg X guard. This captures their leg and creates immediate off-balancing and sweep threats without needing traditional DLR grips. (When to use: When opponent drops their weight low during your extraction or when they step their dragging leg forward into your hip space)


**K-Guard Entry**: During extraction, thread your outside leg across their body and establish K-Guard configuration. Requires more hip mobility but provides strong leg entanglement entries including heel hook and kneebar setups immediately upon recovery. (When to use: When you have strong hip flexibility and want to threaten leg locks immediately upon recovery rather than playing traditional DLR sweeps)
