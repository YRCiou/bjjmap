...
---
title: "Knee Slide from Flattened Half | BJJ Technique | BJJ Map"
description: "Master the knee slide from flattened half guard in BJJ. Step-by-step passing mechanics, crossface pressure, and hip movement for completing the guard pass."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Knee Slide from Flattened Half", "item": "https://bjjmap.pages.dev/Transitions/Knee-Slide-from-Flattened-Half" }
  ]
}
</script>
...
[[Knee Slide from Flattened Half/Attacker|→ Full Attacker Guide]]
...
[[Knee Slide from Flattened Half/Defender|→ Full Defender Guide]]
...
**Crossface-Driven Knee Slide**: Emphasizes driving the crossface deep across the opponent's neck before initiating the knee slide, using the crossface pressure to turn their body and create the angle for the knee to cut through. The crossface arm drives their head away while the chest follows, creating a natural lane for the knee. (When to use: When the bottom player's head is still relatively centered and they maintain some ability to face you. The crossface-first approach eliminates their visibility and structural alignment before committing to the slide.)


**Underhook Knee Slide**: Uses an underhook on the far side arm instead of or in addition to the crossface to control the bottom player's shoulder and prevent them from turning into the pass. The underhook lifts their far shoulder while the knee drives across, creating combined upper and lower body passing pressure. (When to use: When the bottom player keeps their near arm tight and protects against the crossface but leaves the far arm vulnerable. The underhook controls their rotation and prevents them from turning away during the slide.)


**Hip Switch Knee Slide**: Incorporates a rapid hip switch before the knee slide, where the top player momentarily shifts their hips to face the opposite direction before driving the knee through. This creates a change of angle that disrupts the bottom player's defensive timing and opens a wider lane for the knee to pass through. (When to use: When the bottom player maintains a strong leg hook that resists direct knee sliding. The hip switch creates angular momentum that helps clear the hook before the bottom player can readjust their grip.)
