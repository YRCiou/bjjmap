...
---
title: "Underhook Recovery from Flattened | BJJ Technique | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Underhook Recovery from Flattened", "item": "https://bjjmap.pages.dev/Transitions/Underhook-Recovery-from-Flattened" }
  ]
}
</script>
...
[[Underhook Recovery from Flattened/Attacker|Play as Attacker]]
[[Underhook Recovery from Flattened/Defender|Play as Defender]]
...
[[Underhook Recovery from Flattened/Attacker|→ Full Attacker Guide]]
...
[[Underhook Recovery from Flattened/Defender|→ Full Defender Guide]]
...
**Elbow Wedge Recovery**: Uses the near-side elbow as the primary space-creating tool, driving it into the opponent's hip crease to lever open enough space for the underhook arm to thread underneath. Relies on skeletal structure rather than muscular effort to maintain the created space. (When to use: When the opponent's pressure is primarily through their chest and your near-side elbow has freedom of movement near the hip line.)


**Lockdown Assisted Recovery**: Establishes lockdown leg control first to arrest the top player's forward pressure and create a controlled platform. The lockdown prevents the top player from posturing or driving forward, providing a stable base from which to work the hip escape and underhook insertion sequence without time pressure. (When to use: When the top player is driving heavy forward pressure and you need to stall their advancement before working the underhook recovery sequence.)


**Frame-to-Underhook Switch**: Establishes a strong forearm frame on the opponent's neck or shoulder first, creating significant space, then rapidly switches the framing arm into the underhook position in a single fluid motion. The transition is faster but requires precise timing to prevent the opponent from collapsing the space during the switch. (When to use: When you have successfully created a strong frame and the opponent momentarily adjusts their weight distribution, creating a window for the rapid arm switch.)
