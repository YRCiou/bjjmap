...
---
title: "RDLR to Crab Ride Attacker | BJJ Technique Guide | BJJ Map"
description: "Master the attacker perspective for RDLR to Crab Ride in BJJ. Step-by-step inversion mechanics, hook insertion timing, and consolidation techniques for converting reverse De La Riva into dominant crab ride control."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute RDLR to Crab Ride in BJJ",
  "description": "Step-by-step guide for executing RDLR to Crab Ride from Reverse De La Riva Guard/Bottom.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish RDLR Hook and Ankle Grip",
    ...
    {
      "@type": "HowToStep",
      "name": "Elevate Hips and Create Angle",
      "text": "Engage your core to lift your hips off the mat, establishing approximately a 45-degree angle with shoulders elevated. Your far leg frames on the opponent's near hip, preventing them from driving forward to flatten your guard structure and maintaining the vertical space necessary for inversion underneath them.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Load Opponent's Weight onto Hook Side",
      "text": "Pull their far ankle across your centerline while simultaneously increasing hook pressure through your inverted leg to disrupt their base. You need their weight committing onto the hook-side leg so they cannot sprawl or backstep effectively when you initiate the inversion underneath them.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Initiate Inversion",
      "text": "Tuck your chin firmly to your chest and rotate your shoulders toward the mat on the hook side, beginning to thread your body underneath the opponent. The RDLR hook serves as the primary fulcrum for this rotation—your entire body pivots around this contact point as you invert through the available space.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Thread Underneath Opponent",
      "text": "Continue the rotation underneath your opponent while maintaining connection through your hook-side leg as you pass through. Your far leg releases the hip frame and begins transitioning to search for the crab ride hook insertion point on the opponent's near-side hip crease.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Insert Crab Ride Hook",
      "text": "As you emerge perpendicular to the opponent's spine, immediately insert your near leg as the crab ride hook under their hip with your foot positioned inside their thigh. This hook must be established before the opponent can react to your positional change and initiate their escape or guard recovery protocols.",
      "position": 6
    },
    {
      "@type": "HowToStep",
      "name": "Establish Upper Body Control",
      "text": "Secure control of the opponent's far arm, shoulder, or collar while driving your chest firmly against their ribs and shoulder blade. Your body should now be oriented perpendicular to their spine in the characteristic crab ride configuration, with weight committed through your chest rather than sitting back.",
      "position": 7
    },
    {
      "@type": "HowToStep",
      "name": "Consolidate Crab Ride Position",
      "text": "Settle your weight into the crab ride by pressing your chest into their shoulder blade and engaging the hook actively to prevent any forward movement or guard recovery. Establish your free leg as a posting base for stability, completing the transition from RDLR guard player to dominant crab ride controller.",
      "position": 8
    }
  ],
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "RDLR to Crab Ride Attacker",
  "description": "Master the attacker perspective for RDLR to Crab Ride in BJJ. Step-by-step inversion mechanics, hook insertion timing, and consolidation techniques for converting reverse De La Riva into dominant crab ride control.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Transitions/RDLR-to-Crab-Ride"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Transitions/RDLR-to-Crab-Ride/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "RDLR to Crab Ride (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "DLR to crab ride back take",
      "description": "RDLR to Crab Ride (Attacker) film study: DLR to crab ride back take, taught by Moncaio Brothers.",
    ...
    },
    {
      ...
      "description": "RDLR to Crab Ride (Attacker) film study: De La Riva to crab ride back take, basics, taught by PTT Chilliwack.",
    ...
    },
    {
      ...
      "description": "RDLR to Crab Ride (Attacker) film study: Reverse De La Riva to crab ride via inversion, taught by Kameron Ross.",
...
<p class="section-subtitle">Watch RDLR to Crab Ride (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing RDLR to Crab Ride?</p>
...
<p class="section-subtitle">What do you need before attempting RDLR to Crab Ride?</p>
...
<p class="section-subtitle">How do you execute RDLR to Crab Ride step by step?</p>
...
<p class="section-subtitle">How might your opponent counter RDLR to Crab Ride?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing RDLR to Crab Ride?</p>
...
<p class="section-subtitle">How do you train RDLR to Crab Ride (Attacker)?</p>

**Phase 1: Solo Inversion Mechanics** - Developing the hip elevation, shoulder rotation, and body threading movement pattern
Practice the inversion movement solo on the mat, focusing on tucking the chin, rotating shoulders, and threading through an imaginary space. Build the muscle memory for the rotational arc and practice arresting the motion at the perpendicular crab ride angle. Perform 20 repetitions each side per session.

**Phase 2: Cooperative Partner Drilling** - Executing the full transition against a stationary, cooperative partner
Partner assumes standing or combat base position while you establish RDLR and execute the full inversion to crab ride sequence. Partner remains passive, allowing you to develop timing for ankle grip engagement, inversion initiation, hook insertion, and upper body control establishment. Perform 10 repetitions each side.

**Phase 3: Progressive Resistance Drilling** - Maintaining technique quality against increasing defensive pressure
...
<p class="section-subtitle">What are the safety concerns for RDLR to Crab Ride?</p>
