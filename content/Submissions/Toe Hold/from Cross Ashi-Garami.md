...
---
title: "Toe Hold from Cross Ashi-Garami | BJJ Submission | BJJ Map"
description: "Master the toe hold from cross ashi-garami with grip mechanics, rotational finishing details, and safe application from this dominant leg entanglement position."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Toe Hold from Cross Ashi-Garami", "item": "https://bjjmap.pages.dev/Submissions/Toe-Hold-from-Cross-Ashi-Garami" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Toe Hold from Cross Ashi-Garami",
  "description": "The toe hold from cross ashi-garami is a rotational ankle lock that traps the foot in a figure-four grip across the forefoot and twists it toward the buttock, exploiting the crossed-leg entanglement's superior hip control to prevent foot retraction.",
...
**The toe hold from cross ashi-garami is a rotational ankle lock that traps the foot in a figure-four grip across the forefoot and twists it toward the buttock, exploiting the crossed-leg entanglement's superior hip control to prevent foot retraction.**
...
> [!danger] Safety
> Toe Hold from Cross Ashi-Garami targets the Ankle, toes, and foot ligaments. Primary risk: Ankle ligament tears (lateral and medial collateral ligaments). Tap early; release immediately on the tap. [Full safety guide ↓](#safety-considerations)
...
- **Confirm cross ashi control**: Verify your inside hook is deep behind the opponent's hip and your outside leg crosses firmly at shi...

- **Release heel grip and redirect to foot**: Transition your grip from the heel position to the opponent's foot. Your bottom hand (closest to the...

- **Establish figure-four grip**: Your top hand reaches over the opponent's toes and grips your own bottom wrist, creating a figure-fo...

- **Seat the foot against your body**: Pull the opponent's foot snugly against your chest or shoulder to eliminate any slack in the grip. T...

- **Begin controlled rotational pressure**: Initiate the finish by rotating your entire upper body away from the opponent while curling their to...

- **Complete the finish with hip reinforcement**: As the opponent's ankle approaches its breaking threshold, reinforce the rotational pressure by exte...
...
**Standard Figure-Four Toe Hold**: The fundamental toe hold grip where the attacking hand wraps under the foot sole while the other hand grips over the toes, locking a figure-four configuration similar to a kimura grip. Rotation is generated by curling the foot toward the opponent's buttock using torso rotation rather than arm strength. (When to use: When you have clear access to the opponent's foot and their toes are exposed, particularly when they flex their knee to defend heel hooks)


**Estima-Style Toe Hold Entry**: Initiated by trapping the opponent's foot in the crook of your elbow before establishing the figure-four grip, this variation secures the foot position first and prevents early retraction. The elbow crook acts as a fulcrum point for the rotational pressure. (When to use: When the opponent is actively retracting their foot and you need to secure control before establishing the full grip configuration)


**Toe Hold to Heel Hook Transition**: Begin the toe hold attack to force the opponent to straighten their leg defensively, which exposes the heel for a heel hook. The toe hold grip is released and immediately redirected to cup the heel as the opponent extends. Functions as a combination attack rather than a pure toe hold finish. (When to use: Against opponents with strong toe hold defense who straighten the leg reflexively, or when you prefer the heel hook as the primary finish)
...
- [[Positions/Ashi Garami]] - Parent leg entanglement family with alternative toe hold setups
- [[Positions/Ashi Garami/Saddle]] - Advanced leg entanglement reachable when opponent defends the toe hold
- [[Positions/Ashi Garami/Inside Ashi-Garami]] - Transition target when opponent rotates inward to defend
...
**Release Protocol**:
1. Immediately stop all rotational pressure upon tap
2. Release toe grip completely before releasing leg control
3. Release heel control and uncross legs
