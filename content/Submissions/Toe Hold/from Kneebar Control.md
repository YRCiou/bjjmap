...
---
title: "Toe Hold from Kneebar Control | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Toe Hold from Kneebar Control", "item": "https://bjjmap.pages.dev/Submissions/Toe-Hold-from-Kneebar-Control" }
  ]
}
</script>
...
| **Key Principles** | The kneebar threat must be genuine before transitioning - op... | Recognize the grip transition early - the moment the attacke... |
