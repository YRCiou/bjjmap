...
---
title: "Arm Crush from Side Control Attacker | BJJ Submission Guide | BJJ Map"
description: "How to execute Arm Crush in BJJ. Attacking perspective with setup, execution, and finishing mechanics from side control."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Arm Crush from Side Control in BJJ",
  "description": "Step-by-step guide for Arm Crush from Side Control with safety protocols.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Secure side control consolidation",
      "text": "From side control, establish a strong cross-face with your near arm while driving your shoulder into opponent's jaw. Your far arm reaches across to control their far shoulder or reach under their far armpit. Your chest should be heavy on their chest, and your hips should be low and tight to their near hip. This consolidated position prevents escape and sets up the arm trap.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Trap the near arm",
      "text": "As opponent defends by keeping their near elbow tight to their ribs, slide your far arm underneath their trapped arm at the elbow level. Your forearm should wedge between their upper arm and their ribcage. Maintain heavy chest pressure to prevent them from extracting their arm. The tighter they defend, the deeper you can wedge your arm underneath theirs.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Establish the grip configuration",
      "text": "With your far arm wedged under their elbow, reach across with your near hand to grip your own wrist or forearm, creating a figure-four configuration around their trapped arm. Your grip should be tight and your elbows should be squeezed together. This creates the frame that will apply the crushing pressure. Ensure your chest remains heavy on their torso throughout this adjustment.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Position your hips for maximum pressure",
      "text": "Walk your hips slightly toward opponent's head while maintaining chest pressure. This hip movement changes the angle of your torso relative to their trapped arm, increasing the crushing pressure on their shoulder. Your body should form approximately a 45-degree angle to their torso. Keep your weight consolidated and avoid lifting your chest.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Apply the crushing pressure",
      "text": "Drive your chest down and forward toward the mat while simultaneously squeezing your elbows together. This creates intense crushing pressure on opponent's shoulder joint, compressing it between your chest weight and their own body. The pressure should be applied progressively over 2-3 seconds. Watch for the tap - opponent cannot verbally tap if you have a tight cross-face.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Add rotational torque for the finish",
      "text": "While maintaining the crushing pressure, slightly rotate your torso toward opponent's legs. This adds a twisting component to the shoulder lock, combining compression with rotation. The movement should be small and controlled - 2-3 inches of rotation maximum. This final adjustment typically forces an immediate tap as the shoulder joint is simultaneously compressed and twisted.",
      "position": 6
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How does the opponent's defensive posture enable the Arm Crush submission?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Arm Crush from Side Control Attacker",
  "description": "How to execute Arm Crush in BJJ. Attacking perspective with setup, execution, and finishing mechanics from side control.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Submissions/Arm-Crush-from-Side-Control/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Arm Crush from Side Control (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Cradle from side control to armbar shoulder lock",
      "description": "Arm Crush from Side Control (Attacker) film study: Cradle from side control to armbar shoulder lock, taught by Andy Tong.",
    ...
    },
    {
      ...
      "description": "Arm Crush from Side Control (Attacker) film study: Arm crush armbar, taught by AMAZIN BJJ.",
    ...
    },
    {
      ...
      "description": "Arm Crush from Side Control (Attacker) film study: Killing the near side arm from side control, taught by Inverted Gear.",
...
<p class="section-subtitle">Watch Arm Crush from Side Control (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Arm Crush from Side Control?</p>
...
<p class="section-subtitle">What do you need before attempting Arm Crush from Side Control?</p>
...
<p class="section-subtitle">How do you execute Arm Crush from Side Control step by step?</p>
...
<p class="section-subtitle">How might your opponent defend against Arm Crush from Side Control?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Arm Crush from Side Control?</p>
...
**Phase 4: Live Positional Sparring** - Full resistance application and transition decisions
