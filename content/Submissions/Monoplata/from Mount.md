...
---
title: "Monoplata from Mount | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Monoplata from Mount", "item": "https://bjjmap.pages.dev/Submissions/Monoplata-from-Mount" }
  ]
}
</script>
...
| **Key Principles** | Isolate one arm completely before attempting the lock config... | Prevent arm isolation as the absolute first priority—keep el... |
