...
---
title: "Monoplata from Mount Defender | BJJ Defense Guide | BJJ Map"
description: "How to defend against Monoplata from Mount in BJJ. Recognition, escape paths, and defensive strategies."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Monoplata from Mount in BJJ",
  "description": "Step-by-step guide for defending and escaping Monoplata from Mount in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Grab the threading leg with your free hand and block the figure-four from closing",
      "text": "The moment the attacker begins swinging their leg over your head, before the foot passes your far shoulder If successful: Prevents the submission entirely and forces attacker to abandon the attempt, typically returning to standard mount control",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Explosive bridge toward the side of the trapped arm during the leg threading transition",
      "text": "When attacker lifts their leg to swing over your head, creating a momentary base imbalance as their weight shifts If successful: Disrupts the attacker's balance during the most unstable phase of the technique, potentially reversing to guard or forcing them to abandon the submission and re-establish mount",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Turn toward the trapped arm and clasp both hands together to prevent arm extension",
      "text": "When the figure-four is partially or fully closed and you cannot prevent the lock from forming—this is your last-resort defense If successful: Prevents the attacker from extending your arm and applying full rotational pressure. Creates a stalemate where attacker must break your grip before finishing, buying time for further escape attempts",
      "position": 3
    }
  ],
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Monoplata from Mount Defender",
  "description": "How to defend against Monoplata from Mount in BJJ. Recognition, escape paths, and defensive strategies.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Submissions/Monoplata-from-Mount"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Submissions/Monoplata-from-Mount/Defender"
    }
  ]
}
</script>
...
<p class="section-subtitle">How do you know when someone is attempting Monoplata from Mount?</p>
...
<p class="section-subtitle">What are the key principles for defending Monoplata from Mount?</p>
...
<p class="section-subtitle">What can you do to defend against Monoplata from Mount?</p>
...
<p class="section-subtitle">How do you escape Monoplata from Mount?</p>
...
<p class="section-subtitle">What is the best outcome when defending Monoplata from Mount?</p>
...
<p class="section-subtitle">What mistakes should you avoid when defending Monoplata from Mount?</p>

### 1. Extending the trapped arm straight to push the attacker away during the figure-four setup

- **Consequence**: A straight arm is the exact position the monoplata requires to finish. Extending your arm accelerates the submission by creating the full extension the attacker needs for maximum shoulder torque. This also exposes you to an immediate armbar if the attacker adjusts.
- **Correction**: Keep the trapped arm bent at all times with your hand gripping your own collar, opposite shoulder, or clasping both hands together. A bent arm prevents the rotational leverage needed to finish the monoplata and forces the attacker to work significantly harder to extend it.

### 2. Focusing entirely on the leg thread while ignoring basic mount escape fundamentals

- **Consequence**: You abandon core defensive posture (elbows tight, frames active, hips mobile) to deal with the specific monoplata threat, which paradoxically makes both the monoplata and other submissions easier to finish. The attacker can switch to armbar or choke when your defense becomes single-focused.
- **Correction**: Maintain fundamental mount defense posture throughout: elbows connected to ribs, chin tucked, hips ready to bridge. Address the monoplata threat within this defensive framework rather than abandoning it. Your mount escape fundamentals are your first and best line of defense against any mount attack.

### 3. Waiting too long to tap once the figure-four is locked and pressure application begins

- **Consequence**: The monoplata applies rotational stress that can tear the rotator cuff in less than two seconds of full pressure. Delaying the tap past the point where you feel shoulder strain risks catastrophic injury requiring surgery and months of recovery. Unlike chokes, shoulder locks cause permanent structural damage.
- **Correction**: Tap immediately when you feel the figure-four lock tight with hip extension beginning. There is no 'fighting through' a properly locked monoplata without risking serious shoulder injury. If the lock is complete and pressure is starting, the time for escape has passed. Protect your training longevity.
...
<p class="section-subtitle">How do you train defense against Monoplata from Mount?</p>

**Phase 1: Recognition Drilling** - Identifying monoplata setup cues from bottom mount
Partner walks through the monoplata setup at slow speed from mount while you practice identifying each stage: arm isolation, head/far arm control, leg swing initiation, and figure-four closure. Call out each stage verbally as it happens. Build pattern recognition until you can identify the attack within the first two seconds of the setup sequence. No resistance from either partner at this stage.

**Phase 2: Early Prevention Responses** - Practicing leg grabs, bridges, and arm recovery during setup
Partner performs the monoplata setup at moderate speed while you practice specific defensive responses: grabbing the threading leg before the figure-four closes, timing bridges during the leg swing transition, and recovering your isolated arm before the thread begins. Partner provides 30-50% resistance and resets after each defensive attempt. Build automatic responses to each stage of the setup.

**Phase 3: Late-Stage Survival and Tap Recognition** - Defending when the figure-four is partially or fully closed
Start with the figure-four partially established and practice late-stage defenses: hand clasping to prevent extension, turning toward the trapped arm, and hip escaping to create space. Partner applies gradual pressure so you learn to recognize when defense is still viable versus when tapping is the correct decision. Develop the judgment to distinguish between defensible and indefensible positions. Emphasize that tapping to a locked monoplata is always the correct choice.
