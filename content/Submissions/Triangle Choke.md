...
---
title: "Triangle Choke | BJJ Submission Family | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "sameAs": ["https://en.wikipedia.org/wiki/Triangle_choke", "https://www.wikidata.org/wiki/Q2375061"],
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Triangle Choke", "item": "https://bjjmap.pages.dev/Submissions/Triangle-Choke" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Triangle Choke \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Triangle from closed guard",
      "description": "Triangle Choke film study: Triangle from closed guard, taught by Nicholas Meregali.",
    ...
    },
    {
      ...
      "description": "Triangle Choke film study: Surprising triangle from guard, taught by Giancarlo Bodoni.",
    ...
    },
    {
      ...
      "description": "Triangle Choke film study: No-gi triangle from guard, taught by Chewjitsu.",
    ...
    },
    {
      ...
      "description": "Triangle Choke film study: Triangle off the overhook, taught by Jon Thomas \u00b7 Grapplearts.",
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Triangle Choke",
  "description": "The Triangle Choke is a blood choke in which the attacker traps the opponent's head and one arm inside a figure-four leg configuration, driving their own shin across the neck so the opponent's trapped shoulder becomes the fulcrum that compresses both carotid arteries.",
...
> [!danger] Safety
> Triangle Choke targets the Carotid arteries and brachial plexus. Primary risk: Loss of consciousness from blood choke. Tap early; release immediately on the tap. [Full safety guide ↓](#safety-considerations)
...
<p class="section-subtitle">Watch Triangle Choke in action — curated instructionals</p>
