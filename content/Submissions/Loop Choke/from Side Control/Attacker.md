...
---
title: "Loop Choke from Side Control Attacker | BJJ Submission Guide | BJJ Map"
description: "How to execute the Loop Choke from Side Control in BJJ. Attacking perspective with crossface-to-collar setup, sprawl finishing mechanics, and submission chains."
---
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What anatomical structures does the loop choke from side control attack to cause unconsciousness?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The loop choke attacks the carotid arteries and jugular veins on both sides of the neck. When applied correctly, the collar creates a constricting loop that compresses these blood vessels bilaterally, restricting blood flow to and from the brain. This bilateral carotid compression causes rapid unconsciousness within 8-12 seconds of full application without directly attacking the airway. From side control, the horizontal sprawl tension pulls the collar across both sides of the neck simultaneously, creating the bilateral compression required for a true blood choke rather than an air choke."
      }
    },
    {
      "@type": "Question",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Loop Choke from Side Control Attacker",
  "description": "How to execute the Loop Choke from Side Control in BJJ. Attacking perspective with crossface-to-collar setup, sprawl finishing mechanics, and submission chains.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Submissions/Loop-Choke-from-Side-Control/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Loop Choke from Side Control (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Loop Choke from Side Control",
      "description": "Loop Choke from Side Control (Attacker) film study: Loop Choke from Side Control, taught by Goulburn Martial Arts Academy.",
    ...
    },
    {
      ...
      "description": "Loop Choke from Side Control (Attacker) film study: Alexandre Vieira Loop Choke, taught by Alexandre Vieira.",
...
<p class="section-subtitle">Watch Loop Choke from Side Control (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Loop Choke from Side Control?</p>
...
<p class="section-subtitle">What do you need before attempting Loop Choke from Side Control?</p>
...
<p class="section-subtitle">How do you execute Loop Choke from Side Control step by step?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Loop Choke from Side Control?</p>
...
<p class="section-subtitle">How do you train Loop Choke from Side Control (Attacker)?</p>

**Phase 1: Crossface-to-Collar Transition Isolation** - Seamless grip conversion without losing pressure
...
**Phase 2: Loop Configuration and Sprawl Mechanics** - Coordinating dual grips with horizontal finishing force
With both grips established on a compliant partner, practice the sprawl-based finish. Focus on driving your shoulder forward while your hips pull back, creating horizontal tension through the collar. Partner provides feedback on whether they feel bilateral carotid compression versus tracheal pressure. Adjust grip depth and sprawl angle until the blood choke sensation is consistent. Perform 15 repetitions per side.

**Phase 3: Full Sequence Against Controlled Resistance** - Integrating setup, grip transitions, and finish against realistic defense
...
**Phase 4: Live Positional Sparring with Submission Chains** - Applying the loop choke within a multi-threat attack system
