...
---
title: "Loop Choke from Turtle | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Loop Choke from Turtle", "item": "https://bjjmap.pages.dev/Submissions/Loop-Choke-from-Turtle" }
  ]
}
</script>
...
| **Key Principles** | Establish the deep cross-collar grip before committing to an... | Prevent the deep collar grip from being established - once f... |
