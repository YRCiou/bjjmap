...
---
title: "Loop Choke from Half Guard Attacker | BJJ Submission Guide | BJJ Map"
description: "How to execute the Loop Choke from Half Guard Top in BJJ. Attacking perspective with collar grip timing, sprawl finish, and half guard passing integration."
---
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What anatomical structures does the Loop Choke from Half Guard target to cause unconsciousness?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The Loop Choke targets the carotid arteries and jugular veins on both sides of the neck. When the collar loop is properly positioned and tightened through the sprawl, it compresses these blood vessels bilaterally, restricting blood flow to and from the brain. This bilateral carotid compression causes rapid unconsciousness typically within 8-12 seconds of full application. A properly applied loop choke is a blood choke distinguished from an air choke by the collar wrapping around the sides of the neck rather than pressing against the front of the throat."
      }
    },
    {
      "@type": "Question",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Loop Choke from Half Guard Attacker",
  "description": "How to execute the Loop Choke from Half Guard Top in BJJ. Attacking perspective with collar grip timing, sprawl finish, and half guard passing integration.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Submissions/Loop-Choke-from-Half-Guard/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Loop Choke from Half Guard (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Loop Choke from Half Guard",
      "description": "Loop Choke from Half Guard (Attacker) film study: Loop Choke from Half Guard, taught by Sickness Ferro.",
    ...
    },
    {
      ...
      "position": 2,
      "name": "Loop choke from half guard",
      "description": "Loop Choke from Half Guard (Attacker) film study: Loop choke from half guard, taught by Jean Jacques Machado.",
    ...
    },
    {
      ...
      "description": "Loop Choke from Half Guard (Attacker) film study: Loop choke from half guard top, taught by terasankka.",
...
<p class="section-subtitle">Watch Loop Choke from Half Guard (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Loop Choke from Half Guard?</p>
...
<p class="section-subtitle">What do you need before attempting Loop Choke from Half Guard?</p>
...
<p class="section-subtitle">How do you execute Loop Choke from Half Guard step by step?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Loop Choke from Half Guard?</p>
