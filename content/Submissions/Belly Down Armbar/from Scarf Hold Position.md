...
---
title: "Belly Down Armbar from Scarf Hold Position | BJJ Submission | BJJ Map"
description: "Master the belly down armbar finish from scarf hold position. Learn arm isolation, prone transition mechanics, and high-leverage elbow finishing details."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Belly Down Armbar from Scarf Hold Position", "item": "https://bjjmap.pages.dev/Submissions/Belly-Down-Armbar-from-Scarf-Hold-Position" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Belly Down Armbar from Scarf Hold Position",
  "description": "The Belly Down Armbar from Scarf Hold Position is a prone elbow hyperextension finish where the attacker steps over the opponent's head from kesa gatame and rotates face-down, driving the hips into the already-trapped near arm's elbow.",
...
**The Belly Down Armbar from Scarf Hold Position is a prone elbow hyperextension finish where the attacker steps over the opponent's head from kesa gatame and rotates face-down, driving the hips into the already-trapped near arm's elbow.**
<div class="principle-meta">
<span class="meta-chip">Joint Lock</span>
<span class="meta-chip">Arm Lock</span>
<span class="meta-chip">Targets Elbow joint - hyperextension against ulnar collateral ligament</span>
<span class="meta-chip">50% success</span>
</div>

> [!danger] Safety
> Belly Down Armbar from Scarf Hold Position targets the Elbow joint - hyperextension against ulnar collateral ligament. Primary risk: Elbow hyperextension with ligament damage to the ulnar collateral ligament. Tap early; release immediately on the tap. [Full safety guide ↓](#safety-considerations)
...
- **Consolidate arm isolation**: From scarf hold, tighten your grip on the opponent's trapped near arm. Slide your near arm deeper un...

- **Release head control**: Withdraw your far arm from around the opponent's head and immediately use it to reinforce your grip ...

- **Step over the head**: Swing your far leg (the one closest to the opponent's hips) up and over their head and face to the f...

- **Rotate to prone position**: Pivot your entire body face-down by turning toward the opponent's trapped arm. Your chest rotates fr...

- **Establish knee pinch and hip position**: Squeeze your knees tightly together around the opponent's upper arm just above the elbow. Their thum...

- **Secure wrist control for the finish**: Grip their wrist with both hands, keeping their forearm pulled tight against your chest. Their wrist...

- **Apply progressive extension pressure**: Lower your chest toward the mat while keeping their wrist pinned to your sternum. Simultaneously ext...
...
**Americana Fake to Belly Down**: Threaten the americana from scarf hold, forcing the opponent to straighten their arm or turn away. When they extend the arm to defend the shoulder lock, immediately transition to the belly down armbar by stepping over the head and rotating prone. The americana defense creates the exact arm position needed for the armbar finish. (When to use: When opponent has strong americana defense and habitually straightens the arm to prevent the figure-four grip)


**Figure-Four Grip Transition**: Secure a figure-four grip on the trapped arm before initiating the rotation. Lock your hands in a Kimura-style configuration on their wrist and forearm, then step over the head and rotate belly down while maintaining the double-wrist control. This variation provides superior arm retention during the transition window at the cost of slightly slower rotation speed. (When to use: Against opponents who are explosive and likely to rip their arm free during the standard transition)


**Hip Switch Entry**: Instead of stepping over the head from standard scarf hold, switch your hips first by rotating your base toward the opponent's hips, then swing your leg over their face as you complete the prone rotation. This entry angle is less telegraphed because the initial hip switch appears to be a positional adjustment rather than a submission setup. (When to use: Against experienced opponents who recognize the standard head-step entry and begin defending early)
...
- [[Positions/Side Control/Scarf Hold Position]] - Starting position providing pre-existing arm isolation for the belly down transition
- [[Positions/Side Control/Kesa Gatame]] - Traditional judo terminology for the starting position
- [[Positions/Armbar Control]] - Intermediate control position during transition to prone finish
- [[Positions/Side Control]] - Adjacent position family sharing similar top control mechanics and arm isolation opportunities
