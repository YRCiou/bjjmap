...
---
title: "Belly Down Armbar from Mounted Triangle | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Belly Down Armbar from Mounted Triangle", "item": "https://bjjmap.pages.dev/Submissions/Belly-Down-Armbar-from-Mounted-Triangle" }
  ]
}
</script>
...
| **Key Principles** | Secure the wrist before initiating rotation - the entire tec... | Recognize wrist control as the primary indicator that the be... |
