...
---
title: "Belly Down Armbar from Knee on Belly | BJJ Submission | BJJ Map"
description: "Master the belly down armbar finish from knee on belly in BJJ. Complete guide covering setup, execution, defensive strategies, and essential safety protocols."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Belly Down Armbar from Knee on Belly", "item": "https://bjjmap.pages.dev/Submissions/Belly-Down-Armbar-from-Knee-on-Belly" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Belly Down Armbar from Knee on Belly \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Armbar from Knee on Belly",
      "description": "Belly Down Armbar from Knee on Belly film study: Armbar from Knee on Belly, taught by Team Daruma Dojo.",
    ...
    },
    {
      ...
      "description": "Belly Down Armbar from Knee on Belly film study: Knee on Belly 180 Armbar to Triangle, taught by Ritchie Yip.",
    ...
    },
    {
      ...
      "description": "Belly Down Armbar from Knee on Belly film study: Two Knee on Belly Armbars, taught by Ferdi.",
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Belly Down Armbar from Knee on Belly",
  "description": "The belly down armbar from knee on belly is a prone elbow-hyperextension finish where the top player isolates the arm exposed by knee pressure, steps over the head, and rotates face-down to lock the elbow with hip drive and bilateral knee squeeze.",
...
**The belly down armbar from knee on belly is a prone elbow-hyperextension finish where the top player isolates the arm exposed by knee pressure, steps over the head, and rotates face-down to lock the elbow with hip drive and bilateral knee squeeze.**
...
> [!danger] Safety
> Belly Down Armbar from Knee on Belly targets the Elbow joint hyperextension and ulnar collateral ligament. Primary risk: Elbow hyperextension with ligament damage to the ulnar collateral ligament. Tap early; release immediately on the tap. [Full safety guide ↓](#safety-considerations)
...
<p class="section-subtitle">Watch Belly Down Armbar from Knee on Belly in action — curated instructionals</p>
...
**Near arm isolation from knee pressure reaction**: The standard entry where knee on belly pressure forces the bottom player to push against the knee with their near arm. The top player captures the extended wrist, secures two-on-one control, and transitions directly into the step-over and belly down rotation. (When to use: When the opponent reacts to knee pressure by pushing with their near hand, which is the most common defensive reaction.)


**Far arm capture from cross-body reach**: When the bottom player reaches across their body with the far arm to create a frame or grab the top player's leg, the top player captures this extended arm and steps over toward the far side. This variation requires a wider step-over arc but catches opponents who have learned to protect the near arm. (When to use: When the opponent protects the near arm but extends the far arm across their body to frame or push.)
...
- [[Positions/Knee on Belly]] - Primary starting position providing pressure and arm isolation opportunities
- [[Positions/Armbar Control]] - Intermediate control position during transition to belly down finish
- [[Positions/Side Control]] - Alternative entry position and common bail-out when transition fails
