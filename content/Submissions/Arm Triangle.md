...
---
title: "Arm Triangle | BJJ Submission Family | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Arm Triangle", "item": "https://bjjmap.pages.dev/Submissions/Arm-Triangle" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Arm Triangle",
  "description": "The Arm Triangle, or Kata Gatame, is a head-and-arm blood choke applied from dominant top positions such as side control, mount, and north-south, converting an opponent's defensive arm into the lever that cuts off blood flow to the brain.",
...
**The Arm Triangle, or Kata Gatame, is a head-and-arm blood choke applied from dominant top positions such as side control, mount, and north-south, converting an opponent's defensive arm into the lever that cuts off blood flow to the brain.**
...
> [!danger] Safety
> Arm Triangle targets the Carotid arteries (compressed by opponent's own shoulder and your arm). Primary risk: Loss of consciousness from blood choke. Tap early; release immediately on the tap. [Full safety guide ↓](#safety-considerations)
...
- [[Submissions/Cross Collar Choke]] - Alternative choke threatening from similar top positions
- [[Submissions/Americana]] - Shoulder lock chain when arm triangle setup is defended
...
- [[Positions/Half Guard]] - Can set up arm triangle during top pressure passing sequences
