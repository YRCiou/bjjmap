...
---
title: "Paper Cutter Choke | BJJ Submission Family | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Paper Cutter Choke", "item": "https://bjjmap.pages.dev/Submissions/Paper-Cutter-Choke" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Paper Cutter Choke",
  "description": "The Paper Cutter Choke is a gi blood choke from side control and other top pins, where the attacker feeds a deep cross-collar grip and saws the forearm across the far carotid to force the tap.",
...
**The Paper Cutter Choke is a gi blood choke from side control and other top pins, where the attacker feeds a deep cross-collar grip and saws the forearm across the far carotid to force the tap.**
...
> [!danger] Safety
> Paper Cutter Choke targets the Carotid arteries (bilateral compression). Primary risk: Loss of consciousness from carotid artery compression. Tap early; release immediately on the tap. [Full safety guide ↓](#safety-considerations)
