...
---
title: "Twister | BJJ Submission Family | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Twister", "item": "https://bjjmap.pages.dev/Submissions/Twister" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Twister",
  "description": "The Twister is a 10th Planet spinal-lock submission that corkscrews the opponent's spine by driving their upper body one direction while a trapped leg pins their lower body the other, finished from the Truck position.",
...
**The Twister is a 10th Planet spinal-lock submission that corkscrews the opponent's spine by driving their upper body one direction while a trapped leg pins their lower body the other, finished from the Truck position.**
...
> [!danger] Safety
> Twister targets the Cervical and thoracic spine, shoulder girdle. Primary risk: Cervical spine damage (neck injury). Tap early; release immediately on the tap. [Full safety guide ↓](#safety-considerations)
