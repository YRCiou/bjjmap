...
---
title: "Rear Triangle Choke from Rear Triangle | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Rear Triangle Choke from Rear Triangle", "item": "https://bjjmap.pages.dev/Submissions/Rear-Triangle-Choke-from-Rear-Triangle" }
  ]
}
</script>
...
| **Key Principles** | Angle hips toward the trapped arm side to create optimal cut... | Protect the chin immediately by tucking it tight to the ches... |
