...
---
title: "Kneebar from Inside Sankaku | BJJ Submission | BJJ Map"
description: "Master the kneebar from Inside Sankaku in BJJ. Complete finishing guide covering setup mechanics, hip extension technique, defensive counters, and safety protocols."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kneebar from Inside Sankaku", "item": "https://bjjmap.pages.dev/Submissions/Kneebar-from-Inside-Sankaku" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Kneebar from Inside Sankaku",
  "description": "The kneebar from Inside Sankaku is a secondary leg attack that exploits the entanglement's leg isolation to hyperextend the opponent's knee via hip extension, capitalizing on the heel-hiding defense to the inside heel hook.",
...
**The kneebar from Inside Sankaku is a secondary leg attack that exploits the entanglement's leg isolation to hyperextend the opponent's knee via hip extension, capitalizing on the heel-hiding defense to the inside heel hook.**
...
> [!danger] Safety
> Kneebar from Inside Sankaku targets the Knee joint (primarily posterior cruciate ligament, medial collateral ligament, and joint capsule). Primary risk: Posterior cruciate ligament (PCL) tear. Tap early; release immediately on the tap. [Full safety guide ↓](#safety-considerations)
...
| **Key Principles** | Maintain the Inside Sankaku entanglement throughout the enti... | Recognize the kneebar transition early by feeling the attack... |
...
- [[Positions/Inside Sankaku]] - Starting position for this kneebar variation
- [[Positions/Ashi Garami/Saddle]] - Related leg entanglement with similar kneebar mechanics
- [[Positions/Kneebar Control]] - Control position for establishing the kneebar finish
- [[Positions/Ashi Garami/50-50 Guard]] - Related leg entanglement that also allows kneebar attacks
- [[Positions/Ashi Garami/Honey Hole]] - Alternative name for Inside Sankaku position
