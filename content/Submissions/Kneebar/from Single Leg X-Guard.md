...
---
title: "Kneebar from Single Leg X-Guard | BJJ Submission | BJJ Map"
description: "Master the kneebar from Single Leg X-Guard. Expert guide to this BJJ leg lock counter-attack with entry mechanics, finishing details, and safety protocols."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kneebar from Single Leg X-Guard", "item": "https://bjjmap.pages.dev/Submissions/Kneebar-from-Single-Leg-X-Guard" }
  ]
}
</script>
...
**Standard Backstep Kneebar Entry**: The fundamental entry from SLX Top where you control the bottom player's outside hooking foot, backstep your free leg behind their entangling leg, and sit back into kneebar position. Your backstep leg clears their hook line and your body pivots perpendicular to their trapped leg in one fluid motion. The key detail is maintaining foot control throughout the backstep to prevent them from retracting hooks. (When to use: When the bottom player extends their hooks aggressively for a sweep attempt, creating maximum leg extension and minimal defensive awareness. Best initiated at the peak of their sweep commitment.)


**Rolling Kneebar from SLX Top**: When the bottom player blocks the standard backstep by keeping their hooks tight and hips close, the top player initiates a forward roll over the bottom player's entangling leg while maintaining ankle control. The rolling momentum carries you past their defensive structure and lands you in kneebar position on the opposite side. This entry is faster than the backstep but requires more precise timing and commitment. (When to use: Effective when the bottom player anticipates the backstep and tightens their hooks defensively, or when their hips are positioned too close for a clean backstep angle.)


**Kneebar from Guard Pass Transition**: During a guard passing sequence against SLX, when you partially clear the bottom hook but the top hook remains active, pivot your passing motion into a kneebar attack on the hooking leg rather than completing the pass. This takes advantage of the partially cleared leg position where the bottom player's leg is isolated but still engaged, making it ideal for kneebar entry without full backstep commitment. (When to use: When your guard passing attempt partially succeeds but stalls — rather than fighting to complete the pass against a resilient hook, redirect into the kneebar opportunity created by the partial clearance.)


**Immediate Counter-Attack on SLX Establishment**: Attack the kneebar immediately as you feel the bottom player establishing SLX hooks, before they can settle into the position and build sweep momentum. Grab the hooking foot the instant it contacts your hip and initiate the backstep without allowing the bottom player to optimize their angle or grips. This preemptive approach catches guard players during their most vulnerable setup phase. (When to use: Against guard players who telegraph their SLX entries, or when transitioning from another guard configuration into SLX. The brief setup window before the guard is fully established is the optimal moment for this variation.)
...
- [[Positions/Leg Entanglement]] - Fundamental principle underlying the leg isolation and control mechanics of this technique
- [[Positions/Ashi Garami/Inside Ashi-Garami]] - Related leg entanglement position accessible as a transition when kneebar is defended
- [[Positions/X-Guard]] - Related guard position where similar kneebar counter-attacks are available from top
- [[Positions/Ashi Garami/Outside Ashi-Garami]] - Alternative leg entanglement entry from SLX when kneebar angle is unavailable
