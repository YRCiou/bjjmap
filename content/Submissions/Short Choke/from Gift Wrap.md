...
---
title: "Short Choke from Gift Wrap | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Short Choke from Gift Wrap", "item": "https://bjjmap.pages.dev/Submissions/Short-Choke-from-Gift-Wrap" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Short Choke from Gift Wrap \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Gift Wrap Arm Triangle / Ezekiel Choke",
      "description": "Short Choke from Gift Wrap film study: Gift Wrap Arm Triangle / Ezekiel Choke, taught by Prosaic Living.",
    ...
    },
    {
      ...
      "description": "Short Choke from Gift Wrap film study: Gift Wrap Rear Naked Choke, taught by Doug Taylor.",
...
<p class="section-subtitle">Watch Short Choke from Gift Wrap in action — curated instructionals</p>
...
| **Key Principles** | The Gift Wrap arm trap removes half the defender's grip figh... | Prevention is the primary defense - stop the forearm from th... |
