...
---
title: "Armbar from Side Control | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Armbar from Side Control", "item": "https://bjjmap.pages.dev/Submissions/Armbar-from-Side-Control" }
  ]
}
</script>
...
| **Key Principles** | Control the opponent's head and far hip to prevent escape be... | Keep elbows tight to your body at all times—never extend arm... |
