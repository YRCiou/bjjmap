...
---
title: "Armbar from Back with Legs | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Armbar from Back with Legs", "item": "https://bjjmap.pages.dev/Submissions/Armbar-from-Back-with-Legs" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Armbar from Back with Legs \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Armbar from back control",
      "description": "Armbar from Back with Legs film study: Armbar from back control, taught by Cesar Lima.",
    ...
    },
    {
      ...
      "description": "Armbar from Back with Legs film study: Armbar from back mount (Danaher system), taught by Aaron Milam.",
    ...
    },
    {
      ...
      "description": "Armbar from Back with Legs film study: Armbar from the back variation, taught by Malachy Friedman.",
...
<p class="section-subtitle">Watch Armbar from Back with Legs in action — curated instructionals</p>
...
| **Key Principles** | Maintain back control throughout the transition using leg co... | Maintain tight elbows against your body at all times during ... |
