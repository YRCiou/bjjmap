...
---
title: "Rear Naked Choke from Invisible Collar Attacker | BJJ Submission Guide | BJJ Map"
description: "Learn to attack with the Rear Naked Choke from Invisible Collar. Master collar-to-RNC switch timing, grip transition mechanics, and finishing details."
---
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What anatomical structures does the Rear Naked Choke from Invisible Collar target?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The RNC targets the carotid arteries on both sides of the neck, compressing them to restrict blood flow to the brain. The choking arm's radius bone presses against one carotid while the bicep of the same arm compresses the other. The figure-four lock behind the head creates a sealed compression chamber that eliminates gaps in the circumferential pressure around the neck."
      }
    },
    {
      "@type": "Question",
      "name": "What indicators confirm your opponent is ready to be caught by the collar-to-RNC transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Both of the opponent's hands are actively gripping your collar arm, their attention is focused downward toward the collar rather than protecting their chin, and there is a slight forward lean as they strain to strip the grip. When you feel maximum resistance on the collar hand with both their hands fully engaged on your wrist and forearm, the neck is maximally exposed for the transition."
      }
    },
    {
      "@type": "Question",
      "name": "What positional control must be established before attempting the collar-to-RNC transition?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You need secure hook control with at least one deep hook, a functioning seatbelt with your non-collar arm that will maintain back control during the switch, and your chest firmly connected to the opponent's upper back. Your hips should be slightly below theirs to prevent rolling escapes. The collar grip must be deep enough that the opponent perceives it as a genuine finishing threat requiring two-handed defense."
      }
    },
    {
      "@type": "Question",
      "name": "At what point during the transition does the opponent lose the ability to defend effectively?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The point of no escape occurs when the choking forearm passes fully under the chin and your hand contacts the opposite bicep to form the figure-four lock. Once this connection is established, even loosely, the opponent cannot remove the arm without first breaking the lock. The critical window is the 1-2 seconds between collar release and bicep connection. If you achieve this before they redirect their hands, the finish is virtually guaranteed."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "What are the critical finishing errors that reduce effectiveness and increase injury risk?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The most dangerous error is placing the forearm directly across the trachea, creating a windpipe crush instead of a blood choke. Other common errors include cranking the neck backward by pulling the head rather than squeezing elbows together, failing to use the locking hand to push the head forward into the choke, and applying explosive jerking force rather than progressive steady compression. Each error reduces submission effectiveness while increasing injury risk substantially."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Rear Naked Choke from Invisible Collar Attacker",
  "description": "Learn to attack with the Rear Naked Choke from Invisible Collar. Master collar-to-RNC switch timing, grip transition mechanics, and finishing details.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Submissions/Rear-Naked-Choke-from-Invisible-Collar"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Submissions/Rear-Naked-Choke-from-Invisible-Collar/Attacker"
    }
  ]
}
</script>
...
<p class="section-subtitle">What are the key principles for executing Rear Naked Choke from Invisible Collar?</p>
...
<p class="section-subtitle">What do you need before attempting Rear Naked Choke from Invisible Collar?</p>
...
<p class="section-subtitle">How do you execute Rear Naked Choke from Invisible Collar step by step?</p>
...
| Failure | [[Positions/Rubber Guard/Invisible Collar]] | 23% |
...
<p class="section-subtitle">What mistakes should you avoid when executing Rear Naked Choke from Invisible Collar?</p>
...
<p class="section-subtitle">How do you train Rear Naked Choke from Invisible Collar (Attacker)?</p>

**Phase 1: Grip Mechanics** - Collar-to-RNC hand transition in isolation
Practice the collar release and arm threading motion without resistance. Partner sits passively while you repeat the transition 20-30 times per side, focusing on making the release-and-thread one continuous fluid motion. Build muscle memory for the hand path from collar to neck.

**Phase 2: Timing Recognition** - Reading opponent hand commitment
Partner provides 30-50% resistance and defends the collar with varying levels of hand commitment. Practice identifying the moment both hands engage the collar and executing the switch only when the window is genuinely open. Reset when you mistime the transition.

**Phase 3: Live Transition Drilling** - Complete collar-to-RNC chain under progressive resistance
Start from established invisible collar with partner at 50-75% resistance. Execute the full sequence from collar deepening through RNC finish. Partner defends realistically but allows the transition to complete. Focus on maintaining back control throughout and finishing with proper blood choke mechanics.

**Phase 4: Positional Sparring** - Full speed application with complete defensive resistance
Begin from back control with full resistance. Must establish invisible collar, bait the defense, and execute the RNC transition against an actively resisting partner. Partner uses all available defenses. Track success rate over multiple rounds to identify timing and mechanical improvements needed.

**Phase 5: Chain Integration** - Collar-RNC-collar cycling against experienced partners
Practice alternating between collar deepening and RNC attempts as a continuous chain. If the RNC fails, return to the collar. If the collar is defended, switch to the RNC. Develop the ability to cycle between both threats fluidly until the finish presents itself against partners who understand both attacks.
