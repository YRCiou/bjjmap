...
---
title: "Mir Lock from Side Control Defender | BJJ Defense Guide | BJJ Map"
description: "How to defend against Mir Lock in BJJ. Recognition, escape paths, and defensive strategies."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Defend Mir Lock from Side Control in BJJ",
  "description": "Step-by-step guide for defending and escaping Mir Lock from Side Control in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Grip your own belt, gi lapel, or pants to prevent arm extension and create a defensive anchor",
      "text": "As soon as you feel the attacker isolating your arm and before they establish the figure-four grip If successful: Attacker cannot complete the figure-four grip and must either break your grip (wasting energy and time) or abandon the submission and return to positional control",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Explosive bridge toward the trapped arm while turning your body into the attacker to close the hyperextension angle",
      "text": "When the attacker commits their weight forward to apply finishing pressure, creating a momentary balance vulnerability If successful: The bridge disrupts the attacker's base and the body turn reduces the shoulder angle, allowing you to extract your arm and recover half guard or close guard",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Frame against the attacker's hip with your free hand and shrimp away to create distance and extract the trapped arm",
      "text": "When the attacker's figure-four grip is not yet fully locked or when they lift their hips slightly during the submission attempt If successful: The hip frame creates enough space to slide your trapped arm free and immediately insert your knee for half guard recovery",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Roll toward the trapped arm to invert the shoulder angle and reduce hyperextension pressure",
      "text": "When the lock is partially applied and you cannot break the grip - this is an emergency defense to buy time If successful: Rolling inverts the mechanical angle and can cause the attacker to lose their figure-four grip, potentially allowing you to come to top position",
      "position": 4
    }
  ],
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Mir Lock from Side Control Defender",
  "description": "How to defend against Mir Lock in BJJ. Recognition, escape paths, and defensive strategies.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Submissions/Mir-Lock-from-Side-Control"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Defender",
      "item": "https://bjjmap.pages.dev/Submissions/Mir-Lock-from-Side-Control/Defender"
    }
  ]
}
</script>
...
<p class="section-subtitle">How do you know when someone is attempting Mir Lock from Side Control?</p>
...
<p class="section-subtitle">What are the key principles for defending Mir Lock from Side Control?</p>
...
<p class="section-subtitle">What can you do to defend against Mir Lock from Side Control?</p>
...
<p class="section-subtitle">How do you escape Mir Lock from Side Control?</p>
...
<p class="section-subtitle">What is the best outcome when defending Mir Lock from Side Control?</p>
...
<p class="section-subtitle">What mistakes should you avoid when defending Mir Lock from Side Control?</p>
...
<p class="section-subtitle">How do you train defense against Mir Lock from Side Control?</p>

**Phase 1: Recognition and Prevention Drilling** - Identifying Mir Lock setups and maintaining preventive arm positioning
...
**Phase 2: Grips and Early Escape** - Breaking the figure-four grip and escaping before the lock is applied
...
**Phase 3: Emergency Defense Under Pressure** - Late-stage defense when the submission is partially applied
Partner applies the Mir Lock with progressive pressure while you practice the bridge-and-turn escape, rolling toward the trapped arm, and the emergency tap protocol. Build confidence in your ability to recognize when escape is still possible versus when tapping is the correct decision. Partner should vary pressure speed to simulate different levels of urgency and build your decision-making under stress.

**Phase 4: Live Defensive Sparring Integration** - Full resistance defense within complete side control bottom game
