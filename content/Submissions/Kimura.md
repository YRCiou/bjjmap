...
---
title: "Kimura | BJJ Submission Family | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kimura", "item": "https://bjjmap.pages.dev/Submissions/Kimura" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Kimura \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Kimura and armbar from side control",
      "description": "Kimura film study: Kimura and armbar from side control, taught by BJJ Recap.",
    ...
    },
    {
      ...
      "description": "Kimura film study: North-south kimura grip to armbar, taught by Raven Jiu Jitsu.",
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Kimura",
  "description": "The Kimura is a figure-four shoulder lock that rotates the opponent's arm behind their back to attack the rotator cuff and shoulder capsule, usable as both a finish and a controlling grip from nearly every position in grappling.",
...
**The Kimura is a figure-four shoulder lock that rotates the opponent's arm behind their back to attack the rotator cuff and shoulder capsule, usable as both a finish and a controlling grip from nearly every position in grappling.**
...
> [!danger] Safety
> Kimura targets the Shoulder joint, rotator cuff, and shoulder capsule. Primary risk: Rotator cuff tear (supraspinatus, infraspinatus, teres minor, subscapularis). Tap early; release immediately on the tap. [Full safety guide ↓](#safety-considerations)
...
<p class="section-subtitle">Watch Kimura in action — curated instructionals</p>
...
- [[Submissions/Arm Triangle]] - Complementary submission from side control when Kimura defense exposes the neck
