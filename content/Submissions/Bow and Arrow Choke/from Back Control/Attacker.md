...
---
title: "Bow and Arrow Choke from Back Control Attacker | BJJ Submission Guide | BJJ Map"
description: "Learn to attack the Bow and Arrow Choke from back control. Step-by-step collar grip entry, leg leverage, finishing mechanics, and counter-strategies for this elite gi choke."
---
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "What is the correct depth for the collar grip, and how do you recognize when it is too shallow?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The correct depth positions the blade of your wrist directly across the carotid artery, with the collar seam past the opponent's chin line and sitting on the front of the neck. A grip is too shallow when the collar material sits on the jaw or chin rather than the neck, when the opponent can relieve pressure by simply tucking their chin, or when the choke produces pain in the jaw but no blood restriction sensation. Walk the grip deeper using a caterpillar motion if the initial placement is above the chin."
      }
    },
    {
      "@type": "Question",
      "name": "Why is controlling the far leg essential to the bow and arrow finish, and what happens without it?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The far leg grip creates the opposing force vector that gives the bow and arrow its mechanical advantage. Without the leg control, the choke relies solely on collar pull, which generates insufficient compression because the opponent can simply follow the direction of pull and close the gap. The leg grip stretches the opponent's body into an arc, preventing them from tucking or rotating to relieve pressure, and multiplies the effective force on the collar by creating a longer lever arm between the two grip points."
      }
    },
    {
      "@type": "Question",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Bow and Arrow Choke from Back Control Attacker",
  "description": "Learn to attack the Bow and Arrow Choke from back control. Step-by-step collar grip entry, leg leverage, finishing mechanics, and counter-strategies for this elite gi choke.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Submissions/Bow-and-Arrow-Choke-from-Back-Control"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Submissions/Bow-and-Arrow-Choke-from-Back-Control/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Bow and Arrow Choke from Back Control (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Bow and Arrow Choke from Back Control",
      "description": "Bow and Arrow Choke from Back Control (Attacker) film study: Bow and Arrow Choke from Back Control, taught by Evolve MMA.",
    ...
    },
    {
      ...
      "description": "Bow and Arrow Choke from Back Control (Attacker) film study: Bow and Arrow Choke, taught by Helena Crevar.",
    ...
    },
    {
      ...
      "description": "Bow and Arrow Choke from Back Control (Attacker) film study: Bow and Arrow Choke from the Back, taught by Procel BJJ.",
...
<p class="section-subtitle">Watch Bow and Arrow Choke from Back Control (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Bow and Arrow Choke from Back Control?</p>
...
<p class="section-subtitle">What do you need before attempting Bow and Arrow Choke from Back Control?</p>
...
<p class="section-subtitle">How do you execute Bow and Arrow Choke from Back Control step by step?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Bow and Arrow Choke from Back Control?</p>
...
<p class="section-subtitle">How do you train Bow and Arrow Choke from Back Control (Attacker)?</p>

**Phase 1: Grip Mechanics** - Collar grip establishment from seatbelt
Practice feeding the collar grip from the seatbelt position with a stationary partner. Focus on hand placement, depth of grip past the chin line, and maintaining the bottom arm seatbelt during transition. Drill 20 repetitions per side until the grip change becomes fluid.

**Phase 2: Positional Transition** - Full sequence from back control to finishing position
Drill the complete transition: collar grip, hip slide, leg grab, perpendicular rotation, and finishing extension with a compliant partner. Emphasize maintaining control at each checkpoint before progressing to the next step. Practice 10 full repetitions per side.

**Phase 3: Progressive Resistance** - Executing against increasing defensive resistance
Partner provides graduated resistance (25%, 50%, 75%) focusing on common defenses: grip stripping, chin tucking, turning in, and blocking the leg grab. Attacker practices adjusting technique in real-time to overcome each defensive layer.

**Phase 4: Chain Integration** - Combining with RNC and armbar as back attack system
Practice the bow and arrow as part of a three-attack system from back control. Drill transitioning between RNC attempt, bow and arrow setup, and armbar based on the opponent's defensive reactions. Flow between attacks without resetting position.

**Phase 5: Live Application** - Competition-speed execution in sparring
Specific sparring starting from back control. Attacker must use bow and arrow as primary attack with RNC and armbar as secondary options. Focus on reading defensive reactions, timing the collar entry, and committing decisively to the finish. Track success rate over 10 rounds.
