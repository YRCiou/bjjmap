...
---
title: "Outside Heel Hook from Saddle | BJJ Submission | BJJ Map"
description: "Master the outside heel hook from saddle position with proper grip mechanics, rotational finishing details, and critical safety protocols for training."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Outside Heel Hook from Saddle", "item": "https://bjjmap.pages.dev/Submissions/Outside-Heel-Hook-from-Saddle" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Outside Heel Hook from Saddle",
  "description": "The outside heel hook from the Saddle is a leg-lock finish that rotates the opponent's heel laterally to torque the knee's lateral ligaments, used as the counter-threat when a defender hides their heel to escape the inside heel hook.",
...
**The outside heel hook from the Saddle is a leg-lock finish that rotates the opponent's heel laterally to torque the knee's lateral ligaments, used as the counter-threat when a defender hides their heel to escape the inside heel hook.**
...
> [!danger] Safety
> Outside Heel Hook from Saddle targets the Knee joint, ankle joint, and surrounding ligaments. Primary risk: ACL tear (anterior cruciate ligament rupture). Tap early; release immediately on the tap. [Full safety guide ↓](#safety-considerations)
...
- **Confirm Saddle Control**: Verify perpendicular alignment with your hips pressuring directly into the opponent's trapped thigh....

- **Read Defensive Posture**: Assess the opponent's heel protection by observing their knee rotation and foot positioning. If thei...

- **Transition to Outside Heel Cup**: Shift your bottom hand from its positional control grip to cup the opponent's heel from the lateral ...

- **Establish Figure-Four Lock**: Thread your top arm under the opponent's Achilles tendon and connect to your own wrist or bicep in a...

- **Apply Hip Extension**: Drive your hips forward into the opponent's trapped leg while simultaneously pulling the heel toward...

- **Execute Lateral Heel Rotation**: With the figure-four locked and extension established, rotate the heel outward using a slow, control...

- **Complete Finish or Release**: Maintain constant hip pressure and controlled rotation until the opponent taps verbally, physically,...
...
- [[Positions/Ashi Garami/Backside 50-50]] - Related leg entanglement with outside heel hook opportunities
