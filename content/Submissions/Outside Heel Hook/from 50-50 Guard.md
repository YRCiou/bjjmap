...
---
title: "Outside Heel Hook from 50-50 Guard | BJJ Submission | BJJ Map"
description: "Master the outside heel hook from 50-50 guard. Learn grip mechanics, heel exposure techniques, and safe finishing details for this high-risk leg lock attack."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Outside Heel Hook from 50-50 Guard", "item": "https://bjjmap.pages.dev/Submissions/Outside-Heel-Hook-from-50-50-Guard" }
  ]
}
</script>
...
- **Establish inside leg control**: From the 50-50 entanglement, fight for inside position by pressing your shin inside the opponent's l...

- **Strip defensive grips with two-on-one**: Use both hands to attack one of the opponent's defensive grips at a time. Prioritize stripping the h...

- **Control and rotate the foot for heel exposure**: Once defensive grips are broken, secure the opponent's foot with both hands. Place one hand on the t...

- **Lock the figure-four grip on the heel**: Thread your attacking forearm behind the exposed heel with your wrist bone seated firmly against the...

- **Secure the knee line**: Pinch your knees together around the opponent's leg just above their knee joint. This knee line cont...

- **Create the finishing angle with hip positioning**: Angle your hips so they face perpendicular to the opponent's trapped leg rather than parallel. This ...

- **Apply finishing rotation with hip extension**: Extend your hips forward while rotating the opponent's heel laterally away from their body through t...
...
**Standard Supine Finish**: Apply the outside heel hook while remaining on your back in the 50-50 entanglement. Cup the heel with a figure-four grip and use hip extension combined with lateral rotation to generate finishing pressure. This is the highest-percentage variation as it maintains maximum leg entanglement stability throughout the attack. (When to use: Default finishing position when inside control is established and heel is exposed through grip fighting)


**Seated Post Finish**: Sit up and post on one hand while maintaining the heel hook grip with the other arm threaded through the figure-four. The seated position generates additional downward pressure through gravity and allows you to angle your torso perpendicular to the opponent's leg for stronger rotational leverage. (When to use: When opponent is actively trying to sit up and you need additional control leverage to maintain the finishing position)


**Transition to Outside Ashi Finish**: Extract your inside leg from the 50-50 entanglement while maintaining the heel grip, transitioning to outside ashi-garami. This creates a stronger finishing angle with your hips fully behind the opponent's leg and eliminates the positional symmetry that allows counter-attacks from 50-50. (When to use: When opponent's defensive grip fighting is strong in the 50-50 configuration and you need a cleaner finishing angle)
