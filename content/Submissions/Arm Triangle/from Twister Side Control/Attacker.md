...
---
title: "Arm Triangle from Twister Side Control Attacker | BJJ Submission Guide | BJJ Map"
description: "Step-by-step guide to finishing the Arm Triangle from Twister Side Control. Learn grip transitions, finishing angles, and how to capitalize on defensive reactions."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Arm Triangle from Twister Side Control in BJJ",
  "description": "Step-by-step guide for Arm Triangle from Twister Side Control with safety protocols.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Recognize the frame defense",
      "text": "From your Twister Side Control top position, feel the opponent push their near-side arm across their own neck to create a frame against your shoulder pressure and choking threat. This arm crossing their neck is your trigger to transition. Do not fight the frame - instead, welcome it as the setup for the arm triangle.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Pin the trapped arm with chest pressure",
      "text": "Before releasing any part of your controlling grip, drive your chest forward and down onto the opponent's framing arm, pinning it tight against their neck. Your body weight secures the arm in place while you prepare the grip transition. The arm must have no space between their shoulder and their neck.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Swim to head-and-arm control",
      "text": "Release your controlling grip and immediately thread your choking arm over the opponent's trapped arm and behind the back of their neck. Your forearm crosses behind their neck with the blade pressing against the far-side carotid. Move smoothly without creating any gap that would allow head extraction.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Lock the figure-four or gable grip",
      "text": "Connect your hands by gripping your own bicep with the choking hand while your free hand cups behind the opponent's head, or use a tight gable grip. The grip must lock the opponent's head and trapped arm together as a unit with no slack in the configuration.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Walk to the finishing angle",
      "text": "Disengage your legs from the Twister Side Control leg entanglement and walk your hips around toward the opponent's trapped-arm side until you are perpendicular to their body. Your chest should be directly over their face. Each step tightens the choke by removing available space between your bodies.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Drop hip and seal the position",
      "text": "Drop your hip closest to their trapped arm to the mat, sprawling your weight onto the opponent. Your head drops low to the mat on the far side of their head. This seals the position and removes the space opponents use to breathe or create defensive frames. Your body acts as a wall.",
      "position": 6
    },
    {
      "@type": "HowToStep",
      "name": "Apply progressive squeeze",
      "text": "Expand your chest while pulling your elbows together toward your own centerline. The opponent's trapped shoulder compresses one carotid artery while your forearm compresses the other. Apply slow, steady, progressive pressure rather than explosive squeezing. Wait for the tap or feel the resistance fade.",
      "position": 7
    }
  ],
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What anatomical structures does the Arm Triangle from Twister Side Control attack?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The arm triangle compresses both carotid arteries simultaneously. The opponent's own trapped shoulder presses into one carotid from the near side, while your forearm blade crosses behind their neck and presses into the opposite carotid from the far side. This bilateral compression restricts blood flow to the brain, causing unconsciousness in 6-8 seconds if not released."
      }
    },
    {
      "@type": "Question",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Arm Triangle from Twister Side Control Attacker",
  "description": "Step-by-step guide to finishing the Arm Triangle from Twister Side Control. Learn grip transitions, finishing angles, and how to capitalize on defensive reactions.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Submissions/Arm-Triangle-from-Twister-Side-Control"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Submissions/Arm-Triangle-from-Twister-Side-Control/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Arm Triangle from Twister Side Control (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Advanced Arm Triangle from Twister Side",
      "description": "Arm Triangle from Twister Side Control (Attacker) film study: Advanced Arm Triangle from Twister Side, taught by Eddie Bravo.",
      "thumbnailUrl": "https://i.ytimg.com/vi/CuhFzPhwvQA/hqdefault.jpg",
      "embedUrl": "https://www.youtube.com/embed/CuhFzPhwvQA",
      "url": "https://www.youtube.com/watch?v=CuhFzPhwvQA",
    ...
    },
    {
      ...
      "description": "Arm Triangle from Twister Side Control (Attacker) film study: Twister Side Control Attacks, taught by Eddie Bravo.",
    ...
    },
    {
      ...
      "description": "Arm Triangle from Twister Side Control (Attacker) film study: Twister Side Control, taught by Eddie Bravo.",
...
The Arm Triangle from Twister Side Control attacks the carotid arteries using the opponent's own trapped shoulder combined with your forearm pressure. This finish capitalizes on one of the most common defensive reactions in Twister Side Control: the near-side arm frame against shoulder pressure and lateral torque. When your opponent pushes their arm across to relieve pressure, they inadvertently position their arm against their own neck, creating the head-and-arm configuration. Your task is to recognize this moment, pin the trapped arm with chest pressure, establish the head-and-arm grip, and finish with progressive chest-to-chest compression while controlling the angle. The key advantage of attacking from Twister Side Control is that the rotational torque and leg entanglement already break the opponent's posture and alignment, making the arm triangle finish more accessible than from traditional side control positions.
...
<p class="section-subtitle">Watch Arm Triangle from Twister Side Control (Attacker) in action — curated instructionals</p>


<div class="film-clip">

![](https://www.youtube.com/watch?v=CuhFzPhwvQA)

<p class="clip-credit"><strong>Advanced Arm Triangle from Twister Side</strong> — taught by Eddie Bravo · 1:01 · <a href="https://www.youtube.com/watch?v=CuhFzPhwvQA" rel="noopener">Watch on YouTube</a></p>
...
<p class="section-subtitle">What are the key principles for executing Arm Triangle from Twister Side Control?</p>
...
<p class="section-subtitle">What do you need before attempting Arm Triangle from Twister Side Control?</p>

- Established Twister Side Control position with shoulder pressure and controlling grip on opponent's neck
- Opponent has created a near-side arm frame across their own neck as a defensive response to the shoulder pressure and choking threat
- Your hips are positioned to allow transition from Twister Side Control configuration to perpendicular finishing angle
...
<p class="section-subtitle">How do you execute Arm Triangle from Twister Side Control step by step?</p>

1. **Recognize the frame defense**: From your Twister Side Control top position, feel the opponent push their near-side arm across their own neck to create a frame against your shoulder pressure and choking threat. This arm crossing their neck is your trigger to transition. Do not fight the frame - instead, welcome it as the setup for the arm triangle. (Timing: Immediate recognition, 0-1 seconds)
...
| Failure | [[Positions/Twister Control/Twister Side Control]] | 25% |
...
<p class="section-subtitle">How might your opponent defend against Arm Triangle from Twister Side Control?</p>

- **Opponent extracts trapped arm before grip is locked** (Effectiveness: High) - Your Response: If the arm clears, immediately return to your controlling position in Twister Side Control since the opponent removed their own defense. Reset and wait for the frame to reappear. → Leads to [[Positions/Twister Control/Twister Side Control]]
- **Opponent bridges and rolls toward the choking arm side** (Effectiveness: Medium) - Your Response: Post your far-side hand and widen your base on the rolling side. If rolled, maintain the grip and finish from bottom using a guard arm triangle configuration. → Leads to [[Positions/Twister Control/Twister Side Control]]
- **Opponent frames with far arm to create space and prevent chest-to-chest pressure** (Effectiveness: Medium) - Your Response: Use your free hand to strip their far-side frame by swimming inside their elbow. Walk further toward their head to collapse the space their frame creates. → Leads to [[Positions/Twister Control/Twister Side Control]]
- **Opponent pulls guard and locks closed guard to prevent hip walk-around** (Effectiveness: Low) - Your Response: Maintain the head-and-arm grip and work to open their guard by posting your knee into their tailbone. Once the guard opens, immediately walk to the finishing angle. → Leads to [[Positions/Closed Guard]]
...
<p class="section-subtitle">What mistakes should you avoid when executing Arm Triangle from Twister Side Control?</p>

### 1. Releasing controlling grip too early before chest pressure secures the trapped arm
...
### 6. Rushing the transition and losing the Twister Side Control position entirely
...
- **Correction**: The transition should be smooth and deliberate, not explosive. Maintain constant pressure throughout. If the transition stalls, return to your controlling position in Twister Side Control rather than forcing a bad arm triangle.
...
<p class="section-subtitle">How do you train Arm Triangle from Twister Side Control (Attacker)?</p>

**Phase 1: Grip transition mechanics** - Developing the smooth switch from controlling grip to head-and-arm configuration
Partner starts in Twister Side Control bottom with their near arm across their neck in frame position. Practice the grip switch to arm triangle with zero resistance, focusing on maintaining chest pressure on the trapped arm throughout the transition. Repeat 20 times per side. No finishing attempts.

**Phase 2: Finishing angle and compression** - Walking to the correct angle and generating choke pressure through body mechanics
Start with the arm triangle grip already established. Partner gives 30% resistance. Practice walking your hips to the perpendicular angle, dropping your hip, and applying progressive chest compression. Partner provides feedback on pressure location and when the choke becomes effective. Alternate sides.

**Phase 3: Transition chain from Twister Side Control** - Recognizing the frame defense and flowing to the arm triangle in live motion
Partner starts in Twister Side Control bottom and alternates between defending with frames (triggering arm triangle) and defending without frames (staying in position). Practice recognizing which defense is being used and flowing to the appropriate attack. 50% resistance, 3-minute rounds.

**Phase 4: Live positional sparring** - Applying the full technique chain against progressive resistance
Start from Twister Side Control top position. Partner gives 70-100% resistance with all defensive options available. Practice the full sequence: recognize frame, transition grip, walk to angle, finish. If the arm triangle fails, return to controlling position and try again. 5-minute rounds with full reset on escape.
