...
---
title: "Arm Triangle from Turtle | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Arm Triangle from Turtle", "item": "https://bjjmap.pages.dev/Submissions/Arm-Triangle-from-Turtle" }
  ]
}
</script>
...
| **Key Principles** | Maintain heavy chest-to-back pressure throughout the setup t... | Recognize the arm triangle setup early by monitoring for the... |
