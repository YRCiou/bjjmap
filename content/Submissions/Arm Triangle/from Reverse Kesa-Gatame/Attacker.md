...
---
title: "Arm Triangle from Reverse Kesa-Gatame Attacker | BJJ Submission Guide | BJJ Map"
description: "Step-by-step guide to finishing the Arm Triangle from Reverse Kesa-Gatame. Learn to exploit natural arm isolation, grip transitions, and finishing angles from reverse scarf hold."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Arm Triangle from Reverse Kesa-Gatame in BJJ",
  "description": "Step-by-step guide for Arm Triangle from Reverse Kesa-Gatame with safety protocols.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Secure the far arm isolation",
      "text": "From established Reverse Kesa-Gatame, verify the opponent's far arm is clamped tightly under your armpit with your elbow squeezed against your ribs. Your body weight should pin them flat while this arm remains fully controlled. If there is any slack in the armpit clamp, readjust by squeezing your elbow tighter and sinking your weight before proceeding to the next step.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Drive the far arm across the opponent's neck",
      "text": "Using your armpit control, push and drag the opponent's trapped far arm across their own face and neck so their shoulder presses against their near-side carotid artery. Drop your chest weight onto the arm to pin it in the across-neck position. The arm must be driven far enough that the shoulder bone makes firm contact with the neck. Do not release your armpit clamp until the arm is firmly positioned against the carotid.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Thread the choking arm behind the neck",
      "text": "Release your near-arm control and immediately thread your arm closest to the opponent's head over the top of their trapped arm and behind the back of their neck. Your forearm blade should cross behind the neck and press against the far-side carotid artery. This movement must be smooth and continuous with no pause that would allow the opponent to extract their trapped arm during the transition window.",
      "position": 3
    },
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What anatomical structures does the Arm Triangle from Reverse Kesa-Gatame attack?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The arm triangle compresses both carotid arteries simultaneously to restrict blood flow to the brain. The opponent's own trapped shoulder is driven against their near-side carotid artery, while your forearm blade crosses behind their neck and presses against the far-side carotid. This bilateral compression causes unconsciousness in 6-8 seconds if not released. The mechanism is a blood choke, not an airway restriction."
      }
    },
    {
      "@type": "Question",
      "name": "Your opponent keeps their far arm pinned tightly against their own body while you hold Reverse Kesa-Gatame — how do you create the arm triangle opportunity?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "What grip configuration completes the head-and-arm lock in the arm triangle from Reverse Kesa-Gatame?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The primary grip is a figure-four configuration where the choking hand grips your own bicep on the opposite arm, and the free hand cups behind the opponent's head. This creates a self-reinforcing lock that tightens under pressure. An alternative is the gable grip where both palms clasp together behind the opponent's neck, providing tighter initial compression but less long-term endurance. Both grips must lock the head and trapped arm together as a single unit with zero slack."
      }
    },
    {
      "@type": "Question",
      "name": "The opponent bridges explosively during your grip transition from Reverse Kesa-Gatame pin to arm triangle — what is your immediate response?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "What body angle creates maximum finishing pressure once the arm triangle is locked from Reverse Kesa-Gatame?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Arm Triangle from Reverse Kesa-Gatame Attacker",
  "description": "Step-by-step guide to finishing the Arm Triangle from Reverse Kesa-Gatame. Learn to exploit natural arm isolation, grip transitions, and finishing angles from reverse scarf hold.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Submissions/Arm-Triangle-from-Reverse-Kesa-Gatame"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Submissions/Arm-Triangle-from-Reverse-Kesa-Gatame/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Arm Triangle from Reverse Kesa-Gatame (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Reverse Kesa Gatame Arm Attack Roll Over",
      "description": "Arm Triangle from Reverse Kesa-Gatame (Attacker) film study: Reverse Kesa Gatame Arm Attack Roll Over, taught by Carlos Machado.",
    ...
    },
    {
      ...
      "description": "Arm Triangle from Reverse Kesa-Gatame (Attacker) film study: Side Guard to Te Gatame (Arm Triangle), taught by Gordon Ryan.",
    ...
    },
    {
      ...
      "description": "Arm Triangle from Reverse Kesa-Gatame (Attacker) film study: Triangle Attacks From Kuzure Kesa Gatame, taught by Chokes And More.",
...
<p class="section-subtitle">Watch Arm Triangle from Reverse Kesa-Gatame (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Arm Triangle from Reverse Kesa-Gatame?</p>
...
<p class="section-subtitle">What do you need before attempting Arm Triangle from Reverse Kesa-Gatame?</p>
...
<p class="section-subtitle">How do you execute Arm Triangle from Reverse Kesa-Gatame step by step?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Arm Triangle from Reverse Kesa-Gatame?</p>
...
<p class="section-subtitle">How do you train Arm Triangle from Reverse Kesa-Gatame (Attacker)?</p>

**Phase 1: Arm drive mechanics from static position** - Developing the smooth arm drive from armpit clamp to across-neck position
Partner lies flat in Reverse Kesa-Gatame bottom with their far arm loosely positioned under your armpit. Practice the arm drive sequence: tighten clamp, push arm across neck, verify shoulder-on-carotid placement. Zero resistance, focus on mechanical precision and maintaining chest pressure throughout the drive. Repeat 20 times per side.

**Phase 2: Grip transition and head-and-arm lock** - Smooth transition from pin grips to arm triangle configuration without losing control
...
**Phase 3: Walk-around angle and finishing compression** - Walking to the perpendicular angle and generating choke pressure through body mechanics
...
**Phase 4: Full sequence from Reverse Kesa-Gatame** - Connecting all phases into one fluid submission sequence
Start from established Reverse Kesa-Gatame top. Execute the complete sequence: verify arm isolation, drive arm across neck, thread behind head, lock grip, walk to angle, finish. Partner provides 50-70% resistance with realistic defensive reactions. If the arm triangle stalls at any phase, return to maintaining the Reverse Kesa-Gatame pin and reset. 5-minute rounds.

**Phase 5: Live positional sparring with submission cycling** - Integrating the arm triangle into the full Reverse Kesa-Gatame attack system
