...
---
title: "Ankle Lock from X-Guard | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Ankle Lock from X-Guard", "item": "https://bjjmap.pages.dev/Submissions/Ankle-Lock-from-X-Guard" }
  ]
}
</script>
...
| **Key Principles** | Secure the ankle grip before releasing X-Guard hooks — prema... | Recognize the transition from sweep threat to submission att... |
