...
---
title: "Twister from Cross Body Ride | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Twister from Cross Body Ride", "item": "https://bjjmap.pages.dev/Submissions/Twister-from-Cross-Body-Ride" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Twister from Cross Body Ride \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Twister Side Attacks",
      "description": "Twister from Cross Body Ride film study: Twister Side Attacks, taught by Eddie Bravo.",
    ...
    },
    {
      ...
      "description": "Twister from Cross Body Ride film study: Eddie Bravo\u0027s Twister, taught by Eddie Bravo.",
    ...
    },
    {
      ...
      "description": "Twister from Cross Body Ride film study: Twister from Side Control, taught by Eddie Bravo.",
...
<p class="section-subtitle">Watch Twister from Cross Body Ride in action — curated instructionals</p>
...
- **Transition from Cross Body Ride to leg entanglement**: From your established cross body ride, begin threading your legs to establish a leg triangle or lock...

- **Verify leg entanglement depth**: Confirm your leg triangle or lockdown on the opponent's far leg is deep and secure with your hips ti...
...
- **Thread near-side arm under chin**: Begin sliding your near-side forearm underneath the opponent's chin from the far side, working progr...

- **Establish finishing grip configuration**: Connect your threading hand to your far-side hand behind the opponent's head using a gable grip or f...

- **Apply controlled rotational pressure**: Begin the finishing sequence by driving your hips forward while simultaneously pulling the head cont...

- **Complete controlled finish or transition**: Continue slow, controlled rotation until the opponent taps verbally or physically. The finish combin...
...
**Standard Twister from Truck**: The classic entry where you establish full truck position with leg triangle on the far leg, then progressively thread the chin strap grip to complete the spinal lock. This is the highest-percentage setup because the truck provides the deepest leg entanglement and most stable rotational base. (When to use: When you have established full truck position with deep leg control and the opponent is defending conventionally)


**Twister from Twister Side Control**: A lateral entry variation where you transition from twister side control into the full Twister by first establishing the leg entanglement from a side position, then rotating the opponent into the classic spinal lock configuration. Requires additional steps but catches opponents who defend traditional truck entries. (When to use: When the opponent is defending truck entries effectively and you have established twister side control as an alternative)


**Quick Twister off Scramble**: An opportunistic variation where you catch the Twister during a scramble when the opponent exposes their back and you can quickly establish the leg entanglement and chin strap in rapid succession. Higher risk but effective against opponents who scramble aggressively from bottom positions. (When to use: During scrambles when the opponent exposes their back and you can rapidly establish both leg and head control before they recover)
