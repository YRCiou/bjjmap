...
---
title: "Kimura from Crucifix | BJJ Submission | BJJ Map"
description: "Master the Kimura from Crucifix in BJJ. Learn how bilateral arm isolation creates devastating shoulder lock opportunities with expert finishing mechanics."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kimura from Crucifix", "item": "https://bjjmap.pages.dev/Submissions/Kimura-from-Crucifix" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Kimura from Crucifix \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Crucifix kimura",
      "description": "Kimura from Crucifix film study: Crucifix kimura, taught by Rob.",
    ...
    },
    {
      ...
      "description": "Kimura from Crucifix film study: Chokes from T-kimura crucifix control, taught by Mig Mag.",
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Kimura from Crucifix",
  "description": "The Kimura from Crucifix is a figure-four shoulder lock applied from the crucifix position, where bilateral arm isolation removes the defender's standard two-handed Kimura defense, making it one of grappling's highest-percentage shoulder finishes.",
...
**The Kimura from Crucifix is a figure-four shoulder lock applied from the crucifix position, where bilateral arm isolation removes the defender's standard two-handed Kimura defense, making it one of grappling's highest-percentage shoulder finishes.**
<div class="principle-meta">
<span class="meta-chip">Joint Lock</span>
<span class="meta-chip">Shoulder Lock</span>
<span class="meta-chip">Targets Shoulder joint, rotator cuff, and shoulder capsule</span>
<span class="meta-chip">39% success</span>
</div>

> [!danger] Safety
> Kimura from Crucifix targets the Shoulder joint, rotator cuff, and shoulder capsule. Primary risk: Rotator cuff tear (supraspinatus, infraspinatus, teres minor, subscapularis). Tap early; release immediately on the tap. [Full safety guide ↓](#safety-considerations)
...
<p class="section-subtitle">Watch Kimura from Crucifix in action — curated instructionals</p>
...
- **Consolidate crucifix control**: Ensure your leg triangle is locked tight around the opponent's near arm with constant inward squeeze...

- **Isolate the target arm**: Identify the free arm controlled by your hands. Transition from a basic wrist grip to controlling th...

- **Establish the figure-four grip**: Thread your hand under the opponent's wrist and forearm, reaching across to grip your own wrist in t...

- **Pin the elbow to your body**: Clamp the opponent's elbow tight against your ribcage using your arms and body pressure. This elimin...

- **Begin controlled rotation**: Start rotating the opponent's wrist behind their back using your figure-four grip while keeping the ...

- **Apply progressive finishing pressure**: Continue the rotation arc behind the opponent's back while simultaneously lifting their elbow slight...

- **Complete finish and release safely**: If the opponent taps, immediately stop all rotational pressure and return the arm to neutral positio...
...
- **Applying Kimura rotation before securing a deep figure-four grip**
...
- **Using only arm strength to rotate instead of incorporating body mechanics**
...
**Standard Crucifix Kimura**: From established crucifix with legs trapping the near arm, secure figure-four grip on the far arm and rotate behind the opponent's back using body mechanics for force generation (When to use: When the opponent tucks their chin to defend choke attempts, exposing the free arm for the Kimura grip)


**Mounted Crucifix Kimura**: From mounted crucifix variation where you combine mount pressure with arm isolation, the Kimura grip benefits from additional weight and gravity reinforcing the rotational force (When to use: When you have transitioned from standard crucifix to mounted position while maintaining arm control and want maximum finishing pressure)


**Rolling Kimura from Crucifix**: When the opponent attempts a defensive roll to escape the crucifix, maintain the figure-four grip through the transition and finish the Kimura from the resulting position after following the roll (When to use: When the opponent initiates a defensive roll and you can maintain grip control throughout the positional change)
...
- [[Positions/Crucifix]] - Primary starting position for this submission variant
- [[Positions/Back Control]] - Position often leading to crucifix entry before Kimura attack
- [[Positions/Mount/Mounted Crucifix]] - Variant position where this submission also applies with added mount pressure
...
2. Return the arm toward neutral position by slowly externally rotating back to starting position
