...
---
title: "Kimura from Side Control | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kimura from Side Control", "item": "https://bjjmap.pages.dev/Submissions/Kimura-from-Side-Control" }
  ]
}
</script>
...
- [[Submissions/Arm Crush]] - Alternative arm attack from side control when opponent defends shoulder lock
