...
---
title: "Kimura from Side Control Attacker | BJJ Submission Guide | BJJ Map"
description: "How to execute Kimura from Side Control in BJJ. Attacking perspective with setup, execution, and finishing mechanics."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Execute Kimura from Side Control in BJJ",
  "description": "Step-by-step guide for Kimura from Side Control with safety protocols.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Establish Dominant Side Control",
      "text": "From side control, drive your chest weight into the opponent's chest and shoulder area, eliminating all space. Your near-side arm should control their head or far shoulder while your hips stay heavy on their torso. Ensure your base is wide with your far leg posted out for stability.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Isolate the Near Arm",
      "text": "Using your near-side hand, reach under the opponent's near arm (the arm closest to you) and grip their wrist. Simultaneously use your head and shoulder pressure to pin their upper body and prevent them from pulling the arm back to their body. The goal is to create separation between their elbow and their ribs.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Thread Your Arm for Figure-Four Grip",
      "text": "While maintaining wrist control with your near hand, thread your far arm over their arm and reach for your own wrist to establish the figure-four lock. Your forearm should be perpendicular to their forearm, creating the leverage structure. Keep your elbows tight together and close to their body to prevent them from straightening their arm.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Control the Hip and Establish Base",
      "text": "Post your near-side knee tight against the opponent's near hip to prevent them from turning into you. Your far leg should be posted wide and back for base. This hip control is critical - if they can turn toward you, they escape the submission. Maintain chest pressure throughout this adjustment.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Elevate the Elbow",
      "text": "With the figure-four grip secured, begin lifting their elbow toward the ceiling while keeping it close to their body. The elevation should be smooth and controlled, not sudden. As you lift, maintain downward pressure with your chest to keep their shoulder pinned to the mat. This creates the initial stretch on the shoulder.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Rotate the Arm Behind the Back",
      "text": "Once the elbow is elevated to approximately 90 degrees from their body, begin rotating their hand toward their back (like a hammerlock position). The rotation should be slow and progressive. The combination of elevation and rotation creates the shoulder lock. Stop immediately upon feeling tap or resistance.",
      "position": 6
    },
    {
      "@type": "HowToStep",
      "name": "Finish with Walking Motion",
      "text": "If needed for the finish, walk your hips toward their head while maintaining the figure-four grip and continuing the rotation. This walking motion increases the angle and pressure on the shoulder joint. Continue applying slow, steady pressure until the tap, never jerking or spiking the submission.",
      "position": 7
    }
  ],
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Kimura from Side Control Attacker",
  "description": "How to execute Kimura from Side Control in BJJ. Attacking perspective with setup, execution, and finishing mechanics.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://bjjmap.pages.dev/Submissions/Kimura-from-Side-Control"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Attacker",
      "item": "https://bjjmap.pages.dev/Submissions/Kimura-from-Side-Control/Attacker"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Kimura from Side Control (Attacker) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Set up Kimura from side control",
      "description": "Kimura from Side Control (Attacker) film study: Set up Kimura from side control, taught by Heiho Dojo.",
    ...
    },
    {
      ...
      "description": "Kimura from Side Control (Attacker) film study: Kimura finish from side control, taught by ZombieProofBJJ.",
...
<p class="section-subtitle">Watch Kimura from Side Control (Attacker) in action — curated instructionals</p>
...
<p class="section-subtitle">What are the key principles for executing Kimura from Side Control?</p>
...
<p class="section-subtitle">What do you need before attempting Kimura from Side Control?</p>
...
<p class="section-subtitle">How do you execute Kimura from Side Control step by step?</p>
...
<p class="section-subtitle">How might your opponent defend against Kimura from Side Control?</p>
...
<p class="section-subtitle">What mistakes should you avoid when executing Kimura from Side Control?</p>
