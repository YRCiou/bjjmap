...
---
title: "Kimura from Quarter Guard | BJJ Submission | BJJ Map"
description: "Master the Kimura shoulder lock from Quarter Guard top. Expert guide covering figure-four grip attacks, finishing mechanics, counters, and training drills for BJJ."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kimura from Quarter Guard", "item": "https://bjjmap.pages.dev/Submissions/Kimura-from-Quarter-Guard" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Kimura from Quarter Guard",
  "description": "The Kimura from Quarter Guard is a figure-four shoulder lock applied from the dominant top passing position, attacking the bottom player's near arm with forced internal rotation as their underhook or framing attempts expose the wrist.",
...
**The Kimura from Quarter Guard is a figure-four shoulder lock applied from the dominant top passing position, attacking the bottom player's near arm with forced internal rotation as their underhook or framing attempts expose the wrist.**
...
> [!danger] Safety
> Kimura from Quarter Guard targets the Shoulder joint, rotator cuff, and shoulder capsule. Primary risk: Rotator cuff tear (supraspinatus, infraspinatus, teres minor, subscapularis). Tap early; release immediately on the tap. [Full safety guide ↓](#safety-considerations)
...
- **Identify arm exposure window**: From established quarter guard top with crossface pressure, watch for the bottom player's near arm e...

- **Secure wrist control with far hand**: Release your far-side hand from hip control and grip the bottom player's exposed wrist using a C-gri...

- **Thread arm for figure-four grip**: Slide your crossface-side arm underneath the bottom player's trapped forearm from the outside, threa...

- **Pin the elbow to your hip**: Drive the bottom player's captured elbow tight against your hip bone using the figure-four grip, cre...

- **Establish finishing angle**: Shift your body weight slightly toward the bottom player's head while keeping your chest heavy on th...

- **Apply controlled rotational pressure**: Using hip rotation and body weight rather than arm strength alone, drive the bottom player's wrist i...

- **Complete the finish and release on tap**: Continue smooth progressive rotational pressure until the opponent taps. Keep your base wide and wei...
...
- **Pulling the wrist with arm strength instead of using body rotation and weight**
...
**Underhook Trap Entry**: Attack when the bottom player commits to establishing an underhook by swimming over their reaching arm and transitioning directly to the figure-four grip on the exposed wrist and forearm. (When to use: When the bottom player aggressively pursues the underhook, extending their arm past the safe retraction point)


**Frame Isolation Entry**: When the bottom player frames against your chest or shoulder with their near arm, redirect the framing wrist downward and secure the kimura grip during the moment their arm is extended and vulnerable. (When to use: When the bottom player relies on stiff-arm frames rather than underhooks for defense)


**Passing Chain Entry**: Feint guard pass completion to draw a defensive arm reaction from the bottom player, then redirect to the kimura attack on the arm they expose while scrambling to prevent the pass. (When to use: Against experienced defenders who keep arms tight unless forced to react to immediate passing threats)
...
- [[Positions/Half Guard]] - Related guard position where kimura opportunities also arise during passing
- [[Positions/Kimura Trap]] - Control position accessible when opponent defends the initial kimura finish
- [[Positions/Side Control]] - Adjacent position where kimura grip can be maintained if pass completes during attack
