...
---
title: "Kimura from New York Control | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kimura from New York Control", "item": "https://bjjmap.pages.dev/Submissions/Kimura-from-New-York-Control" }
  ]
}
</script>
...
| **Key Principles** | The overhook provides pre-existing arm isolation that elimin... | Prevent the grip conversion from overhook to figure-four bef... |
