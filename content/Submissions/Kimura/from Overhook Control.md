...
---
title: "Kimura from Overhook Control | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kimura from Overhook Control", "item": "https://bjjmap.pages.dev/Submissions/Kimura-from-Overhook-Control" }
  ]
}
</script>
...
| **Key Principles** | Maintain armpit seal pressure on opponent's shoulder through... | Defend the grip transition before the figure-four is establi... |
...
- [[Positions/Darce Control]] - Alternative submission control from same starting position
