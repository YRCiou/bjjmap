...
---
title: "Kimura from Knee on Belly | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kimura from Knee on Belly", "item": "https://bjjmap.pages.dev/Submissions/Kimura-from-Knee-on-Belly" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Kimura from Knee on Belly",
  "description": "The Kimura from Knee on Belly is a figure-four shoulder lock applied from top, where crushing knee pressure forces the bottom player to expose an arm that is then trapped and rotated against the shoulder joint.",
...
**The Kimura from Knee on Belly is a figure-four shoulder lock applied from top, where crushing knee pressure forces the bottom player to expose an arm that is then trapped and rotated against the shoulder joint.**
...
> [!danger] Safety
> Kimura from Knee on Belly targets the Shoulder joint, rotator cuff, and shoulder capsule. Primary risk: Rotator cuff tear (supraspinatus, infraspinatus, teres minor, subscapularis). Tap early; release immediately on the tap. [Full safety guide ↓](#safety-considerations)
...
**Pressure Bait Kimura**: Maintain heavy KOB pressure until the bottom player pushes on your knee with their far hand. The moment they extend their arm, capture the wrist and secure the figure-four grip while maintaining knee contact. (When to use: When the bottom player is reactive and consistently pushes against the knee to relieve pressure)


**Step-Off to North-South Finish**: After securing the figure-four grip from KOB, step your knee off the torso and rotate toward north-south position. This removes the bottom player's bridging power and creates a tighter rotational arc on the shoulder for a higher-percentage finish. (When to use: When the bottom player has strong bridging ability or when the in-place finish is being defended by straightening the arm)


**Near-Side Arm Capture**: Instead of attacking the far arm, target the near-side arm when the bottom player reaches across their body to establish an underhook or frame. Drop your weight to pin their elbow and secure the figure-four on the near wrist. (When to use: When the bottom player's near arm is exposed from reaching for underhooks or defensive frames)
...
- [[Positions/North-South]] - Common transition point for finishing the kimura with improved control
