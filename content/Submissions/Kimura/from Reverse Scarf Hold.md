...
---
title: "Kimura from Reverse Scarf Hold | BJJ Submission | BJJ Map"
description: "Master the Kimura shoulder lock from Reverse Scarf Hold with expert finishing mechanics, grip sequences, defensive counters, and safety protocols."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Kimura from Reverse Scarf Hold", "item": "https://bjjmap.pages.dev/Submissions/Kimura-from-Reverse-Scarf-Hold" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Kimura from Reverse Scarf Hold \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "Kimura from Reverse Scarf",
      "description": "Kimura from Reverse Scarf Hold film study: Kimura from Reverse Scarf, taught by Torres Martial Arts.",
    ...
    },
    {
      ...
      "description": "Kimura from Reverse Scarf Hold film study: Kimura trap from reverse kesa gatame, taught by Smith BJJ.",
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Kimura from Reverse Scarf Hold",
  "description": "The Kimura from Reverse Scarf Hold is a figure-four shoulder lock applied from ushiro kesa gatame, using crushing chest pressure to pin the opponent flat while rotating their trapped near arm behind their back for the tap.",
...
**The Kimura from Reverse Scarf Hold is a figure-four shoulder lock applied from ushiro kesa gatame, using crushing chest pressure to pin the opponent flat while rotating their trapped near arm behind their back for the tap.**
...
> [!danger] Safety
> Kimura from Reverse Scarf Hold targets the Shoulder joint, rotator cuff, and shoulder capsule. Primary risk: Rotator cuff tear (supraspinatus, infraspinatus, teres minor, subscapularis). Tap early; release immediately on the tap. [Full safety guide ↓](#safety-considerations)
...
<p class="section-subtitle">Watch Kimura from Reverse Scarf Hold in action — curated instructionals</p>
...
**Standard Figure-Four Entry**: From established reverse scarf hold, control the near-side wrist with your near hand, thread your far arm under the opponent's elbow, and connect the figure-four grip. The standard entry works best when the opponent's arm is already trapped across their body by positional control. (When to use: When opponent is passive and their near arm is already controlled across their torso)


**Arm Extraction Counter Entry**: When the opponent attempts to extract their trapped near arm by extending it away from their body, immediately capitalize by securing the wrist of the extending arm and threading the figure-four underneath. Their arm extraction attempt exposes the limb for the kimura grip. (When to use: When opponent actively tries to free their trapped arm from the reverse scarf hold control)


**Transition from Americana Threat**: Begin attacking the americana by driving the opponent's wrist toward the mat on the near side. When they resist by pulling their arm upward and away, redirect the energy into a kimura by switching to the figure-four grip on the now-elevated arm. (When to use: When opponent successfully defends the americana by pulling their arm away from the mat)
...
- [[Positions/North-South]] - Common transition target when kimura attempt fails
- [[Positions/Side Control/Kesa Gatame]] - Related scarf hold variant with similar submission opportunities
