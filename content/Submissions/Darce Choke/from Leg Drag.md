...
---
title: "Darce Choke from Leg Drag | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Darce Choke from Leg Drag", "item": "https://bjjmap.pages.dev/Submissions/Darce-Choke-from-Leg-Drag" }
  ]
}
</script>
...
**Standard Leg Drag Darce Entry**: From established leg drag control, drive crossface pressure to force opponent to turn in, then thread the near arm under their neck and through the far armpit as they rotate. Complete the figure-four grip and sprawl to finish. (When to use: When opponent turns toward you during leg drag control, exposing the neck-armpit channel)


**Darce from Leg Drag to Turtle Transition**: As the opponent attempts to turtle from leg drag bottom, follow their movement and thread the choking arm during the transition. The turtle position places the opponent's head lower, creating a tighter channel for the choke. (When to use: When opponent rolls to turtle to escape leg drag rather than turning into you)


**Marcelotine Grip Variation**: Instead of the traditional figure-four lock, use a guillotine-style grip where the free hand clasps the wrist of the threading arm. This variation works when the standard bicep grip is difficult to achieve due to opponent's arm positioning or sweat. (When to use: When you cannot reach the bicep for the standard figure-four grip due to opponent's defensive frames or slippery conditions)
