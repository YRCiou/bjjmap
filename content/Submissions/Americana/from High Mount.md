...
---
title: "Americana from High Mount | BJJ Submission | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Americana from High Mount", "item": "https://bjjmap.pages.dev/Submissions/Americana-from-High-Mount" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Americana from High Mount \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "How To Perform An Americana From Top Mount",
      "description": "Americana from High Mount film study: How To Perform An Americana From Top Mount, taught by Evolve MMA.",
    ...
    },
    {
      ...
      "description": "Americana from High Mount film study: Americana from Mount, taught by Chelsea Ozer.",
    ...
    },
    {
      ...
      "description": "Americana from High Mount film study: Finishing the Americana, taught by The Muscular Octopus.",
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Americana from High Mount",
  "description": "The Americana from High Mount is a figure-four shoulder lock where the top player pins the opponent's wrist to the mat and rotates the arm toward the hip, torquing the shoulder joint until they tap.",
...
**The Americana from High Mount is a figure-four shoulder lock where the top player pins the opponent's wrist to the mat and rotates the arm toward the hip, torquing the shoulder joint until they tap.**
...
> [!danger] Safety
> Americana from High Mount targets the Shoulder joint (specifically glenohumeral joint and rotator cuff). Primary risk: Rotator cuff tear (supraspinatus, infraspinatus, teres minor). Tap early; release immediately on the tap. [Full safety guide ↓](#safety-considerations)
...
<p class="section-subtitle">Watch Americana from High Mount in action — curated instructionals</p>
...
**Standard Paint Stroke Americana**: The classic finish where you pin the wrist beside the opponent's head, secure a figure-four grip under the tricep, and arc the arm toward the hip in a painting motion while keeping the elbow pinned to the mat. The high mount weight advantage makes this the highest-percentage variation. (When to use: When opponent's arm is accessible beside their head and you can establish a clean wrist pin without significant resistance)


**Drag Americana**: Instead of attacking the arm where it lies, drag the opponent's wrist across their body first using a cross-grip, then pin it to the mat on the opposite side before securing the figure-four. This changes the angle of rotation and can catch defenders who are conditioned to the standard setup. (When to use: When opponent successfully defends the standard side attack by keeping elbow tight, or when you want to create confusion about which arm you are targeting)


**Gift Wrap to Americana**: From high mount, thread your arm under the opponent's neck and grab their far wrist, creating a gift wrap position. Use this control to flatten them and isolate the wrapped arm, then transition to the figure-four americana grip. The gift wrap removes one arm from the defensive equation entirely. (When to use: When opponent is actively defending with both hands near their neck, making direct wrist pins difficult to establish)
...
- [[Positions/Armbar Control]] - Chain target when opponent straightens arm to defend the Americana grip
- [[Positions/Mount/S Mount]] - Alternative advancement when opponent pushes on hips during Americana defense
- [[Positions/Mount/Technical Mount]] - Transition target when defender turns to side attempting to relieve shoulder pressure
- [[Positions/Gift Wrap]] - Arm control position that can lead to Americana setup through wrist isolation
