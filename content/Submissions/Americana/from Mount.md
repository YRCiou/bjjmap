...
---
title: "Americana from Mount | BJJ Submission | BJJ Map"
description: "Master the Americana shoulder lock from mount with safety protocols, setup, and execution. Success rates: Beginner 45%, Intermediate 60%, Advanced 75%."
---
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Americana from Mount", "item": "https://bjjmap.pages.dev/Submissions/Americana-from-Mount" }
  ]
}
</script>
...
| **Key Principles** | Control the opponent's wrist before attempting to isolate th... | Keep elbows glued to your ribs at all times - never extend a... |
