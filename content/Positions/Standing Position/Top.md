...
---
title: "Standing Position Top | BJJ Position Guide | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Attack from Standing Position Top",
  "description": "Step-by-step guide to attacking and submitting from Standing Position position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Standing Position Top",
      "item": "https://bjjmap.pages.dev/Positions/Standing-Position-Top"
    }
  ]
}
</script>
...
<p class="section-subtitle">What is Standing Position (Top)?</p>
...
<p class="section-subtitle">What do you need before playing Standing Position (Top)?</p>
...
<p class="section-subtitle">What are the key principles for attacking from Standing Position?</p>
...
<p class="section-subtitle">What should you do from Standing Position (Top)?</p>
...
<p class="section-subtitle">What mistakes should you avoid when attacking from Standing Position?</p>
...
<p class="section-subtitle">How do you train Standing Position attacks?</p>
