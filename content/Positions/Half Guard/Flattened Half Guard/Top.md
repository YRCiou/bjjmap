...
---
title: "Flattened Half Guard Top | BJJ Position Guide | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Attack from Flattened Half Guard Top",
  "description": "Step-by-step guide to attacking and submitting from Flattened Half Guard position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you remaining static with heavy chest pressure without advancing position or creating passing angles?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Allows opponent time to systematically recover frames through incremental hip escapes and space creation The correct approach is: Maintain dynamic pressure that flows between control and advancement - use pressure to limit movement while creating angles for passing sequences"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you posting hands wide or sitting back to adjust position while maintaining flattened half guard control?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Creates space that allows immediate frame recovery and knee shield re-establishment by opponent The correct approach is: Keep chest pressure constant throughout transitions - adjust position through hip movement and weight shifts while maintaining chest-to-chest contact"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you forcing knee slice directly through trapped leg without creating proper angle or timing?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent easily defends with leg hook, wasting energy and telegraphing passing intentions The correct approach is: Create angle first by driving hips to side, then slice knee through when opponent is managing pressure rather than defending leg"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you losing crossface control while attempting to pass or transition to different position?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opens multiple defensive pathways as opponent can now see action, use near arm for frames, and turn into position The correct approach is: Maintain crossface throughout entire passing sequence - transition crossface to different control points rather than abandoning it during movement"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you applying all pressure through arms and shoulders rather than distributing through chest and hips?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Burns arm and shoulder muscles quickly while creating unstable pressure that's easily disrupted by hip movements The correct approach is: Drive pressure through chest and hips with arms used only for positioning and control - let body weight do the work rather than muscular effort"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Flattened Half Guard Top",
      "item": "https://bjjmap.pages.dev/Positions/Flattened-Half-Guard-Top"
    }
  ]
}
</script>
