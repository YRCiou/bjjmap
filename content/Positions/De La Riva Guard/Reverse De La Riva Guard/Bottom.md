...
---
title: "Reverse De La Riva Guard Bottom | BJJ Position Guide | BJJ Map"
description: "Master Reverse De La Riva Guard Bottom in BJJ. Complete guide covering inverted hook mechanics, waiter sweeps, berimbolo entries, and kiss of the dragon back takes. Success rates: Beginner 35%, Intermediate 55%, Advanced 75%."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Escape Reverse De La Riva Guard Bottom",
  "description": "Step-by-step guide to escaping and defending Reverse De La Riva Guard position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you keeping hips flat on the mat without active elevation?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Reduces mobility and eliminates the off-balancing pressure that makes the position effective, allowing opponent to easily control distance and initiate passes. Static hip positioning also makes it impossible to generate the rotational movement needed for back takes. The correct approach is: Actively elevate your hips off the mat by engaging your core and maintaining tension in your hook structure, creating dynamic pressure that keeps opponent off-balance. Think of your hips as the steering wheel that controls the direction of the sweep or back take. Recognition: If you feel static or unable to generate movement, your hips are likely too flat."
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you losing far leg control during transitions?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Allows opponent to step away with their far leg, establishing distance and stable base from which they can initiate passing sequences or completely disengage from the guard. Without far leg control, the inverted hook loses its off-balancing power. The correct approach is: Maintain constant awareness of far leg control through hooks or grips, adjusting between ankle control and knee control based on opponent's position. If you lose the hook, immediately transition to a grip or re-establish control before attempting offensive techniques. The far leg control is what prevents opponent escape and creates the leverage for sweeps."
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you allowing shoulders to turn away from opponent?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Exposes your back and eliminates offensive options, transforming you into a defensive position where opponent can attack your turtle or establish top control. Turning away also breaks the visual connection needed to read opponent's reactions and time your attacks. The correct approach is: Keep shoulders square to opponent with chest facing toward them, maintaining visual contact and hand positioning that controls distance. Your upper body should always be engaged with opponent through grips and frames, never turning to expose your back unless executing a deliberate inversion technique."
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you static hook positioning without dynamic adjustment?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Allows opponent to adapt to your pressure and establish counter-pressure, neutralizing the off-balancing effect of the inverted hook. Static hooks are easy to defend and don't create the dilemmas that force opponent into vulnerable positions. The correct approach is: Constantly adjust hook depth and angle based on opponent's weight distribution, using push-pull motion to keep them reacting. The inverted hook should feel like a constant wave of pressure rather than a fixed anchor point. Vary between deep hooks around the thigh and shallow hooks on the calf based on what creates the most off-balancing effect."
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you gripping opponent's far ankle without controlling their near leg?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Creates an imbalanced control system where opponent can easily drive their near knee forward to smash pass or establish headquarters position. The far ankle grip alone is insufficient to prevent skilled passers from working around the inverted hook. The correct approach is: Use your far leg to control opponent's near leg (either hooking behind their knee or establishing a frame on their hip) while your hand grips their far ankle. This creates a diagonal control system that prevents them from driving forward or stepping away. Both sides of the control structure must work together to create effective off-balancing."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Reverse De La Riva Guard Bottom",
      "item": "https://bjjmap.pages.dev/Positions/Reverse-De-La-Riva-Guard-Bottom"
    }
  ]
}
</script>
...
<p class="section-subtitle">What is Reverse De La Riva Guard (Bottom)?</p>
...
<p class="section-subtitle">What do you need before playing Reverse De La Riva Guard (Bottom)?</p>
...
<p class="section-subtitle">What are the key principles for defending Reverse De La Riva Guard?</p>
...
<p class="section-subtitle">What should you do from Reverse De La Riva Guard (Bottom)?</p>
...
- Execute **[[Guard Recovery/Attacker|Guard Recovery]]** → [[Positions/Open Guard]] (Probability: 60%)
...
<p class="section-subtitle">What mistakes should you avoid when defending Reverse De La Riva Guard?</p>
...
<p class="section-subtitle">How do you train Reverse De La Riva Guard defense?</p>
