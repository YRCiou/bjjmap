...
---
title: "Mount Bottom | BJJ Position Guide | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Escape Mount Bottom",
  "description": "Step-by-step guide to escaping and defending Mount position in BJJ.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Execute Elbow Escape from Mount",
      "text": "From this position, attempt Elbow Escape from Mount. This technique is attempted in 26% of exchanges from this position.",
      "position": 1
    },
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      "text": "From this position, attempt Trap and Roll from Mount. This technique is attempted in 14% of exchanges from this position.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Execute Heel Drag Escape",
      "text": "From this position, attempt Heel Drag Escape. This technique is attempted in 14% of exchanges from this position.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Execute Explosive Bridge to Turtle",
      "text": "From this position, attempt Explosive Bridge to Turtle. This technique is attempted in 9% of exchanges from this position.",
      "position": 5
    },
    {
      "@type": "HowToStep",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What happens if you lying completely flat on back with no defensive frames or angle established?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Allows opponent to distribute full weight making escape nearly impossible and exposing all submission targets The correct approach is: Immediately establish elbow-knee connection frames and maintain slight angle to prevent flat positioning"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you attempting explosive bridge without first trapping opponent's arm and corresponding leg?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Opponent posts free hand easily maintaining base while wasting defender's energy and potentially exposing back The correct approach is: Only bridge explosively after properly trapping same-side arm and foot, or use bridge as setup for hip escape"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you pushing directly on opponent's chest or shoulders with extended straight arms?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Creates immediate vulnerability for Americana, Kimura, and armbar attacks on the extended limbs The correct approach is: Frame on hips and cross-face area using forearm frames rather than extended arm pushing"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you turning to side prematurely without creating sufficient space through hip escape first?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Gives up back control to opponent who can insert hooks easily into the exposed space The correct approach is: Create space through shrimping first, then turn only when sufficient distance prevents hook insertion"
      }
    },
    {
      "@type": "Question",
      "name": "What happens if you using only upper body strength for escape attempts without engaging hip escape mechanics?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Rapid energy depletion with minimal position improvement as arms fatigue against body weight The correct approach is: Focus on hip escape mechanics and leg drive rather than arm strength for sustainable escape"
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Mount Bottom",
      "item": "https://bjjmap.pages.dev/Positions/Mount-Bottom"
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Mount (Bottom) \u2014 Film Study",
  "itemListElement": [
    {
      "@type": "VideoObject",
      "position": 1,
      "name": "2 Mount Escape Options to Half Guard",
      "description": "Mount (Bottom) film study: 2 Mount Escape Options to Half Guard, taught by Revolution BJJ.",
    ...
    },
    {
      "@type": "VideoObject",
      "position": 2,
      "name": "Simple Mount Escape You Should Try",
      "description": "Mount (Bottom) film study: Simple Mount Escape You Should Try, taught by Gabriel Gonzaga.",
    ...
    },
    {
      "@type": "VideoObject",
      "position": 3,
      "name": "Escape the Mount: Knee and Elbow Escape",
      "description": "Mount (Bottom) film study: Escape the Mount: Knee and Elbow Escape, taught by Jamie.",
...
<p class="section-subtitle">Watch Mount (Bottom) in action — curated instructionals</p>
...
<p class="clip-credit"><strong>Simple Mount Escape You Should Try</strong> — taught by Gabriel Gonzaga · 1:33 · <a href="https://www.youtube.com/watch?v=9252EvCT0q4" rel="noopener">Watch on YouTube</a></p>
...
<p class="clip-credit"><strong>Escape the Mount: Knee and Elbow Escape</strong> — taught by Jamie · 1:11 · <a href="https://www.youtube.com/watch?v=pUZcLTWHAzk" rel="noopener">Watch on YouTube</a></p>
...
### 2. Attempting explosive bridge without first trapping opponent's arm and corresponding leg
...
### 3. Pushing directly on opponent's chest or shoulders with extended straight arms
...
### 4. Turning to side prematurely without creating sufficient space through hip escape first
...
### 5. Using only upper body strength for escape attempts without engaging hip escape mechanics
...
### 6. Reaching up to grab opponent's head or collar during escape attempts
...
### 7. Panicking and attempting random explosive movements without systematic escape strategy
...
Partner maintains mount while defender works through escape hierarchy in order: prevent advancement, establish frames, hip escape, insert knee, recover guard. Reset and repeat focusing on each step individually before chaining.

**Duration**: 5 minutes continuous with 1 minute rest, 3 rounds


### Sustained Pressure Survival Drill

Bottom practitioner defends mount for extended period while top applies sustained pressure and threatens submissions. Focus on frame maintenance, controlled breathing, and identifying escape windows without panicking.
...
Start with compliant partner allowing escapes at 30% resistance, increase to 50% then 80% over rounds. Partner gives specific scenarios including high mount, low mount, and posted arm for targeted escape practice.

**Duration**: 10 minutes alternating roles every 2 minutes


### Bridge and Trap Power Development

Partner in mount, bottom practitioner practices explosive bridges with proper same-side arm and leg trap setup. Focus on timing the trap, generating maximum hip drive, and committing fully to the directional roll.
