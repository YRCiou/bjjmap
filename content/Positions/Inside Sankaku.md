...
---
title: "Inside Sankaku | BJJ Position Guide | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Inside Sankaku", "item": "https://bjjmap.pages.dev/Positions/Inside-Sankaku" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "Inside Sankaku",
  "description": "Inside Sankaku is a dominant leg entanglement that traps the opponent's leg in a figure-four with your legs, exposing their inside heel for high-percentage inside heel hook attacks while controlling their hip and knee line.",
...
[[Inside Sankaku/Top|Play as Top]]

</div>

<section id="overview" class="content-section">

**Inside Sankaku is a dominant leg entanglement that traps the opponent's leg in a figure-four with your legs, exposing their inside heel for high-percentage inside heel hook attacks while controlling their hip and knee line.**
...
- Control the knee line barrier to prevent defensive rotation and maintain inside heel exposure

- Systematically break down defensive layers before attempting submission - position before submission

- Maintain proper leg configuration with outside leg crossed over inside leg to secure entanglement

- Distribute weight through hips rather than hands to maximize control pressure on the entanglement

- Remain aware of counter-attack opportunities and protect your own legs while maintaining offensive control

- Use strategic patience to tire opponent's defensive efforts before committing to finishing attacks
...
- **[[Transitions/Counter Leg Attack/Attacker|Counter Leg Attack]]** (17% of attempts)

- **[[Transitions/Frame and Extract to Half Guard/Attacker|Frame and Extract to Half Guard]]** (17% of attempts)

- **[[Transitions/Counter-entangle to 50-50 Guard/Attacker|Counter-entangle to 50-50 Guard]]** (16% of attempts)

- **[[Transitions/Sweep from Inside Sankaku/Attacker|Sweep from Inside Sankaku]]** (9% of attempts)
...
- **[[Transitions/Inside Ashi-Garami to Honey Hole/Attacker|Inside Ashi-Garami to Honey Hole]]** (7% of attempts)
