...
---
title: "Worm Guard | BJJ Position Guide | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Worm Guard", "item": "https://bjjmap.pages.dev/Positions/Worm-Guard" }
  ]
}
</script>
...
- Use lapel as a lever to break opponent's posture and control their movement

- Keep opponent's trapped leg immobilized by pulling the lapel tight around it

- Use your legs to create angles and prevent opponent from squaring up or establishing strong base

- Transition between related lapel guards (Squid, Ringworm) when opponent attempts to counter

- Create sweeping opportunities by off-balancing opponent in the direction their trapped leg cannot recover

- Protect your own lapels and prevent opponent from establishing reciprocal lapel control
...
- **[[Positions/Squid Guard]]** - Advanced progression with additional leg control

- **[[Positions/Ringworm Guard]]** - Alternative lapel configuration using similar principles

- **[[Positions/Lapel Guard]]** - Parent category encompassing worm guard variations

- **[[Positions/De La Riva Guard]]** - Traditional guard often combined with worm guard lapel control

- **[[Positions/Lasso Guard]]** - Similar control mechanism using leg threading

- **[[Positions/Spider Guard]]** - Related open guard that can transition to worm guard

- **[[Positions/X-Guard]]** - Common transition target when transitioning away from lapel control

- **[[Positions/K-Guard]]** - Related modern guard system with similar control concepts
