...
---
title: "Omoplata Control | BJJ Position Guide | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Omoplata Control", "item": "https://bjjmap.pages.dev/Positions/Omoplata-Control" }
  ]
}
</script>
...
- Use leg pressure across the back as both control mechanism and submission threat

- Create dilemmas where every defensive option leads to different offensive opportunity

- Monitor opponent's weight distribution to anticipate and counter escape attempts

- Transition fluidly between submission finish, sweep, and back take based on defensive reactions

- Control opponent's free arm to limit their base and defensive options

- Adjust hip angle continuously to maintain optimal leverage on shoulder joint
...
- **[[Transitions/Cartwheel Escape from Omoplata/Attacker|Cartwheel Escape from Omoplata]]** (13% of attempts)

- **[[Transitions/Roll Forward from Omoplata/Attacker|Roll Forward from Omoplata]]** (15% of attempts)

- **[[Transitions/Stack Defense from Omoplata/Attacker|Stack Defense from Omoplata]]** (13% of attempts)
...
- **[[Transitions/Armbar on Free Arm/Attacker|Armbar on Free Arm]]** (18% of attempts)

- **[[Transitions/Rolling Back Take/Attacker|Rolling Back Take]]** (20% of attempts)

- **[[Transitions/Omoplata to Sweep/Attacker|Omoplata to Sweep]]** (21% of attempts)
