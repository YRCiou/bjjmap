...
---
title: "50-50 Guard | BJJ Position Guide | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "50-50 Guard", "item": "https://bjjmap.pages.dev/Positions/50-50-Guard" }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTerm",
  "name": "50-50 Guard",
  "description": "The 50-50 Guard is a symmetrical leg entanglement in which both grapplers trap one of each other's legs across the hips in a mirror image, giving each equal access to heel hooks and other leg attacks while neither scores points.",
...
**The 50-50 Guard is a symmetrical leg entanglement in which both grapplers trap one of each other's legs across the hips in a mirror image, giving each equal access to heel hooks and other leg attacks while neither scores points.**

Among the leg entanglements that define modern Brazilian Jiu-Jitsu, the 50-50 Guard is the most polarizing - a stalling trap in the eyes of traditionalists and a high-level attacking platform in the hands of leg lock specialists. Named for the theoretically equal positioning of both competitors, its strategic richness comes from a mirrored geometry in which the smallest grip, angle, or foot-control advantage decides who attacks first.
...
[[50-50 Guard/Bottom|→ Full Bottom Guide]]
...
- **[[Transitions/Counter heel hook/Attacker|Counter heel hook]]** (26% of attempts)

- **[[Transitions/50-50 Guard to Single Leg X-Guard/Attacker|50-50 Guard to Single Leg X-Guard]]** (14% of attempts)

- **[[Transitions/Extract legs and stand up/Attacker|Extract legs and stand up]]** (17% of attempts)

- **[[Transitions/Straight Ankle Lock Entry/Attacker|Straight Ankle Lock Entry]]** (16% of attempts)
...
- ❌ **Attempting to reverse position or execute escapes while opponent has access to your heel**
...
- ❌ **Failing to assess inside position honestly and fighting for reversal when opponent has clear advantage**
...
- ❌ **Remaining static on bottom without creating hip movement or space**
...
- ❌ **Ignoring grip fighting and allowing opponent to establish controlling grips**
...
- ❌ **Exhausting yourself with continuous failed escape attempts**
...
[[50-50 Guard/Top|→ Full Top Guide]]
...
- ❌ **Losing inside position by allowing opponent's leg to gain inside angle**
...
- ❌ **Maintaining light hips without constant downward pressure**
...
- ❌ **Chasing heel hook when opponent successfully hides their heel**
...
- ❌ **Using upper body weight by leaning forward instead of maintaining upright posture**
...
- ❌ **Releasing grip control to adjust position without securing replacement grip first**
