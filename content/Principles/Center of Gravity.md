...
---
title: "Center of Gravity | BJJ Principle | BJJ Map"
...
<script type="application/ld+json">
{
  ...
  "@type": "HowTo",
  "name": "How to Apply Center of Gravity in BJJ",
  "description": "Decision framework for applying Center of Gravity.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Assess current position and identify primary control objectives",
      "text": "Determine whether priority is preventing escapes, setting up submissions, enabling transitions, or conserving energy, as this dictates optimal weight distribution pattern for the specific tactical situation.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Identify opponent's most dangerous escape vectors from current position",
      "text": "Analyze which escape paths present greatest threat based on opponent's skill level and previous attempts, prioritizing weight allocation toward blocking these specific vectors rather than applying generic heavy pressure.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Establish initial weight distribution pattern across contact points",
      "text": "Allocate weight strategically across identified contact points with heavier concentration on primary control targets and lighter pressure on base points, creating initial distribution that achieves control objectives while maintaining stability.",
      "position": 3
    },
    {
      "@type": "HowToStep",
      "name": "Monitor opponent's pressure response and defensive strategy",
      "text": "Use tactile feedback to detect how opponent is dealing with current weight distribution, sensing whether they're accepting pressure passively, attempting explosive escapes, or using technical framing to create space.",
      "position": 4
    },
    {
      "@type": "HowToStep",
      "name": "Modulate distribution dynamically based on opponent reactions",
      "text": "Adjust weight allocation in real-time response to opponent's defensive efforts, increasing pressure where they're attempting to create space while potentially lightening pressure in areas where they've stopped resisting to conserve energy.",
      "position": 5
    },
    {
      "@type": "HowToStep",
      "name": "Coordinate weight shifts with technical execution",
      "text": "When executing techniques or transitions, strategically shift weight distribution to enable smooth movement while maintaining sufficient control to prevent escapes during the vulnerable transitional moment.",
      "position": 6
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "description": "Master strategic weight allocation in BJJ top positions. Learn biomechanical pressure principles, dynamic distribution adjustment, and energy-efficient control.",
  "url": "https://bjjmap.pages.dev/Principles/Center-of-Gravity",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BJJ Map",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 3, "name": "Center of Gravity", "item": "https://bjjmap.pages.dev/Principles/Center-of-Gravity"}
  ]
}
</script>
...
### Related Principles
- **[[Pressure]]** (Prerequisite): Center of Gravity represents the strategic refinement of basic Pressure principles, taking the fundamental concept of applying bodyweight and transforming it into a sophisticated system of targeted allocation and dynamic modulation.
- **[[Base]]** (Complementary): Base and Center of Gravity work in constant tension and cooperation, where effective weight distribution requires maintaining sufficient base integrity, while base maintenance often necessitates strategic weight allocation decisions that balance stability against control effectiveness.
- **[[Levers]]** (Prerequisite): Understanding biomechanical leverage is essential for intelligent weight distribution, as optimal pressure allocation depends on identifying leverage points where minimal weight creates maximum control effect through mechanical advantage rather than pure force.
...
- **[[Positional Hierarchy]]** (Prerequisite): Understanding the positional hierarchy is essential for intelligent weight distribution, as knowing the relative value of positions informs how aggressively to commit weight for control versus preserving mobility for advancement, and which positions warrant maximum pressure investment.
- **[[Maximum Efficiency Principle]]** (Extension): Center of Gravity embodies the Maximum Efficiency Principle by seeking to achieve maximum control with minimum effort through strategic allocation rather than maximum force application, exemplifying the core judo principle in practical application.
- **[[Kuzushi]]** (Complementary): Kuzushi and Center of Gravity work synergistically from opposite perspectives: understanding how sweeps exploit poor weight distribution makes the top player's allocation more intelligent, while strategic weight distribution from top creates the imbalances that bottom players must address defensively.
