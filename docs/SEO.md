...
```
[Content Name] | [Content Type] | BJJ Map
```

Examples:
- "Mount | BJJ Position Guide | BJJ Map"
- "Hip Bump Sweep | BJJ Technique | BJJ Map"
- "Triangle Choke | BJJ Submission | BJJ Map"
...
- [ ] Title follows format: `[Name] | [Type] | BJJ Map`
