...
// measured, a run from `bjjmap-share` was served a 343,153-byte `neural.js` from
// `bjjmap-legacy` (ours was 364,190). The gate that most needs to be trustworthy was the last
